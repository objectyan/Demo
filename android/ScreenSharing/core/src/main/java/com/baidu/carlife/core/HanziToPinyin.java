...
/* renamed from: com.baidu.carlife.core.g */
public class HanziToPinyin implements KeepClass {
    /* renamed from: a */
    public static final char[] UNIHANS = new char[]{'\u963f', '\u54ce', '\u5b89',
            '\u80ae', '\u51f9', '\u516b', '\u6300', '\u6273', '\u90a6',
            '\u52f9', '\u9642', '\u5954', '\u4f3b', '\u5c44', '\u8fb9',
            '\u706c', '\u618b', '\u6c43', '\u51ab', '\u7676', '\u5cec',
            '\u5693', '\u5072', '\u53c2', '\u4ed3', '\u64a1', '\u518a',
    ...
    /* compiled from: HanziToPinyin */
    /* renamed from: com.baidu.carlife.core.g$a */
        ...
        for (char c : UNIHANS) {
            if (lastChar != c) {
                ...
                if (COLLATOR.compare(lastString, curString) >= 0) {
                    LogUtil.e(Tag, "Internal error in Unihan table. The last string \"" + lastString + "\" is greater than current string \"" + curString + "\".");
                    return false;
                }
