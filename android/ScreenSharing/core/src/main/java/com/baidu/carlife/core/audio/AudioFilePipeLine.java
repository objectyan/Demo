...
public class AudioFilePipeLine {
    ...
    private static class C1170a {
        /* renamed from: a */
        static final AudioFilePipeLine f3031a = new AudioFilePipeLine();
    ...
    /* renamed from: a */
    public static AudioFilePipeLine m3916a() {
    ...
    public void m3918a(String path) {
        try {
            ...
            e.printStackTrace();
            LogUtil.m4445e(f3032a, "InterruptedException in put, message is " + e.getMessage());
        } catch (NullPointerException e2) {
            e2.printStackTrace();
            LogUtil.m4445e(f3032a, "NullPointerException in put, message is " + e2.getMessage());
        }
    }
    ...
    public String m3921c() {
        try {
            ...
            e.printStackTrace();
            LogUtil.m4445e(f3032a, "InterruptedException in take, message is " + e.getMessage());
            return "";
        }
    }
