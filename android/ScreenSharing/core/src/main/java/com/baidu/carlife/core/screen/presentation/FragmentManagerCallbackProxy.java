...
public class FragmentManagerCallbackProxy implements OnFragmentManagerCallback {
    /* renamed from: a */
    private static FragmentManagerCallbackProxy f3824a;
    /* renamed from: b */
    private NaviFragmentManager f3825b;

    private FragmentManagerCallbackProxy(NaviFragmentManager naviFragmentManager) {
    ...
    public static void m4758a(NaviFragmentManager naviFragmentManager) {
        f3824a = new FragmentManagerCallbackProxy(naviFragmentManager);
    }
