...
public class ReceiverAndConverterThreadInternal extends BaseReceiverAndConverterThread {
    ...
    /* renamed from: k */
    private static Recorder f3853k = Recorder.m4826b();
    /* renamed from: l */
    ...
    public void run() {
        if (f3853k.m4879j() || f3853k.m4840G()) {
            ...
            try {
                f3853k.m4874g(true);
                LogUtil.d(f3850h, "ReceiverAndConverterThreadInternal isRunning=" + this.a);
                ...
                if (!f3853k.m4879j()) {
                    ...
                    f3853k.m4834A();
                    while (this.a) {
                        LogUtil.m4440c(f3850h, "enter  readAndConvert, isRunning=" + this.a);
                        m4808d();
                    }
                    LogUtil.d(f3850h, "ReceiverAndConverterThreadInternal  run finished.");
                    m4807c();
    ...
    private void m4808d() {
        ...
        m4810f();
        JniMethod.convert(d, f3852j, Recorder.f3861b, Recorder.f3862c);
