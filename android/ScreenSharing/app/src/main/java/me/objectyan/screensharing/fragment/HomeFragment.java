...
public class HomeFragment extends ContentFragment implements OnClickListener, OnItemClickListener {
    ...
    /* renamed from: C */
    private HomePersonPanelAdapter f4457C;
    /* renamed from: d */
    ...
    private C0924a f4479y = new C0924a(this) {
        ...
        public void onNetWorkResponse(int responseCode) {
            ...
            if (vehicleLogoModel == null) {
                if (CommonParams.sVehicleChannel.getChannel().equals(channel)) {
            ...
            } else if (CommonParams.sVehicleChannel.getChannel().equals(channel)) {
    ...
    class C14973 implements C1496a {
        ...
        public void mo1564a(String error) {
            LogUtil.d(HomeFragment.f4452a, "UserOnlineNumberRequest error " + error);
        }
    }
    ...
    class C15058 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    private class C1507a extends MsgBaseHandler {
        /* renamed from: a */
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 3007:
                    ...
                    this.f4451a.m5478g();
                    if (msg.what == 1002) {
                        LogUtil.d(HomeFragment.f4452a, "####### MSG_CONNECT_STATUS_DISCONNECTED : " + this.f4451a.f4470p);
                        if (this.f4451a.f4470p != null) {
                            this.f4451a.f4470p.setVisibility(8);
                            View bank1 = this.f4451a.mContentView.findViewById(R.id.card_bank_1);
                            if (bank1 != null) {
                                bank1.setVisibility(8);
                            }
                            View bank2 = this.f4451a.mContentView.findViewById(R.id.card_bank_2);
                            if (bank2 != null) {
                                bank2.setVisibility(8);
                            }
                            View bank3 = this.f4451a.mContentView.findViewById(R.id.card_bank_3);
                            if (bank3 != null) {
                                bank3.setVisibility(8);
                            }
                            View bank4 = this.f4451a.mContentView.findViewById(R.id.card_bank_4);
                            if (bank4 != null) {
    ...
    private void m5458a(Drawable drawable, String name) {
        if (isAdded() && this.f4461g != null) {
            if (drawable == null) {
                this.f4461g.m8438e((int) R.drawable.home_ic_carlife_card);
            } else {
            ...
            if (!TextUtils.isEmpty(name)) {
                ...
                this.f4461g.m8439f((int) R.drawable.home_ic_carlife_name);
            } else {
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        this.mContentView = inflater.inflate(R.layout.frag_home_big_screen, null);
        this.f4463i = new C1507a();
        MsgHandlerCenter.m4460a(this.f4463i);
    ...
    /* renamed from: b */
    private void m5465b() {
        this.f4458d = (HomeCardView) this.mContentView.findViewById(R.id.home_card_navi);
        this.f4459e = (HomeCardView) this.mContentView.findViewById(R.id.home_card_music);
        this.f4460f = (HomeCardView) this.mContentView.findViewById(R.id.home_card_discover);
        this.f4461g = (HomeCardView) this.mContentView.findViewById(R.id.home_card_carlife);
        this.f4462h = (HomeCardView) this.mContentView.findViewById(R.id.home_card_exit);
        this.f4467m = (SimpleDraweeView) this.mContentView.findViewById(R.id.btn_person);
        this.f4468n = this.mContentView.findViewById(R.id.rl_person);
        this.f4469o = this.mContentView.findViewById(R.id.red_point);
        this.f4470p = this.mContentView.findViewById(R.id.viewadapt);
        m5513a();
    }
        ...
        this.f4459e.m8420a(new OnClickListener(this) {
            ...
            public void onClick(View v) {
                ...
                if (C1818h.m6730b().m6834v()) {
                    ...
                    C2201w.m8370a((int) R.string.network_unconnected);
                }
            }
        }).m8428b(new OnClickListener(this) {
            /* renamed from: a */
    ...
    private void m5456a(int dataType) {
        if (C1818h.m6730b().m6834v() && dataType == 101) {
            ...
            this.f4459e.m8426b((int) R.drawable.com_home_ic_music_pause_selector);
            this.f4459e.m8431c((int) R.drawable.com_home_ic_music_next_selector);
            this.f4459e.m8425b();
            return;
        }
        this.f4455A = true;
        m5473d();
        this.f4459e.m8426b((int) R.drawable.com_home_ic_music_play_selector01);
    }
    ...
    private void m5466b(int count) {
        if (this.f4459e != null && !this.f4472r) {
            if (count <= 0) {
                ...
                this.f4459e.m8429b(String.valueOf(count) + getResources().getString(R.string.listen_user));
            } else if (count < CommonParams.iE) {
                int tmp = count / 1000;
                if (tmp % 10 == 0) {
                    this.f4459e.m8429b(String.valueOf(m5512a((double) ((tmp / 10) * 10000))) + getResources().getString(R.string.listen_user));
                } else {
                    this.f4459e.m8429b(String.valueOf(m5512a((((double) tmp) / 10.0d) * 10000.0d)) + getResources().getString(R.string.listen_user));
                }
            } else {
                this.f4459e.m8429b(getResources().getString(R.string.listen_user_ten_m));
            }
        }
    }
    ...
    public boolean onVoiceCommand(String strCommand, String strIntent) {
        LogUtil.d(f4452a, "HomeFragment VOICE Command: " + strCommand + " # " + strIntent);
    ...
    private void m5457a(int drawableId, int stringId) {
        ...
        this.f4477w = CommonParams.sVehicleChannel.getChannel();
    }

    /* renamed from: l */
    private void m5488l() {
        EnumVehicleChannel v = CommonParams.sVehicleChannel;
        switch (v) {
            case VEHICLE_CHANNEL_NORMAL:
                this.f4475u = null;
                this.f4476v = null;
                m5458a(this.f4475u, this.f4476v);
                this.f4477w = v.getChannel();
                return;
            default:
                if (!v.getChannel().equals(this.f4477w) || this.f4475u == null) {
                    this.f4477w = v.getChannel();
    ...
    public void onDetach() {
        MsgHandlerCenter.m4464b(this.f4463i);
        super.onDetach();
    }
    ...
    public void onInitFocusAreas() {
        if (this.mContentView != null && this.f4458d != null && this.f4459e != null && this.f4460f != null && this.f4461g != null && this.f4468n != null) {
            ...
            if (this.f4464j == null) {
                this.f4464j = new C1443g(this.mContentView.findViewById(R.id.layout_icons), 4);
            ...
            if (this.f4466l == null) {
                ...
                this.f4466l.m5300d(rootView.findViewById(R.id.iv_home)).m5300d(rootView.findViewById(R.id.iv_phone_book)).m5300d(rootView.findViewById(R.id.iv_voice_focus_bg)).m5300d(rootView.findViewById(R.id.iv_navi)).m5300d(rootView.findViewById(R.id.iv_music));
            }
            this.f4466l.m5298b(true);
            this.f4466l.m5297b(rootView.findViewById(R.id.iv_voice_focus_bg));
    ...
    private void m5492n() {
        if (this.f4457C == null) {
            this.f4457C = new HomePersonPanelAdapter(getActivity());
    ...
    private void m5497p() {
        if (this.f4457C != null) {
            boolean isLogin;
            String userName = getContext().getString(R.string.user_not_login);
            try {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        switch (position) {
            ...
            case 5:
                if (this.f4471q == null) {
                    this.f4471q = new C1953c(mActivity).m7442b((int) R.string.alert_delete_navi_cache).m7435a((int) R.string.alert_delete_navi_cache_content).m7457g(17).m7447c((int) R.string.alert_confirm).m7458q().m7450d((int) R.string.alert_cancel);
    ...
    /* renamed from: s */
    private void m5503s() {
        if (AddressSettingModel.hasSetCompAddr(AppContext.m3876a())) {
            m5463a(AddressSettingModel.getCompAddrNode(AppContext.m3876a()));
        } else {
    ...
    /* renamed from: t */
    private void m5505t() {
        if (AddressSettingModel.hasSetHomeAddr(AppContext.m3876a())) {
            m5463a(AddressSettingModel.getHomeAddrNode(AppContext.m3876a()));
        } else {
    ...
    /* renamed from: u */
    private void m5507u() {
        LogUtil.d(f4452a, "goVoiceNavi" + C2837c.STATE_WHERE_GOING);
    ...
    private void m5463a(final RoutePlanNode node) {
        if (BaiduNaviSDKManager.getInstance().isNaviBegin()) {
            showDialog(new C1953c(mActivity).m7435a((int) R.string.dialog_quit_naviing_to_navi).m7447c((int) R.string.alert_confirm).m7450d((int) R.string.alert_cancel).m7438a(new OnBtnClickListener(this) {
                /* renamed from: b */
    ...
    /* renamed from: a */
    public void m5513a() {
        if (this.f4470p != null && CarlifeScreenUtil.m4334m()) {
            this.f4470p.setVisibility(0);
            View bank1 = this.mContentView.findViewById(R.id.card_bank_1);
            if (bank1 != null) {
                bank1.setVisibility(0);
            }
            View bank2 = this.mContentView.findViewById(R.id.card_bank_2);
            if (bank2 != null) {
                bank2.setVisibility(0);
            }
            View bank3 = this.mContentView.findViewById(R.id.card_bank_3);
            if (bank3 != null) {
                bank3.setVisibility(0);
            }
            View bank4 = this.mContentView.findViewById(R.id.card_bank_4);
            if (bank4 != null) {
