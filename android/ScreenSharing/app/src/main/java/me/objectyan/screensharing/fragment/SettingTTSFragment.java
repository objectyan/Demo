...
public class SettingTTSFragment extends ContentFragment implements OnClickListener {
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        this.f4820a = (ViewGroup) inflater.inflate(R.layout.frag_tts_setting, null);
        setCommonTitleBar(this.f4820a, getString(R.string.tts_setting));
        this.f4821b = (TextView) this.f4820a.findViewById(R.id.tv_preference_01);
        this.f4822c = (TextView) this.f4820a.findViewById(R.id.tv_preference_02);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_preference_01) {
        ...
        } else if (v.getId() == R.id.tv_preference_02) {
            CarlifeViewContainer.m4699a().m4701b().mo1467b("切换中...");
            BaseTTSPlayer.getInstance().setCustomParams(false);
            BaseTTSPlayer.getInstance().loadCustomResource("");
    ...
    public void onInitFocusAreas() {
        if (this.fragmentType == getCurrentFragmentType() && this.f4820a != null) {
            if (this.f4825f == null) {
                this.f4825f = new C1443g(this.f4820a.findViewById(R.id.common_top_title), 2);
                this.f4825f.m5300d(this.f4820a.findViewById(R.id.ib_left));
            }
