...
public class CarlifeViewPagerAdapter extends PagerAdapter {
    ...
    private List<View> m3171a(Context context, List<C1921b> list) {
        ...
        int i = 0;
        while (i < list.size()) {
            View itemView = LayoutInflater.from(context).inflate(R.layout.carlife_apps_list_item, null);
            Button b = (Button) itemView.findViewById(R.id.btn_start_app);
            b.setTextSize(20.0f);
    ...
    /* renamed from: a */
    private View m3170a() {
        View itemView = LayoutInflater.from(this.f2447d).inflate(R.layout.carlife_apps_list_item, null);
        Button b = (Button) itemView.findViewById(R.id.btn_start_app);
        b.setTextSize(20.0f);
        b.setText("待添加");
        return itemView;
