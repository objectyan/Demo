...
import com.baidu.carlife.adpter.MusicAlbumListAdapter;
...
public class MusicAlbumListFragment extends ContentFragment implements OnClickListener, OnItemClickListener {
    ...
    /* renamed from: E */
    private MsgBaseHandler f4561E = new C15376(this);
    /* renamed from: a */
    ...
    /* renamed from: i */
    private MusicAlbumListAdapter f4569i;
    /* renamed from: j */
    ...
    class C15302 implements C1529a {
        ...
        public void mo1578a(String packageName) {
            ...
            if (dataManager != null && this.f4548a.f4567g.m6814g(dataManager.m6649s())) {
                ...
                MsgHandlerCenter.m4452a((int) CommonParams.dZ);
    ...
    class C15376 extends MsgBaseHandler {
        /* renamed from: a */
        ...
        public void careAbout() {
            addMsg(206);
            addMsg(CommonParams.dQ);
            addMsg(CommonParams.fm);
            addMsg(1002);
            addMsg(CommonParams.gj);
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MsgHandlerCenter.m4460a(this.f4561E);
        this.f4569i = new MusicAlbumListAdapter();
    }

    public void onStart() {
        super.onStart();
        LogUtil.d("CarLifeMusic", "-----MusicAlbumListFragment--onStart()---");
        m5601g();
    }
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        this.mContentView = inflater.inflate(R.layout.frag_music_albumlist, null);
        m5578a();
        m5593d();
    ...
    public void onResume() {
        super.onResume();
        LogUtil.m4434b("CarLifeMusic");
        if (this.f4570j) {
            C2342g.m8864e().m8886a((int) R.string.progress_loading);
        }
    }
    ...
    /* renamed from: a */
    private void m5578a() {
        this.f4586z = (ViewContainer) this.mContentView.findViewById(R.id.container);
        this.f4571k = this.mContentView.findViewById(R.id.ll_title_playlist);
        this.f4572l = this.mContentView.findViewById(R.id.ll_title_toplist);
        this.f4573m = this.mContentView.findViewById(R.id.hint_selected_playlist);
        this.f4574n = this.mContentView.findViewById(R.id.hint_selected_toplist);
        this.f4575o = this.mContentView.findViewById(R.id.ll_title_alllist);
        this.f4571k.setOnClickListener(this);
        this.f4572l.setOnClickListener(this);
        this.f4580t = (RelativeLayout) this.mContentView.findViewById(R.id.rl_music_type);
        this.f4581u = (MultiImageView) this.mContentView.findViewById(R.id.iv_music_type);
        this.f4582v = (ImageView) this.mContentView.findViewById(R.id.iv_list);
        this.f4582v.setImageResource(R.anim.anim_music_playing);
        ...
        this.f4577q = (TextView) this.mContentView.findViewById(R.id.tv_title_mysongs);
        this.f4578r = (TextView) this.mContentView.findViewById(R.id.tv_title_playlist);
        this.f4579s = (TextView) this.mContentView.findViewById(R.id.tv_title_toplist);
        this.f4576p = (GridView) this.mContentView.findViewById(R.id.gv_playlist);
        this.f4576p.setAdapter(this.f4569i);
        this.f4576p.setOnItemClickListener(this);
        this.f4583w = new C2282f(mActivity, R.string.module_music_select_source, this.f4567g.m6771E(), this.f4567g.m6772F());
        this.f4583w.m8636j();
        this.f4585y = (CommonTipView) this.mContentView.findViewById(R.id.common_tip_view);
    ...
    private void m5579a(int pos) {
        ...
        if (app != null) {
            if (app.f6068c >= 3) {
                this.f4581u.setDefaultDrawable(C2188r.m8331b(R.drawable.music_ic_default));
    ...
    private void m5589c() {
        if (this.f4567g.m6826n() == -1) {
            ...
            this.f4582v.setVisibility(0);
            this.f4582v.setImageDrawable(C2188r.m8331b(R.drawable.music_ic_player_normal));
            if (this.f4584x != null) {
                this.f4584x.stop();
            }
        }
    ...
    private void m5596e() {
        ...
        C2342g.m8864e().m8886a((int) R.string.progress_loading);
        if (this.f4561E != null) {
            this.f4561E.sendMessageDelayed(Message.obtain(this.f4561E, CommonParams.dQ, this.f4568h.m6649s(), -2), 15000);
        }
    }
    ...
    private void m5598f() {
        this.f4570j = false;
        if (this.f4561E != null) {
            this.f4561E.removeMessages(CommonParams.dQ);
        }
        C2342g.m8864e().m8895f();
    }
    ...
    private void m5590c(int status) {
        if (status == 2) {
            ...
            this.f4579s.setTextColor(C2188r.m8328a((int) R.color.cl_text_a2_title));
            this.f4578r.setTextColor(C2188r.m8328a((int) R.color.white));
            this.f4571k.setBackgroundResource(R.drawable.com_music_title_bg_selector);
            this.f4572l.setBackground(C2251b.m8530d(mActivity));
        } else if (status == 1) {
            this.f4573m.setVisibility(4);
            this.f4574n.setVisibility(0);
            this.f4579s.setTextColor(C2188r.m8328a((int) R.color.white));
            this.f4578r.setTextColor(C2188r.m8328a((int) R.color.cl_text_a2_title));
            this.f4571k.setBackground(C2251b.m8530d(mActivity));
            this.f4572l.setBackgroundResource(R.drawable.com_music_title_bg_selector);
        }
    }
        ...
        switch (status) {
            ...
            default:
                if (this.f4568h.m6649s() != 1) {
                    if (this.f4568h.m6649s() != 2) {
                        this.f4577q.setText(R.string.module_music_title_bangdan_thirdparty);
                        this.f4577q.setVisibility(0);
                        break;
                    }
                ...
                this.f4577q.setText(R.string.module_music_title_wodeyinyue);
                this.f4577q.setVisibility(0);
                break;
        }
        ...
        switch (status) {
            case 0:
                ...
                if (TextUtils.isEmpty(this.f4567g.m6779a(this.f4568h.m6647q()))) {
                    temp = String.format(getContext().getString(R.string.module_music_thirdparty_not_exist), new Object[]{"第三方"});
                } else {
                    temp = String.format(getContext().getString(R.string.module_music_thirdparty_not_exist), new Object[]{appName});
                }
            ...
            case 1:
                this.f4576p.setVisibility(4);
                if (this.f4568h.m6649s() == 1) {
                    temp = getString(R.string.module_musicqq_not_link);
                } else {
                    if (TextUtils.isEmpty(this.f4567g.m6779a(this.f4568h.m6647q()))) {
                        temp = String.format(getString(R.string.module_music_thirdparty_not_link), new Object[]{"第三方"});
                    } else {
                        temp = String.format(getString(R.string.module_music_thirdparty_not_link), new Object[]{appName});
                    }
                }
                this.f4585y.setVisibility(0);
                this.f4585y.m8400a(temp, (int) R.string.module_music_thirdparty_sync);
                this.f4585y.m8401a(true);
                break;
            case 2:
                if (this.f4568h.m6649s() != 1) {
            ...
            case 3:
                this.f4576p.setVisibility(4);
                this.f4585y.setVisibility(0);
                this.f4585y.m8398a((int) R.string.module_music_content_null_hint, (int) R.string.module_music_content_reconnect);
                this.f4585y.m8401a(true);
                break;
            case 7:
                this.f4576p.setVisibility(4);
                if (this.f4568h.m6649s() == 1) {
                    temp = getString(R.string.module_musicqq_intercepte);
                } else {
                    if (TextUtils.isEmpty(this.f4567g.m6779a(this.f4568h.m6647q()))) {
                        temp = String.format(getString(R.string.module_music_thirdparty_not_link), new Object[]{"第三方"});
                    } else {
    ...
    private C1096a m5607k() {
        this.f4557A = getActivity().getLayoutInflater().inflate(R.layout.item_four_card, this.f4586z, false);
    ...
    public boolean onVoiceCommand(String strCommand, String strIntent) {
        LogUtil.d("CarLifeMusic", "Voice Command: [" + strCommand + "][" + strIntent + "]");
    ...
    private C1443g m5613q() {
        ...
        this.f4565d.m5306i();
        this.f4565d.m5300d(this.f4557A.findViewById(R.id.card_1)).m5300d(this.f4557A.findViewById(R.id.card_2)).m5300d(this.f4557A.findViewById(R.id.card_3)).m5300d(this.f4557A.findViewById(R.id.card_4));
        return this.f4565d;
    }
    ...
    public void driving() {
        LogUtil.d("yftech", "MusicAlbumListFragment driving");
        if (C1343b.m4932a().m4935b()) {
            m5583a(false);
        }
    }
    ...
    public void stopDriving() {
        LogUtil.d("yftech", "MusicAlbumListFragment stopDriving");
        if (C1343b.m4932a().m4935b()) {
            m5583a(true);
        }
    }
    ...
    private void m5588b(boolean bConnected) {
        if (bConnected && CarlifeScreenUtil.m4334m()) {
            this.f4576p.setNumColumns(6);
            this.f4576p.requestLayout();
            this.mContentView.requestLayout();
            LogUtil.d("CarLifeMusic", "Update Gv Columns:6");
            return;
        }
        this.f4576p.setNumColumns(4);
        this.f4576p.requestLayout();
        this.mContentView.requestLayout();
        LogUtil.d("CarLifeMusic", "Update Gv Columns:4");
    }
}
