...
public class C1877u {
    ...
    static class C18741 implements C1873a {
        ...
        /* renamed from: a */
        public void mo1698a() {
            C1877u.m7170b(AppContext.m3876a().getString(R.string.service_terms_title), "file:///android_asset/carlifeDisclaimer.html");
        }
    }
    ...
    static class C18752 implements C1873a {
        ...
        /* renamed from: a */
        public void mo1698a() {
            C1877u.m7170b(AppContext.m3876a().getString(R.string.privacy_policy), "https://www.baidu.com/duty/wise/wise_secretright.html");
        }
    }
    ...
    private static void m7170b(String title, String url) {
        ...
        FragmentManagerCallbackProxy.m4757a().showFragment(517, bundle);
    }
