...
public class PushWebNoticeDialog extends BaseDialog {
    ...
    class C22591 implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            this.f7375a.mo1526d();
            LogUtil.d(PushWebNoticeDialog.f7387e, "####### btn back dismiss");
        }
    }
    ...
    class C22602 implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            this.f7376a.mo1526d();
            LogUtil.d(PushWebNoticeDialog.f7387e, "####### hide back dismiss");
        }
    }
    ...
    public class C2263a extends WebChromeClient {
        ...
        public void onReceivedTitle(WebView view, String title) {
            ...
            LogUtil.d(PushWebNoticeDialog.f7387e, "onReceivedTitle title=" + title);
    ...
    public class C2264b extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (url.startsWith("carlife://") && this.f7380a.m8585c(url)) {
                ...
                LogUtil.d(PushWebNoticeDialog.f7387e, "shouldOverrideUrlLoading：" + url);
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            LogUtil.d(PushWebNoticeDialog.f7387e, "onPageStarted url=" + url);
            this.f7380a.f7403p = false;
        }

        public void onPageFinished(WebView view, String url) {
            super.onPageFinished(view, url);
            LogUtil.d(PushWebNoticeDialog.f7387e, "onPageFinished url=" + url);
            this.f7380a.m8589l();
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            LogUtil.d(PushWebNoticeDialog.f7387e, "onReceivedError errorCode=" + errorCode + ", description=" + description);
            view.stopLoading();
            this.f7380a.m8589l();
            this.f7380a.m8591n();
        }
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(R.layout.dialog_web_view, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7404q = (CommonTipView) findViewById(R.id.common_tip_view);
        this.f7404q.setVisibility(8);
        this.f7400m = getResources().getString(R.string.setting_help);
        this.f7401n = (WebView) findViewById(R.id.web_view);
        ...
        this.f7401n.setBackgroundColor(getResources().getColor(R.color.cl_bg_c_main));
        LogUtil.d(f7387e, "Web dialog: " + this.f7399G);
        mo1630i();
        m8588k();
    ...
    protected void mo1630i() {
        ImageButton btnBack = (ImageButton) findViewById(R.id.ib_left);
        if (btnBack != null) {
            btnBack.setImageDrawable(C2188r.m8331b(R.drawable.com_ic_back));
            btnBack.setBackground(C2251b.m8527a(this.c));
        }
        TextView titleTV = (TextView) findViewById(R.id.tv_title);
        if (titleTV != null) {
            titleTV.setTextColor(C2188r.m8328a((int) R.color.cl_text_a4_title));
        }
    }

    /* renamed from: k */
    private void m8588k() {
        this.f7405r = findViewById(R.id.common_top_title);
        this.f7405r.setVisibility(8);
        ImageButton btnBack = (ImageButton) findViewById(R.id.ib_left);
        if (btnBack != null) {
            btnBack.setOnClickListener(new C22591(this));
        }
        View hide = findViewById(R.id.view_hide);
        if (hide != null) {
            hide.setOnClickListener(new C22602(this));
        }
        this.f7409v = (TextView) findViewById(R.id.tv_title);
        m8581b(this.f7400m);
    }
    ...
    /* renamed from: n */
    private void m8591n() {
        LogUtil.d(f7387e, "showErrorPage !!!");
        this.f7403p = true;
        if (this.f7404q != null) {
