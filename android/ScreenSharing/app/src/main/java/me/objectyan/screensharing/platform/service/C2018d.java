...
class C2018d {
    ...
    public void m7735a(String appName, C2015a listener, String songId, long totalSize, long requestId) {
        LogUtil.d("CarLifePlatform", "startDownloadSong() requestId=" + requestId + " totalSize=" + totalSize);
        this.f6527c = appName;
    ...
    private RandomAccessFile m7727a(String songId, long totalSize) {
        Throwable e;
        String savePath = CommonParams.jm + "/" + songId + ".mp3";
    ...
    public void m7732a(int errorNo, String errorMsg) {
        LogUtil.d("CarLifePlatform", "stopDownloadSong() songId=" + this.f6530f + " appName=" + this.f6527c);
