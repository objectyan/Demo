...
public class C0967a {
    ...
    public void m3162a(String originalContent) {
        ...
        command.m4201c(CommonParams.aQ);
    ...
    private String m3160c(String version) {
        String currentAppVersion = CarlifeUtil.m4373g();
        if (currentAppVersion.equals(f2432e)) {
            currentAppVersion = f2433f;
        }
        LogUtil.d(f2428a, "currentAppVersion= " + currentAppVersion);
    ...
    public void m3163a(boolean result) {
        CarlifeCmdMessage command = new CarlifeCmdMessage(true);
        command.m4201c(CommonParams.aS);
