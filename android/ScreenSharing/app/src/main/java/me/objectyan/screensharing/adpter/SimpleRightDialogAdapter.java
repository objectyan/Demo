...
public class SimpleRightDialogAdapter extends BaseAdapter {
    /* renamed from: a */
    ...
    private class C1022a {
        ...
        ImageView f2609b;
        /* renamed from: c */
        final /* synthetic */ SimpleRightDialogAdapter f2610c;

        private C1022a(SimpleRightDialogAdapter simpleRightDialogAdapter) {
            this.f2610c = simpleRightDialogAdapter;
        }
    }
    ...
    public SimpleRightDialogAdapter(Context context, String[] list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        C1022a holder;
        if (convertView == null) {
            convertView = this.f2612b.inflate(R.layout.item_simple_dialog, parent, false);
            holder = new C1022a();
            holder.f2608a = (TextView) convertView.findViewById(R.id.textview);
            holder.f2609b = (ImageView) convertView.findViewById(R.id.imageview);
