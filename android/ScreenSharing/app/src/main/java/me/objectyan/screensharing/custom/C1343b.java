...
public class C1343b {
        ...
        try {
            ...
            switch (gear) {
                ...
                case 5:
                    ...
                    return;
                default:
                    LogUtil.d(f3937a, "ERROR gear =  " + gear);
                    return;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean m4935b() {
        if (CommonParams.sVehicleChannel == EnumVehicleChannel.VEHICLE_CHANNEL_YIQIFENGTIAN_COROLLA_DA || CommonParams.sVehicleChannel == EnumVehicleChannel.VEHICLE_CHANNEL_YIQIFENGTIAN_COROLLA_GSHV || CommonParams.sVehicleChannel == EnumVehicleChannel.VEHICLE_CHANNEL_IZOA_PANASONIC) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: c */
    public void m4936c() {
        if (m4935b() && FragmentManagerCallbackProxy.m4757a().getNaviFragmentManager() != null) {
            FragmentManagerCallbackProxy.m4757a().getNaviFragmentManager().stopDriving();
        }
    }
    ...
    /* renamed from: d */
    public void m4937d() {
        LogUtil.d(f3937a, "showToast isShowToast =  " + this.f3940d);
        if (this.f3940d) {
