...
public class C1351b extends BaseDialog {
    ...
    protected void mo1529b() {
        this.f3948f = (TextView) findViewById(R.id.btn_cancel);
        this.f3949g = (RelativeLayout) findViewById(R.id.layout_friend);
        this.f3950h = (RelativeLayout) findViewById(R.id.layout_moments);
