...
public class C1977e {
    ...
    private C1489c f6300I = new C1489c(this) {
        ...
        class C19631 implements Runnable {
            ...
            public void run() {
                LogUtil.d(C1977e.f6293d, "StartCheckMD5");
                if (this.f6273a.f6274a.m7532o() == 1) {
                    LogUtil.d(C1977e.f6293d, "checkApkMD5 success");
                    this.f6273a.f6274a.f6294C.sendEmptyMessage(3);
                    return;
                }
                LogUtil.d(C1977e.f6293d, "checkApkMD5 Fail");
        ...
        /* renamed from: a */
        private void m7486a() {
            LogUtil.d(C1977e.f6293d, "Download Error!");
        ...
        /* renamed from: b */
        private void m7487b() {
            LogUtil.d(C1977e.f6293d, "after DownLoadSuccess");
        ...
        /* renamed from: c */
        private void m7488c() {
            LogUtil.d(C1977e.f6293d, "afterDownloadCancel");
            this.f6274a.m7548w();
        }
    };
    /* renamed from: J */
    private ServiceConnection f6301J = new ServiceConnection(this) {
        ...
        public void onServiceDisconnected(ComponentName arg0) {
            LogUtil.d(C1977e.f6293d, "app update onServiceDisconnected");
    ...
    private C1947a f6302K = new C1947a(this) {
        ...
        /* renamed from: a */
        private void m7491a() {
            LogUtil.d(C1977e.f6293d, "OnTranfer Success");
        ...
        /* renamed from: b */
        private void m7492b() {
            LogUtil.d(C1977e.f6293d, "OnTranfer Error");
            this.f6276a.f6317p = 4097;
        ...
        /* renamed from: c */
        private void m7493c() {
            LogUtil.d(C1977e.f6293d, "OnTranfer Cancel");
            this.f6276a.f6317p = 4097;
            this.f6276a.f6316o.dismissDialog();
            if (this.f6276a.f6321t != null) {
                this.f6276a.f6321t.m8209a();
    ...
    /* renamed from: a */
    OnBtnClickListener f6303a = new C19652(this);
    /* renamed from: b */
    OnBtnClickListener f6304b = new C19663(this);
    /* renamed from: c */
    OnDialogCancelListener f6305c = new C19674(this);
    /* renamed from: e */
    ...
    /* renamed from: o */
    private OnDialogListener f6316o;
    /* renamed from: p */
    ...
    class C19641 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    class C19652 implements OnBtnClickListener {
        /* renamed from: a */
        ...
        public void onClick() {
            LogUtil.d(C1977e.f6293d, "####### OnDialogFirstBtnClick: " + this.f6278a.f6320s.getDialogType());
            switch (this.f6278a.f6320s.getDialogType()) {
                case 1001:
                    LogUtil.d(C1977e.f6293d, "####### DLG_NO_NEED_UPDATE click");
                    this.f6278a.m7556b(1001);
                    return;
                case 1002:
                    LogUtil.d(C1977e.f6293d, "####### DLG_CHECK_USE_MOBILE_NET_DWON click");
                    this.f6278a.m7522j();
                    return;
                case 1003:
                    LogUtil.d(C1977e.f6293d, "####### DLG_CHECK_DOWN_LOAD");
                    this.f6278a.m7522j();
                    return;
                case 1005:
                    LogUtil.d(C1977e.f6293d, "####### DLG_CHECK_TRANSFER_NOW");
                    this.f6278a.m7534p();
                    return;
                default:
                    return;
    ...
    class C19663 implements OnBtnClickListener {
        /* renamed from: a */
        ...
        public void onClick() {
            LogUtil.d(C1977e.f6293d, "####### OnDialogSecondBtnClick: " + this.f6279a.f6320s.getDialogType());
            switch (this.f6279a.f6320s.getDialogType()) {
                case 1001:
                    LogUtil.d(C1977e.f6293d, "####### DLG_NO_NEED_UPDATE second");
                    return;
                case 1002:
                    LogUtil.d(C1977e.f6293d, "####### DLG_CHECK_USE_WIFI_DWON second");
                    return;
                case 1005:
                    LogUtil.d(C1977e.f6293d, "####### DLG_CHECK_TRANSFER_NOW second");
                    return;
                default:
                    return;
            }
    ...
    class C19674 implements OnDialogCancelListener {
        /* renamed from: a */
        ...
        public void onCancel() {
            LogUtil.d(C1977e.f6293d, "####### OnDialogCancelBtnClick: " + this.f6280a.f6320s.getDialogType());
            switch (this.f6280a.f6320s.getDialogType()) {
                case 1001:
                    LogUtil.d(C1977e.f6293d, "####### DLG_NO_NEED_UPDATE cancel");
                    return;
                case 1002:
                    LogUtil.d(C1977e.f6293d, "####### DLG_CHECK_USE_WIFI_DWON cancel");
                    return;
                case 1005:
                    LogUtil.d(C1977e.f6293d, "####### DLG_CHECK_TRANSFER_NOW cancel");
                    return;
                default:
                    return;
            }
    ...
    class C19696 implements OnDialogCancelListener {
        /* renamed from: a */
    ...
    class C19707 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    class C19718 implements OnDialogCancelListener {
        /* renamed from: a */
    ...
    class C19729 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    private class C1973a implements C0924a {
        ...
        public void onNetWorkResponse(int responseCode) {
            LogUtil.d(C1977e.f6293d, "onNetWorkResponse: " + responseCode);
            ...
            switch (responseCode) {
                ...
                case 0:
                    ...
                    LogUtil.d(C1977e.f6293d, "RESPONSE_SUCCESS: " + this.f6287a.f6324w.toString());
    ...
    private class C1974b extends MsgBaseHandler {
        /* renamed from: a */
        ...
        public void careAbout() {
            addMsg(CommonParams.bO);
            addMsg(CommonParams.bS);
            addMsg(CommonParams.bT);
        }

        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    LogUtil.d(C1977e.f6293d, "MD5 Success!");
                    this.f6288a.f6317p = 4097;
                    CarlifeProgressDialogContainer.m4686a().mo1468c();
                    this.f6288a.m7556b(1005);
                    return;
                case 2:
                    LogUtil.d(C1977e.f6293d, "MD5 Error!");
                    CarlifeProgressDialogContainer.m4686a().mo1468c();
                    this.f6288a.m7544u();
                    return;
                case 3:
                    LogUtil.d(C1977e.f6293d, "MD5 Success!  AfterDownload");
                    this.f6288a.m7519h();
                    return;
                case 4:
                    this.f6288a.m7516g();
                ...
                case 11:
                    ...
                    return;
                case CommonParams.bO /*491526*/:
                    this.f6288a.m7506b((CarlifeCmdMessage) msg.obj);
                    return;
                case CommonParams.bS /*491530*/:
                    this.f6288a.m7552a((CarlifeCmdMessage) msg.obj);
                    return;
                case CommonParams.bT /*491531*/:
                    this.f6288a.m7511c((CarlifeCmdMessage) msg.obj);
                    return;
                default:
                    return;
            }
    ...
    private class C1976d implements C0924a {
        ...
        public void onNetWorkResponse(int responseCode) {
            LogUtil.d(C1977e.f6293d, "checkNewVersion Response: " + responseCode);
            switch (responseCode) {
                case -2:
                    LogUtil.d(C1977e.f6293d, "onNetWorkResponse: RESPONSE_ERROR_NONETWORK");
                    return;
                case 0:
                    this.f6290a.f6324w = this.f6290a.f6323v.m5976a();
                    LogUtil.d(C1977e.f6293d, "RESPONSE_SUCCESS: " + this.f6290a.f6324w.toString());
                    this.f6290a.f6296E = Integer.parseInt(this.f6290a.f6324w.f5950l);
                    LogUtil.d(C1977e.f6293d, "checkNewVersion: " + this.f6290a.f6296E);
                    ...
                    return;
                default:
                    LogUtil.d(C1977e.f6293d, "onNetWorkResponse Error: " + responseCode);
                    return;
            }
        }
    }
    ...
    /* renamed from: a */
    public void m7552a(CarlifeCmdMessage msg) {
        C2201w.m8369a();
        C2201w.m8373a("传输完成，车机端开始安装更新!", (int) DialogReplaceToastUtils.LONG_TIME);
    }

    /* renamed from: b */
    private void m7506b(CarlifeCmdMessage msg) {
        try {
            ...
            m7555a(false);
            LogUtil.d(f6293d, "MSG_DATA_HU_SYSTEMINFO= " + strUpdateUrl);
            LogUtil.d(f6293d, "MSG_DATA_HU_SYSTEMINFO= " + this.f6295D);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /* renamed from: c */
    private void m7511c(CarlifeCmdMessage msg) {
        try {
    ...
    /* renamed from: g */
    private void m7516g() {
        LogUtil.d(f6293d, "afterDownloadCheckMD5Fail");
        m7548w();
        m7554a(this.f6326y);
    ...
    /* renamed from: h */
    private void m7519h() {
        LogUtil.d(f6293d, "afterDownloadCheckMD5Success");
        m7537q();
        m7556b(1005);
    }
    ...
    /* renamed from: a */
    public void m7551a(Activity activity, OnDialogListener listener) {
        ...
        MsgHandlerCenter.m4460a(this.f6294C);
    }
    ...
    public void m7558c() {
        ...
        LogUtil.d(f6293d, "checkHUNewVersion");
        m7525k();
        m7555a(true);
    }
    ...
    public boolean m7559d() {
        if (this.f6318q.getString(f6291A, "").equals(this.f6324w.f5950l)) {
            ...
            LogUtil.d(f6293d, "Not exit down load apk file !");
        }
        return false;
    }
    ...
    public void m7555a(boolean bUdpate) {
        LogUtil.d("#######", "####### checkNewVersion: " + bUdpate);
    ...
    public void m7560e() {
        if (CarlifeUtil.m4381s() == 1) {
            LogUtil.d(f6293d, "checkUseWifiToDownLoad MOBILE");
            m7556b(1002);
            return;
        }
        LogUtil.d(f6293d, "checkUseWifiToDownLoad WIFI ->> check download immediately");
        m7556b(1003);
    }
    ...
    private void m7522j() {
        ...
        if (this.f6324w != null) {
            if (this.f6324w.f5945g != 1) {
                ...
                LogUtil.d(f6293d, "Download Apk has exist !");
                m7556b(1005);
            } else {
                LogUtil.d(f6293d, "Download file not exit, Download now.......");
                m7541s();
            }
        }
    }
    ...
    /* renamed from: k */
    private void m7525k() {
        CarlifeProgressDialogContainer.m4686a().mo1465a(AppContext.m3876a().getString(R.string.checking_update), new C19641(this));
    }
    ...
    private void m7527l() {
        if (this.f6315n != null) {
            ...
            this.f6319r.setTitle((int) R.string.download_vehicle_carlife);
            this.f6319r.m7458q();
            this.f6319r.m7447c((int) R.string.carlife_update_cancel);
    ...
    private void m7528m() {
        if (this.f6315n != null) {
            ...
            this.f6319r.setTitle((int) R.string.transfer_vehicle_carlife);
            this.f6319r.m7458q();
            this.f6319r.m7447c((int) R.string.carlife_update_cancel);
    ...
    private void m7531n() {
        ...
        LogUtil.d(f6293d, "cancel:: cancelUpdateProgressDialog");
        if (this.f6325x != null) {
            this.f6325x.m5923d();
        }
        if (this.f6321t != null) {
    ...
    private void m7539r() {
        ...
        LogUtil.d(f6293d, "requestDownloadApp: " + strVehicleApkPath);
        this.f6325x = new C1635h(this.f6315n, this.f6324w.f5951m, CommonParams.hQ, strVehicleApkPath, this.f6300I, true, 0);
    ...
    private void m7541s() {
        if (this.f6318q.contains(f6291A)) {
            LogUtil.d(f6293d, "contain update record");
            if (this.f6318q.getString(f6291A, "").equals(this.f6324w.f5950l)) {
                LogUtil.d(f6293d, "has down new vehicle apk");
                if (this.f6326y == null) {
                    this.f6326y = new File(C1962d.m7476f());
                }
                if (this.f6326y == null || !this.f6326y.exists()) {
                    LogUtil.d(f6293d, "OTA File not exist!");
                    m7544u();
                    return;
                }
                m7543t();
        ...
        LogUtil.d(f6293d, "not contain update record");
        m7544u();
    }
    ...
    private void m7546v() {
        ...
        LogUtil.d(f6293d, "cancel:: updateDialogCancel");
        if (this.f6325x != null) {
            this.f6325x.m5923d();
        }
    }
    ...
    private void m7548w() {
        this.f6317p = 4097;
        LogUtil.d(f6293d, "afterDownload dismissdialog");
    ...
    public void m7561f() {
        if (this.f6321t != null) {
            LogUtil.d(f6293d, "unbindService");
    ...
    private void m7510c(int dlgType) {
        LogUtil.d(f6293d, "showUpdateDialog: " + dlgType);
        if (this.f6320s == null) {
