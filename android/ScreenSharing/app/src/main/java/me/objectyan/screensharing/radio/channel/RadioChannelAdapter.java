...
public class RadioChannelAdapter extends RecyclingPagerAdapter {
    ...
    public View mo1782a(int position, View convertView, ViewGroup container) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(this.f6835e).inflate(R.layout.radio_channel_item, container, false);
            viewHolder.f6827a = (SimpleDraweeView) convertView.findViewById(R.id.radio_channel_item_img);
            viewHolder.f6828b = (TextView) convertView.findViewById(R.id.radio_channel_item_txt);
            viewHolder.f6829c = (ImageView) convertView.findViewById(R.id.radio_channel_item_flag_play);
