...
public class HomeDiscoverFoodDetailFragment extends ContentFragment implements OnClickListener {
    ...
    class C14711 implements C0924a {
        ...
        class C14701 implements OnBtnClickListener {
            /* renamed from: a */
        ...
        public void onNetWorkResponse(int responseCode) {
            ...
            if (responseCode == -2) {
                ...
                if (this.f4340a.f4357k == null) {
                    this.f4340a.f4357k = new C1953c(this.f4340a.getContext()).m7442b((int) R.string.home_food_menu_reqsuc_title).m7435a((int) R.string.home_food_menu_reqsuc_content).m7458q().m7447c((int) R.string.positive).m7438a(new C14701(this));
                }
                this.f4340a.showDialog(this.f4340a.f4357k);
            } else if (this.f4340a.f4347a != null) {
                String msg = BaiduNaviApplication.getInstance().getApplicationContext().getString(R.string.common_error_nonetwork);
            ...
            if (this.f4343a.isAdded()) {
                ...
                if (responseCode == 0) {
                    ...
                    if (temp != null && temp.size() > 0) {
                        ...
                        TextView distantTV = (TextView) this.f4343a.mContentView.findViewById(R.id.tv_distant);
                        if (TextUtils.isEmpty(this.f4343a.f4352f.f6005m)) {
                            distantTV.setText("");
                        } else {
                            distantTV.setText(this.f4343a.f4352f.f6005m);
                        }
                        TextView noticeTV = (TextView) this.f4343a.mContentView.findViewById(R.id.tv_notice);
                        if (TextUtils.isEmpty(this.f4343a.f4351e.f5971D)) {
                            noticeTV.setText("");
                        } else {
                            noticeTV.setText(this.f4343a.f4351e.f5971D);
                        }
                        Button stateBtn = (Button) this.f4343a.mContentView.findViewById(R.id.btn_state);
                        if (C1926f.m7390a(this.f4343a.f4352f.f6004l)) {
                            this.f4343a.f4353g = 200;
                            stateBtn.setBackgroundResource(R.drawable.com_bg_btn_c_selector);
                            stateBtn.setEnabled(true);
                            stateBtn.setAlpha(1.0f);
                            stateBtn.setVisibility(0);
                            stateBtn.setText(R.string.home_food_btn_cancel);
                        } else {
                            stateBtn.setVisibility(8);
                        }
                        View queueingView = ((ViewStub) this.f4343a.mContentView.findViewById(R.id.view_queueing)).inflate();
                        TextView queueNameTV = (TextView) queueingView.findViewById(R.id.tv_queue_name);
                        if (TextUtils.isEmpty(this.f4343a.f4352f.f6008p)) {
                            queueNameTV.setText(R.string.home_food_queue_default);
                        } else {
                            queueNameTV.setText(this.f4343a.f4352f.f6008p);
                        }
                        TextView queueWaitNumTV = (TextView) queueingView.findViewById(R.id.tv_queue_waitnum);
                        if (C1926f.m7390a(this.f4343a.f4352f.f6004l)) {
                            queueWaitNumTV.setText(this.f4343a.getString(R.string.home_food_waitnum1, new Object[]{Integer.valueOf(this.f4343a.f4352f.f5996d)}));
                        } else {
                            queueWaitNumTV.setText(R.string.home_food_queue_default);
                        }
                        TextView queueWaittimeTV = (TextView) queueingView.findViewById(R.id.tv_queue_waittime);
                        if (TextUtils.isEmpty(this.f4343a.f4352f.f6001i) || !C1926f.m7390a(this.f4343a.f4352f.f6004l)) {
                            queueWaittimeTV.setText(R.string.home_food_queue_default);
                        } else {
                            queueWaittimeTV.setText(this.f4343a.f4352f.f6001i);
                        }
                        this.f4343a.mContentView.findViewById(R.id.temp).setVisibility(0);
                    }
    ...
    class C14755 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    class C14766 implements OnBtnClickListener {
        /* renamed from: a */
        ...
        public void onClick() {
            CarlifeProgressDialogContainer.m4686a().mo1467b(this.f4345a.getString(R.string.progress_requesting));
    ...
    class C14777 implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            ...
            if (queue != null) {
                CarlifeProgressDialogContainer.m4686a().mo1467b(this.f4346a.getString(R.string.progress_requesting));
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        View contentView = inflater.inflate(R.layout.frag_home_discover_food_detail, null);
        this.f4359m = (CommonTipView) contentView.findViewById(R.id.common_tip_view);
        if (this.mShowBundle != null) {
            ...
            if (model != null) {
                ...
                ((ScrollView) contentView.findViewById(R.id.layout_content)).setOverScrollMode(2);
    ...
    private void m5377a(View contentView) {
        if (this.f4351e != null) {
            contentView.findViewById(R.id.layout_content).setVisibility(0);
            MultiImageView logoIV = (MultiImageView) contentView.findViewById(R.id.iv_logo);
            logoIV.setDefaultDrawable(C2188r.m8331b(R.drawable.home_bg_food_albumcover));
            logoIV.setImageUrl(this.f4351e.f5976j);
            TextView distantTV = (TextView) contentView.findViewById(R.id.tv_distant);
            if (this.f4351e.f5980n.intValue() > 0) {
                CharSequence spannableString = new SpannableString(String.format(getString(R.string.home_food_distance), new Object[]{C1925e.m7388a(this.f4351e.f5980n.intValue())}));
            ...
            TextView addrTV = (TextView) contentView.findViewById(R.id.tv_addr);
            if (!TextUtils.isEmpty(this.f4351e.f5989w)) {
                addrTV.setText(this.f4351e.f5989w);
            }
            TextView openTV = (TextView) contentView.findViewById(R.id.tv_open);
            if (!TextUtils.isEmpty(this.f4351e.f5992z)) {
                openTV.setText(String.format(getString(R.string.home_food_open), new Object[]{this.f4351e.f5992z}));
            }
            RatingBar scoreRB = (RatingBar) contentView.findViewById(R.id.rb_score);
            float temp = 0.0f;
            try {
            ...
            TextView styleTV = (TextView) contentView.findViewById(R.id.tv_style);
            if (!TextUtils.isEmpty(this.f4351e.f5990x)) {
                styleTV.setText(this.f4351e.f5990x);
            }
            TextView priceTV = (TextView) contentView.findViewById(R.id.tv_price);
            if (this.f4351e.f5968A > 0) {
                priceTV.setText(String.format(getString(R.string.home_food_perprice), new Object[]{Integer.valueOf(this.f4351e.f5968A)}));
            }
            TextView discountTV = (TextView) contentView.findViewById(R.id.tv_discount);
            if (TextUtils.isEmpty(this.f4351e.f5972E)) {
                discountTV.setVisibility(8);
                contentView.findViewById(R.id.temp1).setVisibility(8);
            } else {
                discountTV.setText(this.f4351e.f5972E.replace("\t", "\n"));
            }
            View gothereBtn = contentView.findViewById(R.id.btn_gothere);
            if (CommonParams.jr) {
            ...
            contentView.findViewById(R.id.btn_tel).setOnClickListener(this);
            TextView noticeTV = (TextView) contentView.findViewById(R.id.tv_notice);
            if (!TextUtils.isEmpty(this.f4351e.f5978l)) {
                noticeTV.setText(this.f4351e.f5978l);
            }
            Button stateBtn = (Button) contentView.findViewById(R.id.btn_state);
            stateBtn.setOnClickListener(this);
            stateBtn.setBackgroundResource(R.drawable.com_bg_btn_b_selector);
            ...
            switch (this.f4353g) {
                case 0:
                    ...
                    stateBtn.setAlpha(1.0f);
                    stateBtn.setVisibility(0);
                    stateBtn.setText(R.string.home_food_btn_available);
                    break;
                case 100:
                    stateBtn.setEnabled(false);
                    stateBtn.setAlpha(0.2f);
                    stateBtn.setVisibility(0);
                    stateBtn.setText(R.string.home_food_btn_noqueue);
                    break;
                case 102:
                    stateBtn.setEnabled(false);
                    stateBtn.setAlpha(0.2f);
                    stateBtn.setVisibility(0);
                    stateBtn.setText(R.string.home_food_btn_toofar);
                    break;
                case 103:
                    stateBtn.setEnabled(false);
                    stateBtn.setAlpha(0.2f);
                    stateBtn.setVisibility(0);
                    stateBtn.setText(R.string.home_food_btn_live);
                    break;
                case 104:
                    stateBtn.setEnabled(false);
                    stateBtn.setAlpha(0.2f);
                    stateBtn.setVisibility(0);
                    stateBtn.setText(R.string.home_food_btn_disable);
                    break;
                default:
                    stateBtn.setVisibility(8);
                    break;
            ...
            if (this.f4351e.f5973F == null || this.f4354h != 1) {
                contentView.findViewById(R.id.temp).setVisibility(8);
                return;
            }
            if (!TextUtils.isEmpty(this.f4351e.f5971D)) {
                noticeTV.setText(this.f4351e.f5971D);
            }
            LinearLayout queuesLL = (LinearLayout) ((ViewStub) contentView.findViewById(R.id.view_queues)).inflate().findViewById(R.id.ll_queues);
            for (C1926f queue : this.f4351e.f5973F) {
                View view = View.inflate(getContext(), R.layout.item_food_queue, null);
                ((TextView) view.findViewById(R.id.tv_queue_name)).setText(queue.f5994b + "(" + queue.f5995c + ")");
                ((TextView) view.findViewById(R.id.tv_queue_waitnum)).setText(queue.f5996d + "桌");
                TextView queueWaittimeTV = (TextView) view.findViewById(R.id.tv_queue_waittime);
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_tel:
                if (TextUtils.isEmpty(this.f4351e.f5991y)) {
                    C2201w.m8371a((int) R.string.home_food_notel, 0);
                    return;
                }
                if (this.f4356j == null) {
                    this.f4356j = new C1953c(getContext()).m7457g(17).m7444b(this.f4351e.f5991y).m7458q().m7447c((int) R.string.btn_call).m7450d((int) R.string.negative);
    ...
    private void m5376a() {
        if (this.f4358l == null) {
            this.f4358l = new C1953c(getContext()).m7435a((int) R.string.home_food_menu_cancelqueuetip).m7447c((int) R.string.positive).m7450d((int) R.string.negative).m7438a(new C14766(this));
        }
    ...
    private void m5382b() {
        if (this.f4355i == null) {
            ...
            this.f4355i = new C2282f(getContext(), R.string.home_food_menu_queuetype, new SimpleAdapter(getContext(), list, R.layout.item_food_style, new String[]{"text"}, new int[]{R.id.textview}), new C14777(this));
        }
    ...
    public void driving() {
        LogUtil.d("yftech", "HomeDiscoverFoodDetailFragment driving");
        CarlifeProgressDialogContainer.m4686a().mo1468c();
        m5384c();
        back();
        back();
    ...
    public void onInitFocusAreas() {
        if (getCurrentFragmentType() == NaviFragmentManager.TYPE_HOME_DISCOVER_FOOD_DETAIL) {
            if (this.f4361o == null) {
                this.f4361o = new C1443g(this.mContentView.findViewById(R.id.common_top_bar), 2);
                this.f4361o.m5300d(this.mContentView.findViewById(R.id.ib_left));
            }
            if (this.f4362p == null) {
                this.f4362p = new C1443g(this.mContentView.findViewById(R.id.layout_content), 6);
                if (this.f4352f != null && C1926f.m7390a(this.f4352f.f6004l)) {
                    this.f4362p.m5300d(this.mContentView.findViewById(R.id.btn_state));
                }
                this.f4362p.m5300d(this.mContentView.findViewById(R.id.btn_gothere)).m5300d(this.mContentView.findViewById(R.id.btn_tel));
            }
            if (this.f4360n) {
