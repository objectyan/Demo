...
public class SoftInputPhoneKey extends RelativeLayout {
    ...
    public SoftInputPhoneKey(Context context, AttributeSet attrs, int defStyle) {
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.soft_input_phone_key, this, true);
        this.f7801a = (TextView) findViewById(R.id.tv_name);
        this.f7802b = (TextView) findViewById(R.id.tv_desc);
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.C0963p.SoftInputPhoneKey);
