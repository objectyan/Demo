...
import com.baidu.carlife.bluetooth.BtHfpManager.C1045a;
import com.baidu.carlife.bluetooth.BtHfpProtocolHelper;
import com.baidu.carlife.bluetooth.BtHfpStateCallback;
...
public class C1868q {
            ...
            switch (msg.what) {
                case 1:
                    if (this.f5743a.f5788w != null) {
                        LogUtil.d(C1868q.f5757b, "onloadedCallLog");
    ...
    /* renamed from: I */
    private BtHfpStateCallback f5779I = new C18636(this);
    /* renamed from: a */
    C1867f f5780a = null;
    /* renamed from: p */
    ...
    class C18636 implements BtHfpStateCallback {
        /* renamed from: a */
        ...
        public void mo1384a(boolean isEnable) {
            ...
            LogUtil.d("Bt", "isBTConnected = " + this.f5752a.f5771A);
        }
    ...
    private class C1865c extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            LogUtil.d(C1868q.f5757b, "CallLogContentObserver onChange:" + selfChange);
            this.f5754a.m7123i();
        }
    }
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    LogUtil.d(C1868q.f5757b, "CALL_STATE_OFFHOOK:" + incomingNumber);
                    if (!TextUtils.isEmpty(incomingNumber)) {
                        this.f5756a.f5790y = this.f5756a.m7117c(incomingNumber);
                    }
    ...
    public String m7102a() {
        LogUtil.d(f5757b, "getCurrentName() : mCurrentName = " + this.f5790y);
        if (TextUtils.isEmpty(this.f5790y)) {
            return BaiduNaviApplication.getInstance().getApplicationContext().getString(R.string.phone_name_unknown);
        }
        return this.f5790y;
    }
    ...
    public void m7107a(final Context context, String phoneNum) {
        if (context != null && !TextUtils.isEmpty(phoneNum)) {
            if (this.f5781p.getCallState() != 0) {
                C2201w.m8371a((int) R.string.module_tele_call_in_used, 0);
                return;
            }
    ...
    private void m7079b(Context context, String phoneNum) {
        ...
        try {
            ...
            LogUtil.d(f5757b, e.toString());
            C2201w.m8371a((int) R.string.module_tele_no_call_permission, 0);
        } catch (Exception e2) {
            LogUtil.d(f5757b, e2.toString());
            C2201w.m8371a((int) R.string.module_tele_dial_exception, 0);
        }
    }
    ...
    private void m7097o() {
        ...
        if (BtHfpManager.m3397a().f2728A) {
            this.f5776F = true;
        }
        this.f5791z = BtHfpManager.m3397a();
    ...
    private List<String> m7100r() {
        ...
        while (phoneCursor.moveToNext()) {
            ...
            if (!TextUtils.isEmpty(phoneNumber)) {
                ...
                String pinyin = CarlifeUtil.m4372f(contactName);
                char key = '\u0000';
    ...
    private synchronized void m7101s() {
        ...
        String yesterdayString = BaiduNaviApplication.getInstance().getApplicationContext().getString(R.string.phone_calllog_yesterday);
    ...
    public void m7126l() {
        if (C2204x.m8382b()) {
            C2201w.m8371a((int) R.string.phone_mute_tip, 0);
