...
import com.baidu.carlife.adpter.HomeDiscoverParkAdapter;
...
public class HomeDiscoverParkListFragment extends ContentFragment implements C0924a {
    ...
    /* renamed from: f */
    private HomeDiscoverParkAdapter f4420f;
    /* renamed from: g */
    ...
    class C14851 implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            if (this.f4411a.f4420f != null) {
                ...
                CarLifeSearchPoi searchPoi = this.f4411a.f4420f.m3184a(position);
                if (searchPoi != null) {
    ...
    class C14862 implements OnClickListener {
        ...
        public void onClick(View v) {
            if (this.f4412a.m5430c()) {
                this.f4412a.openWebView(4, NaviFragmentManager.TYPE_HOME_DISCOVER_CWYD, this.f4412a.getStringUtil(R.string.home_discovery_cwyd), WebViewFragment.f4872l);
            } else {
    ...
    class C14873 implements OnClickListener {
        ...
        public void onClick(View v) {
            if (this.f4413a.m5428b()) {
                ...
                this.f4413a.openWebView(1, NaviFragmentManager.TYPE_HOME_DISCOVER_ETCP, this.f4413a.getStringUtil(R.string.home_discovery_etcp_title), WebViewFragment.f4870j);
                return;
            }
            C2201w.m8373a("当前城市，暂不支持该服务", 0);
        }
    ...
    private class C1488a extends MsgBaseHandler {
        /* renamed from: a */
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        ...
        ViewGroup contentView = (ViewGroup) inflater.inflate(R.layout.frag_home_discover_parklist, null);
        setCommonTitleBar(contentView, getResources().getStringArray(R.array.home_discovery)[0]);
        ((TextView) contentView.findViewById(R.id.tv_title_desc)).setText("");
        this.f4417c = (ListView) contentView.findViewById(R.id.listview);
        this.f4417c.setOverScrollMode(2);
        this.f4417c.setHeaderDividersEnabled(false);
        this.f4419e = (CommonTipView) contentView.findViewById(R.id.common_tip_view);
        this.f4419e.m8398a((int) R.string.error_nopark, (int) R.drawable.com_ic_parking_empty);
        ...
        if (isAdded()) {
            ...
            switch (responseCode) {
                ...
                case -2:
                    ...
                    return;
                case 0:
                    this.f4420f = new HomeDiscoverParkAdapter(getContext());
    ...
    public void onDestroy() {
        MsgHandlerCenter.m4464b(this.f4423i);
    ...
    /* renamed from: a */
    private void m5427a() {
        if (C1343b.m4932a().m4935b() && CarlifeProgressDialogContainer.m4686a().mo1469d()) {
            CarlifeProgressDialogContainer.m4686a().mo1468c();
        }
    }
    ...
    public void onInitFocusAreas() {
        if (getCurrentFragmentType() == NaviFragmentManager.TYPE_HOME_DISCOVER_PARK) {
            if (this.f4421g == null) {
                this.f4421g = new C1443g(this.mContentView.findViewById(R.id.temp), 2);
                this.f4421g.m5300d(this.mContentView.findViewById(R.id.ib_left));
            }
            if (this.f4422h == null) {
    ...
    private boolean m5428b() {
        if (C1435a.m5226a().m5234f()) {
            ...
            LogUtil.m4440c("Framework", "DistrictInfo=" + mDistrictInfo);
    ...
    public boolean onVoiceCommand(int selectIndex) {
        if (this.f4420f != null) {
            CarLifeSearchPoi searchPoi = this.f4420f.m3184a(selectIndex);
            if (searchPoi != null) {
