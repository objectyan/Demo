...
public class LoginFragment extends ContentFragment {
    ...
    class C15252 extends AuthorizationListener {
        ...
        public void onSuccess() {
            C2201w.m8372a(StyleManager.getString(R.string.login_success));
        ...
        public void onFailed(int errorNo, String errorMsg) {
            C2201w.m8372a(StyleManager.getString(R.string.login_fail));
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        View contentView = inflater.inflate(R.layout.frag_login, null);
        this.f4545a = (SapiWebView) contentView.findViewById(R.id.sapi_webview);
    ...
    public void driving() {
        LogUtil.d("yftech", "LoginFragment driving");
        back();
