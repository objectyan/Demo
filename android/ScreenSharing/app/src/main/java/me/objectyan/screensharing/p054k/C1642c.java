...
public class C1642c extends C1626e {
    ...
    protected C1622d getUrlParams() {
        ...
        map.put("appversioncode", String.valueOf(CarlifeUtil.m4375h()));
        map.put("appversionname", CarlifeUtil.m4373g());
        return map;
    }
    ...
    protected int responseSuccessCallBack(String data) throws JSONException {
        LogUtil.d(this.tag, "ConfigRequest responseSuccessCallBack :" + data);
