...
import me.objectyan.screensharing.R;
...
import me.objectyan.screensharing.core.screen.operation.SpecifyKnobKeyListener;
...
//    private C2278e f3798v;
    ...
    class IVHomeViewFocusListener implements OnFocusChangeListener {
        ...
        final  CarlifeViewWrapper mCarlifeViewWrapper;
...
//                BottomTabDisplayController.getInstance().delayHide();
    ...
    class IVMusicViewFocusListener implements OnFocusChangeListener {
        ...
        final  CarlifeViewWrapper f3772a;
...
//                BottomTabDisplayController.getInstance().delayHide();
    ...
    class IVPhoneViewFocusListener implements OnFocusChangeListener {
        ...
        final  CarlifeViewWrapper f3773a;
...
//                BottomTabDisplayController.getInstance().delayHide();
    ...
    class IVNaviViewFocusListener implements OnFocusChangeListener {
        ...
        final  CarlifeViewWrapper f3774a;
...
//                BottomTabDisplayController.getInstance().delayHide();
    ...
    class IVVoiceViewFocusListener implements OnFocusChangeListener {
        ...
        final  CarlifeViewWrapper f3775a;
...
//                BottomTabDisplayController.getInstance().delayHide();
    ...
    class ContentFrameTouchListener implements OnTouchListener {
        ...
        final  CarlifeViewWrapper f3776a;
    ...
    class DialogHolderClickListener implements OnClickListener {
        ...
        final  CarlifeViewWrapper f3777a;
...
//
//        final  CarlifeViewWrapper f3778a;
//
...
//            case R.id.iv_voice:
//                Log.d(Tag, "click voic recognition btn");
//                m4735k();
//                return;
//            case R.id.iv_navi:
...
//            Log.d(Tag, "onVoiceClick: Listening");
//            C1912n.m7270a().m7312k();
//        } else if (C1912n.m7270a().m7301b()) {
//            Log.d(Tag, "onVoiceClick: Processing");
//            C1903m.m7252a().m7255b();
//        } else if (C1912n.m7270a().m7314m()) {
//            Log.d(Tag, "onVoiceClick: Speeching");
//            C1903m.m7252a().m7255b();
//        } else {
//            Log.d(Tag, "onVoiceClick: stopVoice");
//            C1903m.m7252a().m7255b();
//        }
    }
...
//        }
    ...
    public void showDialog(BaseDialog childView, C1265a gravity) {
        if (childView != null) {
            Log.d("CarlifeViewWrapper", "showDialog=" + isDialogShown());
            if (this.mArrayList.contains(childView)) {
                Log.w(Tag, "showDialog childView is already exists.");
                return;
            }
            this.mArrayList.add(childView);
            Log.d("Dialog", "Carlife's showDialog childView=" + childView + ", size=" + this.mArrayList.size());
...
//            this.f3791o.setVisibility(0);
    ...
    private void m4704a(BaseDialog childView, boolean dismissOrCancel) {
        if (childView != null && isDialogShown()) {
            Log.d("Dialog", "dismissDialog childView=" + childView);
...
//                this.f3791o.setVisibility(8);
            ...
            Log.d("Dialog", "CarlifeView's dismissDialog mHistories.isEmpty=" + this.mArrayList.isEmpty() + ",remove Result=" + result);
            if (result && !childView.m4478h()) {
                Log.d(Tag, "onCancel child");
                if (dismissOrCancel) {
                    childView.mo1526d();
                } else {
                    childView.mo1629c();
...
//            drawable.start();
    ...
    public void showWindowView(View view, LayoutParams layoutParams) {
        Log.d("CarlifeActivity", "showWindowView");
...
//        params.setMargins(0, 0, 0, CarlifeScreenUtil.newInstance().m4343c(20));
//        params.addRule(12);
//        params.addRule(14);
...
//        if (!CarlifeConfig.isSupportInternalScreen() && this.f3794r != null && this.f3794r.getParent() != null) {
