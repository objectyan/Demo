...
public class VideoOutputThread extends Thread {
    ...
    private static MediaCodec f3920e = f3919d.getMediaCodec();

    private static final Object f3921f = f3919d.getRecorderThreadObj();

    private static final Object f3922g = f3919d.getMediaCodecThreadObj();
    ...
    private long f3931p = ((long) (Recorder.sChangeFrameRate / 2));

    private long mChangeFrameRate = ((long) Recorder.sChangeFrameRate);

    public VideoOutputThread() {
        f3920e = f3919d.getMediaCodec();
    }


    public void m4924a(int time) {
        this.f3931p = (long) time;
        this.mChangeFrameRate = (long) (time * 2);
    }


    public void m4923a() {
        Log.d(f3916a, "VideoOutputThread ifStopInputThread=" + (!CarlifeConfig.isSupportInternalScreen()));
        this.f3927l = false;
        f3919d.setVideoOutputThreadNull(null);
    ...
    public void setNeedDropFrame(boolean needDropFrame) {
        if (!this.mNeedDropFrame) {
            this.mNeedDropFrame = needDropFrame;
            this.f3929n = 0;
        }
    }
    ...
    public void run() {
        ...
        if (CarlifeConfig.isSupportInternalScreen()) {
            f3923h = 0;
            Log.d(f3916a, "VideoOutputThread  isFirstEncodeFrame=" + f3919d.getIsFirstEncodeFrame() + ", isRunning=" + this.f3927l);
            if (f3919d.getIsFirstEncodeFrame()) {
                while (m4917d() == 0) {
                    if (!this.f3927l) {
                        break;
                    }
            ...
            m4920g();
            Log.d(f3916a, "VideoOutputThread  isRunning=" + this.f3927l);
            while (this.f3927l) {
                if (m4919f() < 0) {
                    m4923a();
                } else {
                    try {
                        Thread.sleep(this.mChangeFrameRate);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
                }
            }
        } else if (f3919d.getIsLollipop()) {
            while (!f3919d.m4850Q()) {
                if (f3919d.writeVideo2() < 0) {
                    m4923a();
                    return;
                }
                try {
    ...
    private int m4917d() {
        int outDataLength = 0;
        if (f3920e == null) {
            Log.w(f3916a, "还没完成初始化, 或已经被释放");
            return -1;
        }
        try {
            if (f3919d.getIsReleaseMediaCodec()) {
                Thread.sleep(5);
            }
            synchronized (f3922g) {
                ...
                if (outputBufferIndex >= 0) {
                    ...
                    if (f3919d.getIsFirstEncodeFrame()) {
                        ...
                        if (VideoOutputThread.m4914a(outputBuffer)) {
                            ...
                            outputBuffer.clear();
                            f3920e.releaseOutputBuffer(outputBufferIndex, false);
                            f3919d.setIsFirstEncodeFrame(false);
                            Log.d(f3916a, "VideoOutputThread outputSpsPpsAndFirstFrame isFirstEncodeFrame");
                        } else {
                            outputBuffer.clear();
                            f3920e.releaseOutputBuffer(outputBufferIndex, false);
                            f3919d.setIsFirstEncodeFrame(false);
                            m4920g();
                            Log.d(f3916a, "isTEST true, return 20!");
                            return 20;
                        }
                    }
                }
            ...
            t.printStackTrace();
            Log.e(f3916a, "outputSpsPpsAndFirstFrame" + t.toString());
        }
        Log.d(f3916a, "VideoOutputThread  outputSpsPpsAndFirstFrame outDataLength=" + outDataLength);
        if (outDataLength == 0 || f3925j == null) {
            return 0;
        }
        return f3919d.encryptVideoData(f3925j, outDataLength);
    }
    ...
    L_0x0007:
        r6 = "Recorder";
        r7 = "还没完成初始化, 或已经被释放";
        me.objectyan.screensharing.core.Log.w(r6, r7);
    L_0x0010:
        return r4;
    L_0x0011:
        r7 = f3919d;	 Catch:{ Throwable -> 0x003e }
        r7 = r7.getIsReleaseMediaCodec();	 Catch:{ Throwable -> 0x003e }
    ...
    L_0x002d:
        ...
        if (r7 == 0) goto L_0x005e;
    L_0x0031:
        r7 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4922i();	 Catch:{ Throwable -> 0x003e }
        if (r7 != 0) goto L_0x004a;
    L_0x0037:
        r7 = f3919d;	 Catch:{ Throwable -> 0x003e }
        r8 = 1;
        r7.sendTypeMsgToService(r8);	 Catch:{ Throwable -> 0x003e }
        goto L_0x0010;
    L_0x003e:
        r5 = move-exception;
        r5.printStackTrace();
    ...
    L_0x008f:
        r7 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4914a(r1);	 Catch:{ all -> 0x00cb }
        if (r7 == 0) goto L_0x009b;
    L_0x0095:
    ...
    L_0x009b:
        r7 = r12.mNeedDropFrame;	 Catch:{ all -> 0x00cb }
    ...
    L_0x00ab:
        r7 = 0;
        r12.mNeedDropFrame = r7;	 Catch:{ all -> 0x00cb }
        r7 = 0;
    ...
    L_0x00e3:
        r7 = f3919d;	 Catch:{ all -> 0x00cb }
        r7.writeVideo1();	 Catch:{ all -> 0x00cb }
    L_0x00e8:
        monitor-exit(r8);	 Catch:{ all -> 0x00cb }
        r4 = r6;
        goto L_0x0010;
    L_0x00ec:
        r6 = f3919d;
        r7 = f3925j;
        r4 = r6.encryptVideoData(r7, r0);
        goto L_0x0010;
        */
        throw new UnsupportedOperationException("Method not decompiled: me.objectyan.screensharing.core.screen.video.g.e():int");
    }
    ...
    L_0x0007:
        r7 = "Recorder";
        r8 = "还没完成初始化, 或已经被释放";
        me.objectyan.screensharing.core.Log.w(r7, r8);
        r4 = r6;
    L_0x0011:
        return r4;
    L_0x0012:
        r7 = f3919d;	 Catch:{ Throwable -> 0x00ed }
        r7 = r7.getIsReleaseMediaCodec();	 Catch:{ Throwable -> 0x00ed }
    ...
    L_0x002e:
        ...
        if (r7 == 0) goto L_0x0050;
    L_0x0032:
        r7 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4922i();	 Catch:{ Throwable -> 0x00ed }
        if (r7 != 0) goto L_0x0040;
    L_0x0038:
        r7 = f3919d;	 Catch:{ Throwable -> 0x00ed }
        r8 = 1;
        r7.sendTypeMsgToService(r8);	 Catch:{ Throwable -> 0x00ed }
        r4 = r6;
        goto L_0x0011;
    L_0x0040:
        r7 = 0;
    ...
    L_0x0083:
        r7 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4914a(r1);	 Catch:{ all -> 0x00ea }
        if (r7 == 0) goto L_0x008f;
    L_0x0089:
    ...
    L_0x008f:
        r7 = r12.mNeedDropFrame;	 Catch:{ all -> 0x00ea }
    ...
    L_0x0099:
        ...
        me.objectyan.screensharing.core.MsgHandlerCenter.dispatchMessage(r7);	 Catch:{ all -> 0x00ea }
    L_0x009e:
        r7 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4914a(r1);	 Catch:{ all -> 0x00ea }
    ...
    L_0x00aa:
        r7 = 0;
        r12.mNeedDropFrame = r7;	 Catch:{ all -> 0x00ea }
        r7 = 0;
    ...
    L_0x00ed:
        ...
        r8 = r8.append(r9);
        r8 = r8.toString();
        me.objectyan.screensharing.core.Log.e(r7, r8);
        r4 = r6;
        goto L_0x0011;
    L_0x0112:
    ...
    L_0x011d:
        ...
        r12.f3930o = r7;	 Catch:{ all -> 0x00ea }
        r7 = f3919d;	 Catch:{ all -> 0x00ea }
        r4 = r7.writeVideo1();	 Catch:{ all -> 0x00ea }
        monitor-exit(r8);	 Catch:{ all -> 0x00ea }
        goto L_0x0011;
    L_0x012e:
        monitor-exit(r8);	 Catch:{ all -> 0x00ea }
    ...
    L_0x0131:
        ...
        goto L_0x0011;
        */
        throw new UnsupportedOperationException("Method not decompiled: me.objectyan.screensharing.core.screen.video.g.f():int");
    }
    ...
    public static int m4912a(byte[] input) {
        int outDataLength = 0;
        if (input == null) {
            Log.i(f3916a, "input buffer is null");
            return 0;
        }
        Log.e(f3916a, "Into firstSendEncodeFrame(byte[] input) input=" + input.length);
        if (f3920e == null) {
            Log.w(f3916a, "还没完成初始化, 或已经被释放");
            return 0;
        }
            ...
            try {
                synchronized (f3921f) {
                    ...
                    if (inputBufferIndex >= 0) {
                        ...
                        f3920e.queueInputBuffer(inputBufferIndex, 0, input.length, f3919d.getPresentationTimeUs(), 0);
                        Log.e(f3916a, "firstSendEncodeFrame_inputBufferIndex >= 0");
                    } else {
                        Log.e(f3916a, "firstSendEncodeFrame_inputBufferIndex < 0");
                    }
                    ...
                    if (outputBufferIndex >= 0) {
                        ...
                        outputBuffer.clear();
                        f3920e.releaseOutputBuffer(outputBufferIndex, false);
                        Log.e(f3916a, "firstSendEncodeFrame_outputBufferIndex >= 0");
                    } else {
                        Log.e(f3916a, "firstSendEncodeFrame_outputBufferIndex < 0");
                    }
                }
            } catch (IllegalStateException e) {
                Log.e(f3916a, "firstSendEncodeFrame_IllegalStateException");
                e.printStackTrace();
                if (!(f3920e == null || VideoOutputThread.m4922i())) {
                    f3919d.sendTypeMsgToService(1);
                }
            } catch (Throwable t) {
                t.printStackTrace();
            }
        ...
        if (outDataLength == 0 || f3925j == null) {
            Log.i(f3916a, "firstSendEncodeFrame 不是I帧啊");
            f3919d.writeVideo1();
            return 0;
        }
        Log.e(f3916a, "firstSendEncodeFrame(byte[] input) data=" + f3925j + ", outDataLength=" + outDataLength);
        f3919d.encryptVideoData(f3925j, outDataLength);
        Log.e(f3916a, "End firstSendEncodeFrame(byte[] input)");
    ...
    L_0x000b:
        r8 = "Recorder";
        r10 = "还没完成初始化, 或已经被释放";
        me.objectyan.screensharing.core.Log.w(r8, r10);	 Catch:{ all -> 0x0149 }
    ...
    L_0x0024:
        ...
        me.objectyan.screensharing.core.Log.e(r10, r11);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        if (r4 < 0) goto L_0x00f3;
    L_0x0051:
        r3 = r5[r4];	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        r10 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4914a(r3);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        if (r10 == 0) goto L_0x00d5;
    L_0x0059:
        r10 = "Recorder";
        r11 = "firstSendEncodeFrame() isIFrame yes";
        me.objectyan.screensharing.core.Log.i(r10, r11);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
    ...
    L_0x00a0:
        ...
        r9 = r9.append(r2);
        r9 = r9.toString();
        me.objectyan.screensharing.core.Log.e(r8, r9);
    ...
    L_0x00d5:
        ...
        r10 = r10.writeVideo1();	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
    ...
    L_0x010d:
        ...
        me.objectyan.screensharing.core.MsgHandlerCenter.dispatchMessage(r10);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
    L_0x0113:
        r10 = "Recorder";
        r11 = new java.lang.StringBuilder;	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        r11.<init>();	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
    ...
    L_0x0137:
        ...
        if (r10 == 0) goto L_0x0020;
    L_0x013b:
        r10 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4922i();	 Catch:{ all -> 0x0149 }
        if (r10 != 0) goto L_0x0020;
    L_0x0141:
        r8 = f3919d;	 Catch:{ all -> 0x0149 }
        r10 = 1;
        r8.sendTypeMsgToService(r10);	 Catch:{ all -> 0x0149 }
        goto L_0x00a0;
    L_0x0149:
        r7 = move-exception;
        monitor-exit(r9);	 Catch:{ all -> 0x0149 }
    ...
    L_0x0152:
        r7 = f3919d;
        r8 = f3925j;
        r7.encryptVideoData(r8, r2);
        r7 = r2;
        goto L_0x0015;
        */
        throw new UnsupportedOperationException("Method not decompiled: me.objectyan.screensharing.core.screen.video.g.g():int");
    }
    ...
    L_0x0031:
        r8 = me.objectyan.screensharing.core.screen.video.VideoOutputThread.m4914a(r2);	 Catch:{ all -> 0x007b }
    ...
    L_0x005c:
        r7 = me.objectyan.screensharing.core.p069b.CarlifeConfig.isSupportInternalScreen();
        if (r7 == 0) goto L_0x0067;
    L_0x0062:
        r7 = 1038; // 0x40e float:1.455E-42 double:5.13E-321;
        me.objectyan.screensharing.core.MsgHandlerCenter.dispatchMessage(r7);
    L_0x0067:
        r12.f3930o = r6;
        r6 = f3919d;
        r6 = r6.writeVideo2();
    ...
    L_0x007e:
        ...
        r7 = r7.append(r8);
        r7 = r7.toString();
        me.objectyan.screensharing.core.Log.e(r6, r7);
        r6 = -1;
        goto L_0x006f;
    L_0x00a2:
    ...
    L_0x00a9:
        r6 = f3919d;
        r7 = f3925j;
        r6 = r6.encryptVideoData(r7, r1);
        goto L_0x006f;
        */
        throw new UnsupportedOperationException("Method not decompiled: me.objectyan.screensharing.core.screen.video.g.h():int");
    }
