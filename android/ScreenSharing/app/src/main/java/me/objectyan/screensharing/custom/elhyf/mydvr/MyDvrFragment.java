...
public class MyDvrFragment extends ContentFragment {
    ...
    private class C1394a extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = View.inflate(this.f4070c, R.layout.frag_home_my_mydvr_item, null);
            }
            ...
            ImageView ivCameraType = (ImageView) convertView.findViewById(R.id.iv_camera_type);
            ...
            if (receivedFileSpeech != null) {
                if (receivedFileSpeech.m5160a() != null) {
                    ...
                    ivThumbnail.setImageResource(R.mipmap.mydvr_picture);
                    btnShare.setVisibility(0);
                } else {
                    ivThumbnail.setImageResource(R.mipmap.mydvr_video);
                ...
                if (receivedFileSpeech.m5173g() == C1399a.Back_Camera) {
                    ivCameraType.setImageResource(R.mipmap.mydvr_dvr_back);
                } else {
                    ivCameraType.setImageResource(R.mipmap.mydvr_dvr_front);
                }
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        View contentView = inflater.inflate(R.layout.frag_home_my_mydvr, null);
        setCommonTitleBar(contentView, getString(R.string.home_my_mydvr));
        return contentView;
    }
    ...
    /* renamed from: b */
    private void m5111b() {
        this.f4074c = (ImageButton) this.mContentView.findViewById(R.id.ib_left);
        this.f4075d = (TextView) this.mContentView.findViewById(R.id.tv_video);
        this.f4076e = (TextView) this.mContentView.findViewById(R.id.tv_photo);
        this.f4079h = (TextView) this.mContentView.findViewById(R.id.tv_no_video);
        this.f4080i = (TextView) this.mContentView.findViewById(R.id.tv_no_photo);
        this.f4077f = this.mContentView.findViewById(R.id.view_video_bottom_line);
        this.f4078g = this.mContentView.findViewById(R.id.view_photo_bottom_line);
        this.f4081j = (ListView) this.mContentView.findViewById(R.id.lv_mydvr_video);
        this.f4082k = (ListView) this.mContentView.findViewById(R.id.lv_mydvr_photo);
    }
    ...
    /* renamed from: d */
    private void m5115d() {
        this.f4075d.setTextColor(getActivity().getResources().getColor(R.color.mydvr_contact_title_selected));
        this.f4077f.setVisibility(0);
        this.f4081j.setVisibility(0);
        this.f4076e.setTextColor(getActivity().getResources().getColor(R.color.mydvr_contact_title_not_selected));
    ...
    /* renamed from: e */
    private void m5117e() {
        this.f4076e.setTextColor(getActivity().getResources().getColor(R.color.mydvr_contact_title_selected));
        this.f4078g.setVisibility(0);
        this.f4082k.setVisibility(0);
        this.f4075d.setTextColor(getActivity().getResources().getColor(R.color.mydvr_contact_title_not_selected));
    ...
    private void m5109a(final C1400b receivedFileSpeech, final String adapterType) {
        if (this.f4087p == null) {
            this.f4087p = new C1953c(getActivity()).m7442b((int) R.string.home_my_mydvr_dialog_title).m7457g(17).m7447c((int) R.string.alert_confirm).m7458q().m7450d((int) R.string.alert_cancel);
        }
        this.f4087p.m7438a(new OnBtnClickListener(this) {
            /* renamed from: c */
        ...
        if (f4073b.equals(adapterType)) {
            this.f4087p.m7444b(getString(R.string.home_my_mydvr_dialog_content_photo));
        } else {
            this.f4087p.m7444b(getString(R.string.home_my_mydvr_dialog_content_video));
        }
        CarlifeViewContainer.m4699a().m4701b().showDialog(this.f4087p);
    }
    ...
    private void m5108a(final C1400b receivedFileSpeech) {
        ...
        CarlifeViewContainer.m4699a().m4701b().showDialog(this.f4088q);
    }
}
