        ...
        if (event != null && event.getAction() == 0) {
            ...
            switch (keyCode) {
                case 19:
                    ...
                    LogUtil.d("FocusManager", "KEYCODE_DPAD_UP focusArea=" + focusArea);
                    if (focusArea == null) {
                        return true;
                    }
                    focusArea.mo1554a();
                ...
                case 20:
                    ...
                    LogUtil.d("FocusManager", "KEYCODE_DPAD_DOWN focusArea=" + focusArea);
                    if (focusArea == null) {
                        return true;
                    }
                    focusArea.mo1554a();
                ...
                case 21:
                    ...
                    LogUtil.d("FocusManager", "KEYCODE_DPAD_LEFT focusArea=" + focusArea);
                    if (focusArea == null) {
                        return true;
                    }
                    focusArea.mo1554a();
                ...
                case 22:
                    ...
                    LogUtil.d("FocusManager", "KEYCODE_DPAD_RIGHT focusArea=" + focusArea);
                    if (focusArea == null) {
                        return true;
                    }
                    focusArea.mo1554a();
