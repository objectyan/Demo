...
public class C1796d {
    ...
    public static Bitmap m6669a(Context context, Bitmap source, int radius) {
        LogUtil.m4440c(f5521a, "origin size:" + source.getWidth() + "*" + source.getHeight());
        ...
        LogUtil.m4440c(f5521a, "scale size:" + inputBmp.getWidth() + "*" + inputBmp.getHeight());
    ...
    public static Bitmap m6670a(Bitmap sentBitmap, int radius) {
        ...
        int[] pix = new int[(w * h)];
        LogUtil.m4445e("pix", w + " " + h + " " + pix.length);
