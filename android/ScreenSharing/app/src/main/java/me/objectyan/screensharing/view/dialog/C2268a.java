...
import com.baidu.carlife.adpter.LoadMoreBaseAdapter;
...
public class C2268a extends BaseDialog implements OnClickListener, OnTouchListener, OnScrollListener {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        if (this.f7429t.getChildAt(0) != null) {
            if (this.f7419j == 0 || this.f7421l == 0 || this.f7424o != totalItemCount) {
                ...
                if (this.f7431v != null && (this.f7431v instanceof LoadMoreBaseAdapter)) {
                    LoadMoreBaseAdapter loadMoreBaseAdapter = this.f7431v;
            ...
            if (scrollY == 0) {
                if (this.f7426q) {
                    this.f7426q = false;
                    this.f7415f.setImageResource(R.drawable.com_ic_prev_disable);
                    this.f7415f.setEnabled(false);
                }
                if (this.f7427r) {
                    if ((-((this.f7419j - this.f7420k) - 2)) >= 0) {
                        this.f7427r = false;
                        this.f7416g.setImageResource(R.drawable.com_ic_next_disable);
                        this.f7416g.setEnabled(false);
                    }
                } else if ((-((this.f7419j - this.f7420k) - 2)) < 0) {
                    this.f7427r = true;
                    this.f7416g.setImageResource(R.drawable.com_ic_next);
                ...
                if (!(scrollY == 0 || this.f7426q)) {
                    this.f7426q = true;
                    this.f7415f.setImageResource(R.drawable.com_ic_prev);
    ...
    protected View mo1528a() {
        View contentView = LayoutInflater.from(this.c).inflate(R.layout.btnlistview_dialog_right_list, null);
    ...
    protected void mo1529b() {
        this.f7428s = (TextView) findViewById(R.id.tv_title);
        this.f7428s.setText(this.f7430u);
        this.f7429t = (ListView) findViewById(R.id.lv_menu);
        this.f7429t.setOverScrollMode(2);
        this.f7414e = findViewById(R.id.btnlistview_left);
        if (C1342a.m4926a().m4929b() || C1343b.m4932a().m4935b()) {
            this.f7414e.setVisibility(0);
        }
        this.f7417h = (ViewGroup) findViewById(R.id.btnlistview_scroller);
        this.f7418i = findViewById(R.id.btnlistview_scroll_bar);
        this.f7415f = (ImageButton) findViewById(R.id.btnlistview_btn_prev);
        this.f7416g = (ImageButton) findViewById(R.id.btnlistview_btn_next);
