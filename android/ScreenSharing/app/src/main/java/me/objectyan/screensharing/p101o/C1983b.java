...
public class C1983b {
    ...
    class C19801 extends C1979b {
        ...
        public void onCommand(String type, String cmd) {
            LogUtil.d(C1983b.f6376a, "## mCommandListener onCommand():" + type + " # " + cmd);
            if (type.equals("open_home_page")) {
                ...
                LogUtil.d(C1983b.f6376a, "voice scene select: " + cmd);
            }
        }
    }
    ...
    class C19822 implements C1981b {
        ...
        public void mo1727a(String feature) {
            LogUtil.d(C1983b.f6376a, "close feature = " + feature);
            ...
            C1915a.m7321a().m7322a(C1983b.f6378c.getString(R.string.no_this_ability), 1);
        }

        /* renamed from: a */
        public void mo1728a(String feature, boolean isFromVrWakeUp) {
            LogUtil.d(C1983b.f6376a, "open feature = " + feature);
            if (feature.equals(C1981b.f6368h)) {
                ...
                LogUtil.d(C1983b.f6376a, "------- Wake up CMD -------: " + isFromVrWakeUp);
                if (!isFromVrWakeUp) {
                    C1915a.m7321a().m7322a(C1983b.f6378c.getString(R.string.no_this_ability), 1);
                } else if (!this.f6375a.m7588a(feature)) {
                    C1915a.m7321a().m7322a(C1983b.f6378c.getString(R.string.voice_current_no_control), 1);
                }
            }
        }
        ...
        public void mo1729b(String feature) {
            LogUtil.d(C1983b.f6376a, "increase feature = " + feature);
        ...
        public void mo1730c(String feature) {
            LogUtil.d(C1983b.f6376a, "decrease feature = " + feature);
            if (feature.equals(C1981b.f6362b)) {
                C1983b.m7577a(8);
            } else if (feature.equals(C1981b.f6364d)) {
                C1983b.m7577a(12);
        ...
        public void mo1731d(String feature) {
            LogUtil.d(C1983b.f6376a, "maxmize feature = " + feature);
            if (feature.equals(C1981b.f6362b)) {
                C1983b.m7577a(9);
            } else if (feature.equals(C1981b.f6364d)) {
                C1983b.m7577a(13);
        ...
        public void mo1732e(String feature) {
            LogUtil.d(C1983b.f6376a, "minimize feature = " + feature);
        ...
        public void mo1733f(String action) {
            LogUtil.d(C1983b.f6376a, "manipulate feature = " + action);
    ...
    public void m7587a(Context cx) {
        LogUtil.d(f6376a, "VoiceControlManager Init");
        f6378c = cx;
    ...
    public static void m7577a(int cmd) {
        ...
        if (C1663a.m5979a().m5993N()) {
            ...
            if (voiceRequest != null) {
                ...
                LogUtil.d(f6376a, "MD --- >HU: Voice Control Cmd, id =  " + cmd);
                return;
            }
            return;
        }
        LogUtil.d(f6376a, "CarLife not connected");
    }
