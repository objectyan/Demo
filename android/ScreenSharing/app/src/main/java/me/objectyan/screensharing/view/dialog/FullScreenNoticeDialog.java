...
public class FullScreenNoticeDialog extends BaseDialog {
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(R.layout.frag_fullscreen_notice, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7371e = (TextView) findViewById(R.id.agree_btn);
        this.f7372f = (ScrollView) findViewById(R.id.scroll_view);
