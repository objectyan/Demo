...
public class C1954c extends C1953c {
    ...
    protected void mo1529b() {
        super.mo1529b();
        this.f6238q = (TextView) findViewById(R.id.first_btn);
        this.f6239r = (TextView) findViewById(R.id.second_btn);
    }
    ...
    public void mo1630i() {
        if (1001 == this.f6240s) {
            LogUtil.d(f6229e, "Dialog set: " + this.f6240s);
            m7462j();
    ...
    /* renamed from: j */
    public void m7462j() {
        m7442b((int) R.string.carlife_update_tips_dialog_title);
        m7447c((int) R.string.carlife_net_wait_wifi_download);
    ...
    public void m7463k() {
        m7442b((int) R.string.carlife_update_tips_dialog_title);
        m7447c((int) R.string.alert_confirm);
        m7450d((int) R.string.alert_cancel);
        long size = (long) this.f6241t;
        long modeK = size % 1048576;
        LogUtil.d(f6229e, "get firmware size: " + size + " | " + modeK);
