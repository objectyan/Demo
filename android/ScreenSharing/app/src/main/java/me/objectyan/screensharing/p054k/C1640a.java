...
public class C1640a extends C1626e {
    ...
    protected C1622d getPostRequestParams() {
        ...
        params.put("appID", CarlifeUtil.m4371f());
        params.put("appVersionCode", String.valueOf(CarlifeUtil.m4375h()));
        params.put("appVersionName", CarlifeUtil.m4373g());
        params.put("channel", C2172c.m8224c());
        params.put("model", Build.MODEL);
        params.put("subModel", "unknow");
        params.put("platform", CommonParams.jb);
        params.put(SpeechConstant.LANGUAGE, Locale.getDefault().getLanguage());
        params.put("resolution", CarlifeUtil.m4363c());
        params.put("carModel", CommonParams.sVehicleChannel.getChannel());
