...
public class C2142b {
    ...
    public List<C2105a> m8080e() {
        if (this.f6823g.size() > 0) {
            LogUtil.m4440c(f6817a, "use memory cache");
            return this.f6823g;
        }
        String json = m8070h();
    ...
    public void m8079d(String data) {
        LogUtil.m4440c(f6817a, "write cache data");
        this.f6823g.clear();
        this.f6824h = 0;
        FileOutputStream fos = null;
        try {
            fos = AppContext.m3876a().openFileOutput("radio_channel_list.json", 0);
    ...
    /* renamed from: g */
    private long m8069g() {
        LogUtil.m4440c(f6817a, "get cache time");
        try {
            String json = m8070h();
            if (!TextUtils.isEmpty(json)) {
    ...
    private String m8070h() {
        LogUtil.m4440c(f6817a, "read cache data");
        FileInputStream fis = null;
        try {
            fis = AppContext.m3876a().openFileInput("radio_channel_list.json");
    ...
    private String m8071i() {
        LogUtil.m4440c(f6817a, "read default data");
        return C2177h.m8268a(AppContext.m3876a(), "radio_channel_list.json");
    }
