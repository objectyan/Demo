...
public class C2103a {
    ...
    public void m7887a(Context mcontext) {
        LogUtil.d(f6677a, "Start push work");
        String strKey = f6679d;
        this.f6681c = mcontext;
        PushManager.startWork(AppContext.m3876a().getApplicationContext(), 0, strKey);
        LogUtil.d(f6677a, "End push work");
        ...
        tags.add(C2186p.m8304a().m8309a(CommonParams.jA, "20022100"));
    ...
    private void m7882a(String start, String end) {
        ...
        s.setSpan(new ForegroundColorSpan(this.f6681c.getResources().getColor(R.color.common_bottom_text_red_color)), 13, indexTotal, 17);
        s.setSpan(new ForegroundColorSpan(this.f6681c.getResources().getColor(R.color.common_bottom_text_red_color)), indexTotal + 3, indexPosition, 17);
