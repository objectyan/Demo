...
public class C1912n {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 4160:
                    ...
                    return;
                case 4097:
                    LogUtil.d(C1912n.f5889g, "############## delay enter scene and wakeup");
                    this.f5873a.m7308g();
                    return;
                default:
                    return;
    ...
    class C19062 implements C1905a {
        ...
        public void mo1712a() {
            ...
            LogUtil.d("codrivervoice", "----onInitSuccess-----");
    ...
    class C19084 implements C1889c {
        ...
        public boolean mo1716b() {
            if (FragmentManagerCallbackProxy.m4757a().getCurrentFragmentType() == 17 && this.f5877a.f5901r != null) {
                this.f5877a.f5901r.quitCruise();
            }
            if (C1772k.m6480a().m6489c() != 0) {
                C2201w.m8371a((int) R.string.phone_status_busy_voice, 1);
                return false;
            }
        ...
        public void mo1715a(String wakeupWord) {
            ...
            LogUtil.d(C1912n.f5889g, "--onWakeUp---word:" + wakeupWord);
        ...
        public void mo1714a(int errorCode) {
            LogUtil.d(C1912n.f5889g, "---errorCode:" + errorCode);
            switch (errorCode) {
                case 0:
        ...
        public void mo1720f() {
            if (this.f5877a.f5892f == 1 && this.f5877a.f5899p) {
                LogUtil.d(C1912n.f5889g, "Vr State is already LISTENING");
                return;
            }
            this.f5877a.m7292z();
    ...
    public void m7294a(Activity activity) {
        ...
        MsgHandlerCenter.m4460a(this.f5905v);
        C2716c.m10145a(this.f5893j, "3", "cl", CommonParams.sVehicleChannel.getChannel(), CommonParam.getCUID(this.f5893j));
    ...
    private void m7285s() {
        if (this.f5899p || m7313l()) {
            ...
            if (FragmentManagerCallbackProxy.m4757a().getCurrentFragmentType() == 17 && this.f5901r != null) {
    ...
    /* renamed from: e */
    public void m7306e() {
        LogUtil.d(f5889g, "Vr State is: " + this.f5892f);
    }
    ...
    public void m7317p() {
        ...
        if (m7313l()) {
            LogUtil.d(f5889g, " onActivityPause fullscreen capture, Invoke's vr.closeVr");
            m7286t();
        }
        if (m7288v()) {
            LogUtil.d(f5889g, " onActivityPause fullscreen capture, Invoke's vr.closeWakeup() ");
            m7309h();
        }
    }
    ...
    public void m7318q() {
        ...
        if (this.f5900q) {
            LogUtil.d(f5889g, " onActivityResume fullscreen capture, Invoke's vr.startWakeUp() ");
            m7308g();
        }
    }
    ...
    private void m7289w() {
        ...
        switch (this.f5904u) {
            case STATE_FOREGROUND:
                LogUtil.d(f5889g, "onUsbDisConnected  STATE_FOREGROUND");
                if (m7313l()) {
                    m7310i();
                    C2674b.m9985b().m10036m();
                    return;
            ...
            case STATE_BACKGROUND_SUPPORT_INTENAL_SCREEN:
                LogUtil.d(f5889g, "onUsbDisConnected  STATE_BACKGROUND");
                if (m7313l()) {
                    this.f5904u = C1911a.STATE_BACKGROUND_NOT_SUPPORT_INTENAL_SCREEN;
                    m7310i();
                    return;
    ...
    private void m7290x() {
        if (this.f5900q) {
            ...
            LogUtil.d(f5889g, "-----onUsbConnectedImpl----micStatus:" + micStatus);
            if (micStatus == 2) {
                C2201w.m8373a("当前车机不支持语音功能！", 0);
                if (m7313l()) {
                    m7286t();
            ...
            if (!CarlifeCoreSDK.m5979a().m5993N() || micStatus == 1) {
                ...
                LogUtil.d(f5889g, "AecVehicle OUTSIDE_RAW_PCM");
            } else if (micStatus == 3) {
                this.f5902s.m10727a(C2855a.OUTSIDE_AEC_MIC_LEFT, new C1751a(true));
                LogUtil.d(f5889g, "AecVehicle OUTSIDE_AEC_MIC_LEFT_PCM");
            } else if (micStatus == 4) {
                this.f5902s.m10727a(C2855a.OUTSIDE_AEC_MIC_RIGHT, new C1751a(false));
                LogUtil.d(f5889g, "AecVehicle OUTSIDE_AEC_MIC_RIGHT_PCM");
            }
            if (m7313l()) {
                m7286t();
                return;
