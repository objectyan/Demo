...
public final class CarlifeTransferDataSendProto {
    ...
    static class C20891 implements InternalDescriptorAssigner {
        ...
        public ExtensionRegistry assignDescriptors(FileDescriptor root) {
            ...
            CarlifeTransferDataSendProto.internal_static_CarlifeTransferDataSend_fieldAccessorTable = new FieldAccessorTable(CarlifeTransferDataSendProto.internal_static_CarlifeTransferDataSend_descriptor, new String[]{"FileId", "BodyData", "Len"}, CarlifeTransferDataSend.class, CarlifeTransferDataSend.Builder.class);
            return null;
        }
    }
