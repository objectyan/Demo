...
public class HomeDiscoverCardView extends RelativeLayout implements OnTouchListener {
    ...
    protected void m8447a(Context context) {
        this.f7158a = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.carlife_common_home_discover_card, this, true);
        this.f7159b = findViewById(R.id.home_card_ll);
        this.f7160c = findViewById(R.id.card_press_view);
        this.f7161d = findViewById(R.id.card_focus_view);
        this.f7162e = findViewById(R.id.red_point);
        this.f7164g = (ImageView) findViewById(R.id.card_iv_icon);
        this.f7163f = (TextView) findViewById(R.id.card_tv_name);
