...
public class C1962d {
    ...
    class C19562 extends JsonHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, C6327f[] headers, JSONObject response) {
            ...
            LogUtil.d(C1962d.f6250a, "HttpResponseHandler onSuccess: ");
            try {
                ...
                if (code == 0) {
                    ...
                    LogUtil.d(C1962d.f6250a, "HttpResponseHandler code:" + code);
                    LogUtil.d(C1962d.f6250a, "HttpResponseHandler strMsg:" + strMsg);
                }
        ...
        public void onFailure(int statusCode, C6327f[] headers, Throwable throwable, JSONObject errorResponse) {
            LogUtil.d(C1962d.f6250a, "HttpResponseHandler onFailure: ");
        }
    }
    ...
    public void m7478a() {
        try {
            ...
            versionConfig.close();
            LogUtil.d(f6250a, "read data: " + new String(data));
            ...
            LogUtil.d(f6250a, "mIgnoreVersionCode: " + new String(data));
    ...
    public void m7480a(String strServerUrl, String strVersion) {
        LogUtil.d(f6250a, "OTA checkUpdateManual");
    ...
    public void m7481a(String boardName, String versionCode, boolean manual) {
        this.f6270r = 0;
        LogUtil.d(f6250a, "boardName: " + boardName);
        LogUtil.d(f6250a, "versionCode: " + versionCode);
        LogUtil.d(f6250a, "OtaPath: " + C1962d.m7476f());
        this.f6259f = boardName;
        this.f6264k = versionCode;
        LogUtil.d(f6250a, "mIsDownloading: " + this.f6267n);
        if (!this.f6267n) {
    ...
    public void m7483c() {
        ...
        LogUtil.d(f6250a, "downloadPath: " + downloadPath);
        ...
        C1352a.m4958a().get(this.f6260g, new FileAsyncHttpResponseHandler(this, new File(downloadPath)) {
            ...
            public void onFailure(int statusCode, C6327f[] headers, Throwable throwable, File file) {
                ...
                if (this.f6247a.f6270r >= 2) {
                    ...
                    LogUtil.d(C1962d.f6250a, "onDownloadFailed: " + statusCode);
                    return;
                }
            ...
            public void onProgress(long bytesWritten, long totalSize) {
                ...
                LogUtil.d(C1962d.f6250a, "onDownloadProgress: " + ((int) ((100 * bytesWritten) / totalSize)));
            }
        });
