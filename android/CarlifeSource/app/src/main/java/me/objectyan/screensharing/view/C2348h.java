...
import com.baidu.carlife.adpter.VoiceResultsListAdapter;
import com.baidu.carlife.adpter.VoiceResultsListAdapter.C1025a;
...
public class C2348h implements OnClickListener, OnItemClickListener {
    ...
    /* renamed from: u */
    private VoiceResultsListAdapter f7739u;
    /* renamed from: v */
    ...
    class C23431 implements OnDialogCancelListener {
        /* renamed from: a */
    ...
    class C23464 implements Runnable {
        ...
        public void run() {
            C2256c.m8570a().m8571a((int) R.drawable.com_ic_help, (int) R.drawable.ic_voice_hint_b);
        }
    }
    ...
    public void m8918a(CarlifeActivity activity) {
        ...
        this.f7726h = LayoutInflater.from(this.f7724f).inflate(R.layout.tips_voice_full, null);
        this.f7725g = new C2331v(activity, this.f7726h, R.style.CommonRightListDialog, this.f7724f.getResources().getDimensionPixelSize(R.dimen.voice_dialog_width), 5);
        ...
        this.f7728j = (TextView) this.f7726h.findViewById(R.id.tv_voice_hint);
        this.f7727i = (TextView) this.f7726h.findViewById(R.id.tv_voice_recog_status);
        this.f7729k = (ImageView) this.f7726h.findViewById(R.id.iv_voice_close);
        this.f7729k.setOnClickListener(this);
        this.f7730l = (ImageView) this.f7726h.findViewById(R.id.iv_voice_help);
        this.f7730l.setOnClickListener(this);
        this.f7731m = (ImageView) this.f7726h.findViewById(R.id.iv_voice_debug);
        this.f7731m.setOnClickListener(this);
        this.f7732n = (ImageView) this.f7726h.findViewById(R.id.iv_voice_save);
        this.f7732n.setOnClickListener(this);
        this.f7736r = (WaveformView) this.f7726h.findViewById(R.id.wv_speaking);
        this.f7736r.setOnClickListener(this);
        this.f7733o = (ImageView) this.f7726h.findViewById(R.id.iv_voice_status_loading);
        this.f7734p = (ImageView) this.f7726h.findViewById(R.id.iv_voice_status_loading_1);
        this.f7735q = (ImageView) this.f7726h.findViewById(R.id.iv_voice_btn);
        this.f7735q.setOnClickListener(this);
        this.f7737s = (ScrollView) this.f7726h.findViewById(R.id.sv_layout_common);
        this.f7738t = (ListView) this.f7726h.findViewById(R.id.lv_multi_result);
        this.f7739u = new VoiceResultsListAdapter(this.f7724f);
        ...
        TextView temp = (TextView) this.f7737s.findViewById(R.id.temp);
        if (CommonParams.jr) {
            temp.setText(R.string.voice_domain_common_detail);
            this.f7737s.findViewById(R.id.temp1).setVisibility(0);
            this.f7737s.findViewById(R.id.temp2).setVisibility(0);
            return;
        }
        temp.setText(R.string.voice_domain_common_detail_closenavi);
        this.f7737s.findViewById(R.id.temp1).setVisibility(8);
        this.f7737s.findViewById(R.id.temp2).setVisibility(8);
    }
    ...
    /* renamed from: a */
    public void m8914a() {
        CarlifeViewContainer.m4699a().showDialog(this.f7725g, C1265a.Right);
        this.f7744z = true;
        if (this.f7721b) {
    ...
    private void m8907g() {
        ...
        this.f7726h.findViewById(R.id.rl_bottom).setVisibility(0);
        ...
        this.f7727i.setText("");
        this.f7728j.setText(R.string.voice_hint_a);
    ...
    private void m8908h() {
        if (m8922b()) {
            this.f7744z = false;
            m8907g();
            CarlifeViewContainer.m4699a().dismissDialog(this.f7725g);
            m8911k();
            if (this.f7721b) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_voice_help:
                if (LightnessControlManager.m4481b().m4499g()) {
                    LightnessControlManager.m4481b().m4502j();
                }
                m8923c();
                return;
            case R.id.iv_voice_debug:
            ...
            case R.id.iv_voice_save:
                ...
                C2169a.f6915a = z;
                return;
            case R.id.wv_speaking:
            case R.id.iv_voice_btn:
                switch (this.f7722d) {
                    case 1:
                    case 5:
                    case 6:
    ...
    public void m8917a(int status, int errorCode, String cmd) {
        switch (status) {
            ...
            case 3:
                this.f7722d = 3;
                this.f7727i.setText("");
                this.f7728j.setText(R.string.speaking);
                return;
            case 4:
                this.f7722d = 4;
                ...
                this.f7735q.setVisibility(4);
                this.f7727i.setText("");
                this.f7728j.setText(R.string.in_recog);
                return;
            case 5:
                this.f7722d = 1;
                this.f7736r.setVisibility(4);
                ...
                this.f7728j.setText("");
                if (1 == errorCode) {
                    this.f7728j.setText(R.string.in_search);
                    return;
                }
                return;
            case 6:
                ...
                switch (errorCode) {
                    case 2:
                        m8898a(4, String.format(this.f7724f.getString(R.string.error_recog_no_found), new Object[]{cmd}));
                        return;
                    case 3:
                        m8901b(3, R.string.error_recog_no_network);
                        return;
                    case 4:
                        m8901b(3, R.string.error_recog_fail_start);
                        StatisticManager.onEvent(StatisticConstants.VOICE_CONTROL_RECOGNITION_FAIL_ERROR_CLIENT, "小度无法启动");
                        return;
                    case 5:
                        if (TextUtils.isEmpty(cmd)) {
                            voiceHint = this.f7724f.getString(R.string.error_recog_no_music);
                        } else {
                            voiceHint = String.format(this.f7724f.getString(R.string.error_recog_no_found), new Object[]{cmd});
                        }
                        m8898a(4, voiceHint);
                        return;
                    case 6:
                        if (TextUtils.isEmpty(this.f7723e)) {
                            voiceHint = this.f7724f.getString(R.string.error_recog_no_poi);
                        } else {
                            voiceHint = String.format(this.f7724f.getString(R.string.error_recog_no_found), new Object[]{this.f7723e});
                            m8919a(null);
                        }
                        m8898a(4, voiceHint);
                        return;
                    case 7:
                        ...
                        m8901b(3, R.string.error_recog_no_mic);
                        return;
                    case 8:
                        m8901b(3, R.string.error_recog_music_is_playing);
                        return;
                    case 9:
                        m8898a(3, this.f7724f.getString(R.string.error_recog_cancle_search_poi));
                        return;
                    default:
                        if (CarlifeUtil.m4358a().m4401r()) {
                            m8901b(1, R.string.error_recog_default);
                        } else {
                            m8901b(3, R.string.error_recog_no_network_when_offline);
                        }
                        if (!TextUtils.isEmpty(cmd)) {
            ...
            case 7:
                ...
                this.f7728j.setText(R.string.voice_hint_b);
                this.f7727i.setVisibility(4);
                this.f7730l.setVisibility(4);
                this.f7731m.setVisibility(4);
                this.f7732n.setVisibility(4);
                this.f7726h.findViewById(R.id.rl_bottom).setVisibility(4);
                this.f7738t.setVisibility(8);
                this.f7729k.setImageResource(R.drawable.com_ic_back);
    ...
    private void m8898a(int event, String voiceHint) {
        LogUtil.d("Voice", "--postProcess--event:" + event + "----lastEvent:" + this.f7743y);
        ...
        this.f7738t.post(new Runnable(this) {
            ...
            public void run() {
                ...
                if (type == C1025a.ITEM_TYPE_MUSIC_LOCAL) {
                    tts = this.f7718c.f7724f.getString(R.string.voice_domain_music_search_local);
                } else if (type == C1025a.ITEM_TYPE_MUSIC_ONLINE) {
                    tts = this.f7718c.f7724f.getString(R.string.voice_domain_music_search_online);
                } else {
                    tts = this.f7718c.f7724f.getString(R.string.voice_domain_phone_search_contact);
                }
    ...
    private void m8912l() {
        ...
        params.height = (int) this.f7724f.getResources().getDimension(R.dimen.common_icon_small);
        params.width = (int) this.f7724f.getResources().getDimension(R.dimen.common_item_width);
    ...
    /* renamed from: m */
    private void m8913m() {
        this.f7729k.setImageResource(R.drawable.com_ic_close_selector);
        LayoutParams params = (LayoutParams) this.f7729k.getLayoutParams();
        params.height = (int) this.f7724f.getResources().getDimension(R.dimen.common_icon_exit_height);
        params.width = (int) this.f7724f.getResources().getDimension(R.dimen.common_icon_small);
        this.f7729k.setLayoutParams(params);
        this.f7729k.setBackgroundResource(R.drawable.common_btn_bg_focus);
    }
}
