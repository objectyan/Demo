...
public class C1789a extends C1133a<C1784a> {
    ...
    class C17872 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    class C17883 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    public void m6589a(String albumListId, int size) {
        if (size >= 1) {
            ...
            if (C1838q.f5701U.equals(albumListId)) {
                discoverCardView = (DiscoverCardView) mo1429b().m3703a((int) R.id.card_1);
                resources = discoverCardView.getContext().getResources();
                discoverCardView.m8408b(resources.getString(R.string.qqmusice_album_size) + size + resources.getString(R.string.qqmusice_album_size_unit));
            } else if (C1838q.f5702V.equals(albumListId)) {
                discoverCardView = (DiscoverCardView) mo1429b().m3703a((int) R.id.card_3);
                resources = discoverCardView.getContext().getResources();
                discoverCardView.m8408b(resources.getString(R.string.qqmusice_album_size) + size + resources.getString(R.string.qqmusice_album_size_unit));
            } else if (C1838q.f5703W.equals(albumListId)) {
                discoverCardView = (DiscoverCardView) mo1429b().m3703a((int) R.id.card_2);
                resources = discoverCardView.getContext().getResources();
                discoverCardView.m8408b(resources.getString(R.string.qqmusice_album_size) + size + resources.getString(R.string.qqmusice_album_size_unit));
            }
        }
    ...
    protected void m6587a(C1784a data) {
        m6581a((int) R.id.card_1, C1783a.m6530a().m6533b(C1145a.m3844a((int) R.string.module_musicqq_localmusic)).m6534c(C1145a.m3844a((int) R.string.qqmusice_album_empty)).m6536d(C1145a.m3845a(Integer.valueOf(R.drawable.music_ic_qq_downloadsong))).m6537e(C1145a.m3845a(Integer.valueOf(0))).m6535c());
        m6581a((int) R.id.card_2, C1783a.m6530a().m6533b(C1145a.m3844a((int) R.string.module_musicqq_myfavourite)).m6534c(C1145a.m3844a((int) R.string.qqmusice_album_unlogin)).m6536d(C1145a.m3845a(Integer.valueOf(R.drawable.music_ic_qq_favoriter))).m6537e(C1145a.m3845a(Integer.valueOf(2))).m6535c());
        m6581a((int) R.id.card_3, C1783a.m6530a().m6533b(C1145a.m3844a((int) R.string.module_musicqq_recent)).m6534c(C1145a.m3844a((int) R.string.qqmusice_album_empty)).m6536d(C1145a.m3845a(Integer.valueOf(R.drawable.music_ic_qq_recent))).m6537e(C1145a.m3845a(Integer.valueOf(1))).m6535c());
        m6581a((int) R.id.card_4, C1783a.m6530a().m6533b(C1145a.m3844a((int) R.string.module_musicqq_poprank)).m6534c(C1145a.m3844a((int) R.string.qqmusice_album_recommend)).m6536d(C1145a.m3845a(Integer.valueOf(R.drawable.music_ic_qq_popular))).m6537e(C1145a.m3845a(Integer.valueOf(3))).m6535c());
    }
    ...
    private void m6581a(int viewId, final C1784a cardModel) {
        ...
        if (isQQMusicPlaying && ((String) cardModel.m6540b().m3762b()).equals(this.f5455g.m6645o())) {
            discoverCardView.setCardTitleColor(C2188r.m8328a((int) R.color.cl_other_c_highlight));
        } else {
            discoverCardView.setCardTitleColor(C2188r.m8328a((int) R.color.cl_text_a5_title));
        }
    ...
    private void m6585h() {
        if (this.f5457i == null) {
            this.f5457i = new C1953c(AppContext.m3876a().getApplicationContext());
            this.f5457i.m7442b((int) R.string.qqmusic_jump_title);
            this.f5457i.m7435a((int) R.string.qqmusic_jump_msg);
            this.f5457i.m7440a(true);
            this.f5457i.m7447c((int) R.string.alert_cancel);
            this.f5457i.m7438a(new C17872(this));
            this.f5457i.m7445b(true);
            this.f5457i.m7450d((int) R.string.alert_confirm);
            this.f5457i.m7459r();
            this.f5457i.m7443b(new C17883(this));
            CarlifeViewContainer.m4699a().showDialog(this.f5457i);
        }
    }
    ...
    protected void m6591f() {
        try {
            ...
            LogUtil.d("qqmusic", "openQQMusicForLogin error:" + e.getMessage());
        }
    }
