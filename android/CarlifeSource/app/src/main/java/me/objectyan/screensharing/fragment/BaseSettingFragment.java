...
public abstract class BaseSettingFragment<T extends C1103a> extends ContentFragment {
    ...
    public void onInitFocusAreas() {
        if (this.fragmentType == getCurrentFragmentType()) {
            if (this.f4234a == null) {
                this.f4234a = new C1443g(this.mContentView.findViewById(R.id.title_bar), 2);
                this.f4234a.m5300d(this.mContentView.findViewById(R.id.ib_left));
            }
            if (this.f4235b == null) {
    ...
    protected void onUpdateSkin() {
        super.onUpdateSkin();
        updateCommonSkin();
        this.f4236c.setSelector(C2188r.m8331b(R.drawable.com_bg_item_selector));
        this.f4236c.setDivider(C2188r.m8331b(R.color.cl_line_a1_item));
        this.f4236c.setDividerHeight(getResources().getDimensionPixelSize(R.dimen.common_item_line));
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        ...
        this.f4236c = (ListView) this.mContentView.findViewById(R.id.setting_list);
    ...
    public void driving() {
        LogUtil.d("yftech", "BaseSettingFragment driving");
