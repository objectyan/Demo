...
import com.baidu.carlife.adpter.HomeMySkinAdapter;
...
public class HomeMySkinFragment extends ContentFragment implements C0924a, C1318b {
    ...
    /* renamed from: b */
    private HomeMySkinAdapter f4504b;
    /* renamed from: c */
    ...
    class C15121 implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            LogUtil.d("Framework", "position = " + position + ", id = " + id);
            view.performClick();
        }
    }
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        View contentView = inflater.inflate(R.layout.home_my_skin, null);
        setCommonTitleBar(contentView, getString(R.string.home_my_skin));
        GridView gridView = (GridView) contentView.findViewById(R.id.skin_gv);
        gridView.setOverScrollMode(2);
        this.f4507e = C1872t.m7136a();
        this.f4507e.m7151a((C1318b) this);
        m5528a();
        this.f4504b = new HomeMySkinAdapter(getContext(), this.f4506d);
        gridView.setAdapter(this.f4504b);
        gridView.setOnItemClickListener(new C15121(this));
        contentView.findViewById(R.id.tv_title).setOnClickListener(new C15132(this));
        return contentView;
    }

    /* renamed from: a */
    private void m5528a() {
        String[] skinNames = getResources().getStringArray(R.array.home_my_skin);
        this.f4506d = new ArrayList();
        C1934l defaultSkin = new C1934l();
        defaultSkin.f6089d = skinNames[0];
        defaultSkin.f6095j = 0;
        defaultSkin.f6096k = R.drawable.home_ic_my_skin_black;
        defaultSkin.f6093h = C1872t.f5805b;
        C1934l blueSkin = new C1934l();
        blueSkin.f6095j = 1;
        blueSkin.f6089d = skinNames[1];
        blueSkin.f6093h = CommonParams.jk;
        blueSkin.f6096k = R.drawable.home_ic_my_skin_blue;
        blueSkin.f6090e = 3;
    ...
    public void mo1481b(boolean isSuccess) {
        if (isSuccess) {
            ...
            C2201w.m8371a((int) R.string.home_my_skin_fail, 0);
        }
    }
    ...
    public void onInitFocusAreas() {
        if (this.f4508f == null) {
            this.f4508f = new C1443g(this.mContentView.findViewById(R.id.ll_title), 2);
            this.f4508f.m5300d(this.mContentView.findViewById(R.id.ib_left));
        }
        if (this.f4509g == null) {
            this.f4509g = new C1437b((GridView) this.mContentView.findViewById(R.id.skin_gv), 6);
        }
    ...
    public void driving() {
        LogUtil.d("yftech", "HomeMySkinFragment driving");
        back();
        C1342a.m4926a().m4931d();
    }

    public void stopDriving() {
        LogUtil.d("yftech", "HomeMySkinFragment stopDriving");
    }
}
