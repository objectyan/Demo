...
public class C1857p {
    ...
    /* renamed from: c */
    private static final String f5739c = (AudioUtil.f3010n + C1857p.class.getSimpleName());
    /* renamed from: d */
    ...
    public int m7048a(int sampleRate, int channelConfig, int sampleFormat, byte[] byteData) {
        ...
        if (initParameter.length > byteData.length) {
            LogUtil.d(f5739c, "initParameter.length>byteData.length!!");
        }
        LogUtil.d(f5739c, "byteData:" + Arrays.toString(byteData));
