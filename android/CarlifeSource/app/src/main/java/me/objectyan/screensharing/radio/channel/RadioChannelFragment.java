...
public class RadioChannelFragment extends ContentFragment {
    ...
    /* renamed from: n */
    private MsgBaseHandler f6864n = new C21462(this);
    ...
    class C21462 extends MsgBaseHandler {
        /* renamed from: a */
            ...
            if (event != null && event.getAction() == 0) {
                switch (keyCode) {
                    ...
                    case 300:
                        ...
                        if (CarlifeViewContainer.m4699a().isDialogShown() && !C1440d.m5251a().m5270i()) {
                            return true;
                        }
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        ...
        MsgHandlerCenter.m4460a(this.f6864n);
        new ab().mo1769c();
        new C2112c().mo1769c();
        m8105b();
        return this.f6853c;
    ...
    public void onDetach() {
        ...
        MsgHandlerCenter.m4464b(this.f6864n);
        this.f6864n = null;
        super.onDetach();
    }
    ...
    private void m8105b() {
        m8110c();
        this.f6855e = (ImageButton) this.f6853c.findViewById(R.id.fragment_radio_channel_back);
    ...
    /* renamed from: c */
    private void m8110c() {
        this.f6854d = (RecyclingViewPager) this.f6853c.findViewById(R.id.fragment_radio_channel_viewpager);
        ...
        this.f6853c.findViewById(R.id.fragment_radio_channel_viewpager_container).setOnTouchListener(new C21516(this));
    ...
    public void onInitFocusAreas() {
        if (this.f6861k == null) {
            ...
            this.f6861k.m5300d(this.f6853c.findViewById(R.id.fragment_radio_channel_back));
        }
        if (this.f6862l == null) {
            View focusView = this.f6853c.findViewById(R.id.fragment_radio_channel_focus_view);
            ...
            new C2139a(getContext()).m8066a(this, new C1491a(this) {
                ...
                public void mo1562a() {
                    if (this.f6850b.m8108b(channel)) {
                        C2201w.m8370a((int) R.string.module_music_not_yet_played);
                        return;
                    }
    ...
    private boolean m8108b(C2105a channel) {
        return C2142b.f6818b.equals(channel.m7893a()) && TextUtils.isEmpty(C2186p.m8304a().m8309a(CommonParams.ic, ""));
    }
    ...
    private void m8119e() {
        ...
        for (View view : childrenViews.keySet()) {
            ImageView flagImageView = (ImageView) view.findViewById(R.id.radio_channel_item_flag_play);
            if (((Integer) childrenViews.get(view)).intValue() == this.f6854d.getCurrentItem()) {
                ...
                if (C1818h.m6730b().m6834v()) {
                    flagImageView.setImageResource(R.drawable.anim_radio_channel_playing);
                    ((AnimationDrawable) flagImageView.getDrawable()).start();
                } else {
                    flagImageView.setImageResource(R.drawable.radio_ic_play_dynamic07);
                }
            } else {
    ...
    /* renamed from: a */
    public void m8124a() {
        if (CarlifeScreenUtil.m4334m() && this.f6856f != null) {
            ...
            LogUtil.d("Framework", "before adapte: ContainerWidth: " + nContainerWidth + " # ViewpageWidth: " + nViewpageWidth + " # Height: " + nContainerHeight);
            this.f6854d.setOffscreenPageLimit(9);
            ...
            LogUtil.d("Framework", "after adapte: ContainerWidth: " + nContainerWidth + " # ViewpageWidth: " + this.f6854d.getWidth() + " # Height: " + this.f6856f.getHeight());
        }
    }
}
