...
public class C2269b extends C1953c {
    ...
    public C2269b(Context context) {
        super(context);
        View view = LayoutInflater.from(context).inflate(R.layout.carlife_update_progress_dialog, null);
        this.f7435e = (ProgressBar) view.findViewById(R.id.update_progress);
        this.f7436f = (TextView) view.findViewById(R.id.has_finished);
        this.f7437g = (TextView) view.findViewById(R.id.percent);
        m7437a(view);
    }
