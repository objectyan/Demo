...
public class HomeCardView extends RelativeLayout implements OnTouchListener {
    ...
    protected void m8423a(Context context) {
        this.f7138c = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.carlife_common_home_card, this, true);
        this.f7139d = findViewById(R.id.home_card_ll);
        this.f7140e = findViewById(R.id.home_card_up_ll);
        this.f7141f = findViewById(R.id.home_card_content_ll);
        this.f7144i = findViewById(R.id.home_card_middle_ll);
        this.f7142g = findViewById(R.id.card_press_view);
        this.f7143h = findViewById(R.id.card_focus_view);
        this.f7145j = findViewById(R.id.red_point);
        this.f7146k = (TextView) findViewById(R.id.tv_home_card_up_title);
        this.f7147l = (TextView) findViewById(R.id.tv_home_card_up_info);
        this.f7148m = (ImageView) findViewById(R.id.iv_home_card_middle_first);
        this.f7149n = (ImageView) findViewById(R.id.iv_home_card_middle_secend);
        this.f7150o = (ImageView) findViewById(R.id.iv_home_card_vehicle_logo);
        this.f7151p = (HomeCardMusicMelodyView) findViewById(R.id.music_melody);
    ...
    protected void m8424a(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.C0963p.HomeCardView);
