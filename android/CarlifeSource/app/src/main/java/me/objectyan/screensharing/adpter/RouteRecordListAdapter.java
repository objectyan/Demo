...
public class RouteRecordListAdapter extends BaseAdapter {
    /* renamed from: a */
    ...
    private class C1009a {
        ...
        /* renamed from: j */
        final /* synthetic */ RouteRecordListAdapter f2584j;

        private C1009a(RouteRecordListAdapter routeRecordListAdapter) {
            this.f2584j = routeRecordListAdapter;
        }
    }

    public RouteRecordListAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = this.f2586b.inflate(R.layout.item_route_record, parent, false);
            holder.f2575a = convertView;
            holder.f2576b = (TextView) convertView.findViewById(R.id.tv_start_addr);
            holder.f2577c = (TextView) convertView.findViewById(R.id.tv_des_addr);
            holder.f2578d = (TextView) convertView.findViewById(R.id.tv_distance);
            holder.f2579e = (TextView) convertView.findViewById(R.id.tv_duration);
            holder.f2580f = (TextView) convertView.findViewById(R.id.tv_speed);
            holder.f2581g = (TextView) convertView.findViewById(R.id.tv_date);
            holder.f2582h = (TextView) convertView.findViewById(R.id.tv_time);
            holder.f2583i = (RelativeLayout) convertView.findViewById(R.id.rl_delete_btn);
        ...
        if (model.f6071a) {
            ...
            if (model.f6080j) {
                ...
                holder.f2583i.setOnClickListener(new OnClickListener(this) {
                    /* renamed from: c */
                    final /* synthetic */ RouteRecordListAdapter f2574c;
