...
public abstract class C1720a extends C1133a<C1717a> {
    ...
    class C17181 implements OnClickListener {
        ...
        public void onClick(View v) {
            C1141f.m3839a().m3841a(this.f5243a.m6290f(), Boolean.valueOf(((SwitchButton) this.f5243a.mo1429b().m3703a((int) R.id.sw_voice_wakeup)).isChecked()), C1092a.m3696c());
        }
    }
    ...
    public void m6288a(C1717a data) {
        ...
        mo1429b().m3703a((int) R.id.sw_voice_wakeup).setClickable(false);
        m6287a(((Boolean) data.m6276b().m3762b()).booleanValue());
        mo1429b().m3705a((int) R.id.tv_item_name, (String) data.m6282e().m3762b());
        mo1429b().m3703a((int) R.id.iv_direction_icon).setVisibility(8);
        data.m6276b().m3760a(new C17192(this));
    }

    /* renamed from: a */
    private void m6287a(boolean isChecked) {
        ((SwitchButton) mo1429b().m3703a((int) R.id.sw_voice_wakeup)).setChecked(isChecked);
    }
}
