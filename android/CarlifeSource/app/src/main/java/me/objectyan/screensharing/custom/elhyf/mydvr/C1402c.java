...
public class C1402c {
    ...
    public void m5182a(String picPath, C1401a shareWXScene) {
        ...
        C2201w.m8373a(this.f4120d.getString(R.string.weixin_share_file_no_existed), 1);
    }
    ...
    private boolean m5178b() {
        ...
        C2201w.m8373a(this.f4120d.getString(R.string.weixin_share_no_weixin_app), 1);
        return false;
    }
    ...
    private boolean m5179c() {
        ...
        C2201w.m8373a(this.f4120d.getString(R.string.weixin_share_no_support), 1);
        return false;
    }
}
