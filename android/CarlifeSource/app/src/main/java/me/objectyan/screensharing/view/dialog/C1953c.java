...
public class C1953c extends BaseDialog {
    ...
    /* renamed from: v */
    private OnBtnClickListener f6225v;
    /* renamed from: w */
    private OnBtnClickListener f6226w;
    /* renamed from: x */
    private OnCountDownListener f6227x;
    /* renamed from: y */
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(R.layout.common_dialog_center, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f6217l = (RelativeLayout) findViewById(R.id.dialog_content);
        this.f6218m = (TextView) findViewById(R.id.dialog_title);
        this.f6220q = (TextView) findViewById(R.id.content_msg);
        this.f6221r = (TextView) findViewById(R.id.first_btn);
        this.f6222s = (TextView) findViewById(R.id.second_btn);
        this.f6223t = findViewById(R.id.temp1);
        this.f6224u = (ImageButton) findViewById(R.id.dialog_title_bnt_right);
    ...
    public C1953c m7458q() {
        this.f6221r.setTextColor(this.c.getResources().getColor(R.color.cl_other_c_btn_dialog));
        return this;
    }

    /* renamed from: r */
    public C1953c m7459r() {
        this.f6222s.setTextColor(this.c.getResources().getColor(R.color.cl_other_c_btn_dialog));
        return this;
    }
    ...
    /* renamed from: a */
    public C1953c m7438a(OnBtnClickListener listener) {
        this.f6225v = listener;
        return this;
    }

    /* renamed from: b */
    public C1953c m7443b(OnBtnClickListener listener) {
        this.f6226w = listener;
        return this;
    }

    /* renamed from: a */
    public C1953c m7439a(OnCountDownListener listener) {
    ...
    /* renamed from: f */
    public void mo1530f() {
        C1443g mFocusDialogDown = new C1443g(findViewById(R.id.bottom_bar), 11);
