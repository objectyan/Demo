...
public class LightVoiceMicView extends ImageView implements LifeCycleListener {
    ...
    public LightVoiceMicView(Context context, AttributeSet attrs) {
        ...
        m7205h();
        m7206i();
        CarlifeLifeCycleManager.m3276a().m3279a((LifeCycleListener) this);
    }

    /* renamed from: h */
    private void m7205h() {
        this.f5825c = new C1885a(this, Looper.getMainLooper());
        MsgHandlerCenter.m4460a(this.f5825c);
    }

    /* renamed from: i */
    private void m7206i() {
        this.f5829g = (AnimationDrawable) getResources().getDrawable(R.drawable.baidu_mic_asr);
        ...
        this.f5830h = (AnimationDrawable) getResources().getDrawable(R.drawable.baidu_mic_asrtonlu);
        ...
        this.f5831i = (AnimationDrawable) getResources().getDrawable(R.drawable.baidu_mic_nlu);
    ...
    private void m7209l() {
        ...
        setImageResource(R.drawable.com_ic_voice_selector);
        setEnabled(true);
    }
    ...
    /* renamed from: g */
    public void m7219g() {
        MsgHandlerCenter.m4452a(4101);
        MsgHandlerCenter.m4452a(4100);
        MsgHandlerCenter.m4452a(4159);
        MsgHandlerCenter.m4464b(this.f5825c);
        this.f5825c.removeCallbacksAndMessages(null);
        this.f5825c = null;
        CarlifeLifeCycleManager.m3276a().m3281b(this);
        this.f5832j = 0;
    }
