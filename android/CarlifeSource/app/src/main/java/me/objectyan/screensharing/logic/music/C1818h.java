...
public class C1818h {
    ...
    class C18042 implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            LogUtil.d(C1818h.f5590a, "---onServiceConnected----");
            this.f5570a.f5620T = (C2164a) service;
            this.f5570a.f5620T.m8188a(new C18031(this));
        }

        public void onServiceDisconnected(ComponentName name) {
            LogUtil.d(C1818h.f5590a, "---onServiceDisconnected----");
        }
    }
            ...
            if (this.f5571a.f5604B != null) {
                ...
                if (downloadSize >= totalSize && totalSize != 0) {
                    ...
                    if ((id != null && id.equals(this.f5571a.f5604B.f5909a)) || (path != null && path.equals(this.f5571a.f5604B.f5921m))) {
                        ...
                        MsgHandlerCenter.m4452a((int) CommonParams.dG);
                        MsgHandlerCenter.m4462b(CommonParams.dG, 101);
                    }
                }
            }
        }
    ...
    private class C1817a extends MsgBaseHandler {
        /* renamed from: a */
            ...
            switch (msg.what) {
                ...
                case 217:
                    ...
                    if (this.f5587a.m6829q()) {
                        ...
                        LogUtil.d(C1818h.f5590a, "----MSG_MUSIC_DOWNLOAD_COMPLETE--NEXTSONG-");
                        C1819i.m6843a(-1);
                        return;
                    } else {
                        this.f5587a.af();
                        ...
                        if (list != null && !list.isEmpty() && !TextUtils.isEmpty(this.f5587a.f5603A.f5915g)) {
                            new Thread(new Runnable(this) {
                                ...
                                public void run() {
                                    ...
                                    MsgHandlerCenter.m4458a((int) CommonParams.dB, this.f5581c.f5587a.f5627n, this.f5581c.f5587a.f5603A.f5916h);
                                    this.f5581c.f5587a.f5622V.m6688a(this.f5581c.f5587a.f5603A, CarlifeUtil.m4358a().m4393a(this.f5581c.f5587a.f5603A.f5916h), list.size(), this.f5581c.f5587a.f5626m);
                                }
                            }).start();
                            return;
                        }
                ...
                case 307:
                    if (this.f5587a.m6829q()) {
                        if (this.f5587a.f5604B != null) {
                            MsgHandlerCenter.m4455a(307, this.f5587a.f5604B.f5918j, 101, 1000);
                        ...
                        MsgHandlerCenter.m4455a(msg.what, this.f5587a.f5603A.f5918j, this.f5587a.f5627n, 1000);
                ...
                case 407:
                    if (this.f5587a.m6829q()) {
                        ...
                        if (list != null && !list.isEmpty() && this.f5587a.f5604B != null && !TextUtils.isEmpty(this.f5587a.f5604B.f5910b)) {
                            this.f5587a.f5622V.m6688a(this.f5587a.f5604B, CarlifeUtil.m4358a().m4393a(this.f5587a.f5604B.f5916h), list.size(), 2);
                            return;
                        }
                        return;
                    }
                    ...
                    if (list != null && !list.isEmpty()) {
                        this.f5587a.f5622V.m6688a(this.f5587a.f5603A, CarlifeUtil.m4358a().m4393a(this.f5587a.f5603A.f5916h), list.size(), this.f5587a.f5626m);
                        return;
                    }
                    return;
                case 416:
    ...
    public void m6782a() {
        ...
        MsgHandlerCenter.m4460a(this.f5616P);
        ...
        f5597h = this.f5619S.getResources().getString(R.string.music_mode_single);
        f5598i = this.f5619S.getResources().getString(R.string.music_mode_random);
        f5599j = this.f5619S.getResources().getString(R.string.music_mode_circle);
    ...
    private void m6708K() {
        ...
        if (this.f5627n == 1 || this.f5627n == 0) {
            MsgHandlerCenter.m4452a((int) CommonParams.dG);
            MsgHandlerCenter.m4462b(CommonParams.dG, this.f5627n);
        }
        this.f5616P.sendEmptyMessage(229);
        m6722Y();
        MsgHandlerCenter.m4454a(225, this.f5627n, 100);
        MsgHandlerCenter.m4462b(CommonParams.dZ, CommonParams.ir);
    ...
    private void m6709L() {
        ...
        m6722Y();
        MsgHandlerCenter.m4454a(225, 101, 100);
        C1772k.m6480a().m6485a(3, 1);
        m6767A();
        if (this.f5637y) {
            m6811f(this.f5635w);
    ...
    private void m6731b(int type, MusicSongModel song) {
        this.f5616P.removeMessages(CommonParams.dr);
        this.f5616P.sendMessageDelayed(Message.obtain(this.f5616P, CommonParams.dr, type, -1, song), 0);
    }
    ...
    private synchronized void m6742h(MusicSongModel song) {
        ...
        if (CarlifeUtil.m4382t()) {
            for (MusicSongModel tmp : m6776J()) {
                LogUtil.d(f5590a, "----addBufferMusic--song:" + tmp.f5910b);
            }
        }
    }
        ...
        for (MusicSongModel song : m6776J()) {
            if ((song.f5909a == null || !song.f5909a.equals(songId)) && (song.f5921m == null || !song.f5921m.equals(removeSong.f5921m))) {
                ...
                if (m6776J().indexOf(tmp) < 0) {
                    File f = new File(CommonParams.jm + "/" + tmp.f5909a + ".mp3");
                    if (f.exists()) {
                        f.delete();
                    }
                }
                LogUtil.d(f5590a, "----removeBufferMusic--song:" + tmp.f5910b);
                return;
            }
        }
    }
    ...
    public void m6790a(boolean isNext, boolean isManual) {
        if (!m6829q()) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                if (songIndex < 0) {
                    C2201w.m8373a(this.f5619S.getString(R.string.module_music_first_hint), 1);
                } else if (songIndex >= len) {
                    C2201w.m8373a(this.f5619S.getString(R.string.module_music_last_hint), 1);
                } else {
                    m6721X();
                    m6796c(songIndex);
    ...
    public void m6803d(boolean isManualPlayed) {
        if (this.f5603A != null && this.f5620T != null && !m6829q()) {
            ...
            if (!this.f5635w && !this.f5603A.f5919k) {
                ...
                MsgHandlerCenter.m4462b(225, this.f5627n);
                this.f5616P.sendEmptyMessage(407);
                C1772k.m6480a().m6485a(3, 1);
    ...
    public void m6807e(boolean isManualPlayed) {
        if (this.f5604B != null && this.f5620T != null && m6829q()) {
            ...
            if (!this.f5635w && !this.f5604B.f5919k && this.f5623W.m6188c().mo1696p() == this.f5604B) {
                ...
                MsgHandlerCenter.m4462b(225, 101);
                this.f5616P.sendEmptyMessage(407);
                C1772k.m6480a().m6485a(3, 1);
            }
        }
    ...
    public void m6785a(final int type, MusicSongModel song) {
        ...
        if (this.f5620T != null && song != null && C1818h.m6745i(type)) {
            ...
            if (type == 0) {
                ...
                MsgHandlerCenter.m4452a((int) CommonParams.dG);
                MsgHandlerCenter.m4462b(CommonParams.dG, type);
    ...
    private void m6729a(MusicSongModel currentPlayingSong, int songType) {
        ...
        MsgHandlerCenter.m4452a((int) CommonParams.dG);
        MsgHandlerCenter.m4462b(CommonParams.dG, songType);
    }
    ...
    public void m6819j(int type) {
        this.f5634v = 0;
        this.f5637y = false;
        MsgHandlerCenter.m4462b(CommonParams.dH, type);
        m6767A();
    }
    ...
    /* renamed from: E */
    public MusicSDKListAdapter m6771E() {
    ...
    public boolean m6775I() {
        this.f5631s = false;
        int networkStatus = CarlifeUtil.m4381s();
        if (networkStatus == 1) {
            if (!this.f5606D) {
                return true;
            }
    ...
    private void aa() {
        if (!m6829q()) {
            ...
            m6789a(true);
            C2201w.m8373a(this.f5619S.getString(R.string.module_music_not_found_hint), 1);
    ...
    private void m6749k(MusicSongModel song) {
        m6832t();
        LogUtil.d(f5590a, "----startDownloadSong---0----");
        if (C2181l.m8283a(CommonParams.jm) <= 10000000) {
            m6833u();
            if (C2181l.m8283a(CommonParams.jm) <= 10000000) {
                C2201w.m8373a(this.f5619S.getString(R.string.module_music_insufficient_storage_hint), 1);
                return;
            }
        }
        if (m6829q()) {
            ...
            LogUtil.d(f5590a, "----startDownloadSong---MUSIC_TYPE_THIRDPARTY----");
            C1995c.m7602a().m7617a(m6755o(this.f5627n), song);
        } else if (this.f5627n == 2 || this.f5627n == 0) {
            LogUtil.d(f5590a, "----startDownloadSong---NETEASE or WECHAT----");
    ...
    private void ag() {
        ...
        if (!TextUtils.isEmpty(this.f5604B.f5909a) || !TextUtils.isEmpty(this.f5604B.f5921m)) {
            LogUtil.d(f5590a, "---------bufferSize11:" + this.f5604B.f5922n);
    ...
    private void ai() {
        ...
        if (!TextUtils.isEmpty(this.f5603A.f5909a) || !TextUtils.isEmpty(this.f5603A.f5921m)) {
            LogUtil.d(f5590a, "---------bufferSize11:" + this.f5603A.f5922n);
            ...
            LogUtil.d(f5590a, "-----time:" + time);
            if (time <= 2.0f) {
                LogUtil.d(f5590a, "---------bufferTime:" + this.f5634v);
                int i2 = this.f5634v;
                this.f5634v = i2 + 1;
                if (i2 < this.f5638z) {
                    this.f5616P.removeMessages(221);
    ...
    private void al() {
        ...
        try {
            ...
            if (downloadSize < totalSize && downloadSize <= curPlaySize && this.f5632t) {
                ...
                this.f5632t = false;
                m6768B();
                LogUtil.d(f5590a, "-service--is not Enough----");
            } else if ((downloadSize >= totalSize || downloadSize > curPlaySize) && !this.f5632t) {
                m6803d(false);
                this.f5632t = true;
                m6767A();
                LogUtil.d(f5590a, "-service-- Enough startplay----");
            }
            if (this.f5603A.f5920l) {
                LogUtil.d(f5590a, "---MSG_MUSIC_PLAY_UI_UPDATE------bufferTime:" + this.f5634v);
                int i = this.f5634v + 1;
                this.f5634v = i;
                if (i > 8) {
                    m6811f(true);
        ...
        if (this.f5628p) {
            ...
            switch (this.f5627n) {
                ...
                case 1:
                    ...
                    if (!listName.isEmpty()) {
                        if (!listName.equals(this.f5619S.getString(R.string.module_musicqq_localmusic))) {
                            if (!listName.equals("最近播放")) {
                                if (!listName.equals(this.f5619S.getString(R.string.module_musicqq_myfavourite))) {
                                    if (!listName.equals(this.f5619S.getString(R.string.module_musicqq_poprank))) {
                                        if (listName.equals(this.f5619S.getString(R.string.module_musicqq_hotrank))) {
