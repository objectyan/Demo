...
public class MainActivity extends FragmentActivity implements OnClickListener, BMEventBus$OnEvent {
    ...
    class C09451 extends BaseMapViewListener {
        /* renamed from: b */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button zoomout = (Button) findViewById(R.id.btn_zoomout);
        ((Button) findViewById(R.id.btn_zoomin)).setOnClickListener(this);
        zoomout.setOnClickListener(this);
        button1.setOnClickListener(this);
        button2.setOnClickListener(this);
        button3.setOnClickListener(this);
        FragmentManagerCallbackProxy.m4758a(new NaviFragmentManager(this));
        FrameLayout container = (FrameLayout) findViewById(R.id.map_container);
