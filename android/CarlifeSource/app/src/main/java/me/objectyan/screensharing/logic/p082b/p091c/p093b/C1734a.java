    ...
    class C17323 extends C1726c {
        ...
        class C17311 extends C1105d<Void, Void> {
            ...
            public void m6310a(Void input) {
                this.f5253a.f5254a.f5260e.openWebView(0, NaviFragmentManager.TYPE_COMMON_QUESTION, this.f5253a.f5254a.f5260e.getStringUtil(R.string.home_more_common_question), "http://carlife.baidu.com/static/carlifeweb/problems/android.html");
            }
        }
