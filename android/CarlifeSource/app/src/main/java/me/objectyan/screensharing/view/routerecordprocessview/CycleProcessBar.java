...
public class CycleProcessBar extends View {
    ...
    /* renamed from: b */
    private final int f7789b = ContextCompat.getColor(getContext(), R.color.cl_line_a2_progress);
    /* renamed from: c */
    private final int f7790c = ContextCompat.getColor(getContext(), R.color.cl_other_c);
    /* renamed from: d */
