...
public class MusicAlbumListAdapter extends BaseAdapter {
    ...
    private static class C0988a {
        ...
        public void m3207b(String url) {
            int imagesize = CarlifeScreenUtil.m4331a().m4343c(100) - (CarlifeUtil.m4358a().m4397n() / MusicAlbumListAdapter.f2525a);
            LayoutParams params = this.f2523a.getLayoutParams();
            params.height = imagesize;
            params.width = imagesize;
            this.f2523a.setLayoutParams(params);
            this.f2523a.setDefaultDrawable(C2188r.m8331b(R.drawable.music_ic_albumcover));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(this.f2526b).inflate(R.layout.music_albumlist_item, null);
            C0988a cache = new C0988a();
            cache.f2524b = (TextView) convertView.findViewById(R.id.tv_music_theme);
            cache.f2523a = (MultiImageView) convertView.findViewById(R.id.iv_music_theme);
        ...
        try {
            ...
            if (model.f6055c.equals(C1818h.m6730b().m6818j())) {
                cacheTag.m3204a(C2188r.m8328a((int) R.color.cl_other_c_highlight));
                return convertView;
            }
            cacheTag.m3204a(C2188r.m8328a((int) R.color.cl_text_a5_content));
            return convertView;
        } catch (IndexOutOfBoundsException e) {
            return null;
        }
