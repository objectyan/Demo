...
public class HomeDiscoverFragment extends ContentFragment implements OnClickListener {
    ...
    /* renamed from: m */
    private MsgBaseHandler f4410m = new C14841(this);

    /* renamed from: com.baidu.carlife.fragment.HomeDiscoverFragment$1 */
    class C14841 extends MsgBaseHandler {
        /* renamed from: a */
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1002:
                    LogUtil.d("Framework", "handleMessage=MSG_CONNECT_STATUS_DISCONNECTED   HomeDiscoverFragment.");
                    this.f4397a.m5421a();
                    return;
                case 1007:
                    LogUtil.d("Framework", "handleMessage=MSG_CONNECT_STATUS_FEATURE_CONFIG_SUCCESS   HomeDiscoverFragment.");
                    this.f4397a.m5421a();
                    return;
                default:
                    return;
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        View contentView = inflater.inflate(R.layout.frag_home_discover, null);
        setCommonTitleBar(contentView, getStringUtil(R.string.home_car_service));
        this.f4404g = (DiscoverCardView) contentView.findViewById(R.id.card_1);
        this.f4405h = (DiscoverCardView) contentView.findViewById(R.id.card_2);
        this.f4406i = (DiscoverCardView) contentView.findViewById(R.id.card_3);
        this.f4407j = (DiscoverCardView) contentView.findViewById(R.id.card_4);
    ...
    public void onResume() {
        super.onResume();
        LogUtil.d("Framework", "HomeDiscoverFragment --onResume ");
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        LogUtil.d("Framework", "--onHiddenChanged- hidden=" + hidden);
        m5421a();
    }
    ...
    public void onInitFocusAreas() {
        if (this.f4408k == null) {
            this.f4408k = new C1443g(this.mContentView.findViewById(R.id.ll_title), 2);
            this.f4408k.m5300d(this.mContentView.findViewById(R.id.ib_left));
        }
        if (this.f4409l == null) {
            this.f4409l = new C1443g(this.mContentView.findViewById(R.id.discover_ll), 4);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MsgHandlerCenter.m4460a(this.f4410m);
    }

    public void onDestroy() {
        super.onDestroy();
        MsgHandlerCenter.m4464b(this.f4410m);
    }

    /* renamed from: a */
    private void m5421a() {
        if (this.f4404g == null || this.f4405h == null || this.f4406i == null || this.f4407j == null) {
            LogUtil.d("yftech", "HomeDiscoverFragment --updateAdapter Card is null");
            return;
        }
        this.f4403f = m5423b();
        if (this.f4403f) {
            this.f4404g.m8406a((int) R.drawable.home_ic_parking);
            this.f4406i.m8406a((int) R.drawable.home_ic_fuel);
            this.f4405h.m8406a((int) R.drawable.home_ic_food);
            this.f4407j.m8406a((int) R.drawable.home_ic_rescue);
            this.f4404g.m8407a(getStringUtil(R.string.home_discovery_zcw));
            this.f4406i.m8407a(getStringUtil(R.string.home_discovery_qcd));
            this.f4405h.m8407a(getStringUtil(R.string.home_discovery_zms));
            this.f4407j.m8407a(getStringUtil(R.string.home_discovery_hjy));
            this.f4404g.m8408b(getStringUtil(R.string.home_discovery_parking_description));
            this.f4406i.m8408b(getStringUtil(R.string.home_discovery_charge_description));
            this.f4405h.m8408b(getStringUtil(R.string.home_discovery_food_description));
            this.f4407j.m8408b(getStringUtil(R.string.home_discovery_rescue_description));
            ...
            this.f4407j.m8406a((int) R.drawable.home_ic_rescue);
            this.f4404g.m8407a(getStringUtil(R.string.home_discovery_zcw));
            this.f4406i.m8407a(getStringUtil(R.string.home_discovery_qjy));
            this.f4405h.m8407a(getStringUtil(R.string.home_discovery_zms));
            this.f4407j.m8407a(getStringUtil(R.string.home_discovery_hjy));
            this.f4404g.m8408b(getStringUtil(R.string.home_discovery_parking_description));
            this.f4406i.m8408b(getStringUtil(R.string.home_discovery_fuel_description));
            this.f4405h.m8408b(getStringUtil(R.string.home_discovery_food_description));
            this.f4407j.m8408b(getStringUtil(R.string.home_discovery_rescue_description));
            this.f4404g.setTagInt(1);
        ...
        this.f4404g.setBackgroundResource(R.color.discover_card_background);
        this.f4405h.setBackgroundResource(R.color.discover_card_background);
        this.f4406i.setBackgroundResource(R.color.discover_card_background);
        this.f4407j.setBackgroundResource(R.color.discover_card_background);
        ...
        LogUtil.d("yftech", "HomeDiscoverFragment --updateAdapter ");
    }
    ...
    public void driving() {
        LogUtil.d("yftech", "HomeDiscoverFragment driving");
        m5421a();
        dismissDialog();
    }

    public void stopDriving() {
        LogUtil.d("yftech", "HomeDiscoverFragment stopDriving");
        m5421a();
    }

    public boolean onVoiceCommand(String strCommand, String strIntent) {
        LogUtil.d("Framework", "HomeDiscoverFragment VOICE Command: [" + strCommand + "] [" + strIntent + "]");
    ...
    private boolean m5424c() {
        return "20272111".equals(C2186p.m8304a().m8309a(CommonParams.jA, ""));
    }
}
