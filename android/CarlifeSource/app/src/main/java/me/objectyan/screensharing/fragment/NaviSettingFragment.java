...
public class NaviSettingFragment extends ContentFragment {
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        this.f4641a = (ViewGroup) inflater.inflate(R.layout.navi_setting, null);
        setCommonTitleBar(this.f4641a, getString(R.string.navi_setting));
        m5689a();
        return this.f4641a;
    }
    ...
    /* renamed from: a */
    private void m5689a() {
        this.f4642b = (StatusButton) this.f4641a.findViewById(R.id.bt_speak_mode);
        this.f4643c = (StatusButton) this.f4641a.findViewById(R.id.bt_routplan_mode);
        this.f4651k = (TextView) this.f4641a.findViewById(R.id.tv_search_mode);
        this.f4644d = (StatusButton) this.f4641a.findViewById(R.id.bt_search_mode);
        this.f4645e = (StatusButton) this.f4641a.findViewById(R.id.bt_day_night_mode);
        LinearLayout bobao = (LinearLayout) this.f4641a.findViewById(R.id.ll_bobao_setting);
        this.f4647g = (CheckBox) bobao.findViewById(R.id.cb_over_speed);
        this.f4650j = (CheckBox) bobao.findViewById(R.id.cb_straight);
        LinearLayout condition = (LinearLayout) this.f4641a.findViewById(R.id.ll_road_condition);
        this.f4649i = (CheckBox) condition.findViewById(R.id.cb_road_condition);
        this.f4646f = (CheckBox) condition.findViewById(R.id.cb_elec_eye);
        this.f4648h = (CheckBox) ((LinearLayout) this.f4641a.findViewById(R.id.ll_safe_setting)).findViewById(R.id.cb_safe_drive);
    ...
    /* renamed from: c */
    private void m5695c() {
        this.f4645e.m8492a((int) R.string.day_mode, (int) R.string.nighg_mode, (int) R.string.auto_mode);
        this.f4645e.m8494a(this.f4656p);
        this.f4642b.m8492a((int) R.string.speak_fresher, (int) R.string.speak_professor, (int) R.string.speak_silent);
        this.f4642b.m8494a(this.f4656p);
        this.f4643c.m8491a((int) R.string.pref_offline, (int) R.string.pref_online);
        this.f4643c.m8494a(this.f4656p);
        this.f4644d.m8491a((int) R.string.pref_offline, (int) R.string.pref_online);
    ...
    public void onInitFocusAreas() {
        if (this.fragmentType == getCurrentFragmentType()) {
            if (this.f4657q == null) {
                this.f4657q = new C1443g(this.mContentView.findViewById(R.id.common_top_title), 2);
                this.f4657q.m5300d(this.mContentView.findViewById(R.id.ib_left));
            }
