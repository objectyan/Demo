...
public class GFtestBroadcast extends BroadcastReceiver {
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals("com.baidu.carlife.driving.start") && CarlifeCoreSDK.m5979a().m5993N() && (C1342a.m4926a().m4929b() || C1343b.m4932a().m4935b())) {
            C1342a.m4926a().m4928a(true);
            FragmentManagerCallbackProxy.m4757a().getNaviFragmentManager().driving();
        }
        if (!intent.getAction().equals("com.baidu.carlife.driving.stop") || !CarlifeCoreSDK.m5979a().m5993N()) {
            return;
        }
