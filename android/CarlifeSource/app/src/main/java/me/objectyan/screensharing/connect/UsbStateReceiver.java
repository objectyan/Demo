...
public class UsbStateReceiver extends BroadcastReceiver {
    ...
    /* renamed from: j */
    private OnDialogListener f2965j = null;

    /* renamed from: com.baidu.carlife.connect.UsbStateReceiver$2 */
    class C11532 implements OnBtnClickListener {
        /* renamed from: a */
    ...
    public void onReceive(Context context, Intent intent) {
        this.f2965j = CarlifeViewContainer.m4699a().m4701b();
        ...
        if (intent.getExtras().getBoolean("connected")) {
            LogUtil.d(f2956a, "usb connect is changed: connected");
        ...
        LogUtil.d(f2956a, "usb connect is changed: disconnected");
    ...
    private void m3863e() {
        ...
        try {
            LogUtil.d(f2956a, "startTimer for usb debug switch");
    ...
    /* renamed from: f */
    private void m3865f() {
        LogUtil.d(f2956a, "stopTimer for usb debug switch");
        if (this.f2962f != null) {
            this.f2962f.cancel();
            this.f2962f = null;
        }
    ...
    private void m3866g() {
        if (this.f2964i == null) {
            this.f2964i = new C1953c(this.f2960d).m7442b((int) R.string.connectguide_dialog_title).m7435a((int) R.string.connectguide_dialog_hint).m7447c((int) R.string.connectguide_dialog_ok).m7438a(new C11532(this));
            this.f2964i.getContentView().setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.com_ic_usb_debug, 0, 0);
