...
public class C2131t extends C2110a {
    ...
    private void m8032b(String json) {
        try {
            ...
            if (jsonObject.getInt(C2125n.f6745M) == 0) {
                LogUtil.m4440c("response_time", "channel_id=10; response_time=" + (System.currentTimeMillis() - this.b) + "ms");
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    if (format >= 1 && format <= 3) {
                        ...
                        songModel.m7363g(m8030a((int) R.drawable.radio_ch_cover_voice));
    ...
    private List<MusicSongModel> m8033c(String newsParam) {
        ...
        try {
            ...
            LogUtil.d("Voice parseNewsParam error:", e.getMessage());
        }
