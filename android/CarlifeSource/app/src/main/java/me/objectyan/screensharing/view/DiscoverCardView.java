...
public class DiscoverCardView extends ConstraintLayout {
    ...
    private void m8405a(Context context) {
        this.f7102a = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.item_discover_card, this, true);
        this.f7105d = (ImageView) this.f7102a.findViewById(R.id.icon);
        this.f7103b = (TextView) this.f7102a.findViewById(R.id.title);
        this.f7107f = this.f7102a.findViewById(R.id.red_point);
        this.f7104c = (TextView) this.f7102a.findViewById(R.id.description);
        this.f7106e = this.f7102a.findViewById(R.id.card_focus_view);
