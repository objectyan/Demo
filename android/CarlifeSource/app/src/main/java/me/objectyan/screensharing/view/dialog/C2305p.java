...
public class C2305p extends BaseDialog implements OnClickListener {
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(R.layout.new_feature_introduction, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7560f = (ImageView) findViewById(R.id.iv_display_icon);
        this.f7561g = (ImageView) findViewById(R.id.iv_display_hint);
        this.f7562h = (Button) findViewById(R.id.btn_close);
    ...
    public void mo1530f() {
        if (this.f7559e == null) {
            this.f7559e = new C1443g(findViewById(R.id.dialog_layout_newfeature), 12);
            this.f7559e.m5300d(findViewById(R.id.btn_close));
        }
    ...
    public void mo1526d() {
        ...
        if ("VOICE".equals(this.f7563i)) {
            CarLifeSettings.m4069a().m4086g(false);
