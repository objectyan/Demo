...
public class C1643d extends C1626e {
    ...
    protected int responseSuccessCallBack(String data) throws JSONException {
        ...
        PreferenceHelper.getInstance(this.f5057b).putString(CommonParams.jE, clientid);
        PreferenceHelper.getInstance(this.f5057b).putString(CommonParams.jF, appid);
        PreferenceHelper.getInstance(this.f5057b).putString(CommonParams.jG, devid);
        return 0;
    }
}
