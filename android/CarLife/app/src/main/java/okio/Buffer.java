  ...
  implements Cloneable, BufferedSink, BufferedSource
{
  ...
  public long indexOf(byte paramByte, long paramLong)
  {
    ...
    if (this.size - paramLong < paramLong) {
      for (l2 = this.size;; l2 -= ((Segment)localObject2).limit - ((Segment)localObject2).pos)
      {
        l1 = l2;
    ...
    {
      l2 = l1 + (((Segment)localObject2).limit - ((Segment)localObject2).pos);
      localObject1 = localObject2;
      l3 = paramLong;
      if (l2 >= paramLong) {
        break;
    ...
    for (;;)
    {
      ...
      int i = (int)(((Segment)localObject1).pos + l3 - l1);
      int j = ((Segment)localObject1).limit;
      while (i < j)
      {
  ...
  public int select(Options paramOptions)
  {
    ...
    paramOptions = paramOptions.byteStrings;
    int i = 0;
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes3-dex2jar.jar!/okio/Buffer.class
