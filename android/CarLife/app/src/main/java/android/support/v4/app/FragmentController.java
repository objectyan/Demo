  ...
  implements OnFragmentListener
{
  ...
  {
    this.mHost.bindDialog(paramDialog);
  }
  ...
  {
    return this.mHost.isVehicleConnected();
  }
  ...
  {
    this.mHost.setWindow(paramWindow);
  }
  
  public void setVehicleConnected(boolean paramBoolean)
  {
    this.mHost.setVehicleConnected(paramBoolean);
  }
}


/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/android/support/v4/app/FragmentController.class
