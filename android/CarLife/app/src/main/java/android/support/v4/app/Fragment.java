  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  {
    FragmentActivity localFragmentActivity1 = null;
    if (this.mHost != null) {
      localFragmentActivity1 = (FragmentActivity)this.mHost.getActivity();
    }
    FragmentActivity localFragmentActivity2 = localFragmentActivity1;
    if (localFragmentActivity1 == null) {
      localFragmentActivity2 = FragmentActivityHolder.getInstance().getFragmentActivity();
    }
    return localFragmentActivity2;
  }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/android/support/v4/app/Fragment.class
