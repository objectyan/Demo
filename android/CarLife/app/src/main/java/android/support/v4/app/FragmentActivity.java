...
public class FragmentActivity
  ...
  implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompatApi23.RequestPermissionsRequestCodeValidator, OnFragmentListener
{
  ...
  boolean mCreated;
  final FragmentController mFragments = FragmentController.createController(new ActivityHostCallbacks(this));
  ...
  protected void onCreate(@Nullable Bundle paramBundle)
  {
    ...
    Log.e("FragmentActivity", "onCreate " + this + ", mFragments=" + this.mFragments);
    FragmentActivityHolder.getInstance().setFragmentActivity(this);
    this.mFragments.attachHost(null);
  ...
  {
    super.onDestroy();
    if (!this.mFragments.isVehicleConnected())
    {
      doReallyStop(false);
      this.mFragments.dispatchDestroy();
      this.mFragments.doLoaderDestroy();
    }
    FragmentManagerHolder.getInstance().destroy();
    FragmentActivityHolder.getInstance().setFragmentActivity(null);
  }
  ...
  public void setFragmentWindow(Window paramWindow)
  {
    if (FragmentManagerImpl.DEBUG) {
      Log.v("FragmentManager", "FragmentActivity. setFragmentWindow:" + paramWindow);
    }
  ...
  {
    if (FragmentManagerImpl.DEBUG) {
      Log.v("FragmentManager", "FragmentActivity. setVehicleConnected:" + paramBoolean);
    }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/android/support/v4/app/FragmentActivity.class
