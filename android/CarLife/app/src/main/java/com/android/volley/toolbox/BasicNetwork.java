...
public class BasicNetwork implements Network {
    ...
    L_0x0042:
        r3 = new com.android.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x0162, ConnectTimeoutException -> 0x00c6, MalformedURLException -> 0x00d8, IOException -> 0x00f9 }
    ...
    L_0x0054:
        ...
        r7 = new com.android.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x0162, ConnectTimeoutException -> 0x00c6, MalformedURLException -> 0x00d8, IOException -> 0x00f9 }
    ...
    L_0x00b0:
        ...
        goto L_0x0085;
    L_0x00b4:
        r13 = new com.android.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x015f, MalformedURLException -> 0x015c, IOException -> 0x015a }
        r17 = 0;
        r4 = android.os.SystemClock.elapsedRealtime();	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x015f, MalformedURLException -> 0x015c, IOException -> 0x015a }
        r18 = r4 - r24;
        r15 = r11;
    ...
    L_0x0100:
        ...
        r7 = r27.getUrl();
        r4[r5] = r7;
        com.android.volley.VolleyLog.m1687e(r3, r4);
    ...
    protected void logError(String what, String url, long start) {
        ...
        VolleyLog.m1689v("HTTP ERROR(%s) %d ms to fetch %s", what, Long.valueOf(now - start), url);
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                ...
                VolleyLog.m1689v("Error occured when calling consumingContent", new Object[0]);
            }
