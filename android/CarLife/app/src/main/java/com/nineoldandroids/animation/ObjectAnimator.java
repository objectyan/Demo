...
public final class ObjectAnimator extends ValueAnimator {
    ...
    static {
        ...
        PROXY_PROPERTIES.put(MapObjKey.OBJ_SS_ARROW_ROTATION, PreHoneycombCompat.ROTATION);
        ...
        PROXY_PROPERTIES.put("x", PreHoneycombCompat.f24646X);
        PROXY_PROPERTIES.put("y", PreHoneycombCompat.f24647Y);
    }
