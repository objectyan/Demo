...
public class ValueAnimator extends Animator {
    ...
    private static final ThreadLocal<ArrayList<ValueAnimator>> sAnimations = new C60601();
    private static final Interpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sDelayedAnims = new C60623();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sEndingAnims = new C60634();
    private static final TypeEvaluator sFloatEvaluator = new FloatEvaluator();
    private static long sFrameDelay = 10;
    private static final TypeEvaluator sIntEvaluator = new IntEvaluator();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sPendingAnimations = new C60612();
    private static final ThreadLocal<ArrayList<ValueAnimator>> sReadyAnims = new C60645();
    ...
    static class C60601 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C60601() {
        }
    ...
    static class C60612 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C60612() {
        }
    ...
    static class C60623 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C60623() {
        }
    ...
    static class C60634 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C60634() {
        }
    ...
    static class C60645 extends ThreadLocal<ArrayList<ValueAnimator>> {
        C60645() {
        }
