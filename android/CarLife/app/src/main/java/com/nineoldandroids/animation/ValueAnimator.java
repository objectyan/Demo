  ...
  extends Animator
{
  ...
  boolean animationFrame(long paramLong)
  {
    ...
    boolean bool1;
    float f1;
    for (float f2 = (float)(paramLong - this.mStartTime) / (float)this.mDuration;; f2 = 1.0F)
    {
      bool1 = bool2;
      f1 = f2;
      if (f2 < 1.0F) {
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes3-dex2jar.jar!/com/nineoldandroids/animation/ValueAnimator.class
