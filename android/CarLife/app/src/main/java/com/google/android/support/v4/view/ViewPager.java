...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C56651();
    ...
    private static final Interpolator sInterpolator = new C56662();
    ...
    private final Runnable mEndScrollRunnable = new C56673();
    ...
    /* renamed from: com.google.android.support.v4.view.ViewPager$1 */
    class C56651 implements Comparator<ItemInfo> {
        C56651() {
        }
    ...
    /* renamed from: com.google.android.support.v4.view.ViewPager$2 */
    class C56662 implements Interpolator {
        C56662() {
        }
    ...
    /* renamed from: com.google.android.support.v4.view.ViewPager$3 */
    class C56673 implements Runnable {
        C56673() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C56681());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: com.google.android.support.v4.view.ViewPager$SavedState$1 */
        class C56681 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C56681() {
            }
    ...
    public void setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        ...
        if (VERSION.SDK_INT >= 11) {
            ...
            boolean needsPopulate = hasTransformer ^ i2;
