...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C56991();
    ...
    static class C56991 implements Comparator<Comparable> {
        C56991() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C57001 extends LinkedTreeMapIterator<Entry<K, V>> {
            C57001() {
                super();
            }
    ...
    class KeySet extends AbstractSet<K> {
        ...
        class C57011 extends LinkedTreeMapIterator<K> {
            C57011() {
                super();
            }
