...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new C57182();
    public static final TypeAdapterFactory BIT_SET_FACTORY = newFactory(BitSet.class, BIT_SET);
    public static final TypeAdapter<Boolean> BOOLEAN = new C57193();
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new C57204();
    public static final TypeAdapterFactory BOOLEAN_FACTORY = newFactory(Boolean.TYPE, Boolean.class, BOOLEAN);
    public static final TypeAdapter<Number> BYTE = new C57215();
    ...
    public static final TypeAdapter<Class> CLASS = new C57161();
    ...
    public static final TypeAdapter<Number> FLOAT = new C57259();
    ...
    public static final TypeAdapter<Number> INTEGER = new C57237();
    ...
    public static final TypeAdapter<Locale> LOCALE = new TypeAdapter<Locale>() {
        public Locale read(JsonReader in) throws IOException {
            ...
            StringTokenizer tokenizer = new StringTokenizer(in.nextString(), JNISearchConst.LAYER_ID_DIVIDER);
    ...
    public static final TypeAdapter<Number> LONG = new C57248();
    ...
    public static final TypeAdapter<Number> SHORT = new C57226();
    ...
    static class C57161 extends TypeAdapter<Class> {
        C57161() {
        }
    ...
    static class C57182 extends TypeAdapter<BitSet> {
        C57182() {
        }
    ...
    static class C57193 extends TypeAdapter<Boolean> {
        C57193() {
        }
    ...
    static class C57204 extends TypeAdapter<Boolean> {
        C57204() {
        }
    ...
    static class C57215 extends TypeAdapter<Number> {
        C57215() {
        }
    ...
    static class C57226 extends TypeAdapter<Number> {
        C57226() {
        }
    ...
    static class C57237 extends TypeAdapter<Number> {
        C57237() {
        }
    ...
    static class C57248 extends TypeAdapter<Number> {
        C57248() {
        }
    ...
    static class C57259 extends TypeAdapter<Number> {
        C57259() {
        }
