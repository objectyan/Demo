...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(4, 116), new ECB(4, MessageType.BNMessageTypeCarFreeStatus));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, 121), new ECB(5, C1253f.df));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, MessageType.BNMessageTypeCarFreeStatus), new ECB(4, MessageType.BNMessageTypeTunnelUpdate));
        ...
        iArr = new int[]{6, 34, 62, 90, MessageType.BNMessageTypeTunnelUpdate};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(8, C1253f.df), new ECB(4, 123));
        ...
        iArr = new int[]{6, 26, 50, 74, 98, C1253f.df};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, MessageType.BNMessageTypeCarFreeStatus), new ECB(10, MessageType.BNMessageTypeTunnelUpdate));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(7, 116), new ECB(7, MessageType.BNMessageTypeCarFreeStatus));
        ...
        iArr = new int[]{6, 34, 62, 90, MessageType.BNMessageTypeTunnelUpdate, 146};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 54, 78, 102, 126, CommonHandlerThread.MSG_START_RECORD_TRAJECTORY};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, 121), new ECB(7, C1253f.df));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, 121), new ECB(14, C1253f.df));
        ...
        iArr = new int[]{6, 28, 54, 80, 106, NaviFragmentManager.TYPE_CAR_DRV_SETTING, RouteLineResConst.LINE_ARR_DARK_RED_NORMAL};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, C1253f.df), new ECB(4, 123));
        ...
        iArr = new int[]{6, 32, 58, 84, 110, RouteLineResConst.LINE_DARK_RED_NORMAL, 162};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, C1253f.df), new ECB(18, 123));
        ...
        iArr = new int[]{6, 26, 54, 82, 110, 138, RouteLineResConst.LINE_ARR_FOOT_GREEN_NORMAL};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(20, MessageType.BNMessageTypeCarFreeStatus), new ECB(4, MessageType.BNMessageTypeTunnelUpdate));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, MessageType.BNMessageTypeTunnelUpdate), new ECB(6, 119));
