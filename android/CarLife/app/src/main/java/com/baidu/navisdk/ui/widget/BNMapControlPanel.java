...
public class BNMapControlPanel
  implements View.OnClickListener
{
  ...
  private BNMapObserver mBNMapObserver = new BNMapObserver()
  {
    public void update(BNSubject paramAnonymousBNSubject, int paramAnonymousInt1, int paramAnonymousInt2, Object paramAnonymousObject)
    {
      ...
      {
        return;
      } while ((BNMapControlPanel.this.mContext == null) || (!NetworkUtils.isNetworkAvailable(BNMapControlPanel.this.mContext)));
      BNMapControlPanel.this.mMapNetStatusIcon.setVisibility(8);
      BNMapControlPanel.this.mMapNetworkHandler.removeMessages(1);
      BNMapControlPanel.this.mMapNetworkHandler.sendEmptyMessageDelayed(1, 5000L);
    }
  };
  ...
  public BNMapControlPanel(Context paramContext, View paramView, boolean paramBoolean)
  {
    ...
    this.mLocationBtn = ((ImageButton)this.mRootView.findViewById(1711866148));
  ...
  private void updateItsBtn()
  {
    if (BNSettingManager.isRoadCondOnOrOff())
    {
      this.mITSImageView.setImageDrawable(BNStyleManager.getDrawable(1711407518));
      return;
    }
    this.mITSImageView.setImageDrawable(BNStyleManager.getDrawable(1711407517));
  }
  ...
  public void onUpdateStyle(boolean paramBoolean)
  {
    ...
    this.mLocationBtn.setBackgroundDrawable(BNStyleManager.getDrawable(1711407462));
    updateLocationBtn();
    this.mITSButtonView.setBackgroundDrawable(BNStyleManager.getDrawable(1711407462));
    updateItsBtn();
  ...
  public void setZoomBtnClickListener(BNZoomButtonView.OnZoomBtnClickListener paramOnZoomBtnClickListener)
  {
  ...
  public void updateLocationBtn()
  {
    ...
    case 0: 
      ...
      {
        this.mLocationBtn.setImageDrawable(JarUtils.getResources().getDrawable(1711407684));
        return;
      }
      this.mLocationBtn.setImageDrawable(BNStyleManager.getDrawable(1711407684));
      return;
    case 1: 
      if (this.noNightStyle)
      {
        this.mLocationBtn.setImageDrawable(JarUtils.getResources().getDrawable(1711407381));
        return;
      }
      this.mLocationBtn.setImageDrawable(BNStyleManager.getDrawable(1711407381));
      return;
    }
    if (this.noNightStyle)
    {
      this.mLocationBtn.setImageDrawable(JarUtils.getResources().getDrawable(1711407385));
      return;
    }
    this.mLocationBtn.setImageDrawable(BNStyleManager.getDrawable(1711407385));
  }
    ...
    extends Handler
  {
    ...
    private MapNetworkHandler(BNMapControlPanel paramBNMapControlPanel)
    {
      this.mPanel = paramBNMapControlPanel;
    }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/navisdk/ui/widget/BNMapControlPanel.class
