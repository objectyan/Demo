...
public class C1002n extends BaseAdapter {
    /* renamed from: a */
    ...
    private class C1001a {
        ...
        TextView f2549b;
        /* renamed from: c */
        final /* synthetic */ C1002n f2550c;

        private C1001a(C1002n c1002n) {
            this.f2550c = c1002n;
        }
    }
    ...
    public C1002n(Context context) {
        this.f2552b = LayoutInflater.from(context);
        this.f2551a = context.getString(C0965R.string.phone_name_unknown);
        this.f2555e = context.getResources().getColor(C0965R.color.cl_other_c_highlight);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        C1001a viewCache;
        if (convertView == null) {
            convertView = this.f2552b.inflate(C0965R.layout.phone_softinput_list_item, parent, false);
            viewCache = new C1001a();
            viewCache.f2548a = (TextView) convertView.findViewById(C0965R.id.tv_phonebook_name);
            viewCache.f2549b = (TextView) convertView.findViewById(C0965R.id.tv_phonebook_num);
