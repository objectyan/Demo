...
public class GetFavoriteAsFilePacker extends BasePacker {
    ...
    public DataStruct unpack(JSONObject obj) {
        ...
        GetFavoriteAsFileDataStruct ds = new GetFavoriteAsFileDataStruct();
        ds.mFavFile = extDataObj.optString(GetFavoriteAsFileDataStruct.KEY_FAVFILEPATH, "");
        ds.mFavNum = extDataObj.optInt(GetFavoriteAsFileDataStruct.KEY_FAVNUM);
