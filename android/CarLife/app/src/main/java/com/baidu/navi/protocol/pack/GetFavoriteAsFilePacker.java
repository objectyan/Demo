...
public class GetFavoriteAsFilePacker
  extends BasePacker
{
  ...
  public DataStruct unpack(JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject != null)
    {
      ...
      if (paramJSONObject != null)
      {
        localObject1 = new GetFavoriteAsFileDataStruct();
        ((GetFavoriteAsFileDataStruct)localObject1).mFavFile = paramJSONObject.optString(GetFavoriteAsFileDataStruct.KEY_FAVFILEPATH, "");
        ((GetFavoriteAsFileDataStruct)localObject1).mFavNum = paramJSONObject.optInt(GetFavoriteAsFileDataStruct.KEY_FAVNUM);
        ((GetFavoriteAsFileDataStruct)localObject1).commandResult.errCode = paramJSONObject.optInt(AddFavoriteByFileDataStruct.KEY_ERROR_CODE);
      }
    }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/navi/protocol/pack/GetFavoriteAsFilePacker.class
