...
public class C1765g implements C1199a {
    /* renamed from: C */
    ...
    /* renamed from: G */
    private C0936j f5364G = new C17622(this);
    /* renamed from: w */
    ...
    class C17622 extends C0936j {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case C1253f.aY /*98386*/:
                    this.f5331a.f5363F = this.f5331a.m6425a((C1212c) msg.obj);
                    this.f5331a.m6433i();
                    this.f5331a.m6435k();
                    if (C1663a.m5979a().m6000U()) {
                        C1260i.m4435b(C1765g.f5359y, "[configure] encrypt: on");
                        C1663a.m5979a().m6011a(this.f5331a);
                        return;
                    }
                    C1260i.m4435b(C1765g.f5359y, "[configure] encrypt: off");
                    C1261k.m4461b(1007);
    ...
    class C17644 extends Thread {
        ...
        public void run() {
            C1260i.m4435b("CarLifeVoice", "request mic permission");
    ...
    /* renamed from: a */
    private List<CarlifeFeatureConfig> m6425a(C1212c cmd) {
    ...
    private void m6433i() {
        if (this.f5363F != null && !this.f5363F.isEmpty()) {
            try {
                for (CarlifeFeatureConfig config : this.f5363F) {
                    C1260i.m4435b(f5359y, "------key:" + config.getKey() + "----value:" + config.getValue());
                    if (f5338c.equals(config.getKey())) {
                        C1043a.m3360a().m3378a(config.getKey(), config.getValue());
                        ...
                        C1260i.m4435b(f5359y, "KEY_MEDIA_SAMPLE_RATE = " + config.getValue());
                        ...
                        C1260i.m4435b(f5359y, "KEY_AUDIO_TRANSMISSION_MODE = " + config.getValue());
                        ...
                        C1260i.m4435b(f5359y, "engine type: " + config.getValue());
                        ...
                        C1260i.m4435b(f5359y, "####### KEY_INPUT_DISABLE:" + config.getValue());
                    } else {
                        C1260i.m4445e(f5359y, "the key is error:" + config.getKey());
                    }
                }
            } catch (Exception ex) {
                C1260i.m4445e(f5359y, "feature config get exception");
                ex.printStackTrace();
            }
        }
    }
    ...
    private void m6434j() {
        try {
            C1260i.m4435b(f5359y, "Wait for Feature Config Timer Start");
            this.f5360A = new Timer();
            this.f5361B = new C17611(this);
            this.f5360A.schedule(this.f5361B, (long) f5358x);
        } catch (Exception ex) {
            C1260i.m4435b(f5359y, "startTimer get exception");
            ex.printStackTrace();
        }
    }
    ...
    /* renamed from: k */
    private void m6435k() {
        C1260i.m4445e(f5359y, "Wait for Feature Config Stop");
        if (this.f5360A != null) {
            this.f5360A.cancel();
            this.f5360A = null;
        }
    ...
    public static void m6429a(int keycode) {
        C1212c carlifeMsg = new C1212c(true);
        carlifeMsg.m4201c(C1253f.bL);
        ...
        C1261k.m4457a(C1253f.bL, 0, 0, carlifeMsg, 500);
    }
    ...
    public void mo1641a(boolean flag) {
        if (flag) {
            C1663a.m5979a().m6026c((int) C1253f.bm);
            m6440b(true);
            C1261k.m4461b(1007);
            return;
        }
