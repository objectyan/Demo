...
public class C1058f {
    ...
    /* renamed from: x */
    private static C1058f f2768x = null;
    /* renamed from: A */
    ...
    /* renamed from: L */
    private final BroadcastReceiver f2780L = new BtManager$4(this);
    /* renamed from: v */
    ...
    class C10511 extends Handler {
        /* renamed from: a */
        final /* synthetic */ C1058f f2741a;

        C10511(C1058f this$0) {
            this.f2741a = this$0;
        }
            ...
            switch (inMsg.what) {
                ...
                case 20:
                    if (this.f2741a.f2775G > 0) {
                        ...
                        C1260i.m4435b(C1058f.f2747a, "IDLE STAGE: Polling BT Adapter state left times = " + this.f2741a.f2775G);
                        if (this.f2741a.m3514q()) {
                            C1260i.m4435b(C1058f.f2747a, "IDLE STAGE: Bluetooth Adapter enabled after polling");
                    ...
                    C1260i.m4435b(C1058f.f2747a, "IDLE STAGE: Polling adapter state timeout");
                    this.f2741a.m3473a(-1);
                    return;
                case 21:
                    if (this.f2741a.f2776H > 0) {
                        this.f2741a.f2776H = this.f2741a.f2776H - 1;
                        C1260i.m4435b(C1058f.f2747a, "READY STAGE: Polling HFP connection state left times = " + this.f2741a.f2776H);
                        state = this.f2741a.m3526d();
                        if (state == 1) {
                            C1260i.m4435b(C1058f.f2747a, "READY STAGE: Get ready for bluetooth connection");
                            ...
                            C1260i.m4435b(C1058f.f2747a, "READY STAGE: Had been connected with HU");
                            return;
                        } else {
                            return;
                        }
                    }
                    C1260i.m4435b(C1058f.f2747a, "READY STAGE: Polling HFP connection state timeout");
                ...
                case 23:
                    ...
                    if (bond == 12) {
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Bonded with HU, start hfp connect");
                        this.f2741a.m3485d(this.f2741a.f2769A);
                        return;
                    }
                    if (bond == 11) {
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Still in Bonding, cancel bond and restart");
                    ...
                    return;
                case 24:
                    C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Connected with HU timeout");
                    state = this.f2741a.m3524c();
                    if (state == 0) {
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Still in disconnected state");
                    } else if (state == 2) {
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Connected with HU yet");
                        return;
                    } else {
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Still in connecting state, do a disconnect and restart connect");
                        this.f2741a.m3518t();
                    }
                ...
                case 40:
                    ...
                    if (!this.f2741a.f2769A.equals(address)) {
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Address is not matched with last stage");
                        return;
                    } else if (this.f2741a.f2778J > 0) {
                        this.f2741a.f2778J = this.f2741a.f2778J - 1;
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Try to connect hfp with left attempts = " + this.f2741a.f2778J);
                        ...
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Failed as down counter is over");
                ...
                case 41:
                    ...
                    if (!this.f2741a.f2769A.equals(address)) {
                        ...
                        C1260i.m4435b(C1058f.f2747a, "PAIR STAGE: Try to bond with left attempts = " + this.f2741a.f2777I);
    ...
    class C10522 implements ServiceListener {
        /* renamed from: a */
        final /* synthetic */ C1058f f2742a;

        C10522(C1058f this$0) {
            this.f2742a = this$0;
        }

        public void onServiceDisconnected(int profile) {
            this.f2742a.f2772D = null;
            C1260i.m4435b(C1058f.f2747a, "INIT STAGE: Disconnect headset proxy!!!");
        }

        public void onServiceConnected(int profile, BluetoothProfile proxy) {
            if (profile == 1 && proxy != null) {
                this.f2742a.f2772D = (BluetoothHeadset) proxy;
                C1260i.m4435b(C1058f.f2747a, "INIT STAGE: Get headset proxy: " + this.f2742a.f2772D);
            }
        }
    }
    ...
    class C10533 implements ServiceListener {
        /* renamed from: a */
        final /* synthetic */ C1058f f2743a;

        C10533(C1058f this$0) {
            this.f2743a = this$0;
        }

        public void onServiceDisconnected(int profile) {
            this.f2743a.f2773E = null;
            C1260i.m4435b(C1058f.f2747a, "INIT STAGE: Disconnect A2DP proxy!!!");
        }

        public void onServiceConnected(int profile, BluetoothProfile proxy) {
            if (profile == 2 && proxy != null) {
                this.f2743a.f2773E = (BluetoothA2dp) proxy;
                C1260i.m4435b(C1058f.f2747a, "INIT STAGE: Get A2DP proxy: " + this.f2743a.f2773E);
            }
        }
    }
    ...
    class C10544 implements Runnable {
        /* renamed from: a */
        final /* synthetic */ C1058f f2744a;

        C10544(C1058f this$0) {
            this.f2744a = this$0;
        }

        public void run() {
            if (this.f2744a.m3514q()) {
                C1260i.m4435b(C1058f.f2747a, "Bluetooth is Enabled yet");
            } else if (this.f2744a.m3512p()) {
                C1260i.m4435b(C1058f.f2747a, "Enable Bluetooth In Success");
            } else {
                C1260i.m4435b(C1058f.f2747a, "Enable Bluetooth In Failure");
            }
        }
    }
    ...
    class C10555 implements Runnable {
        /* renamed from: a */
        final /* synthetic */ C1058f f2745a;

        C10555(C1058f this$0) {
            this.f2745a = this$0;
        }

        public void run() {
            if (this.f2745a.m3512p()) {
                C1260i.m4435b(C1058f.f2747a, "IDLE STAGE: Start to enable Bluetooth Adapter, and polling state...");
            ...
            C1260i.m4435b(C1058f.f2747a, "IDLE STAGE: Failed to enable Bluetooth Adapter");
        }
    }
    ...
    public class C1057b extends C0936j {
        /* renamed from: a */
        final /* synthetic */ C1058f f2746a;

        public C1057b(C1058f this$0) {
            this.f2746a = this$0;
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case C1253f.f3539F /*98309*/:
                    C1260i.m4435b(C1058f.f2747a, "my OOB info");
                    try {
                        ...
                        if (btInfo != null) {
                            ...
                            C1260i.m4435b(C1058f.f2747a, "MD <--- HU :address = " + btInfo.getAddress() + ",status = " + status);
    ...
    /* renamed from: a */
    public static C1058f m3470a() {
        if (f2768x == null) {
            synchronized (C1058f.class) {
                if (f2768x == null) {
                    f2768x = new C1058f();
                }
            }
    ...
    public void m3519a(Context context) {
        ...
        if (this.f2783y == null) {
            C1260i.m4435b(f2747a, "INIT STAGE: Failed to obtain Bluetooth Adapter for MD");
            return;
        }
        m3504l();
        m3506m();
    ...
    private void m3504l() {
        if (this.f2783y != null) {
            try {
                ...
                e.printStackTrace();
                C1260i.m4435b(f2747a, "INIT STAGE: getProfileProxy Exception");
            }
        }
    }
    ...
    private void m3506m() {
        if (this.f2783y != null) {
            try {
                ...
                e.printStackTrace();
                C1260i.m4435b(f2747a, "INIT STAGE: getA2dpProxy Exception");
            }
        }
    }
            ...
            if (devices != null) {
                for (BluetoothDevice device : devices) {
                    if (device != null) {
                        try {
                            if (this.f2773E != null) {
                                if (C1079i.m3618c(this.f2773E.getClass(), this.f2773E, device)) {
                                    C1260i.m4435b(f2747a, "BtUtils.disconnectA2dp = TRUE ");
                                } else {
                                    C1260i.m4435b(f2747a, "BtUtils.disconnectA2dp = FALSE");
                                }
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
    ...
    public int m3524c() {
        ...
        try {
            ...
            e.printStackTrace();
            C1260i.m4435b(f2747a, "Failed in getConnectionState");
        }
        return connState;
    }
    ...
    public int m3526d() {
        int state = m3524c();
        C1260i.m4435b(f2747a, "checkHfpConnection state = " + state);
        if (state == 0) {
            C1260i.m4435b(f2747a, "HFP is disconnected");
            return 1;
        } else if (state == 2) {
            ...
            C1260i.m4435b(f2747a, "HFP is connecting");
            return 2;
        } else if (state != 3) {
            return 2;
        } else {
            C1260i.m4435b(f2747a, "HFP is disconnecting");
            return 2;
        }
    }
    ...
    public void m3527e() {
        if (this.f2772D != null && this.f2783y != null) {
            ...
            C1260i.m4435b(f2747a, "UNINIT STAGE: Close headset proxy");
        }
    }
    ...
    public void m3528f() {
        ...
        filter.addAction(C1079i.f2830c);
        filter.addAction(C1079i.f2831d);
        filter.addAction("android.bluetooth.adapter.action.STATE_CHANGED");
        filter.addAction("android.bluetooth.headset.profile.action.CONNECTION_STATE_CHANGED");
        if (this.f2771C != null) {
            this.f2771C.registerReceiver(this.f2780L, filter);
        }
        C1260i.m4435b(f2747a, "INIT STAGE: register Bluetooth broadcast receiver");
        if (this.f2781v != null) {
            C1260i.m4435b(f2747a, "start register msg handler");
            C1261k.m4460a(this.f2781v);
        }
    }
    ...
    public void m3529g() {
        if (!(this.f2771C == null || this.f2780L == null)) {
            try {
                ...
                C1260i.m4435b(f2747a, "UNINIT STAGE: unregister Bluetooth broadcast receiver");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        if (this.f2781v != null) {
            C1261k.m4464b(this.f2781v);
        }
    }
    ...
    private void m3479b(String addr, String pincode) {
        if (m3514q()) {
            C1260i.m4435b(f2747a, "IDLE STAGE: Bluetooth Adapter is enabled yet!");
            this.f2776H = 10;
    ...
    private void m3473a(int errcode) {
        switch (errcode) {
            case -4:
                C1260i.m4435b(f2747a, "Auto-Pair Failed in checking hfp connection");
                break;
            case -3:
                C1260i.m4435b(f2747a, "Auto-Pair Failed in connecting");
                break;
            case -2:
                C1260i.m4435b(f2747a, "Auto-Pair Failed in pairing");
                break;
            case -1:
                C1260i.m4435b(f2747a, "Auto-Pair Failed in enabling adapter");
                break;
        }
        if (this.f2782w != null) {
            this.f2782w.removeMessages(24);
        ...
        C1043a.m3360a().m3391m();
    }

    /* renamed from: a */
    public void m3521a(String remoteAddr, String pincode) {
        C1260i.m4435b(f2747a, "HU ---> MD : HU OOB INFO IDLE, addr = " + remoteAddr + ",pincode = " + pincode);
        Message msg = new Message();
        msg.what = 0;
    ...
    public void m3520a(String remoteAddr) {
        C1260i.m4435b(f2747a, "HU ---> MD : HU OOB INFO READY, addr = " + remoteAddr);
        if (remoteAddr == null || !remoteAddr.equals(this.f2769A)) {
            C1260i.m4435b(f2747a, "PAIR STAGE: Received invalid address from HU");
        } else if (m3502k(remoteAddr)) {
            C1260i.m4435b(f2747a, "PAIR STAGE: has been paired, just do hfp connection");
            m3485d(remoteAddr);
        } else {
            C1260i.m4435b(f2747a, "PAIR STAGE: not paired, start pairing...");
            m3488e(remoteAddr);
        }
    }
    ...
    public void m3523b(String remoteAddr) {
        C1260i.m4435b(f2747a, "HU ---> MD : HU OOB INFO DONE, addr = " + remoteAddr);
        C1043a.m3360a().m3392n();
    }
    ...
    public boolean m3525c(String address) {
        List<BluetoothDevice> devices = m3532j();
        if (devices == null || devices.size() == 0) {
            C1260i.m4435b(f2747a, "isHfpConnectWith: Connected device list is NULL");
            return false;
            ...
            for (BluetoothDevice device : devices) {
                if (device != null) {
                    ...
                    if (TextUtils.isEmpty(address) || !address.equals(bdaddr)) {
                        C1260i.m4435b(f2747a, "isHfpConnectWith: Bluetooth has been connected with wrong device");
                    } else {
                        C1260i.m4435b(f2747a, "isHfpConnectWith: Bluetooth has been connected with correct device");
                        return true;
                    }
                }
            }
            ...
            C1260i.m4435b(f2747a, "isHfpConnectWith: Bluetooth address is invalid");
            return false;
        }
    }
        ...
        if (devices != null) {
            for (BluetoothDevice device : devices) {
                if (device != null) {
                    try {
                        if (this.f2772D != null) {
                            if (C1079i.m3615b(this.f2772D.getClass(), this.f2772D, device)) {
                                C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.disconnect = TRUE ");
                            } else {
                                C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.disconnect = FALSE");
                            }
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    private void m3491f(String address) {
        if (address != null && BluetoothAdapter.checkBluetoothAddress(address)) {
            ...
            if (this.f2772D != null && device != null) {
                try {
                    if (C1079i.m3611a(this.f2772D.getClass(), this.f2772D, device)) {
                        C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.connect = TRUE ");
                    } else {
                        C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.connect = FALSE");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.connect exception");
                }
            }
        }
    }
    ...
    private boolean m3494g(String address) {
        if (this.f2783y == null || TextUtils.isEmpty(address)) {
            C1260i.m4435b(f2747a, "pair: mBluetoothAdapter is NULL");
            return false;
        } else if (BluetoothAdapter.checkBluetoothAddress(address)) {
            BluetoothDevice device = this.f2783y.getRemoteDevice(address);
            if (device == null) {
                C1260i.m4435b(f2747a, "pair: Bluetooth Device is null");
                return false;
            }
            try {
                boolean bond = C1079i.m3608a(device.getClass(), device);
                if (bond) {
                    C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.createBond = TRUE ");
                    return bond;
                }
                C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.createBond = FALSE");
                return bond;
            } catch (Exception e) {
                e.printStackTrace();
                ...
                C1260i.m4435b(f2747a, "PAIR STAGE: Special case for Huawei Honor");
                return true;
            }
        } else {
            C1260i.m4435b(f2747a, "pair: address is invalid");
            return false;
        }
    }
    ...
    private void m3496h(String address) {
        if (this.f2783y != null) {
            ...
            if (device != null) {
                try {
                    if (C1079i.m3617c(device.getClass(), device)) {
                        C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.removeBond = TRUE ");
                    } else {
                        C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.removeBond = FALSE");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void m3498i(String address) {
        if (this.f2783y == null) {
            C1260i.m4435b(f2747a, "stopPair: mBluetoothAdapter is NULL");
        } else if (BluetoothAdapter.checkBluetoothAddress(address)) {
            BluetoothDevice device = this.f2783y.getRemoteDevice(address);
            if (device == null) {
                C1260i.m4435b(f2747a, "stopPair: Bluetooth Device is NULL");
            } else if (this.f2783y != null && device != null) {
                try {
                    if (C1079i.m3614b(device.getClass(), device)) {
                        C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.cancelBondProcess = TRUE ");
                    } else {
                        C1260i.m4435b(f2747a, "PAIR STAGE: BtUtils.cancelBondProcess = FALSE");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    C1260i.m4435b(f2747a, "stopPair: Exception in cancelBondProcess");
                }
            }
        } else {
            C1260i.m4435b(f2747a, "stopPair: address is invalid");
        }
    }
