...
public class C1341g extends Thread {
    /* renamed from: a */
    ...
    /* renamed from: d */
    private static C1338e f3919d = C1338e.m4826b();
    /* renamed from: e */
    ...
    /* renamed from: p */
    private long f3931p = ((long) (C1338e.f3864e / 2));
    /* renamed from: q */
    private long f3932q = ((long) C1338e.f3864e);
    ...
    /* renamed from: a */
    public void m4923a() {
        C1260i.m4435b(f3916a, "VideoOutputThread ifStopInputThread=" + (!C1190a.m4065a()));
        this.f3927l = false;
        f3919d.m4858a(null);
        if (!C1190a.m4065a()) {
            f3919d.m4835B();
    ...
    public void run() {
        this.f3932q = (long) C1338e.f3864e;
        if (C1190a.m4065a()) {
            f3923h = 0;
            C1260i.m4435b(f3916a, "VideoOutputThread  isFirstEncodeFrame=" + f3919d.m4887r() + ", isRunning=" + this.f3927l);
            if (f3919d.m4887r()) {
                while (m4917d() == 0) {
                    if (!this.f3927l) {
                        break;
            ...
            m4920g();
            C1260i.m4435b(f3916a, "VideoOutputThread  isRunning=" + this.f3927l);
            while (this.f3927l) {
                if (m4919f() < 0) {
                    m4923a();
                } else {
    ...
    private int m4917d() {
        int outDataLength = 0;
        if (f3920e == null) {
            C1260i.m4443d(f3916a, "还没完成初始化, 或已经被释放");
            return -1;
        }
        try {
            if (f3919d.m4843J()) {
            ...
            synchronized (f3922g) {
                ...
                if (outputBufferIndex >= 0) {
                    ...
                    if (f3919d.m4887r()) {
                        ...
                        if (C1341g.m4914a(outputBuffer)) {
                            outputBuffer.get(f3925j, f3924i.length, f3926k.size);
                            outputBuffer.clear();
                            f3920e.releaseOutputBuffer(outputBufferIndex, false);
                            f3919d.m4872f(false);
                            C1260i.m4435b(f3916a, "VideoOutputThread outputSpsPpsAndFirstFrame isFirstEncodeFrame");
                        } else {
                            outputBuffer.clear();
                            f3920e.releaseOutputBuffer(outputBufferIndex, false);
                            f3919d.m4872f(false);
                            m4920g();
                            C1260i.m4435b(f3916a, "isTEST true, return 20!");
                            return 20;
                        }
                    }
                }
            ...
            t.printStackTrace();
            C1260i.m4445e(f3916a, "outputSpsPpsAndFirstFrame" + t.toString());
        }
        C1260i.m4435b(f3916a, "VideoOutputThread  outputSpsPpsAndFirstFrame outDataLength=" + outDataLength);
    ...
    L_0x0007:
        r6 = "Recorder";
        r7 = "还没完成初始化, 或已经被释放";
        com.baidu.carlife.core.C1260i.m4443d(r6, r7);
    L_0x0010:
        return r4;
    L_0x0011:
    ...
    L_0x002d:
        ...
        if (r7 == 0) goto L_0x005e;
    L_0x0031:
        r7 = com.baidu.carlife.core.screen.video.C1341g.m4922i();	 Catch:{ Throwable -> 0x003e }
    ...
    L_0x008f:
        r7 = com.baidu.carlife.core.screen.video.C1341g.m4914a(r1);	 Catch:{ all -> 0x00cb }
        if (r7 == 0) goto L_0x009b;
    L_0x0095:
    ...
    L_0x0007:
        r7 = "Recorder";
        r8 = "还没完成初始化, 或已经被释放";
        com.baidu.carlife.core.C1260i.m4443d(r7, r8);
        r4 = r6;
    L_0x0011:
        return r4;
    L_0x0012:
    ...
    L_0x002e:
        ...
        if (r7 == 0) goto L_0x0050;
    L_0x0032:
        r7 = com.baidu.carlife.core.screen.video.C1341g.m4922i();	 Catch:{ Throwable -> 0x00ed }
    ...
    L_0x0083:
        r7 = com.baidu.carlife.core.screen.video.C1341g.m4914a(r1);	 Catch:{ all -> 0x00ea }
        if (r7 == 0) goto L_0x008f;
    L_0x0089:
    ...
    L_0x0099:
        ...
        com.baidu.carlife.core.C1261k.m4461b(r7);	 Catch:{ all -> 0x00ea }
    L_0x009e:
        r7 = com.baidu.carlife.core.screen.video.C1341g.m4914a(r1);	 Catch:{ all -> 0x00ea }
    ...
    L_0x00ed:
        ...
        r8 = r8.append(r9);
        r8 = r8.toString();
        com.baidu.carlife.core.C1260i.m4445e(r7, r8);
        r4 = r6;
        goto L_0x0011;
    L_0x0112:
    ...
    public static int m4912a(byte[] input) {
        int outDataLength = 0;
        if (input == null) {
            C1260i.m4440c(f3916a, "input buffer is null");
            return 0;
        }
        C1260i.m4445e(f3916a, "Into firstSendEncodeFrame(byte[] input) input=" + input.length);
        if (f3920e == null) {
            C1260i.m4443d(f3916a, "还没完成初始化, 或已经被释放");
            return 0;
        }
            ...
            try {
                synchronized (f3921f) {
                    ...
                    if (inputBufferIndex >= 0) {
                        ...
                        C1260i.m4445e(f3916a, "firstSendEncodeFrame_inputBufferIndex >= 0");
                    } else {
                        C1260i.m4445e(f3916a, "firstSendEncodeFrame_inputBufferIndex < 0");
                    }
                    ...
                    if (outputBufferIndex >= 0) {
                        ...
                        outputBuffer.clear();
                        f3920e.releaseOutputBuffer(outputBufferIndex, false);
                        C1260i.m4445e(f3916a, "firstSendEncodeFrame_outputBufferIndex >= 0");
                    } else {
                        C1260i.m4445e(f3916a, "firstSendEncodeFrame_outputBufferIndex < 0");
                    }
                }
            } catch (IllegalStateException e) {
                C1260i.m4445e(f3916a, "firstSendEncodeFrame_IllegalStateException");
                e.printStackTrace();
                if (!(f3920e == null || C1341g.m4922i())) {
                    f3919d.m4855a(1);
                }
            } catch (Throwable t) {
                t.printStackTrace();
            }
            C1341g.m4913a(enterTimeStamp, outputBuffers);
        }
        ...
        if (outDataLength == 0 || f3925j == null) {
            C1260i.m4440c(f3916a, "firstSendEncodeFrame 不是I帧啊");
            f3919d.m4845L();
            return 0;
        }
        C1260i.m4445e(f3916a, "firstSendEncodeFrame(byte[] input) data=" + f3925j + ", outDataLength=" + outDataLength);
        f3919d.m4853a(f3925j, outDataLength);
        C1260i.m4445e(f3916a, "End firstSendEncodeFrame(byte[] input)");
    ...
    L_0x000b:
        r8 = "Recorder";
        r10 = "还没完成初始化, 或已经被释放";
        com.baidu.carlife.core.C1260i.m4443d(r8, r10);	 Catch:{ all -> 0x0149 }
    ...
    L_0x0024:
        ...
        com.baidu.carlife.core.C1260i.m4445e(r10, r11);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        if (r4 < 0) goto L_0x00f3;
    L_0x0051:
        r3 = r5[r4];	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        r10 = com.baidu.carlife.core.screen.video.C1341g.m4914a(r3);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        if (r10 == 0) goto L_0x00d5;
    L_0x0059:
        r10 = "Recorder";
        r11 = "firstSendEncodeFrame() isIFrame yes";
        com.baidu.carlife.core.C1260i.m4440c(r10, r11);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
    ...
    L_0x00a0:
        ...
        r9 = r9.append(r2);
        r9 = r9.toString();
        com.baidu.carlife.core.C1260i.m4445e(r8, r9);
    ...
    L_0x010d:
        ...
        com.baidu.carlife.core.C1261k.m4461b(r10);	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
    L_0x0113:
        r10 = "Recorder";
        r11 = new java.lang.StringBuilder;	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
        r11.<init>();	 Catch:{ IllegalStateException -> 0x012f, Throwable -> 0x014c }
    ...
    L_0x0137:
        ...
        if (r10 == 0) goto L_0x0020;
    L_0x013b:
        r10 = com.baidu.carlife.core.screen.video.C1341g.m4922i();	 Catch:{ all -> 0x0149 }
        if (r10 != 0) goto L_0x0020;
    L_0x0141:
    ...
    L_0x0031:
        r8 = com.baidu.carlife.core.screen.video.C1341g.m4914a(r2);	 Catch:{ all -> 0x007b }
    ...
    L_0x005c:
        r7 = com.baidu.carlife.core.p069b.C1190a.m4065a();
        if (r7 == 0) goto L_0x0067;
    L_0x0062:
        r7 = 1038; // 0x40e float:1.455E-42 double:5.13E-321;
        com.baidu.carlife.core.C1261k.m4461b(r7);
    L_0x0067:
        r12.f3930o = r6;
        r6 = f3919d;
        r6 = r6.m4846M();
    ...
    L_0x007e:
        ...
        r7 = r7.append(r8);
        r7 = r7.toString();
        com.baidu.carlife.core.C1260i.m4445e(r6, r7);
        r6 = -1;
        goto L_0x006f;
    L_0x00a2:
    ...
    private static void m4913a(long enterTime, ByteBuffer[] outputBuffers) {
        if (System.currentTimeMillis() - enterTime > 2000 && !f3918c) {
            ...
            C1261k.m4459a((int) C1253f.fj, (Object) "缓冲区已清空");
        }
    }
