...
public class C0971a extends BaseAdapter {
    ...
    public C0971a(Context context) {
        ...
        this.f2455c = BaiduNaviApplication.getInstance().getApplicationContext().getString(C0965R.string.module_tele_unknow_name);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        C0970a cache;
        if (convertView == null) {
            convertView = this.f2453a.inflate(C0965R.layout.call_log_list_item, parent, false);
            cache = new C0970a();
            cache.f2448a = (TextView) convertView.findViewById(C0965R.id.tv_calllog_name);
            cache.f2449b = (TextView) convertView.findViewById(C0965R.id.tv_calllog_count);
            cache.f2450c = convertView.findViewById(C0965R.id.iv_calllog_type);
            cache.f2451d = (TextView) convertView.findViewById(C0965R.id.tv_calllog_time);
            cache.f2452e = convertView.findViewById(C0965R.id.cl_line);
        ...
        if (calllogType == 3) {
            cache.f2448a.setTextColor(C2188r.m8328a((int) C0965R.color.cl_other_a_highlight));
            cache.f2449b.setTextColor(C2188r.m8328a((int) C0965R.color.cl_other_a_highlight));
        } else {
            cache.f2448a.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_content));
            cache.f2449b.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_content));
        }
