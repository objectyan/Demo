  ...
  implements AbsListView.OnScrollListener
{
  ...
  private void initWithContext(Context paramContext)
  {
    disableEdgeEffect();
    disableEdgeGlow();
    this.mLayout = ((LinearLayout)View.inflate(paramContext, 2130968891, null));
    this.mContentLayout = ((LinearLayout)this.mLayout.findViewById(2131625512));
    ...
    ((LinearLayout)this.mLayout.findViewById(2131625511)).addView(this.mHeader);
    this.mFooterView = new XFooterView(paramContext);
    paramContext = new LinearLayout.LayoutParams(-1, -1);
    paramContext.gravity = 17;
    ((LinearLayout)this.mLayout.findViewById(2131625513)).addView(this.mFooterView, paramContext);
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/navi/view/xpulltorefresh/XScrollView.class
