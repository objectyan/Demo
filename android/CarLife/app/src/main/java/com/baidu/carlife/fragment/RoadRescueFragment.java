...
public class RoadRescueFragment extends ContentFragment implements OnClickListener {
    ...
    /* renamed from: n */
    private C0936j f4761n = new C1570a();
    /* renamed from: o */
    private View f4762o;
    /* renamed from: p */
    private View f4763p;
    ...
    class C15691 implements C0672b {
        /* renamed from: a */
    ...
    private class C1570a extends C0936j {
        /* renamed from: a */
        ...
        public void handleMessage(Message msg) {
            C1260i.m4440c(RoadRescueFragment.f4748a, "msg.what=" + msg.what);
            switch (msg.what) {
                case 3011:
                    try {
    ...
    public RoadRescueFragment() {
        C1261k.m4460a(this.f4761n);
    }

    protected View onCreateContentView(LayoutInflater inflater) {
        C1260i.m4440c(f4748a, "onCreateContentView");
        this.f4762o = inflater.inflate(C0965R.layout.frag_road_rescue, null);
        setCommonTitleBar(this.f4762o, getString(C0965R.string.rescue_service));
        this.f4760m = (ImageButton) this.f4762o.findViewById(C0965R.id.ib_right);
        this.f4756i = (LinearLayout) this.f4762o.findViewById(C0965R.id.linlayout_add_info);
        this.f4757j = (LinearLayout) this.f4762o.findViewById(C0965R.id.linlayout_dialing);
        this.f4758k = (LinearLayout) this.f4762o.findViewById(C0965R.id.linlayout_add_info_container);
        this.f4759l = (TextView) this.f4762o.findViewById(C0965R.id.tv_rescue_provide);
        this.f4763p = this.f4762o.findViewById(C0965R.id.stub_rescue_info);
        this.f4764q = (TextView) this.f4762o.findViewById(C0965R.id.tv_rescue_name);
        this.f4765r = (TextView) this.f4762o.findViewById(C0965R.id.tv_rescue_phone);
        this.f4766s = (TextView) this.f4762o.findViewById(C0965R.id.tv_rescue_car_num);
        this.f4767t = (TextView) this.f4762o.findViewById(C0965R.id.tv_rescue_car_color);
        this.f4768u = (TextView) this.f4762o.findViewById(C0965R.id.tv_rescue_contact_name);
        this.f4769v = (TextView) this.f4762o.findViewById(C0965R.id.tv_rescue_contact_phone);
        this.f4760m.setVisibility(0);
        this.f4760m.setImageResource(C0965R.drawable.com_ic_edit);
        String rescueProvider = getResources().getString(C0965R.string.rescue_provider);
        SpannableStringBuilder spBuilder = new SpannableStringBuilder(rescueProvider);
        spBuilder.setSpan(new ForegroundColorSpan(getResources().getColor(C0965R.color.cl_other_c_highlight)), rescueProvider.length() - 4, rescueProvider.length(), 33);
    ...
    public void onResume() {
        ...
        if (getNaviFragmentManager().isDriving()) {
            C1260i.m4435b("yftech", "RoadRescueFragment onResume driving");
            m5786c();
            return;
        }
        C1260i.m4435b("yftech", "RoadRescueFragment onResume stopDriving");
        m5784b();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case C0965R.id.linlayout_add_info:
                if (!showConnectForbidDialog()) {
                    showFragment(551, null);
                    return;
                }
                return;
            case C0965R.id.linlayout_dialing:
                StatisticManager.onEvent(StatisticConstants.DISCOVER_HJY_0002);
                C1953c commonDialog = new C1953c(getContext()).m7435a((int) C0965R.string.rescue_call_yuanmeng).m7447c((int) C0965R.string.alert_cancel).m7459r().m7450d((int) C0965R.string.alert_confirm);
                commonDialog.m7443b(new C15691(this));
                showDialog(commonDialog);
                return;
            case C0965R.id.tv_rescue_provide:
    ...
    private void m5782a(String name, String phone, String contactName, String contactPhone, String carNum, String carColor) {
        if (mActivity != null) {
            ...
            try {
                ...
                C1260i.m4440c(f4748a, fsdSoap);
                C1260i.m4440c(f4748a, soap);
                byte[] entity = soap.getBytes();
                HttpURLConnection conn = (HttpURLConnection) new URL(C1253f.gE).openConnection();
                ...
                C1260i.m4440c(f4748a, conn.getResponseCode() + "");
    ...
    public void driving() {
        C1260i.m4435b("yftech", "RoadRescueFragment driving");
        m5786c();
    }

    public void stopDriving() {
        C1260i.m4435b("yftech", "RoadRescueFragment stopDriving");
        m5784b();
    }
    ...
    public void onInitFocusAreas() {
        if (this.f4770w == null) {
            this.f4770w = new C1443g(this.mContentView.findViewById(C0965R.id.ll_title), 2);
            this.f4770w.m5300d(this.mContentView.findViewById(C0965R.id.ib_left));
        }
        if (this.f4771x == null) {
