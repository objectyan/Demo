...
public class BaiduGLSurfaceView extends SurfaceView implements Callback {
    ...
    private static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        public EGLSurface createWindowSurface(EGL10 egl, EGLDisplay display, EGLConfig config, Object nativeWindow) {
            ...
            try {
                ...
                C2911f.c(BaiduGLSurfaceView.TAG, "eglCreateWindowSurface", e);
            }
            return result;
        }
    ...
    private static class EglHelper {
        ...
        public boolean createSurface() {
            if (this.mEgl == null) {
                ...
                if (this.mEglSurface == null || this.mEglSurface == EGL10.EGL_NO_SURFACE) {
                    ...
                    C2911f.e("EglHelper", "createWindowSurface returned EGL_BAD_NATIVE_WINDOW.");
                    return false;
        ...
        public static void logEglErrorAsWarning(String tag, String function, int error) {
            C2911f.d(tag, formatEglError(function, error));
        }
    ...
    static class GLThread extends Thread {
        ...
        private void guardedRun() throws java.lang.InterruptedException {
            /*
            r22 = this;
            r19 = new com.baidu.platform.comapi.map.BaiduGLSurfaceView$EglHelper;
            r0 = r22;
            ...
            r7 = 0;
        L_0x002f:
            r20 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;	 Catch:{ all -> 0x01db }
        ...
        L_0x003c:
            ...
            r20 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;
            monitor-enter(r20);
        ...
        L_0x0089:
            ...
            r19 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;	 Catch:{ all -> 0x01d8 }
        ...
        L_0x00d7:
            ...
            r16 = (com.baidu.platform.comapi.map.BaiduGLSurfaceView) r16;	 Catch:{ all -> 0x01d8 }
        ...
        L_0x0239:
            ...
            r19 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;	 Catch:{ all -> 0x02f9 }
        ...
        L_0x0251:
            ...
            r8 = r0;
            r19 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;	 Catch:{ all -> 0x01db }
            r0 = r19;
        ...
        L_0x026c:
            ...
            r16 = (com.baidu.platform.comapi.map.BaiduGLSurfaceView) r16;	 Catch:{ all -> 0x01db }
        ...
        L_0x02d2:
            ...
            r0 = r19;
            r1 = r20;
            com.baidu.platform.comapi.map.BaiduGLSurfaceView.EglHelper.logEglErrorAsWarning(r0, r1, r14);	 Catch:{ all -> 0x01db }
            r20 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;	 Catch:{ all -> 0x01db }
            monitor-enter(r20);	 Catch:{ all -> 0x01db }
            r19 = 1;
            r0 = r19;
            ...
            r19 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;	 Catch:{ all -> 0x0340 }
        ...
        L_0x02fc:
            ...
            r19 = com.baidu.platform.comapi.map.BaiduGLSurfaceView.sGLThreadManager;	 Catch:{ all -> 0x031b }
        ...
        L_0x0343:
            ...
            throw r19;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.baidu.platform.comapi.map.BaiduGLSurfaceView.GLThread.guardedRun():void");
        }
