...
public class CruiseMapController
{
  ...
  private long getMapYOffset(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (!paramBoolean2) {
      if (paramBoolean1) {
        l = ScreenUtil.getInstance().getHeightPixels() - ScreenUtil.getInstance().dip2px(70);
      }
    }
    for (long l = -l / 4L + ScreenUtil.getInstance().dip2px(40);; l = ScreenUtil.getInstance().dip2px(40))
    {
      LogUtil.e("Cruise", "getMapYOffset: isPortrait " + paramBoolean1 + ", is2DNorth " + paramBoolean2 + ", Y offset " + l);
      return l;
      l = ScreenUtil.getInstance().getWidthPixels();
      break;
      if (paramBoolean1) {
        l = -ScreenUtil.getInstance().dip2px(70) / 2;
      }
    }
  }
  ...
  private void setMapInitScaleLevel()
  {
    ...
    int i = readMapScaleLevel();
    localMapStatus._Level = i;
    localMapStatus._Rotation = 0;
    LogUtil.e("Cruise", "init map level " + i);
  ...
  public void setMapStatus(LocData paramLocData, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (localMapStatus != null)
    {
      ...
      localMapStatus._Xoffset = getMapXOffset(false);
      localMapStatus._Yoffset = getMapYOffset(false, paramBoolean1);
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/navisdk/ui/cruise/control/CruiseMapController.class
