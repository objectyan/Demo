...
public class C1020q extends BaseAdapter {
    /* renamed from: a */
    ...
    class C10121 implements C1011b {
        /* renamed from: a */
        final /* synthetic */ C1020q f2587a;

        C10121(C1020q this$0) {
            this.f2587a = this$0;
        }
    ...
    class C10132 implements OnCheckedChangeListener {
        /* renamed from: a */
        final /* synthetic */ C1020q f2588a;

        C10132(C1020q this$0) {
            this.f2588a = this$0;
        }
    ...
    class C10143 implements OnCheckedChangeListener {
        /* renamed from: a */
        final /* synthetic */ C1020q f2589a;

        C10143(C1020q this$0) {
            this.f2589a = this$0;
        }
    ...
    class C10154 implements OnCheckedChangeListener {
        /* renamed from: a */
        final /* synthetic */ C1020q f2590a;

        C10154(C1020q this$0) {
            this.f2590a = this$0;
        }
    ...
    private class C1018a extends Thread {
        ...
        public C1018a(C1020q c1020q, CompoundButton buttonView, boolean isChecked) {
            this.f2595c = c1020q;
        ...
        L_0x0019:
            ...
            r0 = com.baidu.carlife.core.C1251e.m4358a();	 Catch:{ all -> 0x005c }
            r2 = 0;
    ...
    private class C1019c {
        ...
        View f2599d;
        /* renamed from: e */
        final /* synthetic */ C1020q f2600e;

        private C1019c(C1020q c1020q) {
            this.f2600e = c1020q;
        }
    }

    public C1020q(Context context, int arrayId) {
        this.f2602b = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(this.f2602b).inflate(C0965R.layout.setting_list_item, parent, false);
            C1019c viewCache = new C1019c();
            viewCache.f2596a = (TextView) convertView.findViewById(C0965R.id.tv_item_name);
            viewCache.f2597b = (SwitchButton) convertView.findViewById(C0965R.id.sw_voice_wakeup);
            viewCache.f2598c = (ImageView) convertView.findViewById(C0965R.id.iv_direction_icon);
            viewCache.f2599d = convertView.findViewById(C0965R.id.red_point);
        ...
        cache.f2596a.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_content));
        return convertView;
    }
