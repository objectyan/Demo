...
public class PrivacyPolicyFragment extends ContentFragment {
    ...
    public void onInitFocusAreas() {
        if (this.fragmentType == getCurrentFragmentType()) {
            if (this.f4740b == null) {
                this.f4740b = new C1443g(this.mContentView.findViewById(C0965R.id.title_bar), 2);
                this.f4740b.m5300d(this.mContentView.findViewById(C0965R.id.ib_left));
            }
            if (this.f4741c == null) {
    ...
    /* renamed from: a */
    private void m5775a() {
        this.f4742d = (WebView) this.mContentView.findViewById(C0965R.id.wv_service_terms);
