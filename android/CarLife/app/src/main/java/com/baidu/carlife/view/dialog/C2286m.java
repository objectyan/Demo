...
public class C2286m extends BaseDialog {
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(C0965R.layout.navi_dialog, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7475e = (TextView) findViewById(C0965R.id.title_bar);
        this.f7478h = (LinearLayout) findViewById(C0965R.id.top_content);
        this.f7476f = (FrameLayout) findViewById(C0965R.id.content);
        this.f7482l = (LinearLayout) findViewById(C0965R.id.layout_list);
        this.f7477g = (FrameLayout) findViewById(C0965R.id.content_list);
        this.f7483m = (TextView) findViewById(C0965R.id.title_bar_list);
        this.f7480j = (TextView) findViewById(C0965R.id.first_btn);
        this.f7481k = (TextView) findViewById(C0965R.id.second_btn);
        this.f7479i = findViewById(C0965R.id.bottom_bar);
    ...
    public C2286m mo1630i() {
        this.f7480j.setTextColor(StyleManager.getDayColor(C0965R.color.navi_dialog_high_light));
        return this;
    }

    /* renamed from: j */
    public C2286m mo1820j() {
        this.f7481k.setTextColor(StyleManager.getDayColor(C0965R.color.navi_dialog_high_light));
        return this;
    }
    ...
    public C2286m mo1808b(View content) {
        this.f7478h.setBackgroundResource(StyleManager.getDayColor(C0965R.drawable.transparent));
    ...
    public C2286m mo1817e(String text) {
        ...
        this.f7483m.setTextColor(StyleManager.getDayColor(C0965R.color.navi_dialog_high_light));
