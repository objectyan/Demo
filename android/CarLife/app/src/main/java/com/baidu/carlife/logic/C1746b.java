...
public class C1746b {
    ...
    private class C1711a extends C0936j {
        /* renamed from: a */
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 270:
                    switch (msg.arg1) {
                        case -3:
                            C1260i.m4435b("CarLifeMusic", "---AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK-----");
                            ...
                            return;
                        case -2:
                            C1260i.m4435b("CarLifeMusic", "---AUDIOFOCUS_LOSS_TRANSIENT-----");
                            this.f5231a.f5283g.mo1665b(false);
                            return;
                        case -1:
                            C1260i.m4435b("CarLifeMusic", "---AUDIOFOCUS_LOSS-----");
                            this.f5231a.f5283g.mo1665b(false);
                            return;
                        case 1:
                            C1260i.m4435b("CarLifeMusic", "---AUDIOFOCUS_GAIN-----retry:" + this.f5232b);
                ...
                case 1002:
                    ...
                    return;
                case 2002:
                    C1260i.m4435b("CarLifeMusic", "---MSG_TELE_STATE_CHANGE_OFFHOOK-----");
                    this.f5231a.f5283g.mo1665b(false);
                    AudioUtils.pauseTTS(this.f5231a.f5282d);
                    AudioUtils.pauseTTS(this.f5231a.f5282d);
                    return;
                case 2004:
                    C1260i.m4435b("CarLifeMusic", "---MSG_TELE_STATE_CHANGE_RINGING-----");
                    this.f5231a.f5283g.mo1665b(false);
                    AudioUtils.pauseTTS(this.f5231a.f5282d);
                    AudioUtils.pauseTTS(this.f5231a.f5282d);
                    return;
                case 2009:
                    C1260i.m4435b("CarLifeMusic", "---MSG_TELE_STATE_CHANGE_IDLE-----");
