...
public class FillUsernameResult
  extends SapiResult
{
  ...
  {
    this.msgMap.put(0, "用户名设置成功");
    this.msgMap.put(110000, "用户名设置成功");
    this.msgMap.put(160103, "用户登录状态失效，请重新登录");
    this.msgMap.put(160104, "该用户已有用户名");
    this.msgMap.put(160105, "该用户名已被注册,请更换其他用户名");
    this.msgMap.put(160110, "仅支持中英文、数字和下划线");
    this.msgMap.put(160111, "该用户名已被注册,请更换其他用户名");
    this.msgMap.put(65334, "用户名设置失败");
  }
}


/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/sapi2/result/FillUsernameResult.class
