...
public class C2298l extends BaseDialog implements OnClickListener {
    ...
    class C22921 implements C2226b {
        ...
        public void mo1819a(boolean hasPrePage, boolean hasNextPage, int visibleCount) {
            ...
            if (this.f7515a.f7537k.getCount() == 0 && TextUtils.isEmpty(this.f7515a.f7535i.getText())) {
                ...
                this.f7515a.findViewById(C0965R.id.keyboard_result_hide_divider).setVisibility(0);
                this.f7515a.f7533g.setVisibility(8);
                this.f7515a.f7534h.setVisibility(8);
                this.f7515a.findViewById(C0965R.id.keyboard_result_left_divider).setVisibility(8);
                this.f7515a.findViewById(C0965R.id.keyboard_result_right_divider).setVisibility(8);
            } else {
                this.f7515a.f7532f.setVisibility(8);
                this.f7515a.findViewById(C0965R.id.keyboard_result_hide_divider).setVisibility(8);
                if (hasPrePage || hasNextPage) {
                    float f2;
                    this.f7515a.f7533g.setVisibility(0);
                    this.f7515a.f7534h.setVisibility(0);
                    this.f7515a.findViewById(C0965R.id.keyboard_result_left_divider).setVisibility(0);
                    this.f7515a.findViewById(C0965R.id.keyboard_result_right_divider).setVisibility(0);
    ...
    protected View mo1528a() {
        View contentView = LayoutInflater.from(this.c).inflate(C0965R.layout.keyboard, null);
    ...
    protected void mo1529b() {
        this.f7535i = (EditText) findViewById(C0965R.id.keyboard_result_tv);
        this.f7536j = (KeyboardResultView) findViewById(C0965R.id.keyboard_result);
        ...
        this.f7538l = findViewById(C0965R.id.keyboard_letter);
        this.f7539m = findViewById(C0965R.id.keyboard_num);
        this.f7532f = findViewById(C0965R.id.keyboard_result_hide);
        this.f7532f.setOnClickListener(this);
        this.f7533g = findViewById(C0965R.id.keyboard_result_left);
        this.f7533g.setOnClickListener(this);
        this.f7534h = findViewById(C0965R.id.keyboard_result_right);
        this.f7534h.setOnClickListener(this);
        this.f7540n = (ImageView) findViewById(C0965R.id.keyboard_letter_shift);
        this.f7540n.setOnClickListener(this);
        this.f7541o = findViewById(C0965R.id.keyboard_letter_switch);
        this.f7541o.setOnClickListener(this);
        this.f7542p = (TextView) findViewById(C0965R.id.keyboard_letter_language);
        this.f7542p.setOnClickListener(this);
        this.f7543q = findViewById(C0965R.id.keyboard_letter_delete);
        this.f7543q.setOnClickListener(this);
        this.f7544r = (TextView) findViewById(C0965R.id.keyboard_letter_finish);
        this.f7544r.setOnClickListener(this);
        this.f7545s = (TextView) findViewById(C0965R.id.keyboard_letter_space);
        this.f7545s.setOnClickListener(this);
        this.f7546t = findViewById(C0965R.id.keyboard_num_switch);
        this.f7546t.setOnClickListener(this);
        this.f7547u = findViewById(C0965R.id.keyboard_num_delete);
        this.f7547u.setOnClickListener(this);
        this.f7548v = (TextView) findViewById(C0965R.id.keyboard_num_finish);
        this.f7548v.setOnClickListener(this);
        this.f7549w = findViewById(C0965R.id.keyboard_num_space);
        ...
        this.f7550x[0] = (TextView) findViewById(C0965R.id.keyboard_q);
        this.f7550x[1] = (TextView) findViewById(C0965R.id.keyboard_w);
        this.f7550x[2] = (TextView) findViewById(C0965R.id.keyboard_e);
        this.f7550x[3] = (TextView) findViewById(C0965R.id.keyboard_r);
        this.f7550x[4] = (TextView) findViewById(C0965R.id.keyboard_t);
        this.f7550x[5] = (TextView) findViewById(C0965R.id.keyboard_y);
        this.f7550x[6] = (TextView) findViewById(C0965R.id.keyboard_u);
        this.f7550x[7] = (TextView) findViewById(C0965R.id.keyboard_i);
        this.f7550x[8] = (TextView) findViewById(C0965R.id.keyboard_o);
        this.f7550x[9] = (TextView) findViewById(C0965R.id.keyboard_p);
        this.f7550x[10] = (TextView) findViewById(C0965R.id.keyboard_a);
        this.f7550x[11] = (TextView) findViewById(C0965R.id.keyboard_s);
        this.f7550x[12] = (TextView) findViewById(C0965R.id.keyboard_d);
        this.f7550x[13] = (TextView) findViewById(C0965R.id.keyboard_f);
        this.f7550x[14] = (TextView) findViewById(C0965R.id.keyboard_g);
        this.f7550x[15] = (TextView) findViewById(C0965R.id.keyboard_h);
        this.f7550x[16] = (TextView) findViewById(C0965R.id.keyboard_j);
        this.f7550x[17] = (TextView) findViewById(C0965R.id.keyboard_k);
        this.f7550x[18] = (TextView) findViewById(C0965R.id.keyboard_l);
        this.f7550x[19] = (TextView) findViewById(C0965R.id.keyboard_z);
        this.f7550x[20] = (TextView) findViewById(C0965R.id.keyboard_x);
        this.f7550x[21] = (TextView) findViewById(C0965R.id.keyboard_c);
        this.f7550x[22] = (TextView) findViewById(C0965R.id.keyboard_v);
        this.f7550x[23] = (TextView) findViewById(C0965R.id.keyboard_b);
        this.f7550x[24] = (TextView) findViewById(C0965R.id.keyboard_n);
        this.f7550x[25] = (TextView) findViewById(C0965R.id.keyboard_m);
        for (TextView temp : this.f7550x) {
            temp.setOnClickListener(this);
        }
        this.f7552z = new TextView[16];
        this.f7552z[0] = (TextView) findViewById(C0965R.id.keyboard_0);
        this.f7552z[1] = (TextView) findViewById(C0965R.id.keyboard_1);
        this.f7552z[2] = (TextView) findViewById(C0965R.id.keyboard_2);
        this.f7552z[3] = (TextView) findViewById(C0965R.id.keyboard_3);
        this.f7552z[4] = (TextView) findViewById(C0965R.id.keyboard_4);
        this.f7552z[5] = (TextView) findViewById(C0965R.id.keyboard_5);
        this.f7552z[6] = (TextView) findViewById(C0965R.id.keyboard_6);
        this.f7552z[7] = (TextView) findViewById(C0965R.id.keyboard_7);
        this.f7552z[8] = (TextView) findViewById(C0965R.id.keyboard_8);
        this.f7552z[9] = (TextView) findViewById(C0965R.id.keyboard_9);
        this.f7552z[10] = (TextView) findViewById(C0965R.id.keyboard_char1);
        this.f7552z[11] = (TextView) findViewById(C0965R.id.keyboard_char2);
        this.f7552z[12] = (TextView) findViewById(C0965R.id.keyboard_char3);
        this.f7552z[13] = (TextView) findViewById(C0965R.id.keyboard_char4);
        this.f7552z[14] = (TextView) findViewById(C0965R.id.keyboard_char5);
        this.f7552z[15] = (TextView) findViewById(C0965R.id.keyboard_char6);
        for (TextView temp2 : this.f7552z) {
            temp2.setOnClickListener(this);
        }
        this.f7522A = (TextView) findViewById(C0965R.id.cover_view);
    ...
    public void mo1530f() {
        if (this.f7527F == null) {
            this.f7527F = new C1443g(findViewById(C0965R.id.keyboard_result_layout), 7, false);
            this.f7528G = new C1443g(findViewById(C0965R.id.keyboard_keymid1), 13, false);
            this.f7529H = new C1443g(findViewById(C0965R.id.keyboard_keymid2), 14, false);
            this.f7530I = new C1443g(findViewById(C0965R.id.keyboard_keymid3), 15, false);
            this.f7531J = new C1443g(findViewById(C0965R.id.keyboard_keydown), 11, false);
