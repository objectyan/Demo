...
public class C2329u extends C1953c {
    ...
    public C2329u(Context context) {
        super(context);
        View view = LayoutInflater.from(context).inflate(C0965R.layout.vehicle_update_progress_dialog, null);
        this.f7637e = (ProgressBar) view.findViewById(C0965R.id.update_progress);
        this.f7638f = (TextView) view.findViewById(C0965R.id.has_finished);
        this.f7639g = (TextView) view.findViewById(C0965R.id.percent);
        this.f7640h = (TextView) view.findViewById(C0965R.id.titletxt);
        m7437a(view);
    }
    ...
    public void setTitle(String strTitle) {
        if (this.f7640h != null) {
            C1260i.m4435b("BaseDialog", "Set UpdateProgressDialog Title: " + strTitle);
