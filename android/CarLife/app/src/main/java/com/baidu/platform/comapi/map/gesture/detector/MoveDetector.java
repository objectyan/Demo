...
public class MoveDetector {
    ...
    private void handleMoving(MotionEvent event) {
        ...
        if (Math.abs(((Vector) velocity.first).f19860x) > 0.0d || Math.abs(((Vector) velocity.first).f19861y) > 0.0d || Math.abs(((Vector) velocity.second).f19860x) > 0.0d || Math.abs(((Vector) velocity.second).f19861y) > 0.0d) {
