...
public class C2282f extends BaseDialog {
    ...
    protected View mo1528a() {
        View contentView = LayoutInflater.from(this.c).inflate(C0965R.layout.common_dialog_right_list, null);
    ...
    protected int getCustomWidth() {
        if (C1249d.m4334m()) {
            return this.c.getResources().getDimensionPixelSize(C0965R.dimen.common_menu_right_big_screen_width);
        }
        return this.c.getResources().getDimensionPixelSize(C0965R.dimen.common_menu_right_width);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7464e = (TextView) findViewById(C0965R.id.tv_title);
        this.f7464e.setText(this.f7466g);
        this.f7465f = (ListView) findViewById(C0965R.id.lv_menu);
    ...
    public void setSelected(int selectedPos) {
        if (this.f7467h instanceof C1023r) {
            ((C1023r) this.f7467h).m3261a(selectedPos);
