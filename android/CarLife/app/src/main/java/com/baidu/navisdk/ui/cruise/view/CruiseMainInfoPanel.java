...
public class CruiseMainInfoPanel {
    ...
    /* renamed from: com.baidu.navisdk.ui.cruise.view.CruiseMainInfoPanel$1 */
    class C42761 implements OnTouchListener {
        C42761() {
        }
    ...
    public CruiseMainInfoPanel(Activity activity) {
        this.mContext = activity;
        initViews(JarUtils.inflate(activity, C4048R.layout.nsdk_layout_cruise_bar_top, null));
    }
    ...
    private void initViews(View parentView) {
        if (parentView != null) {
            View mRootView = parentView.findViewById(C4048R.id.layout_cruise_top);
            this.mSatelliteNumTextView = (TextView) parentView.findViewById(C4048R.id.text_cruise_satellite_num);
            this.mSatelliteImageView = (ImageView) parentView.findViewById(C4048R.id.img_cruise_satellite);
            this.mNetStatusTextView = (TextView) parentView.findViewById(C4048R.id.text_cruise_net_status);
            this.mNetStatusTextView.setVisibility(4);
            if (mRootView != null) {
                mRootView.setOnTouchListener(new C42761());
                this.mCameraIconLayout = mRootView.findViewById(C4048R.id.layout_cruise_camera_icon);
                this.mCameraIconImageView = (ImageView) mRootView.findViewById(C4048R.id.img_cruise_camera_icon);
                this.mCameraSpeedTextView = (TextView) mRootView.findViewById(C4048R.id.text_cruise_camera_speed);
                this.mCameraSpeedTextView.setVisibility(4);
                this.mSpeedIndicatorImageView = (ImageView) mRootView.findViewById(C4048R.id.img_cruise_speed_indicator);
                this.mCameraInfoLayout = mRootView.findViewById(C4048R.id.layout_cruise_camera_info);
                this.mCameraDistanceTextView = (TextView) this.mCameraInfoLayout.findViewById(C4048R.id.text_cruise_distance);
                this.mCameraDistanceLable = (TextView) this.mCameraInfoLayout.findViewById(C4048R.id.text_cruise_distance_suffix);
                this.mCameraTypeTextView = (TextView) this.mCameraInfoLayout.findViewById(C4048R.id.text_cruise_camera_type);
                this.mCurrentSpeedInfoLayout = mRootView.findViewById(C4048R.id.layout_cruise_speed_info);
                this.mCurrentSpeedTextView = (TextView) this.mCurrentSpeedInfoLayout.findViewById(C4048R.id.text_cruise_speed);
                this.mMiscStatusTextView = (TextView) mRootView.findViewById(C4048R.id.text_cruise_misc_status);
            }
            try {
                this.mSpeedIndicatorBitmap = ((BitmapDrawable) JarUtils.getResources().getDrawable(C4048R.drawable.nsdk_drawable_rg_cruise_speed_indicator)).getBitmap();
    ...
    private void updateCameraInfo(int progress) {
        if (this.mCameraDistanceTextView != null) {
            int distance = this.mUIModel.getCameraDistance();
            this.mCameraDistanceTextView.setText(JarUtils.getResources().getString(C4048R.string.nsdk_string_cruise_camera_distance, new Object[]{Integer.valueOf(distance)}));
        }
    }
    ...
    private void hideCameraInfo() {
        ...
        if (this.mCameraIconImageView != null) {
            this.mCameraIconImageView.setImageDrawable(JarUtils.getResources().getDrawable(C4048R.drawable.nsdk_drawable_rg_cruise_speed_panel));
        }
    }
    ...
    public void updateSatelliteViews(int satelliteNum) {
        ...
        if (satelliteNum < 3) {
            this.mSatelliteImageView.setImageDrawable(JarUtils.getResources().getDrawable(C4048R.drawable.nsdk_drawable_rg_ic_satellite_red));
            this.mSatelliteNumTextView.setTextColor(JarUtils.getResources().getColor(C4048R.color.nsdk_cruise_satellite_text_red));
        } else if (satelliteNum >= 3 && satelliteNum < 6) {
            this.mSatelliteImageView.setImageDrawable(JarUtils.getResources().getDrawable(C4048R.drawable.nsdk_drawable_rg_ic_satellite_yellow));
            this.mSatelliteNumTextView.setTextColor(JarUtils.getResources().getColor(C4048R.color.nsdk_cruise_text_assis));
        } else if (satelliteNum >= 6) {
            this.mSatelliteImageView.setImageDrawable(JarUtils.getResources().getDrawable(C4048R.drawable.nsdk_drawable_rg_ic_satellite_green));
            this.mSatelliteNumTextView.setTextColor(JarUtils.getResources().getColor(C4048R.color.nsdk_cruise_text_assis));
        }
    }
    ...
    public void setToDisconnected() {
        ...
        if (!hasData && this.mNetStatusTextView != null) {
            ...
            this.mNetStatusTextView.setText(JarUtils.getResources().getString(C4048R.string.nsdk_string_cruise_no_network_short));
        }
    }
    ...
    public void setViewWhenNoGPS() {
        ...
        if (this.mMiscStatusTextView != null) {
            this.mMiscStatusTextView.setText(JarUtils.getResources().getString(C4048R.string.nsdk_string_cruise_nogps_map_tip));
        }
    ...
    public void setViewWhenGPSRecover() {
        ...
        if (getState() == CruiseState.GPS_DISABLED || getState() == CruiseState.GPS_WEAK) {
            setCruiseState(CruiseState.NORMAL);
            if (this.mCameraIconImageView != null) {
                this.mCameraIconImageView.setImageDrawable(BNStyleManager.getDrawable(C4048R.drawable.nsdk_drawable_rg_cruise_speed_panel));
            }
            switchToCurrentSpeedLayout();
        }
    }
    ...
    public void setViewWhenNotLocated() {
        ...
        if (this.mCameraIconImageView != null) {
            this.mCameraIconImageView.setImageDrawable(JarUtils.getResources().getDrawable(C4048R.drawable.nsdk_drawable_rg_cruise_try_locate));
        }
        if (this.mMiscStatusTextView != null) {
            this.mMiscStatusTextView.setText(JarUtils.getResources().getString(C4048R.string.nsdk_string_cruise_try_locate));
        }
        switchToMiscStatusInfoLayout();
    }
