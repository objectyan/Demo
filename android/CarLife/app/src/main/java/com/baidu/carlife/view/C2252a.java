...
public class C2252a implements C2227c {
    ...
    public class C2245a implements OnTouchListener {
        ...
        public C2245a(final C2252a this$0, KeyboardEditText editText, int imeOptions, C2248c finishListener, final C2249d onFocusChangeListener) {
            ...
            switch (imeOptions) {
                case 3:
                    editText.setFinishText(BaiduNaviApplication.getInstance().getString(C0965R.string.keyboard_search));
                    break;
                default:
                    editText.setFinishText(BaiduNaviApplication.getInstance().getString(C0965R.string.keyboard_finish));
                    break;
            }
    ...
    private class C2247b extends C2246d {
        ...
        public void mo1799a(View v) {
            ...
            C2252a c2252a;
            switch (v.getId()) {
                case C0965R.id.keyboard_result_hide:
                    this.f7327a.m8567d();
                    return;
                case C0965R.id.keyboard_result_left:
                    this.f7327a.f7356u.m8456b();
                    return;
                case C0965R.id.keyboard_result_right:
                    this.f7327a.f7356u.m8455a();
                    return;
                case C0965R.id.keyboard_q:
                case C0965R.id.keyboard_w:
                case C0965R.id.keyboard_e:
                case C0965R.id.keyboard_r:
                case C0965R.id.keyboard_t:
                case C0965R.id.keyboard_y:
                case C0965R.id.keyboard_u:
                case C0965R.id.keyboard_i:
                case C0965R.id.keyboard_o:
                case C0965R.id.keyboard_p:
                case C0965R.id.keyboard_a:
                case C0965R.id.keyboard_s:
                case C0965R.id.keyboard_d:
                case C0965R.id.keyboard_f:
                case C0965R.id.keyboard_g:
                case C0965R.id.keyboard_h:
                case C0965R.id.keyboard_j:
                case C0965R.id.keyboard_k:
                case C0965R.id.keyboard_l:
                case C0965R.id.keyboard_z:
                case C0965R.id.keyboard_x:
                case C0965R.id.keyboard_c:
                case C0965R.id.keyboard_v:
                case C0965R.id.keyboard_b:
                case C0965R.id.keyboard_n:
                case C0965R.id.keyboard_m:
                    ...
                    return;
                case C0965R.id.keyboard_letter_shift:
                    c2252a = this.f7327a;
                    ...
                    this.f7327a.m8552f();
                    return;
                case C0965R.id.keyboard_letter_delete:
                case C0965R.id.keyboard_num_delete:
                    ...
                    return;
                case C0965R.id.keyboard_letter_switch:
                case C0965R.id.keyboard_num_switch:
                    c2252a = this.f7327a;
                    ...
                    return;
                case C0965R.id.keyboard_letter_language:
                    c2252a = this.f7327a;
                    ...
                    this.f7327a.m8552f();
                    return;
                case C0965R.id.keyboard_letter_space:
                case C0965R.id.keyboard_num_space:
                    if (!this.f7327a.m8552f()) {
                        this.f7327a.m8535a(" ");
                        return;
                    }
                    return;
                case C0965R.id.keyboard_letter_finish:
                case C0965R.id.keyboard_num_finish:
                    ...
                    this.f7327a.m8554g();
                    return;
                case C0965R.id.keyboard_char1:
                case C0965R.id.keyboard_1:
                case C0965R.id.keyboard_2:
                case C0965R.id.keyboard_3:
                case C0965R.id.keyboard_char2:
                case C0965R.id.keyboard_4:
                case C0965R.id.keyboard_5:
                case C0965R.id.keyboard_6:
                case C0965R.id.keyboard_char3:
                case C0965R.id.keyboard_char4:
                case C0965R.id.keyboard_7:
                case C0965R.id.keyboard_8:
                case C0965R.id.keyboard_9:
                case C0965R.id.keyboard_char5:
                case C0965R.id.keyboard_0:
                case C0965R.id.keyboard_char6:
                    this.f7327a.m8535a(((TextView) v).getText().toString());
                    return;
                case C0965R.id.cover_view:
    ...
    /* renamed from: a */
    public void m8561a(Activity activity, C1277e listener) {
    ...
    /* renamed from: e */
    private void m8548e() {
        this.f7344i = new C2298l(C1157a.m3876a());
    ...
    private void m8539b(boolean isEnglish) {
        ...
        int a4 = BaiduNaviApplication.getInstance().getResources().getColor(C0965R.color.cl_text_a4_bgtext);
        int a1 = BaiduNaviApplication.getInstance().getResources().getColor(C0965R.color.cl_text_a1_bgtext);
        if (isEnglish) {
    ...
    private void m8542c(boolean isUpper) {
        ...
        if (isUpper) {
            ...
            this.f7348m.setImageResource(C0965R.drawable.input_ic_keyboard_shift_focus);
            return;
        }
        for (i = 0; i < this.f7349n; i++) {
            this.f7347l[i].setText(String.valueOf(this.f7350o[i]));
        }
        this.f7348m.setImageResource(C0965R.drawable.input_ic_keyboard_shift);
    }
    ...
    private void m8544d(boolean isConfirm) {
        ...
        if (isConfirm) {
            this.f7351p.setText(C0965R.string.keyboard_confirm);
            this.f7351p.setSelected(true);
            return;
        }
        String finishText = C1157a.m3876a().getString(C0965R.string.keyboard_finish);
    ...
    public void mo1800a(int position, View itemView) {
        String s = ((TextView) itemView.findViewById(C0965R.id.keyboard_result_item_tv)).getText().toString();
        m8535a(s);
        this.f7357v.setText("");
        m8544d(false);
