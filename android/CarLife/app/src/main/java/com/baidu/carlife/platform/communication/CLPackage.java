...
import com.baidu.carlife.core.connect.C1211b;
...
public class CLPackage implements Serializable {
    ...
    public boolean setHeader(byte[] header) {
        ...
        try {
            this.reserved = C1211b.m4189d(header, 0);
            this.type = header[2] & 255;
            this.dataType = header[3] & 255;
            this.length = C1211b.m4189d(header, 4);
            this.service = C1211b.m4189d(header, 6);
            this.dataId = C1211b.m4171a(header, 8);
            return true;
        } catch (Throwable e) {
            C1260i.m4438b(TAG, e);
            return false;
    ...
    public byte[] getHeader() {
        ...
        try {
            ...
            C1211b.m4173a(this.dataId, bytes, 8);
            return bytes;
        } catch (Throwable e) {
            C1260i.m4438b(TAG, e);
            return null;
