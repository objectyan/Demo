...
public class C1798e extends C1790b {
    ...
    public C1798e(Context context) {
        ...
        m6623e(this.E);
        m6606a(context.getResources().getString(C0965R.string.music_local));
        this.C = context;
        this.F = 0;
        m6599a(1);
    ...
    /* renamed from: z */
    public void mo1661z() {
        C1260i.m4435b("ouyang", "---setLocalMusicRecentIndex:" + this.B);
    ...
    private int m6671B() {
        ...
        C1260i.m4435b("ouyang", "---getLocalMusicRecentIndex:" + index);
