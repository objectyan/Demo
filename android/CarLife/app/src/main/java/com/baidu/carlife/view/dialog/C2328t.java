...
public class C2328t extends BaseDialog {
    ...
    protected View mo1528a() {
        View contentView = LayoutInflater.from(this.c).inflate(C0965R.layout.layout_vehicle_disable, null);
    ...
    protected void mo1529b() {
        findViewById(C0965R.id.tv_msg).setOnClickListener(new C23272(this));
    }

    protected int getCustomWidth() {
        return this.c.getResources().getDimensionPixelSize(C0965R.dimen.dialog_vehicle_disable_width);
    }

    public int getCustomHeight() {
        return this.c.getResources().getDimensionPixelSize(C0965R.dimen.dialog_vehicle_disable_height);
    }
