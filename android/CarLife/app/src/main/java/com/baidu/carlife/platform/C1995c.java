...
public class C1995c {
    ...
    class C19851 implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName className, IBinder binder) {
            C1260i.m4435b("CarLifePlatform", "onServiceConnected()");
    ...
    class C19932 extends C1992a {
        ...
        public void mo1738a(final String name) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.onRemoteClinetConnected()");
        ...
        public void mo1739b(final String packageName) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.onRemoteClientDisconnected()");
            if (this.f6427a.f6439k != null) {
                this.f6427a.f6439k.post(new Runnable(this) {
                    /* renamed from: b */
        ...
        public void mo1736a(int errorNo, String errorMsg, String packageName, String songListId, List<MusicSongModel> songList, int pn, int rn, int total) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.onGetSongList() error=" + errorNo + " msg=" + errorMsg + " package=" + packageName + " songListId=" + songListId + " pn=" + pn + " rn=" + rn + " total=" + total);
            if (this.f6427a.f6439k != null) {
                final int i = errorNo;
        ...
        public void mo1735a(int errorNo, String errorMsg, String packageName, String songId, long downloadSize, long totalSize, boolean stop) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.onGetSong()");
            if (this.f6427a.f6439k != null) {
                final int i = errorNo;
                final String str = errorMsg;
                final String str2 = packageName;
        ...
        public void mo1737a(int errorNo, String errorMsg, String packageName, List<CLAlbum> albumList) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.onGetAlbumList()");
            if (this.f6427a.f6439k != null) {
                final int i = errorNo;
                final String str = errorMsg;
                final String str2 = packageName;
                    ...
                    case 2:
                        ...
                        if (args != null && args.length >= 3) {
                            try {
                                ...
                                C1260i.m4432a("PlatformManager", e2);
                                return;
                            }
                        }
                        return;
                    case 3:
                        if (msg.obj != null) {
                            ...
                            try {
                                ...
                                C1260i.m4432a("PlatformManager", e22);
                                return;
                            }
                        }
                        return;
                    case 4:
                        if (!TextUtils.isEmpty((String) msg.obj)) {
                            try {
                                ...
                                C1260i.m4432a("PlatformManager", e222);
                                return;
                            }
                        }
                        return;
                    case 5:
                        if (!TextUtils.isEmpty((String) msg.obj)) {
                            try {
                                ...
                                C1260i.m4432a("PlatformManager", e2222);
                                return;
                            }
                        }
                        return;
    ...
    public boolean m7619a(String appName) {
        if (m7611d(appName)) {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.getAlbumList()");
            Message.obtain(this.f6436g, 1, appName).sendToTarget();
            return true;
        }
        C1260i.m4445e("CarLifePlatform", "PlatformManager.getAlbumList() invalid appname " + appName);
        return false;
    }
    ...
    public void m7618a(String appName, String songListId, int pn, int rn) {
        if (m7611d(appName)) {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.getSongList() app=" + appName + " id=" + songListId + " pn=" + pn + " rn=" + rn);
            if (TextUtils.isEmpty(songListId)) {
                C1260i.m4445e("CarLifePlatform", "PlatformManager.requestSongList() invalid songListId: " + songListId);
                return;
            }
            Message.obtain(this.f6436g, 2, new Object[]{appName, songListId, Integer.valueOf(pn), Integer.valueOf(rn)}).sendToTarget();
            return;
        }
        C1260i.m4445e("CarLifePlatform", "PlatformManager.requestSongList() invalid appname " + appName);
    }

    /* renamed from: a */
    public void m7617a(String appName, MusicSongModel song) {
        if (m7611d(appName)) {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.getDataWithid()");
            Message.obtain(this.f6436g, 3, new Pair(appName, song)).sendToTarget();
            return;
        }
        C1260i.m4445e("CarLifePlatform", "PlatformManager.getDataWithid() invalid appname " + appName);
    }

    /* renamed from: b */
    public void m7621b(String appName) {
        if (m7611d(appName)) {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.stopDownload()");
            Message.obtain(this.f6436g, 4, appName).sendToTarget();
            return;
        }
        C1260i.m4445e("CarLifePlatform", "PlatformManager.stopDownload() invalid appname " + appName);
    }

    /* renamed from: c */
    public void m7622c(String appName) {
        if (m7611d(appName)) {
            C1260i.m4435b("CarLifePlatform", "PlatformManager.disconnectApp()");
            Message.obtain(this.f6436g, 5, appName).sendToTarget();
            return;
        }
        C1260i.m4445e("CarLifePlatform", "PlatformManager.disconnectApp() invalid appname " + appName);
    }
