...
public class C1371b implements C1369a {
    ...
    class C13531 implements C0672b {
        /* renamed from: a */
        ...
        public void onClick() {
            ...
            this.f3956a.f4002h.setTitle(this.f3956a.f4004j.getString(C0965R.string.ota_title_downloading));
            C1309g.m4699a().showDialog(this.f3956a.f4002h);
        }
    }

    /* compiled from: ElhCustom */
    /* renamed from: com.baidu.carlife.custom.elhyf.b$2 */
    class C13542 implements C0672b {
        /* renamed from: a */
    ...
    class C13564 implements C0672b {
        /* renamed from: a */
    ...
    class C13575 implements C0672b {
        /* renamed from: a */
        ...
        public void onClick() {
            ...
            this.f3963a.f4002h.setTitle(this.f3963a.f4004j.getString(C0965R.string.ota_title_downloading));
            C1309g.m4699a().m4701b().showDialog(this.f3963a.f4002h);
        }
    }

    /* compiled from: ElhCustom */
    /* renamed from: com.baidu.carlife.custom.elhyf.b$6 */
    class C13586 implements C0672b {
        /* renamed from: a */
    ...
    private void m5000b(String tips, long packSize) {
        ...
        if (this.f3998d == null) {
            this.f3998d = new C1953c(this.f4004j).m7448c(this.f4004j.getString(C0965R.string.ota_find_new_version, new Object[]{Float.valueOf(((float) (packSize / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID)) / 1024.0f)})).m7457g(17).m7451d(this.f4004j.getString(C0965R.string.alert_confirm)).m7458q().m7450d((int) C0965R.string.alert_ignore);
        ...
        this.f3998d.m7444b(tips + "\n" + this.f4004j.getString(C0965R.string.ota_is_download) + (isMobileNetwork ? "\n（" + this.f4004j.getString(C0965R.string.module_music_mobile_flow_hint) + ")" : ""));
        C1309g.m4699a().m4701b().showDialog(this.f3998d);
    }

    /* renamed from: b */
    private void m5001b(final String filePath, final String boardName, final String versionCode) {
        if (this.f3999e == null) {
            this.f3999e = new C1953c(this.f4004j).m7442b((int) C0965R.string.ota_new_version_downloaded).m7457g(17).m7447c((int) C0965R.string.alert_confirm).m7458q().m7450d((int) C0965R.string.alert_ignore);
            this.f3999e.m7438a(new C0672b(this) {
                /* renamed from: d */
        ...
        this.f3999e.m7444b(this.f4004j.getString(C0965R.string.ota_already_download));
        C1309g.m4699a().showDialog(this.f3999e);
    }

    /* renamed from: i */
    private void m5004i() {
        if (this.f4000f == null) {
            this.f4000f = new C1953c(this.f4004j).m7442b((int) C0965R.string.ota_title_md5_check).m7457g(17);
        }
        if (this.f4000f.isShown()) {
            this.f4000f.mo1526d();
        }
        this.f4000f.m7435a((int) C0965R.string.ota_file_md5_check_start);
        C1309g.m4699a().showDialog(this.f4000f);
    }

    /* renamed from: j */
    private void m5005j() {
        if (this.f4001g == null) {
            this.f4001g = new C1953c(this.f4004j).m7442b((int) C0965R.string.ota_title_md5_check).m7457g(17).m7447c((int) C0965R.string.ota_file_re_download).m7450d((int) C0965R.string.alert_cancel);
        ...
        this.f4001g.m7435a((int) C0965R.string.ota_file_md5_check_failed);
        C1309g.m4699a().showDialog(this.f4001g);
    }

    /* renamed from: c */
    private void m5003c(String filePath, String newBoardName, String newVersionCode) {
        if (!C1663a.m5979a().m5993N()) {
            C2201w.m8371a((int) C0965R.string.usb_disconnected, 1);
        } else if (this.f3996b == null || this.f3996b.isEmpty()) {
            C2201w.m8371a((int) C0965R.string.ota_low_version, 1);
        } else {
            ...
            if (this.f3995a.equals(newBoardName) && curVerCode < newCode) {
                ...
                this.f4003i.setTitle(this.f4004j.getString(C0965R.string.ota_title_pushing));
                C1309g.m4699a().showDialog(this.f4003i);
