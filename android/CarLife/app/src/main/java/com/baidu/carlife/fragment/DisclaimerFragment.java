...
public class DisclaimerFragment extends ContentFragment {
    ...
    class C14511 implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (this.f4259a.f4266f) {
                this.f4259a.f4261a.setCompoundDrawablesWithIntrinsicBounds(C0965R.drawable.com_ic_unchecked, 0, 0, 0);
            } else {
                this.f4259a.f4261a.setCompoundDrawablesWithIntrinsicBounds(C0965R.drawable.com_ic_check, 0, 0, 0);
            }
    ...
    class C14522 implements OnClickListener {
        ...
        public void onClick(View v) {
            C1192c.m4069a().m4075b(this.f4260a.f4266f);
            this.f4260a.showFragment(NaviFragmentManager.TYPE_HOME, null);
        }
    }

    protected View onCreateContentView(LayoutInflater inflater) {
        this.mContentView = inflater.inflate(C0965R.layout.frag_disclaimer, null);
        this.f4261a = (TextView) this.mContentView.findViewById(C0965R.id.notip_tv);
        this.f4262b = this.mContentView.findViewById(C0965R.id.agree_btn);
        this.f4263c = (ScrollView) this.mContentView.findViewById(C0965R.id.scroll_view);
