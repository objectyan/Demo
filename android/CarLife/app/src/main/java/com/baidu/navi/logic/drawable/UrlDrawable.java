  ...
  extends Drawable
{
  ...
  private UrlDrawable(final String paramString1, final String paramString2)
  {
    new UserTask()
    {
      ...
      {
        this.mBmp = Tools.getBitmapFromPath(paramString2);
        if (this.mBmp != null) {
          return this.mBmp;
        }
      ...
      public void onPostExecute(Bitmap paramAnonymousBitmap)
      {
        ...
        ((Drawable)localObject).setBounds(Tools.calcSquareRect(paramAnonymousBitmap.mCurrent.getBounds()));
  ...
  private static void init()
  {
    try
    {
      if (!mHasInit)
      {
        ...
        mDefaultBitmap = Tools.getBitmapFromResId(2130838698);
        mFailedBitmap = Tools.getBitmapFromResId(2130838733);
      }
      mHasInit = true;
      return;
    }
  ...
  public void onBoundsChange(Rect paramRect)
  {
    if (this.mCurrent != null)
    {
      ...
      this.mCurrent.setBounds(Tools.calcSquareRect(paramRect));
    }
    for (;;)
    {
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/navi/logic/drawable/UrlDrawable.class
