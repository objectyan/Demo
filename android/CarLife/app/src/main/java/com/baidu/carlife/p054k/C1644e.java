...
public class C1644e extends C1626e {
    ...
    protected C1622d getPostRequestParams() {
        ...
        String clientid = PreferenceHelper.getInstance(this.f5062e).getString(C1253f.jE, "");
        String appid = PreferenceHelper.getInstance(this.f5062e).getString(C1253f.jF, "");
        String deviceid = PreferenceHelper.getInstance(this.f5062e).getString(C1253f.jG, "");
