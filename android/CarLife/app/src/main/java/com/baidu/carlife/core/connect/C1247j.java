...
public class C1247j {
    ...
    public static String m4319a(String hexString, int encodeType) {
        ...
        for (int i = 0; i < max; i++) {
            result = result + ((char) C1247j.m4321b(hexString.substring(i * encodeType, (i + 1) * encodeType)));
        }
        return result;
    }
    ...
    public static String m4326d(String content) {
        ...
        for (int i = 0; i < length; i++) {
            result = result + String.valueOf((char) C1247j.m4321b(content.substring(i * 2, (i * 2) + 2)));
        }
        return result;
    }
    ...
    public static String m4317a(int algorism, int maxLength) {
        ...
        return C1247j.m4322b(str.toUpperCase(), maxLength);
    }
    ...
    public static byte[] m4328f(String hex) {
        ...
        String binarys = C1247j.m4325c(hex);
        for (int i = 0; i < max; i++) {
            bytes[i] = (byte) C1247j.m4327e(binarys.substring((i * 8) + 1, (i + 1) * 8));
