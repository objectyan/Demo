...
import com.baidu.carlife.core.audio.C1166b;
import com.baidu.carlife.core.audio.C1172f;
import com.baidu.carlife.core.audio.C1177h;
import com.baidu.carlife.core.audio.C1182m;
import com.baidu.carlife.core.audio.C1185n;
import com.baidu.carlife.core.audio.C1186o;
import com.baidu.carlife.core.audio.C1188q;
...
public class C1665b {
    /* renamed from: a */
    private static final String f5126a = (C1163a.f3010n + C1665b.class.getSimpleName());
    /* renamed from: b */
    ...
    /* renamed from: j */
    private C1172f f5136j = new C1177h();
    /* renamed from: k */
    private C1172f f5137k = new C1185n();
    /* renamed from: l */
    private C1172f f5138l = new C1182m();
    /* renamed from: m */
    private C1172f f5139m = new C1188q();
    /* renamed from: n */
    private C1166b f5140n = C1166b.m3896a();
    /* renamed from: o */
    ...
    /* renamed from: t */
    private Context f5145t = C1157a.m3876a().getApplicationContext();
    ...
    public void m6070b(int sampleRate, int channelConfig, int sampleFormat) {
        ...
        C1260i.m4435b(f5126a, "receive TTS init command sampleRate:" + sampleRate + " channelConfig:" + channelConfig + " sampleFormat:" + sampleFormat);
    }
    ...
    public void m6082j() {
        ...
        C1260i.m4435b(f5126a, "receive TTS stop command");
    }
    ...
    public void m6073c(int sampleRate, int channelConfig, int sampleFormat) {
        ...
        C1260i.m4435b(f5126a, "receive VR init command sampleRate:" + sampleRate + " channelConfig:" + channelConfig + " sampleFormat:" + sampleFormat);
    }
    ...
    public void m6084l() {
        ...
        C1260i.m4435b(f5126a, "receive VR stop command");
    }
    ...
    /* renamed from: n */
    public void m6086n() {
        C1260i.m4435b(f5126a, "send command: MSG_CMD_GET_AUDIO_FOCUS");
    }
    ...
    public void m6065a(Context context) {
        if (Build.MODEL.equals("MI 3")) {
            ...
            C1260i.m4435b(f5126a, "current media volume: " + vol);
            if (vol <= 2) {
                audioManager.setStreamVolume(3, 2, 0);
            }
            C1260i.m4435b(f5126a, "set media volume: " + audioManager.getStreamVolume(3));
        }
    }
    ...
    public boolean m6091s() {
        return C1163a.m3882a().m3895g();
    }

    /* renamed from: a */
    public void m6062a(int mode) {
        C1163a.m3882a().m3890b(mode);
    }

    /* renamed from: t */
    public boolean m6092t() {
        return C1163a.m3882a().m3892d();
    }

    /* renamed from: b */
    public void m6069b(int sr) {
        C1163a.m3882a().m3884a(sr);
    }

    /* renamed from: a */
    public byte[] m6068a(int type, int dataLen) {
        C1186o ttsPackage = new C1186o();
