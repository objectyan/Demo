...
public abstract class C1790b {
            ...
            if (apps.iterator().hasNext()) {
                ...
                if (ri != null) {
                    ...
                    try {
                        ...
                        C1260i.m4435b(C1818h.f5590a, "startActivity error:" + e.getMessage());
                        return;
                    }
                }
                return;
            }
            C1260i.m4445e(C1818h.f5590a, "openApp " + packageName + " fail, can't find ResolveInfo");
    ...
    /* renamed from: u */
    public void m6651u() {
        C1328h.m4757a().showFragment(NaviFragmentManager.TYPE_MUSIC_ALBUMLIST, null);
    }
