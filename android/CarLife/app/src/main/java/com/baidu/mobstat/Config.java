...
public class Config
{
  ...
  public static final String STAT_SDK_VERSION_NUM = "3.7.6.1";
  ...
  static
  {
    ...
    for (String str = "http://hmma.baidu.com/app.gif";; str = "https://hmma.baidu.com/app.gif")
    {
      LOG_SEND_URL = str;
      return;
    }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/mobstat/Config.class
