...
public abstract class C1723b extends C1133a<C1717a> {
    ...
    public void m6295a(C1717a data) {
        ...
        mo1429b().m3705a((int) C0965R.id.title, (String) data.m6282e().m3762b());
        mo1429b().m3705a((int) C0965R.id.description, (String) data.m6280d().m3762b());
    }

    /* renamed from: a */
    private void m6294a(boolean isShowRedPoint) {
        mo1429b().m3703a((int) C0965R.id.red_point).setVisibility(isShowRedPoint ? 0 : 8);
    }
}
