...
public class C1952b {
    ...
    private class C1951e extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void m7411a(Boolean result) {
            ...
            C1260i.m4435b(C1952b.f6194b, "OnPostExecute: " + result);
    ...
    public void m7422a(int nSize) {
        ...
        command.m4201c(C1253f.bP);
        command.m4199b(transferStart.toByteArray());
        command.m4203d(transferStart.getSerializedSize());
        C1260i.m4435b(f6194b, "Start transfer data");
        C1218e.m4228a().m4241b(command);
    }
    ...
    public boolean m7428b() {
        ...
        C1260i.m4435b(f6194b, "NetworkAvailable Error");
        return false;
    }
    ...
    public void m7429c(int verCode) {
        ...
        C1260i.m4435b(f6194b, "startTransferData: " + strFile);
        try {
            C1260i.m4435b(f6194b, "### size: " + C1952b.m7412a(new File(strFile)));
        } catch (Exception e) {
            e.printStackTrace();
        }
        m7422a(this.f6204l);
    ...
    /* renamed from: b */
    private void m7418b(C1212c msg) {
        try {
    ...
    /* renamed from: c */
    private CarlifeTransferSend m7419c(C1212c msg) {
        try {
    ...
    private boolean m7421d() {
        ...
        try {
            ...
            if (fileSize > 2147483647L) {
                C1260i.m4445e(f6194b, "file too big...");
                return false;
            }
            C1260i.m4435b(f6194b, "transfer data start: " + fileSize);
            ...
            while (((long) sumRead) < fileSize) {
                ...
                C1260i.m4445e(f6194b, "transferData : [" + nIndex + " : " + sumRead);
            }
            m7427b(this.f6206n);
            if (((long) sumRead) < fileSize) {
                C1260i.m4445e(f6194b, "Could not completely read file: " + sumRead);
                bTransferResult = false;
            }
            fi.close();
            C1260i.m4435b(f6194b, "transfer end: " + sumRead);
            return bTransferResult;
        } catch (IOException ex) {
            C1260i.m4445e(f6194b, "transfer data error!!!");
            ex.printStackTrace();
        }
    }
}
