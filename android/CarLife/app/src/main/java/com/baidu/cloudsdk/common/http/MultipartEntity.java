  ...
  implements HttpEntity
{
  ...
  public MultipartEntity()
  {
    ...
    this.mBoundary = localStringBuilder.toString();
  ...
  protected void addPart(String paramString1, String paramString2, InputStream paramInputStream, String paramString3, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 95	com/baidu/cloudsdk/common/http/MultipartEntity:writeBoundaryLine	()V
    //   4: aload_0
    ...
    //   44: invokevirtual 84	java/io/ByteArrayOutputStream:write	([B)V
    //   47: aload 4
    //   49: ifnull +81 -> 130
    //   52: aload_0
    ...
    //   84: invokevirtual 84	java/io/ByteArrayOutputStream:write	([B)V
    //   87: sipush 4096
    //   90: newarray <illegal type>
    //   92: astore_1
    //   93: aload_3
    //   94: aload_1
    //   95: invokevirtual 114	java/io/InputStream:read	([B)I
    //   98: istore 6
    //   100: iload 6
    //   102: iconst_m1
    ...
    //   111: iconst_0
    //   112: iload 6
    //   114: invokevirtual 117	java/io/ByteArrayOutputStream:write	([BII)V
    //   117: goto -24 -> 93
    //   120: astore_1
    //   121: aload_1
    //   122: invokevirtual 91	java/io/IOException:printStackTrace	()V
    //   125: aload_3
    //   126: invokevirtual 120	java/io/InputStream:close	()V
    //   129: return
    //   130: aload_0
    ...
    //   139: invokevirtual 84	java/io/ByteArrayOutputStream:write	([B)V
    //   142: goto -55 -> 87
    //   145: astore_1
    //   146: aload_3
    //   147: invokevirtual 120	java/io/InputStream:close	()V
    //   150: aload_1
    //   151: athrow
    //   152: aload_0
    //   153: getfield 38	com/baidu/cloudsdk/common/http/MultipartEntity:mOut	Ljava/io/ByteArrayOutputStream;
    //   156: invokevirtual 125	java/io/ByteArrayOutputStream:flush	()V
    //   159: aload_3
    //   160: invokevirtual 120	java/io/InputStream:close	()V
    //   163: return
    //   164: astore_1
    //   165: aload_1
    ...
    //   170: astore_1
    //   171: aload_1
    //   172: invokevirtual 91	java/io/IOException:printStackTrace	()V
    //   175: return
    //   176: astore_2
    //   177: aload_2
    //   178: invokevirtual 91	java/io/IOException:printStackTrace	()V
    //   181: goto -31 -> 150
  ...
  public void writeTo(OutputStream paramOutputStream)
    throws IOException
  {
    paramOutputStream.write(this.mOut.toByteArray());
  }
}


/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/com/baidu/cloudsdk/common/http/MultipartEntity.class
