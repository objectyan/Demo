...
public class C2342g implements OnClickListener, OnRGInfoListener {
    ...
    /* renamed from: h */
    private static final int f7673h = C1249d.m4331a().m4351h();
    /* renamed from: A */
    ...
    class C23387 implements C1060g {
        ...
        public void mo1390a(boolean isBTConnected) {
            this.f7663a.m8893c();
            ((Chronometer) this.f7663a.f7697l.findViewById(C0965R.id.tip_phone_start_timing)).stop();
            int curModuleType = C1328h.m4757a().m4768d();
            if (isBTConnected && 4002 != curModuleType && this.f7663a.f7689P) {
                this.f7663a.m8870i();
                this.f7663a.f7693c.sendEmptyMessageDelayed(C1253f.gT, BNOffScreenParams.MIN_ENTER_INTERVAL);
            }
        ...
        /* renamed from: a */
        public void mo1389a() {
            Chronometer startTimeView = (Chronometer) this.f7663a.f7697l.findViewById(C0965R.id.tip_phone_start_timing);
    ...
    private class C2341a extends C0936j {
        /* renamed from: a */
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case C1253f.dB /*219*/:
                    ...
                    if (bitmap == null) {
                        this.f7666a.f7704s.setImageResource(C0965R.drawable.music_ic_albumcover);
                        return;
                    } else {
                ...
                case C1253f.dZ /*310*/:
                    ...
                    if (C1818h.m6730b().m6829q()) {
                        if (!C1328h.m4757a().m4763a(curFragmentType)) {
                            this.f7666a.m8859c(this.f7666a.m8882o());
                            this.f7666a.f7694i = 0;
                            return;
                        }
                        return;
                    } else if (C1328h.m4757a().m4765b(curFragmentType)) {
                        removeMessages(C1253f.dZ);
                        if (this.f7666a.f7694i = this.f7666a.f7694i + 1 < 25) {
                            sendEmptyMessageDelayed(C1253f.dZ, 500);
                            return;
                        } else {
                            this.f7666a.f7694i = 0;
                            return;
    ...
    /* renamed from: a */
    public void m8888a(C1319h viewWrapper) {
        this.f7697l = viewWrapper.m4695g();
        f7671f = C1157a.m3876a().getResources().getDimensionPixelSize(C0965R.dimen.tips_progress_default_size);
        this.f7698m = (LinearLayout) this.f7697l.findViewById(C0965R.id.tips_music);
        this.f7699n = (LinearLayout) this.f7697l.findViewById(C0965R.id.tips_wechat);
        this.f7700o = (LinearLayout) this.f7697l.findViewById(C0965R.id.tips_navi);
        this.f7699n.setOnClickListener(null);
        this.f7709x = (ImageView) this.f7699n.findViewById(C0965R.id.tips_wechat_button);
        this.f7709x.setOnClickListener(new C23398(this));
        this.f7710y = (ImageView) this.f7699n.findViewById(C0965R.id.tips_wechat_close);
        this.f7710y.setOnClickListener(new C23409(this));
        this.f7711z = (TextView) this.f7699n.findViewById(C0965R.id.tips_wechat_title);
        this.f7674A = (TextView) this.f7699n.findViewById(C0965R.id.tips_wechat_desc);
        this.f7704s = (ImageView) this.f7698m.findViewById(C0965R.id.iv_song_image);
        this.f7705t = (MarqueeTextView) this.f7698m.findViewById(C0965R.id.music_name);
        this.f7706u = (MarqueeTextView) this.f7698m.findViewById(C0965R.id.music_singer);
        ImageButton ibCancleTips = (ImageButton) this.f7698m.findViewById(C0965R.id.ib_cancle_tips);
        ibCancleTips.requestFocusFromTouch();
        ibCancleTips.setOnClickListener(this);
        this.f7707v = (MarqueeTextView) this.f7700o.findViewById(C0965R.id.tv_front_info);
        this.f7708w = (MarqueeTextView) this.f7700o.findViewById(C0965R.id.tv_next_road_info);
        this.f7675B = (ImageView) this.f7700o.findViewById(C0965R.id.iv_turn_icon);
        ImageButton ibCancleTipsNavi = (ImageButton) this.f7700o.findViewById(C0965R.id.ib_cancle_tips);
        ibCancleTipsNavi.requestFocusFromTouch();
        ibCancleTipsNavi.setOnClickListener(this);
        this.f7702q = (ProgressBar) LayoutInflater.from(C1157a.m3876a()).inflate(C0965R.layout.carlife_progress_bar, null);
    }

    /* renamed from: b */
    public void m8892b() {
        if (this.f7697l != null) {
            this.f7681H = this.f7697l.findViewById(C0965R.id.tips_phone_incoming);
            this.f7682I = this.f7697l.findViewById(C0965R.id.tips_phone_end);
            this.f7685L = (ImageButton) this.f7697l.findViewById(C0965R.id.tip_phone_btn_answer);
            ...
            this.f7686M = (ImageButton) this.f7697l.findViewById(C0965R.id.tip_phone_btn_break);
            this.f7686M.setOnClickListener(new OnClickListener(this) {
                ...
                public void onClick(View v) {
                    this.f7651a.m8893c();
                    this.f7651a.f7688O.m7106a(C1157a.m3876a());
            ...
            this.f7687N = (ImageButton) this.f7697l.findViewById(C0965R.id.tip_phone_btn_close);
    ...
    public void m8894d() {
        if (this.f7682I != null) {
            ...
            this.f7697l.findViewById(C0965R.id.tip_phone_start_timing).setVisibility(8);
            if (m8873j()) {
                C1440d.m5251a().m5255b(null);
            }
        }
    ...
    private void m8869h() {
        ...
        ((TextView) this.f7697l.findViewById(C0965R.id.tip_phone_name)).setText(this.f7688O.m7102a());
        if (this.f7683J == null) {
    ...
    private void m8870i() {
        ...
        this.f7697l.findViewById(C0965R.id.tip_phone_start_timing).setVisibility(this.f7690Q ? 0 : 8);
        if (this.f7684K == null) {
    ...
    /* renamed from: l */
    private void m8877l() {
        this.f7693c.removeMessages(C1253f.gR);
        if (this.f7700o != null) {
            this.f7700o.setVisibility(8);
            this.f7696k = true;
            this.f7693c.sendEmptyMessageDelayed(C1253f.gU, BNOffScreenParams.MIN_ENTER_INTERVAL);
        }
        if (m8873j()) {
            C1440d.m5251a().m5255b(null);
        }
    ...
    private void m8850a(int xPos, String content) {
        if (this.f7701p != null) {
            ...
            if (!TextUtils.isEmpty(content)) {
                ((TextView) this.f7701p.findViewById(C0965R.id.tv_process_content)).setText(content);
            }
        }
    }
    ...
    private void m8849a(int xPos, int resId) {
        if (this.f7701p != null) {
            this.f7701p.setVisibility(0);
            if (resId > 0) {
                ((TextView) this.f7701p.findViewById(C0965R.id.tv_process_content)).setText(resId);
            }
        }
    }
    ...
    private void m8856b(int xPos) {
        if (!m8873j()) {
            ...
            this.f7693c.sendEmptyMessageDelayed(C1253f.gR, BNOffScreenParams.MIN_ENTER_INTERVAL);
            if (this.f7679F == null) {
                this.f7679F = new C1443g(this.f7698m, 0);
                this.f7679F.m5300d(this.f7700o.findViewById(C0965R.id.ib_cancle_tips));
            }
    ...
    private void m8859c(int xPos) {
        C1260i.m4435b("ouyang", "----------xPos:" + xPos);
        if (!m8873j() && this.f7680G) {
            ...
            if (this.f7703r != null && !TextUtils.isEmpty(this.f7703r.f5910b)) {
                ...
                if (this.f7678E == null) {
                    ...
                    this.f7678E.m5300d(this.f7698m.findViewById(C0965R.id.ib_cancle_tips));
                }
    ...
    public void m8889a(C2381a showType) {
        ...
        switch (showType) {
            case Play:
                this.f7709x.setImageResource(C0965R.mipmap.com_ic_tips_play);
                return;
            case Navi:
                this.f7709x.setImageResource(C0965R.mipmap.com_ic_tips_navigation);
                return;
            case Reply:
                this.f7709x.setImageResource(C0965R.mipmap.com_ic_tips_replay);
                return;
            default:
                this.f7709x.setImageResource(C0965R.mipmap.com_ic_tips_play);
                return;
    ...
    private int m8882o() {
        int curFragmentType = C1328h.m4757a().getCurrentFragmentType();
        if (C1328h.m4757a().m4765b(curFragmentType) || C1328h.m4757a().isCarlifeFragment(curFragmentType) || curFragmentType == 17) {
            return 0;
        }
    ...
    public void onSimpleGuideInfoUpdate(Message msg) {
        ...
        if (simpleGuideData != null) {
            ...
            if (!(remainDist <= 0 && RoutePlanParams.TURN_TYPE_ID_END.equals(this.f7695j) && TextUtils.isEmpty(nextRoad)) && BNavigator.getInstance().isNaviBegin()) {
                ...
                if (C1328h.m4757a().isCarlifeFragment(C1328h.m4757a().getCurrentFragmentType()) && !this.f7696k) {
                    m8856b(m8882o());
                    return;
                }
                return;
    ...
    public void onVectorExpandMapShow(Message msg) {
        if (C1328h.m4757a().getCurrentFragmentType() == 113) {
            m8879m();
        }
    }
