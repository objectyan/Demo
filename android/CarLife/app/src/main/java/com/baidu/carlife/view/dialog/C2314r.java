...
public class C2314r extends BaseDialog implements OnClickListener {
    ...
    public C2314r(Context context, EditText editText) {
        super(context, null, C0965R.style.SoftInputDialog);
        this.f7594q = 0;
        this.f7598u = new C23123(this);
        this.f7599v = new C23134(this);
        this.f7588k = editText;
        this.f7596s = this.c.getResources().getDimensionPixelSize(C0965R.dimen.softinput_key_size);
        this.f7597t = this.c.getResources().getDimensionPixelSize(C0965R.dimen.softinput_key_small);
    }

    /* renamed from: a */
    protected View mo1528a() {
        View contentView = LayoutInflater.from(this.c).inflate(C0965R.layout.layout_soft_input, null);
    ...
    protected void mo1529b() {
        ...
        this.f7587j = this.c.getResources().getStringArray(C0965R.array.soft_input_num);
        this.f7589l = (HorizontalScrollView) findViewById(C0965R.id.hsv_key);
        this.f7590m = (LinearLayout) findViewById(C0965R.id.layout_key);
        this.f7593p = (ImageButton) findViewById(C0965R.id.key_space);
        this.f7593p.setOnClickListener(this);
        this.f7592o = (ImageButton) findViewById(C0965R.id.key_delete);
        this.f7592o.setOnClickListener(this);
        this.f7591n = (Button) findViewById(C0965R.id.btn_mode);
        this.f7591n.setOnClickListener(this);
        this.f7595r = (TextView) findViewById(C0965R.id.cover_view);
        this.f7591n.setOnFocusChangeListener(new C23102(this));
        findViewById(C0965R.id.btn_hide).setOnClickListener(this);
        m8790a(this.f7594q);
        setCanceledOnTouchOutside(true);
    }

    public int getCustomHeight() {
        return this.c.getResources().getDimensionPixelSize(C0965R.dimen.softinput_keyboard_height);
    }
    ...
    private void m8792a(String[] keys) {
        ...
        for (CharSequence text : keys) {
            Button temp = (Button) View.inflate(this.c, C0965R.layout.softinput_item, null);
    ...
    public void onClick(View v) {
        int viewId = v.getId();
        if (viewId == C0965R.id.btn_mode) {
            this.f7594q = this.f7594q == 0 ? 1 : 0;
            m8790a(this.f7594q);
            mo1530f();
        } else if (viewId == C0965R.id.btn_hide) {
            mo1526d();
        } else if (this.f7588k == null) {
        } else {
            if (viewId == C0965R.id.key_space) {
                m8793b(" ");
            } else if (viewId == C0965R.id.key_delete) {
                m8800l();
    ...
    /* renamed from: f */
    public void mo1530f() {
        C1443g mFocusViewGroup = new C1443g(findViewById(C0965R.id.temp), 11, true);
    ...
    public void mo1630i() {
        if (this.f7595r.getVisibility() == 0) {
            C1261k.m4452a((int) C1253f.hJ);
            C1261k.m4454a((int) C1253f.hJ, 50, 100);
        }
    }
