...
public class C1829n {
                ...
                if (C1829n.f5661a.size() < 2) {
                    ...
                    if (C1829n.f5661a.size() <= 1) {
                        ...
                        if (PlayList != null && PlayList.length >= 1) {
                            ...
                            C1260i.m4435b("PlayPCM", "Start play ID:" + this.f5654c.f5678r);
                            ...
                            try {
                                ...
                                if (this.f5654c.f5677q == null) {
                                    ...
                                    C1260i.m4435b("PlayPCM", "Play song:" + this.f5654c.f5678r + " end!!!");
                                }
    ...
    private void m6887a(int arg1, int arg2, String songId) {
        if (songId.equals(this.f5678r)) {
            C1260i.m4435b("PlayPCM", "PPlayExit arg1=" + arg1 + ", error: arg2=" + arg2 + ", songId:" + songId);
            this.f5677q.f5659e = 0;
            this.f5670j = true;
    ...
    L_0x0011:
        ...
        com.baidu.carlife.core.C1260i.m4435b(r4, r6);	 Catch:{ all -> 0x0073 }
        r4 = 0;
        r6 = 0;
    ...
    L_0x004e:
        ...
        r5 = r5.append(r2);
        r5 = r5.toString();
        com.baidu.carlife.core.C1260i.m4445e(r4, r5);
        r4 = -8;
        ...
        synchronized (this.f5676p) {
            ...
            if (hm == null || hm.size() < 2 || hm.get(ParamKey.KEY_MSG_ERRORS) != null) {
                ...
                if (hm == null || hm.size() < 2 || hm.get(ParamKey.KEY_MSG_ERRORS) != null) {
                    ...
                    C1260i.m4443d(str2, append.append(str).toString());
                    this.f5670j = true;
