...
public class C1042n {
    ...
    public static class C1083a {
        ...
        /* renamed from: d */
        private C1034m f2841d;
        /* renamed from: e */
        private C1034m f2842e;

        C1083a(Message msg, String info, C1034m state, C1034m orgState) {
            m3637a(msg, info, state, orgState);
        }

        /* renamed from: a */
        public void m3637a(Message msg, String info, C1034m state, C1034m orgState) {
        ...
        /* renamed from: d */
        public C1034m m3640d() {
            return this.f2841d;
        }

        /* renamed from: e */
        public C1034m m3641e() {
            return this.f2842e;
        }
    ...
    private static class C1084b {
        ...
        /* renamed from: a */
        void m3644a(Message msg, String messageInfo, C1034m state, C1034m orgState) {
            this.f2847e++;
    ...
    private static class C1088c extends Handler {
        ...
        /* renamed from: l */
        private C1042n f2865l;
        /* renamed from: m */
        private HashMap<C1034m, C1087c> f2866m;
        /* renamed from: n */
        private C1034m f2867n;
        /* renamed from: o */
        private C1034m f2868o;
        /* renamed from: p */
        private ArrayList<Message> f2869p;

        /* compiled from: StateMachine */
        /* renamed from: com.baidu.carlife.bluetooth.n$c$a */
        private class C1085a extends C1034m {
            /* renamed from: a */
        ...
        private class C1086b extends C1034m {
            /* renamed from: a */
        ...
        public final void handleMessage(Message msg) {
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "handleMessage: E msg.what=" + msg.what);
            }
            this.f2856c = msg;
            if (this.f2858e) {
                m3656a(msg);
            ...
            m3654a();
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "handleMessage: X");
            }
        }

        /* renamed from: a */
        private void m3654a() {
            C1034m destState = null;
            while (this.f2868o != null) {
                if (this.f2855a) {
                    Log.d(C1042n.f2655a, "handleMessage: new destination call exit");
                }
        ...
        private final void m3674c() {
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "completeConstruction: E");
            }
            int maxDepth = 0;
            ...
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "completeConstruction: maxDepth=" + maxDepth);
            }
            ...
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "completeConstruction: X");
            }
        }
        ...
        private final void m3656a(Message msg) {
            ...
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "processMsg: " + curStateInfo.f2850a.mo1381c());
            }
        ...
        private final void m3658a(C1087c commonStateInfo) {
            while (this.f2860g >= 0 && this.f2859f[this.f2860g] != commonStateInfo) {
                C1034m curState = this.f2859f[this.f2860g].f2850a;
                if (this.f2855a) {
                    Log.d(C1042n.f2655a, "invokeExitMethods: " + curState.mo1381c());
                }
                curState.mo1380b();
        ...
        private final void m3655a(int stateStackEnteringIndex) {
            for (int i = stateStackEnteringIndex; i <= this.f2860g; i++) {
                if (this.f2855a) {
                    Log.d(C1042n.f2655a, "invokeEnterMethods: " + this.f2859f[i].f2850a.mo1381c());
                }
        ...
        private final void m3677d() {
            for (int i = this.f2869p.size() - 1; i >= 0; i--) {
                ...
                if (this.f2855a) {
                    Log.d(C1042n.f2655a, "moveDeferredMessageAtFrontOfQueue; what=" + curMsg.what);
                }
        ...
        private final int m3678e() {
            ...
            for (int i = this.f2862i - 1; i >= 0; i--) {
                if (this.f2855a) {
                    Log.d(C1042n.f2655a, "moveTempStackToStateStack: i=" + i + ",j=" + j);
                }
            ...
            this.f2860g = j - 1;
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "moveTempStackToStateStack: X mStateStackTop=" + this.f2860g + ",startingIndex=" + startingIndex + ",Top=" + this.f2859f[this.f2860g].f2850a.mo1381c());
            }
            return startingIndex;
        }

        /* renamed from: a */
        private final C1087c m3650a(C1034m destState) {
            this.f2862i = 0;
            ...
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "setupTempStateStackWithStatesToEnter: X mTempStateStackCount=" + this.f2862i + ",curStateInfo: " + curStateInfo);
            }
            return curStateInfo;
        }
        ...
        private final void m3681f() {
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "setupInitialStateStack: E mInitialState=" + this.f2867n.mo1381c());
            }
        ...
        /* renamed from: h */
        private final C1033k m3684h() {
            return this.f2859f[this.f2860g].f2850a;
        }

        /* renamed from: a */
        private final C1087c m3651a(C1034m state, C1034m parent) {
            if (this.f2855a) {
                String str;
                String str2 = C1042n.f2655a;
            ...
            if (stateInfo.f2851b == null || stateInfo.f2851b == parentStateInfo) {
                ...
                if (this.f2855a) {
                    Log.d(C1042n.f2655a, "addStateInternal: X stateInfo: " + stateInfo);
                }
                return stateInfo;
            }
        ...
        private C1088c(Looper looper, C1042n sm) {
            super(looper);
            this.f2855a = false;
        ...
        /* renamed from: b */
        private final void m3670b(C1034m initialState) {
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "setInitialState: initialState=" + initialState.mo1381c());
            }
            this.f2867n = initialState;
        }

        /* renamed from: a */
        private final void m3657a(C1033k destState) {
            this.f2868o = (C1034m) destState;
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "transitionTo: destState=" + this.f2868o.mo1381c());
            }
        }
        ...
        private final void m3669b(Message msg) {
            if (this.f2855a) {
                Log.d(C1042n.f2655a, "deferMessage: msg=" + msg.what);
            }
    ...
    protected C1042n(String name) {
        this.f2660d = new HandlerThread(name);
        this.f2660d.start();
        m3316a(name, this.f2660d.getLooper());
    }

    protected C1042n(String name, Looper looper) {
        m3316a(name, looper);
    }

    /* renamed from: a */
    protected final void m3330a(C1034m state, C1034m parent) {
    ...
    /* renamed from: s */
    protected final C1033k m3350s() {
        return this.f2659c.m3684h();
    }

    /* renamed from: a */
    protected final void m3329a(C1034m state) {
        this.f2659c.m3651a(state, null);
    }

    /* renamed from: b */
    protected final void m3336b(C1034m initialState) {
        this.f2659c.m3670b(initialState);
    }

    /* renamed from: a */
    protected final void m3328a(C1033k destState) {
