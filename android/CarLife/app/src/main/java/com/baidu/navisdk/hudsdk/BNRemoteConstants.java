...
public class BNRemoteConstants {
    ...
    public static final int[] MAP_PORTS_POOL = new int[]{9293, 54326, 54327, 54328, 54329, 54330};
    public static final String MODULE_TAG = "BNRemote";
    public static final int[] NAVI_PORTS_POOL = new int[]{9394, 54321, 54322, 54323, 54324, 54325};
