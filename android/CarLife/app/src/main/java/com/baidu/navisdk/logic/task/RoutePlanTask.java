  ...
  public static Callable<CommandResult> newTask(ReqData paramReqData)
  {
    new Callable()
    {
      public CommandResult call()
        throws Exception
      {
        CommandResult localCommandResult = RoutePlanTask.doTask(this.val$reqdata, this.val$reqdata.mCmd);
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/navisdk/logic/task/RoutePlanTask.class
