...
public class C2170a {
    ...
    private static Bitmap m8214a(Context context) {
        ...
        return BitmapFactory.decodeStream(context.getResources().openRawResource(C0965R.drawable.music_ic_albumcover), null, opts);
    }

    /* renamed from: a */
    public static boolean m8217a() {
        if (C1157a.m3876a().getApplicationContext().getResources().getConfiguration().locale.getLanguage().endsWith("zh")) {
            return true;
        }
        return false;
    }
