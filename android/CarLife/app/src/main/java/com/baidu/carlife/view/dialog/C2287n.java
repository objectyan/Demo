...
public class C2287n extends C2286m {
    ...
    public class C2303a extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView textView;
            if (convertView == null) {
                convertView = LayoutInflater.from(this.f7556a.getContext()).inflate(C0965R.layout.tv_iv_list_item, null);
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(C0965R.layout.navi_dialog_listview, null);
    }

    protected int getCustomWidth() {
        return this.c.getResources().getDimensionPixelSize(C0965R.dimen.common_dialog_navi);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7489e = (ListView) findViewById(C0965R.id.list_view);
    }
