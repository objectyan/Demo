...
public class C1751a implements C1750o {
    ...
    public void mo1633a(C2610a in) {
        ...
        if (flag == -1 || flag != 12) {
            C1260i.m4445e(f5294c, "-- get data length failed");
            in.f8633a = null;
            in.f8634b = -1;
            C2858a.m10817b();
            return;
        ...
        if (dataLength != this.f5300i.length) {
            C1260i.m4445e(f5294c, "---- get data error!!!-len:" + dataLength);
            in.f8633a = null;
            in.f8634b = -1;
            C2858a.m10817b();
        } else if (C1663a.m5979a().m6033e(this.f5300i, dataLength) < 0) {
            C1260i.m4445e(f5294c, "-- get data failed---");
            in.f8633a = null;
            in.f8634b = -1;
            C2858a.m10817b();
        } else {
            C1260i.m4435b(f5294c, "- get data OK!!-dataLength:" + dataLength);
            if (C1663a.m5979a().m6001V()) {
                if (C1663a.m5979a().m6040g(this.f5300i, dataLength) == null) {
                    C1260i.m4445e(f5294c, "decrypt failed!");
                    in.f8633a = null;
                    in.f8634b = -1;
                    C2858a.m10817b();
                }
