...
public class C2291j extends BaseDialog implements OnClickListener {
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(C0965R.layout.dialog_guide_for_home, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7508j = (RelativeLayout) findViewById(C0965R.id.wrapper_layout_rlt);
        this.f7509k = (RelativeLayout) findViewById(C0965R.id.navi_layout_rlt);
        this.f7510l = (RelativeLayout) findViewById(C0965R.id.radio_layout_rlt);
        this.f7511m = (ImageView) findViewById(C0965R.id.bottom_next_btn);
        this.f7512n = (ImageView) findViewById(C0965R.id.bottom_confirm_btn);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case C0965R.id.wrapper_layout_rlt:
            case C0965R.id.bottom_next_btn:
            case C0965R.id.bottom_confirm_btn:
                m8710j();
                return;
            default:
                return;
    ...
    public void mo1530f() {
        if (this.f7511m != null && this.f7512n != null) {
            if (this.f7507i == null) {
                this.f7507i = new C1443g(findViewById(C0965R.id.wrapper_layout_rlt), 12);
    ...
    private void m8711k() {
        this.b.removeCallbacks(this.f7513o);
        C2186p.m8304a().m8323c(C1253f.ih, false);
        mo1526d();
    }
}
