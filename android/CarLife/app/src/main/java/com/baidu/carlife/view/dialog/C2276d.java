...
public class C2276d extends BaseDialog {
    ...
    protected View mo1528a() {
        View contentView = LayoutInflater.from(this.c).inflate(C0965R.layout.common_dialog_left_list, null);
        contentView.setOnClickListener(new C22731(this));
        return contentView;
    }

    protected int getCustomWidth() {
        return this.c.getResources().getDimensionPixelSize(C0965R.dimen.common_menu_left_width);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7447e = (ListView) findViewById(C0965R.id.lv_menu);
    ...
    public void setSelected(int selectedPos) {
        if (this.f7448f instanceof C0984g) {
            ((C0984g) this.f7448f).m3190a(selectedPos);
    ...
    public boolean mo1802a(String strCommand) {
        String[] items = StyleManager.getStringArray(C0965R.array.person_ctrl_menu_item);
        int nIndex = -1;
        ...
        C1260i.m4435b("BaseDialog", "person dialog onVoiceCommand: " + nIndex);
        if (nIndex != -1) {
            nIndex++;
        } else {
            C1260i.m4435b("BaseDialog", "check login command: " + strCommand);
            if (strCommand.contains("登录帐号")) {
                nIndex = 0;
                C1260i.m4435b("BaseDialog", "person dialog item index: " + 0);
            }
        }
        if (nIndex != -1) {
    ...
    public boolean m8612a(String strCommand, String strIntent) {
        ...
        C1260i.m4435b("BaseDialog", "List click index: " + nIndex);
        if (nIndex == -1) {
            return false;
        }
        onItemClickListener.onItemClick(this.f7447e, null, nIndex, 0);
