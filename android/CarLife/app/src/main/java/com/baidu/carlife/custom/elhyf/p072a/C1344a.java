...
public class C1344a extends BaseDialog {
    ...
    protected View mo1528a() {
        return View.inflate(getContext(), C0965R.layout.yf_common_progress_dialog, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f3942e = (TextView) findViewById(C0965R.id.dialog_title);
        this.f3943f = (ProgressBar) findViewById(C0965R.id.progress_bar);
