...
public final class Util {
    ...
    public static boolean hasOtherServiceRuninMyPid(Context context, String str) {
        for (RunningServiceInfo runningServiceInfo : ((ActivityManager) context.getApplicationContext().getSystemService(BusinessActivityManager.AUDIO_DIR)).getRunningServices(100)) {
