...
public class a
{
  ...
  {
    boolean bool = false;
    if ((f.jx == f.a.W) || (f.jx == f.a.Y) || (f.jx == f.a.X) || (f.jx == f.a.Z)) {
      bool = true;
    }
    return bool;
  }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/com/baidu/carlife/custom/a.class
