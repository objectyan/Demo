...
public class C1772k {
    ...
    public void m6487b() {
        ...
        if (this.f5390c != null) {
            ...
            C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus moduleId:" + this.f5390c.m7394a() + " statusId" + this.f5390c.m7396b());
        }
        if (this.f5391d != null) {
            ...
            C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus moduleId:" + this.f5391d.m7394a() + " statusId" + this.f5391d.m7396b());
        }
        if (this.f5392e != null) {
            builder.addModuleStatus(m6481a(this.f5392e));
            C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus moduleId:" + this.f5392e.m7394a() + " statusId" + this.f5392e.m7396b());
        }
        if (this.f5393f != null) {
            builder.addModuleStatus(m6481a(this.f5393f));
            C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus moduleId:" + this.f5393f.m7394a() + " statusId" + this.f5393f.m7396b());
        }
        if (this.f5394g != null) {
            builder.addModuleStatus(m6481a(this.f5394g));
            C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus moduleId:" + this.f5394g.m7394a() + " statusId" + this.f5394g.m7396b());
        }
        if (C1757d.m6389a().m6393d().getMajorVersion() >= 2) {
            if (this.f5395h != null) {
                ...
                C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus moduleId:" + this.f5395h.m7394a() + " statusId" + this.f5395h.m7396b());
            }
            if (this.f5396i != null) {
                ...
                C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus moduleId:" + this.f5396i.m7394a() + " statusId" + this.f5396i.m7396b());
            }
        }
        builder.setCnt(builder.getModuleStatusCount());
        CarlifeModuleStatusList carlifeModuleStatusList = builder.build();
        C1260i.m4435b(f5388a, "sendCarlifeModuleListStatus carlifeModuleStatusList.size : " + carlifeModuleStatusList.getCnt());
    ...
    private void m6483b(C1928h module) {
        if (module != null) {
            C1260i.m4435b(f5388a, "--sendCarlifeModuleStatus--moduleId:" + module.m7394a() + "--statusId:" + module.m7396b());
            Builder builder = CarlifeModuleStatusList.newBuilder();
    ...
    public void m6484a(int statusId) {
        if (C1253f.jx.m4403a().length() >= 4) {
            String channel = C1253f.jx.m4403a().substring(0, 4);
            if ("2006".equals(channel) || "2019".equals(channel) || "2020".equals(channel) || m6486a(C1253f.jx.m4403a())) {
                ...
                if (carlifeModuleStatusList != null && carlifeModuleStatusList.getModuleStatusCount() > 0) {
                    ...
                    if (C1663a.m5979a().m6001V() && sendLen > 0) {
                        ...
                        if (sendData == null) {
                            C1260i.m4445e(f5388a, "encrypt failed!");
                            return;
                        }
                        sendLen = sendData.length;
                    }
                    C1857p command = new C1857p();
                    command.m7055c(C1253f.bC);
                    command.m7054c();
    ...
    public boolean m6486a(String strChannel) {
        ...
        for (String equals : strBoschChannelArray) {
            if (equals.equals(strChannel)) {
                C1260i.m4435b(f5388a, "is boshi channel : " + strChannel);
                return true;
            }
        }
        return false;
