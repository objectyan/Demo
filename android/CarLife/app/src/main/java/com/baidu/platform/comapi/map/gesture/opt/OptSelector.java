  ...
  implements MoveDetector.Listener
{
  ...
  private void switchOverlook(MoveDetector paramMoveDetector)
  {
    ...
    {
      this.opt.finish(paramMoveDetector, null);
  ...
  public boolean onMoveEnd(MoveDetector paramMoveDetector)
  {
    ...
    this.tracker.finish();
    this.opt.finish(paramMoveDetector, localPair);
    return true;
  }
}


/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/platform/comapi/map/gesture/opt/OptSelector.class
