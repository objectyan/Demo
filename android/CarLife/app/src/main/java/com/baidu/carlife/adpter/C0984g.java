...
public class C0984g extends BaseAdapter {
    /* renamed from: a */
    ...
    public C0984g(Activity activity) {
        this.f2506c = activity;
        this.f2505b = StyleManager.getStringArray(C0965R.array.person_ctrl_menu_item);
    ...
    public View getView(int position, View convertView, ViewGroup root) {
        TextView textView;
        if (position == 0) {
            convertView = this.f2507d.inflate(C0965R.layout.person_control_panel_item_login, root, false);
            textView = (TextView) convertView.findViewById(C0965R.id.tv_person_login);
            SimpleDraweeView person = (SimpleDraweeView) convertView.findViewById(C0965R.id.sdv_person);
            person.setAlpha(m3193a() ? 1.0f : 0.4f);
            m3189a(person);
            textView.setText(this.f2508e);
            textView.setEnabled(m3193a());
        } else {
            convertView = this.f2507d.inflate(C0965R.layout.person_control_panel_list_item, root, false);
            textView = (TextView) convertView.findViewById(C0965R.id.person_control_panel_list_item_tv);
            textView.setText(m3194b(position));
            View lineView = convertView.findViewById(C0965R.id.control_panel_list_item_line);
            View redPointView = convertView.findViewById(C0965R.id.red_point);
