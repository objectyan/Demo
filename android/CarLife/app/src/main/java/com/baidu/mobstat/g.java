...
public final class g
{
  ...
  private boolean a(String paramString)
  {
    ...
    //   2: aconst_null
    //   3: astore 4
    //   5: getstatic 343	android/os/Build$VERSION:SDK_INT	I
    //   8: bipush 24
    //   10: if_icmplt +83 -> 93
    //   13: iconst_0
    //   14: istore_2
    //   15: aload_0
    //   16: getfield 72	com/baidu/mobstat/g:b	Landroid/content/Context;
    //   19: ldc_w 345
    //   22: iload_2
    //   23: invokevirtual 349	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   26: astore 5
    //   28: aload 5
    //   30: astore 4
    //   32: aload 5
    //   34: aload_1
    //   35: invokevirtual 277	java/lang/String:getBytes	()[B
    //   38: invokevirtual 353	java/io/FileOutputStream:write	([B)V
    //   41: aload 5
    //   43: astore 4
    //   45: aload 5
    //   47: invokevirtual 356	java/io/FileOutputStream:flush	()V
    //   50: aload 5
    //   52: ifnull +8 -> 60
    //   55: aload 5
    //   57: invokevirtual 357	java/io/FileOutputStream:close	()V
    //   60: iload_2
    //   61: ifne +30 -> 91
    //   64: new 359	java/io/File
    //   67: dup
    //   68: aload_0
    //   69: getfield 72	com/baidu/mobstat/g:b	Landroid/content/Context;
    //   72: invokevirtual 363	android/content/Context:getFilesDir	()Ljava/io/File;
    //   75: ldc_w 345
    //   78: invokespecial 366	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   81: invokevirtual 369	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   84: sipush 436
    //   87: invokestatic 374	com/baidu/mobstat/k:a	(Ljava/lang/String;I)Z
    //   90: istore_3
    //   91: iload_3
    //   92: ireturn
    //   93: iconst_1
    ...
    //   98: astore_1
    //   99: aload_1
    //   100: invokestatic 104	com/baidu/mobstat/g:b	(Ljava/lang/Throwable;)V
    //   103: goto -43 -> 60
    //   106: astore 4
    //   108: aconst_null
    //   109: astore_1
    //   110: aload 4
    //   112: invokestatic 104	com/baidu/mobstat/g:b	(Ljava/lang/Throwable;)V
    //   115: aload_1
    //   116: ifnull +7 -> 123
    //   119: aload_1
    //   120: invokevirtual 357	java/io/FileOutputStream:close	()V
    //   123: iconst_0
    //   124: ireturn
    //   125: astore_1
    //   126: aload_1
    //   127: invokestatic 104	com/baidu/mobstat/g:b	(Ljava/lang/Throwable;)V
    //   130: goto -7 -> 123
    //   133: astore_1
    //   134: aload 4
    //   136: ifnull +8 -> 144
    //   139: aload 4
    //   141: invokevirtual 357	java/io/FileOutputStream:close	()V
    //   144: aload_1
    //   145: athrow
    //   146: astore 4
    //   148: aload 4
    //   150: invokestatic 104	com/baidu/mobstat/g:b	(Ljava/lang/Throwable;)V
    //   153: goto -9 -> 144
    //   156: astore 5
    //   158: aload_1
    //   159: astore 4
              ...
              for (i = 1;; i = j)
              {
                ...
                for (;;)
                {
                  ...
                  for (localObject1 = e(((j)localObject3).a());; localObject1 = null)
                  {
                    ...
                    if ((bool) && (!TextUtils.isEmpty(((j)localObject3).b)))
                    {
  ...
  private j d(String paramString)
  {
    ...
    //   0: iconst_0
    //   1: istore_3
    //   2: getstatic 343	android/os/Build$VERSION:SDK_INT	I
    //   5: bipush 23
    //   7: if_icmpge +18 -> 25
    //   10: iconst_1
    //   11: istore_2
    ...
    //   30: ldc 118
    //   32: astore 6
    //   34: new 359	java/io/File
    //   37: dup
    //   38: invokestatic 513	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   41: ldc_w 624
    //   44: invokespecial 366	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   47: astore 4
    //   49: aload 4
    //   51: invokevirtual 440	java/io/File:exists	()Z
    //   54: ifeq +98 -> 152
    //   57: new 626	java/io/BufferedReader
    //   60: dup
    //   61: new 87	java/io/FileReader
    //   64: dup
    //   65: aload 4
    //   67: invokespecial 90	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   70: invokespecial 629	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   73: astore 4
    ...
    //   82: astore 5
    //   84: aload 4
    //   86: invokevirtual 632	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   89: astore 7
    //   91: aload 7
    //   93: ifnull +79 -> 172
    //   96: aload 5
    ...
    //   132: dup
    //   133: aconst_null
    //   134: invokespecial 479	com/baidu/mobstat/j:<init>	(Lcom/baidu/mobstat/h;)V
    //   137: astore_1
    //   138: aload_1
    //   139: aload 6
    //   141: putfield 494	com/baidu/mobstat/j:a	Ljava/lang/String;
    //   144: aload_1
    //   145: aload 5
    //   147: putfield 496	com/baidu/mobstat/j:b	Ljava/lang/String;
    //   150: aload_1
    //   151: areturn
    //   152: new 359	java/io/File
    //   155: dup
    //   156: invokestatic 513	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   159: ldc_w 524
    //   162: invokespecial 366	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   165: astore 4
    //   167: iconst_1
    //   168: istore_3
    //   169: goto -112 -> 57
    //   172: aload 4
    //   174: invokevirtual 635	java/io/BufferedReader:close	()V
    ...
    //   198: invokestatic 637	com/baidu/mobstat/a:b	(Ljava/lang/String;Ljava/lang/String;[B)[B
    //   201: invokespecial 36	java/lang/String:<init>	([B)V
    //   204: ldc_w 546
    //   207: invokevirtual 641	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   210: astore 5
    //   212: aload 5
    //   214: ifnull +146 -> 360
    //   217: aload 5
    ...
    //   262: aload 4
    //   264: aload_1
    //   265: invokestatic 526	com/baidu/mobstat/g:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   268: aload_1
    //   269: astore 6
    //   271: aload 4
    //   273: astore 5
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/mobstat/g.class
