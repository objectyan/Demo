...
public class C1249d implements C0689h {
    /* renamed from: a */
    ...
    /* renamed from: e */
    private static C1249d f3454e = null;
    /* renamed from: f */
    ...
    /* renamed from: a */
    public static C1249d m4331a() {
        if (f3454e == null) {
            synchronized (C1249d.class) {
                if (f3454e == null) {
                    f3454e = new C1249d();
                }
            }
    ...
    public void m4337a(Activity activity) {
        if (activity != null) {
            ...
            C1260i.m4429a(f3453d, "mDensity = " + this.f3457h);
            C1260i.m4429a(f3453d, "mWidthPixels = " + this.f3458i + ", mHeightPixels = " + this.f3459j);
            C1260i.m4429a(f3453d, "mWindowWidthPixels = " + this.f3460k + ", mWindowHeightPixels = " + this.f3461l);
            C1260i.m4429a(f3453d, "mStatusBarHeight = " + this.f3462m);
            C1260i.m4429a(f3453d, "mDensityDpi = " + this.f3463n);
        }
    }
    ...
    public void m4338a(Message message) {
        try {
            ...
            C1260i.m4435b(f3453d, "####### MSG_CMD_VIDEO_ENCODER_INIT:[ " + width + " : " + height + "]");
            if (((double) width) / ((double) height) >= 2.3d) {
                this.f3464o = C1248a.W_8_H_3;
                C1260i.m4435b(f3453d, "####### W_8_H_3 : " + this.f3464o);
                return;
            }
            this.f3464o = C1248a.W_16_H_9;
            C1260i.m4435b(f3453d, "####### W_16_H_9 : " + this.f3464o);
        } catch (InvalidProtocolBufferException e) {
            C1260i.m4445e(f3453d, "Get VIDEO_ENCODER_INIT_INFO Error");
            e.printStackTrace();
        }
    }
    ...
    public static boolean m4334m() {
        if (C1249d.m4331a().m4340b() == C1248a.W_16_H_9 || !C1190a.m4065a()) {
            return false;
        }
        String channel = C1253f.jx.m4403a();
        C1260i.m4435b(f3453d, "####### isVehicleSupportScreenAdapt: " + channel);
        if (channel != null) {
            if (C1253f.jx == C1252a.VEHICLE_CHANNEL_YUANFENG_ELH_ONLINE || C1253f.jx == C1252a.VEHICLE_CHANNEL_YUANFENG_ELH_PCBA || channel.equals("20882101") || channel.equals("20882100")) {
                C1260i.m4435b(f3453d, "####### isVehicleSupportScreenAdapt: true");
                return true;
            }
            ...
            while (iter.hasNext()) {
                ...
                if (value.equals(channel)) {
                    C1260i.m4435b(f3453d, "Server channel support ScreenAdapt: " + value);
                    return true;
                }
            }
        }
        C1260i.m4435b(f3453d, "####### isVehicleSupportScreenAdapt: not sport");
        return false;
    }

    /* renamed from: a */
    public static void m4332a(String strChannel) {
        C1260i.m4435b(f3453d, "####### addScreenAdaptChannel: " + strChannel);
