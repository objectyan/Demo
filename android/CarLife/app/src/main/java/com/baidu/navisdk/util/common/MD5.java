...
public class MD5 {
    ...
    /* renamed from: F */
    private long m15793F(long x, long y, long z) {
        return (x & y) | ((-1 ^ x) & z);
    }

    /* renamed from: G */
    private long m15794G(long x, long y, long z) {
        return (x & z) | ((-1 ^ z) & y);
    }

    /* renamed from: H */
    private long m15795H(long x, long y, long z) {
        return (x ^ y) ^ z;
    }

    /* renamed from: I */
    private long m15796I(long x, long y, long z) {
        return ((-1 ^ z) | x) ^ y;
    }

    private long FF(long a, long b, long c, long d, long x, long s, long ac) {
        a += (m15793F(b, c, d) + x) + ac;
        return ((long) ((((int) a) << ((int) s)) | (((int) a) >>> ((int) (32 - s))))) + b;
    }

    private long GG(long a, long b, long c, long d, long x, long s, long ac) {
        a += (m15794G(b, c, d) + x) + ac;
        return ((long) ((((int) a) << ((int) s)) | (((int) a) >>> ((int) (32 - s))))) + b;
    }

    private long HH(long a, long b, long c, long d, long x, long s, long ac) {
        a += (m15795H(b, c, d) + x) + ac;
        return ((long) ((((int) a) << ((int) s)) | (((int) a) >>> ((int) (32 - s))))) + b;
    }

    private long II(long a, long b, long c, long d, long x, long s, long ac) {
        a += (m15796I(b, c, d) + x) + ac;
        return ((long) ((((int) a) << ((int) s)) | (((int) a) >>> ((int) (32 - s))))) + b;
    }
