...
public final class LocationClientOption {
    ...
    public String addrType = GetPluginInfoDataStruct.KEY_DETAIL;
    ...
    public void setCoorType(String str) {
        ...
        if (toLowerCase.equals("gcj02") || toLowerCase.equals(BDLocation.BDLOCATION_GCJ02_TO_BD09) || toLowerCase.equals("bd09ll")) {
