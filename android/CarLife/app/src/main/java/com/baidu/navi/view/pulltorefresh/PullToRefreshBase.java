...
import com.baidu.navi.view.pulltorefresh.internal.FlipLoadingLayout;
import com.baidu.navi.view.pulltorefresh.internal.LoadingLayout;
import com.baidu.navi.view.pulltorefresh.internal.RotateLoadingLayout;
import com.baidu.navi.view.pulltorefresh.internal.Utils;
import com.baidu.navi.view.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /* renamed from: com.baidu.navi.view.pulltorefresh.PullToRefreshBase$1 */
    ...
    /* renamed from: com.baidu.navi.view.pulltorefresh.PullToRefreshBase$2 */
    class C40312 implements OnSmoothScrollFinishedListener {
        C40312() {
        }
    ...
    public void addView(View child, int index, LayoutParams params) {
        ...
        if (refreshableView instanceof ViewGroup) {
            ...
            LogUtil.m15791e(LOG_TAG, "Refreshable View is not a ViewGroup so can't addView");
        }
    }
    ...
    protected final void setHeaderScroll(int value) {
        ...
        ViewCompat.setLayerType(view, i);
        switch (getPullToRefreshScrollDirection()) {
            case HORIZONTAL:
                scrollTo(value, 0);
                return;
    ...
    private void addRefreshableView(Context context, T refreshableView) {
        ...
        refreshableView.setPadding(0, (int) this.mHeaderPadding, 0, (int) this.mFooterPadding);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0965R.C0963p.PullToRefresh);
        if (a.hasValue(6)) {
            this.mMode = Mode.mapIntToValue(a.getInteger(6, 0));
        }
        if (a.hasValue(14)) {
            this.mLoadingAnimationStyle = AnimationStyle.mapIntToValue(a.getInteger(14, 0));
        }
        if (a.hasValue(0)) {
            this.mHeaderPadding = a.getDimension(0, 0.0f);
        }
        if (a.hasValue(1)) {
            this.mFooterPadding = a.getDimension(1, 0.0f);
        }
        ...
        Drawable background;
        if (a.hasValue(2)) {
            background = a.getDrawable(2);
            if (background != null) {
                this.mRefreshableView.setBackgroundDrawable(background);
            }
        } else if (a.hasValue(18)) {
            Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
            background = a.getDrawable(18);
            if (background != null) {
                this.mRefreshableView.setBackgroundDrawable(background);
            }
        }
        if (a.hasValue(11)) {
            this.mOverScrollEnabled = a.getBoolean(11, true);
        }
        if (a.hasValue(15)) {
            this.mScrollingWhileRefreshingEnabled = a.getBoolean(15, false);
        }
    ...
    private final void smoothScrollToAndBack(int y) {
        smoothScrollTo(y, 200, 0, new C40312());
    }
}
