...
public class LoadMoreFooter extends RelativeLayout {
    ...
    private void m8457a(Context context) {
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0965R.layout.load_more_footer, this, true);
        this.f7185d = (TextView) findViewById(C0965R.id.btn_load_more);
        this.f7186e = findViewById(C0965R.id.view_loading);
        setVisibility(8);
    }
