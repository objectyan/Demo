...
public enum y
{
  ...
  public int a(ArrayList<Long> paramArrayList)
  {
    ...
    //   41: istore_3
    //   42: aload_0
    //   43: invokevirtual 129	com/baidu/mobstat/y:a	()Lcom/baidu/mobstat/x;
    //   46: astore 9
    //   48: iload 5
    //   50: istore_3
    //   51: aload 9
    ...
    //   57: astore 8
    //   59: aload 9
    //   61: invokevirtual 133	com/baidu/mobstat/x:a	()Z
    //   64: istore 6
    //   66: iload 6
    //   68: ifne +27 -> 95
    //   71: iload 4
    ...
    //   76: ifnull -47 -> 29
    //   79: aload 9
    //   81: invokevirtual 138	com/baidu/mobstat/x:close	()V
    //   84: iload 4
    //   86: istore_3
    //   87: goto -58 -> 29
    //   90: astore_1
    ...
    //   146: invokevirtual 160	com/baidu/mobstat/x:b	(J)Z
    //   149: istore 6
    //   151: iload 6
    //   153: ifne +77 -> 230
    //   156: iload_2
    ...
    //   160: ifnull -131 -> 29
    //   163: aload 9
    //   165: invokevirtual 138	com/baidu/mobstat/x:close	()V
    //   168: iload_2
    //   169: istore_3
    //   170: goto -141 -> 29
    //   173: aload 9
    //   175: ifnull +52 -> 227
    //   178: aload 9
    //   180: invokevirtual 138	com/baidu/mobstat/x:close	()V
    //   183: iload_2
    //   184: istore_3
    //   185: goto -156 -> 29
    //   188: astore_1
    ...
    //   191: astore 8
    //   193: aload_1
    //   194: invokestatic 143	com/baidu/mobstat/bd:b	(Ljava/lang/Throwable;)V
    //   197: iload_3
    //   198: istore_2
    //   199: aload 7
    //   201: ifnull -18 -> 183
    //   204: aload 7
    //   206: invokevirtual 138	com/baidu/mobstat/x:close	()V
    //   209: iload_3
    //   210: istore_2
    //   211: goto -28 -> 183
    //   214: astore_1
    ...
    //   217: ifnull +8 -> 225
    //   220: aload 8
    //   222: invokevirtual 138	com/baidu/mobstat/x:close	()V
    //   225: aload_1
    //   226: athrow
    //   227: goto -44 -> 183
    //   230: iload 4
  ...
  public long a(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = localx;
      localObject2 = localx;
      paramLong = localx.a(String.valueOf(paramLong), paramString);
      l = paramLong;
      paramLong = l;
      if (localx != null)
      {
  ...
  public ArrayList<w> a(int paramInt1, int paramInt2)
  {
    for (;;)
    {
      ...
      finally
      {
        ...
        ((x)localObject4).close();
      }
      return (ArrayList<w>)localObject4;
      Object localObject1 = localx;
      localObject4 = localx;
      ArrayList localArrayList2 = localx.a(paramInt1, paramInt2);
  ...
  public boolean b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokespecial 71	com/baidu/mobstat/y:c	()I
    //   6: istore_1
    //   7: iload_1
    //   8: ifne +9 -> 17
    //   11: iconst_1
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/mobstat/y.class
