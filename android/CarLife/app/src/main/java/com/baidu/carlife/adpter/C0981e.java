...
public class C0981e extends BaseAdapter {
    /* renamed from: a */
    ...
    private class C0980a {
        ...
        View f2494f;
        /* renamed from: g */
        final /* synthetic */ C0981e f2495g;

        private C0980a(C0981e c0981e) {
            this.f2495g = c0981e;
        }
    }

    public C0981e(Context context) {
        this.f2499d = context;
        this.f2497b = LayoutInflater.from(context);
        this.f2498c = context.getString(C0965R.string.home_discover_park_free);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        C0980a viewHolder;
        if (convertView == null) {
            convertView = this.f2497b.inflate(C0965R.layout.item_home_discover_park, parent, false);
            viewHolder = new C0980a();
            viewHolder.f2489a = (TextView) convertView.findViewById(C0965R.id.tv_go);
            viewHolder.f2490b = (TextView) convertView.findViewById(C0965R.id.tv_name);
            viewHolder.f2491c = (TextView) convertView.findViewById(C0965R.id.tv_addr);
            viewHolder.f2492d = (TextView) convertView.findViewById(C0965R.id.tv_num);
            viewHolder.f2493e = (TextView) convertView.findViewById(C0965R.id.tv_price);
            viewHolder.f2494f = convertView.findViewById(C0965R.id.cl_line);
    ...
    private void m3183a(C0980a viewHolder) {
        viewHolder.f2490b.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_content));
        viewHolder.f2489a.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a4_content));
        viewHolder.f2491c.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a4_content));
        viewHolder.f2492d.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a4_content));
        viewHolder.f2493e.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a4_content));
    }
    ...
    public void m3185a(C0980a viewHolder, C1927g model) {
        if (model != null) {
            ...
            viewHolder.f2493e.setTextColor(C2188r.m8328a((int) C0965R.color.cl_other_f_free));
        }
    }

    /* renamed from: a */
    public C1269a m3184a(int position) {
        C1927g model = (C1927g) getItem(position);
        ...
        return new C1269a(model.f6019i, model.f6018h);
    }
}
