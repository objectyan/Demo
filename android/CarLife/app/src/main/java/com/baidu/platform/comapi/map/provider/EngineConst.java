...
public class EngineConst {
    ...
    public interface BUS_STEP_TYPE {
    ...
    public interface ENGINE_ONLINE_NODE_TYPE {
    ...
    public interface ICON_ALIGN_TYPE {
    ...
    public interface OVERLAY_KEY {
        ...
        /* renamed from: X */
        public static final String f19863X = "x";
        /* renamed from: Y */
        public static final String f19864Y = "y";
    }

    public interface POI_TYPE {
