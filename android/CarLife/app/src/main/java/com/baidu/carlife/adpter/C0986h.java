...
public abstract class C0986h extends BaseAdapter {
    /* renamed from: a */
    ...
    public C0986h(Context context) {
        this.f2517g = context;
        this.f2516f = LayoutInflater.from(this.f2517g).inflate(C0965R.layout.listview_load_more, null);
        this.f2518h = (TextView) this.f2516f.findViewById(C0965R.id.btn_load_more);
        this.f2519i = this.f2516f.findViewById(C0965R.id.view_loading);
    }
