...
public class C1825l extends C1790b {
    ...
    /* renamed from: V */
    private C0936j f5650V = null;

    /* compiled from: NeteaseDataManager */
    /* renamed from: com.baidu.carlife.logic.music.l$a */
    private class C1824a extends C0936j {
        /* renamed from: a */
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    if (searchedList != null && !searchedList.isEmpty()) {
                        ...
                        C1261k.m4458a(218, this.f5647a.m6649s(), new Pair(C1799f.f5533C, newlist));
                        return;
                    }
                    return;
                case 205:
                    ...
                    if (this.f5647a.mo1658e(msg.arg1)) {
                        C1261k.m4463b(206, msg.arg1, this.f5647a.m6649s());
                        return;
                    }
                    StatisticManager.onEvent(StatisticConstants.MUSIC_NETEASE_0005, "获取歌单失败");
                    C1261k.m4454a((int) C1253f.dQ, this.f5647a.m6649s(), 1000);
                    return;
                case 222:
                    String id = msg.obj;
                    ...
                    if (list2 == null || list2.size() <= 0) {
                        ...
                        C1261k.m4454a((int) C1253f.dR, this.f5647a.m6649s(), 1000);
                        return;
                    }
                    C1261k.m4458a(218, this.f5647a.m6649s(), new Pair(id, list2));
                    return;
                default:
                    return;
            }
    ...
    public Bitmap mo1656d(String url) {
        ...
        return C1251e.m4357a(url + "?" + f5648T);
    }
