...
public class C0999m extends BaseAdapter {
    /* renamed from: a */
    ...
    private class C0998a {
        ...
        View f2543d;
        /* renamed from: e */
        final /* synthetic */ C0999m f2544e;

        private C0998a(C0999m c0999m) {
            this.f2544e = c0999m;
        }
    }
    ...
    public C0999m(Context context) {
        this.f2546b = LayoutInflater.from(context);
        this.f2545a = context.getString(C0965R.string.phone_name_unknown);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        C0998a viewCache;
        if (convertView == null) {
            convertView = this.f2546b.inflate(C0965R.layout.phone_book_list_item, parent, false);
            viewCache = new C0998a();
            viewCache.f2540a = (TextView) convertView.findViewById(C0965R.id.tv_phonebook_name);
            viewCache.f2541b = (TextView) convertView.findViewById(C0965R.id.tv_phonebook_num);
            viewCache.f2542c = (TextView) convertView.findViewById(C0965R.id.tv_phonebook_type);
            viewCache.f2543d = convertView.findViewById(C0965R.id.cl_line);
        ...
        if (contact != null) {
            ...
            viewCache.f2540a.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_content));
            viewCache.f2541b.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a2_content));
            viewCache.f2542c.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a2_content));
        }
        return convertView;
    }
}
