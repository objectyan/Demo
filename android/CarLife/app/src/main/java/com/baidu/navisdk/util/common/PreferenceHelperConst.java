...
public interface PreferenceHelperConst {
    ...
    public static final String COMPANY_HAS_SYNCED = "company_has_synced";
    ...
    public static final String CRUISE_MAP_USER_SCALE_LEVEL = "sp_cruise_map_user_scale_level";
    public static final String FAMILY_HAS_SYNCED = "family_has_synced";
    ...
    public static final String SP_LAST_NAVIAPPLIBSO_SIZE = "sp_last_naviapplibso_size";
    ...
    public static final String SP_RG_INSTANT_FIRST_START_GUIDE = "sp_rg_instant_first_start_guide";
    public static final String SP_RG_INSTANT_LAST_CLOUD_OPEN_STATE = "sp_rg_instant_last_cloud_open_state";
    public static final String SP_RG_INSTANT_LAST_CLOUD_PSTLABELDIS_VALUE = "sp_rg_instant_last_cloud_pstlabeldis_value";
