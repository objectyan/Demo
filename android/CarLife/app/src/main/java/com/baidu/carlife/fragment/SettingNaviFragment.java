...
public class SettingNaviFragment extends ContentFragment implements OnClickListener {
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        this.f4793a = (ViewGroup) inflater.inflate(C0965R.layout.frag_navi_setting, null);
        setCommonTitleBar(this.f4793a, getString(C0965R.string.navi_setting));
        this.f4807o = C1249d.m4331a().m4351h() / (C1249d.m4331a().m4350g() / 160);
        m5799b();
        m5807g();
    ...
    /* renamed from: b */
    private void m5799b() {
        this.f4794b = (TextView) this.f4793a.findViewById(C0965R.id.tv_daystyle_day);
        this.f4795c = (TextView) this.f4793a.findViewById(C0965R.id.tv_daystyle_night);
        this.f4796d = (TextView) this.f4793a.findViewById(C0965R.id.tv_daystyle_auto);
        this.f4797e = (TextView) this.f4793a.findViewById(C0965R.id.tv_speck_novice);
        this.f4798f = (TextView) this.f4793a.findViewById(C0965R.id.tv_speck_veteran);
        this.f4799g = (TextView) this.f4793a.findViewById(C0965R.id.tv_speck_quite);
        this.f4805m = (SwitchButton) this.f4793a.findViewById(C0965R.id.swbtn_calcroute_pre);
        this.f4806n = this.f4793a.findViewById(C0965R.id.rl_calc_route);
        this.f4800h = (SwitchButton) this.f4793a.findViewById(C0965R.id.switch_plate_control);
        this.f4801i = (TextView) this.f4793a.findViewById(C0965R.id.tv_plate_number);
        this.f4802j = this.f4793a.findViewById(C0965R.id.rl_plate_number);
        this.f4803k = new ArrayList();
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_01));
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_02));
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_03));
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_04));
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_05));
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_06));
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_07));
        this.f4803k.add((TextView) this.f4793a.findViewById(C0965R.id.tv_preference_08));
    }
    ...
    private void m5805e() {
        ...
        if (!C2170a.m8217a()) {
            Resources resources = C1157a.m3876a().getResources();
            for (i = 0; i < this.f4804l.size(); i++) {
                model = (RGRouteSortModel) this.f4804l.get(i);
                if ("智能推荐".equals(model.mItemName)) {
                    model.mItemName = resources.getString(C0965R.string.route_smart);
                } else if ("时间优先".equals(model.mItemName)) {
                    model.mItemName = resources.getString(C0965R.string.route_time);
                }
                if ("距离优先".equals(model.mItemName)) {
                    model.mItemName = resources.getString(C0965R.string.route_dis);
                }
                if ("躲避拥堵".equals(model.mItemName)) {
                    model.mItemName = resources.getString(C0965R.string.route_d);
                }
                if ("不走高速".equals(model.mItemName)) {
                    model.mItemName = resources.getString(C0965R.string.route_dg);
                }
                if ("高速优先".equals(model.mItemName)) {
                    model.mItemName = resources.getString(C0965R.string.route_g);
                }
        ...
        while (i < this.f4804l.size() && i < this.f4808p && i < this.f4803k.size()) {
            ...
            if (!C2170a.m8217a()) {
                ...
                textView.getLayoutParams().width = C1157a.m3876a().getResources().getDimensionPixelSize(C0965R.dimen.en_route_width);
            }
            i++;
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case C0965R.id.rl_plate_number:
                m5808h();
                break;
            case C0965R.id.tv_daystyle_day:
                this.f4794b.setSelected(true);
                this.f4795c.setSelected(false);
                this.f4796d.setSelected(false);
                BNSettingManager.setNaviDayAndNightMode(2);
                return;
            case C0965R.id.tv_daystyle_night:
                this.f4794b.setSelected(false);
                this.f4795c.setSelected(true);
                this.f4796d.setSelected(false);
                BNSettingManager.setNaviDayAndNightMode(3);
                return;
            case C0965R.id.tv_daystyle_auto:
                this.f4794b.setSelected(false);
                this.f4795c.setSelected(false);
                this.f4796d.setSelected(true);
                BNSettingManager.setNaviDayAndNightMode(1);
                return;
            case C0965R.id.tv_speck_novice:
                this.f4797e.setSelected(true);
                this.f4798f.setSelected(false);
                this.f4799g.setSelected(false);
                ...
                return;
            case C0965R.id.tv_speck_veteran:
                this.f4797e.setSelected(false);
                this.f4798f.setSelected(true);
                this.f4799g.setSelected(false);
    ...
    public void onInitFocusAreas() {
        if (this.fragmentType == getCurrentFragmentType() && this.f4793a != null) {
            if (this.f4812t == null) {
                this.f4812t = new C1443g(this.f4793a.findViewById(C0965R.id.common_top_title), 2);
                this.f4812t.m5300d(this.f4793a.findViewById(C0965R.id.ib_left));
            }
