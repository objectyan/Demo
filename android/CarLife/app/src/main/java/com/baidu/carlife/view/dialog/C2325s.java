...
import com.baidu.carlife.adpter.C1002n;
...
public class C2325s extends BaseDialog implements OnClickListener {
    ...
    class C23173 implements C0690d {
        /* renamed from: a */
    ...
    protected View mo1528a() {
        if (C1249d.m4334m()) {
            C1260i.m4435b("BaseDialog", "phone: show big Screen input");
            this.f7632x = LayoutInflater.from(this.c).inflate(C0965R.layout.layout_soft_input_phone_big_screen, null);
        } else {
            C1260i.m4435b("BaseDialog", "phone: show normal Screen input");
            this.f7632x = LayoutInflater.from(this.c).inflate(C0965R.layout.layout_soft_input_phone, null);
        }
    ...
    protected void mo1529b() {
        this.f7614f = (EditText) findViewById(C0965R.id.et_input);
        this.f7615g = findViewById(C0965R.id.btn_delete);
        this.f7615g.setOnClickListener(this);
        this.f7616h = (ImageButton) findViewById(C0965R.id.btn_phone);
        this.f7616h.setOnClickListener(this);
        this.f7629u = (ListView) findViewById(C0965R.id.lv_sug);
        this.f7629u.setOverScrollMode(2);
        this.f7617i = (SoftInputPhoneKey) findViewById(C0965R.id.key1);
        this.f7618j = (SoftInputPhoneKey) findViewById(C0965R.id.key2);
        this.f7619k = (SoftInputPhoneKey) findViewById(C0965R.id.key3);
        this.f7620l = (SoftInputPhoneKey) findViewById(C0965R.id.key4);
        this.f7621m = (SoftInputPhoneKey) findViewById(C0965R.id.key5);
        this.f7622n = (SoftInputPhoneKey) findViewById(C0965R.id.key6);
        this.f7623o = (SoftInputPhoneKey) findViewById(C0965R.id.key7);
        this.f7624p = (SoftInputPhoneKey) findViewById(C0965R.id.key8);
        this.f7625q = (SoftInputPhoneKey) findViewById(C0965R.id.key9);
        this.f7626r = (SoftInputPhoneKey) findViewById(C0965R.id.key_xing);
        this.f7627s = (SoftInputPhoneKey) findViewById(C0965R.id.key0);
        this.f7628t = (SoftInputPhoneKey) findViewById(C0965R.id.key_jing);
    ...
    private void m8826i() {
        if (this.f7613e) {
            this.f7616h.setImageResource(C0965R.drawable.phone_ic_hangup);
            this.f7616h.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_btn_rounded_rectangle_c_selector));
            findViewById(C0965R.id.temp1).setVisibility(8);
            this.f7629u.setVisibility(8);
            this.f7631w.m7108a(this.f7633y);
            return;
        }
        this.f7630v = new C1002n(getContext());
        this.f7629u.setAdapter(this.f7630v);
        this.f7629u.setOnItemClickListener(new C23184(this));
        this.f7616h.setImageResource(C0965R.drawable.phone_ic_call);
        this.f7616h.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_btn_rounded_rectangle_a_selector));
    ...
    public void m8831a(boolean bBigScreen) {
        ...
        if (bBigScreen) {
            if (this.f7629u != null) {
                ...
                para1.width = this.c.getResources().getDimensionPixelSize(C0965R.dimen.soft_input_phone_dialog_width);
                this.f7629u.setLayoutParams(para1);
                this.f7632x.requestLayout();
            }
        } else if (this.f7629u != null) {
            para1 = this.f7629u.getLayoutParams();
            para1.width = this.c.getResources().getDimensionPixelSize(C0965R.dimen.soft_input_phone_contact_width);
            this.f7629u.setLayoutParams(para1);
            this.f7632x.requestLayout();
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case C0965R.id.btn_delete:
                m8827j();
                return;
            case C0965R.id.btn_phone:
                if (this.f7613e) {
    ...
    public void mo1530f() {
        if (this.f7611A == null) {
            this.f7611A = new C1443g(findViewById(C0965R.id.layout_right), 10);
