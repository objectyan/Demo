...
public class C0977c extends BaseAdapter {
    /* renamed from: a */
    ...
    private class C0976a {
        ...
        View f2474n;
        /* renamed from: o */
        final /* synthetic */ C0977c f2475o;

        private C0976a(C0977c c0977c) {
            this.f2475o = c0977c;
        }
    }

    public C0977c(Context context, C1283l listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (getItemViewType(position) == 1) {
                convertView = this.f2478c.inflate(C0965R.layout.item_food_cafe, parent, false);
                holder.f2463c = (MultiImageView) convertView.findViewById(C0965R.id.iv_logo);
                holder.f2461a = (TextView) convertView.findViewById(C0965R.id.tv_name);
                holder.f2464d = (RatingBar) convertView.findViewById(C0965R.id.rb_score);
                holder.f2465e = (TextView) convertView.findViewById(C0965R.id.tv_price);
                holder.f2466f = (TextView) convertView.findViewById(C0965R.id.tv_style);
                holder.f2467g = (TextView) convertView.findViewById(C0965R.id.tv_waitnum);
                holder.f2469i = (TextView) convertView.findViewById(C0965R.id.tv_notice);
                holder.f2468h = (TextView) convertView.findViewById(C0965R.id.tv_temp);
                holder.f2462b = (TextView) convertView.findViewById(C0965R.id.tv_distant);
                convertView.setTag(holder);
            } else {
                convertView = this.f2478c.inflate(C0965R.layout.item_food_cafe_queue, parent, false);
                holder.f2461a = (TextView) convertView.findViewById(C0965R.id.tv_name);
                holder.f2470j = (TextView) convertView.findViewById(C0965R.id.tv_state);
                holder.f2462b = (TextView) convertView.findViewById(C0965R.id.tv_distant);
                holder.f2471k = (TextView) convertView.findViewById(C0965R.id.tv_queue_name);
                holder.f2472l = (TextView) convertView.findViewById(C0965R.id.tv_queue_waitnum);
                holder.f2473m = (TextView) convertView.findViewById(C0965R.id.tv_queue_waittime);
                holder.f2474n = convertView.findViewById(C0965R.id.btn_distant);
                convertView.setTag(holder);
            }
        }
        ...
        if (model instanceof C1926f) {
            ...
            if (TextUtils.isEmpty(queue.f6005m)) {
                ...
                if (C1926f.m7390a(queue.f6004l)) {
                    holder.f2470j.setBackgroundResource(C0965R.drawable.com_bg_point01);
                } else {
                    holder.f2470j.setBackgroundResource(C0965R.drawable.com_bg_point02);
                }
            }
            int distance = 0;
            ...
            if (TextUtils.isEmpty(queue.f6008p)) {
                holder.f2471k.setText(C0965R.string.home_food_queue_default);
            } else {
                holder.f2471k.setText(queue.f6008p);
            }
            if (!C1926f.m7390a(queue.f6004l) || TextUtils.isEmpty(queue.f6001i)) {
                holder.f2473m.setText(C0965R.string.home_food_queue_default);
            } else {
                holder.f2473m.setText(queue.f6001i);
            }
            if (C1926f.m7390a(queue.f6004l)) {
                holder.f2472l.setText(BaiduNaviApplication.getInstance().getApplicationContext().getString(C0965R.string.home_food_waitnum1, new Object[]{Integer.valueOf(queue.f5996d)}));
            } else {
                holder.f2472l.setText(C0965R.string.home_food_queue_default);
            }
            if (C1253f.jr) {
                holder.f2474n.setVisibility(0);
                holder.f2474n.setOnClickListener(new OnClickListener(this) {
                    /* renamed from: b */
                    final /* synthetic */ C0977c f2460b;
            ...
            holder.f2463c.setDefaultDrawable(C2188r.m8331b(C0965R.drawable.home_bg_food_albumcover));
            ...
            if (cafe.f5968A > 0) {
                holder.f2465e.setText(BaiduNaviApplication.getInstance().getApplicationContext().getString(C0965R.string.home_food_perprice, new Object[]{Integer.valueOf(cafe.f5968A)}));
            } else {
            ...
            if (cafe.f5979m > 0) {
                ...
                if (cafe.f5978l == null || cafe.f5978l.isEmpty()) {
                    holder.f2469i.setText(BaiduNaviApplication.getInstance().getApplicationContext().getString(C0965R.string.home_food_no_status));
                    holder.f2469i.setTextColor(C2188r.m8328a((int) C0965R.color.cl_other_a_highlight));
                } else {
                    holder.f2469i.setText(cafe.f5978l);
                    if (cafe.f5978l.equals("不用排队")) {
                        holder.f2469i.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a2_content));
                    } else {
                        holder.f2469i.setTextColor(C2188r.m8328a((int) C0965R.color.cl_other_a_highlight));
                    }
                }
