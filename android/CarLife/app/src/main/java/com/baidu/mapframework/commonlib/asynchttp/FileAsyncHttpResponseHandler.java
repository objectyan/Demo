...
public abstract class FileAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public FileAsyncHttpResponseHandler(File file, boolean append, boolean renameTargetFileIfExists) {
        ...
        if (file.isDirectory() && !file.mkdirs()) {
            AsyncHttpClient.log.mo2623d(LOG_TAG, "Cannot create directories for requested Directory location, might not be a problem");
        }
        this.file = file;
        this.append = append;
    ...
    protected File getTemporaryFile(Context context) {
        ...
        try {
            ...
            AsyncHttpClient.log.mo2626e(LOG_TAG, "Cannot create temporary file", e);
            return null;
        }
    }
    ...
    protected File getTargetFileByParsingURL() {
        ...
        String format;
        if (filename.contains("build/intermediates/exploded-aar/com.baidu.baidumap/map-basic-libs/1.0.0/res")) {
