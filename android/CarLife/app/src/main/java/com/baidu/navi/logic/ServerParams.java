...
public class ServerParams {
    ...
    public static final String SERVER_ONLINE_URL = "https://appnavi.baidu.com/";
    public static final String SERVER_PLUGIN_ONLINE_URL = "https://vehicle.baidu.com";
    public static final String SERVER_PLUGIN_QA_URL = "http://cq01-rdqa-pool211.cq01.baidu.com:8282";
    public static final String SERVER_PLUGIN_USED_URL = "https://vehicle.baidu.com";
    public static final String SERVER_QA_URL = "http://db-qa-bu-qa26.db01.baidu.com:8388";
    public static final String SERVER_USED_URL = "https://appnavi.baidu.com/";
