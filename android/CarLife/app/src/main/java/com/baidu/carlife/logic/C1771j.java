...
public class C1771j extends C1759e {
    ...
    private class C1770a extends C1760f {
        ...
        void mo1642a(String diskFilePath) throws IOException {
            if (this.f5382a.f5386e.f5922n >= this.f5382a.f5386e.f5923o) {
                C1260i.m4435b(C1771j.f5384c, "download complete");
                C1261k.m4458a(217, 2, this.f5382a.f5386e);
            }
            this.f5382a.m6473h();
        }
    }
    ...
    private void m6472g() {
        ...
        try {
            ...
            C1260i.m4435b(f5384c, "downloadSimpleSong fail");
            e.printStackTrace();
    ...
    private void m6473h() {
        ...
        if (downLoadBytes > 0 && this.f5386e.f5925q > 0) {
            while (downLoadBytes > 17999999) {
                StatisticManager.onEventDuration(C1157a.m3876a(), StatisticConstants.FM_FLOW_0001, StatisticConstants.FM_FLOW_0001, 17999999);
                if (C1251e.m4381s() == 1) {
                    StatisticManager.onEventDuration(C1157a.m3876a(), StatisticConstants.FM_FLOW_0002, StatisticConstants.FM_FLOW_0002, 17999999);
                }
                downLoadBytes -= 17999999;
            }
            if (downLoadBytes > 0) {
                StatisticManager.onEventDuration(C1157a.m3876a(), StatisticConstants.FM_FLOW_0001, StatisticConstants.FM_FLOW_0001, (int) downLoadBytes);
                if (C1251e.m4381s() == 1) {
                    StatisticManager.onEventDuration(C1157a.m3876a(), StatisticConstants.FM_FLOW_0002, StatisticConstants.FM_FLOW_0002, (int) downLoadBytes);
                }
            }
        }
    }
    ...
    void mo1646a(RandomAccessFile file) {
        if (this.f5386e.f5922n > 0) {
            try {
                ...
                C1260i.m4435b(f5384c, "seek fail");
                e.printStackTrace();
            }
        }
    }
