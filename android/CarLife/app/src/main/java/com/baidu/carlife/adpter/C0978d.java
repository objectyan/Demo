...
public class C0978d extends BaseAdapter {
    /* renamed from: a */
    ...
    public C0978d(Context context, String[] strings, int[] imageIds, int adapterType) {
        this.f2485e = context;
        this.f2486f = strings;
    ...
    public C0978d(Context context, int adapterType) {
        this.f2485e = context;
        this.f2488h = adapterType;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(this.f2485e).inflate(C0965R.layout.home_big_icon_item, parent, false);
            itemTV = (PressTextView) convertView.findViewById(C0965R.id.item_tv);
        ...
        itemTV.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_bgtext));
