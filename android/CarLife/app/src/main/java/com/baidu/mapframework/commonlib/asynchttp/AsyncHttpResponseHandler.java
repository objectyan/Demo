...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    private static class ResponderHandler extends Handler {
        /* renamed from: a */
        private final AsyncHttpResponseHandler f18814a;

        ResponderHandler(AsyncHttpResponseHandler mResponder, Looper looper) {
            super(looper);
            this.f18814a = mResponder;
        }

        public void handleMessage(Message msg) {
            this.f18814a.handleMessage(msg);
        }
    }
    ...
    public void setUseSynchronousMode(boolean sync) {
        if (!sync && this.looper == null) {
            sync = true;
            AsyncHttpClient.log.mo2636w(LOG_TAG, "Current thread has not called Looper.prepare(). Forcing synchronous mode.");
        }
    ...
    public void onProgress(long bytesWritten, long totalSize) {
        ...
        logInterface.mo2634v(str, String.format(str2, objArr));
    }
    ...
    public void onRetry(int retryNo) {
        AsyncHttpClient.log.mo2623d(LOG_TAG, String.format("Request retry no. %d", new Object[]{Integer.valueOf(retryNo)}));
    }

    public void onCancel() {
        AsyncHttpClient.log.mo2623d(LOG_TAG, "Request got cancelled");
    }

    public void onUserException(Throwable error) {
        AsyncHttpClient.log.mo2626e(LOG_TAG, "User-space exception detected!", error);
            ...
            switch (message.what) {
                case 0:
                    ...
                    if (response == null || response.length < 3) {
                        AsyncHttpClient.log.mo2625e(LOG_TAG, "SUCCESS_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 1:
                    ...
                    if (response == null || response.length < 4) {
                        AsyncHttpClient.log.mo2625e(LOG_TAG, "FAILURE_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 4:
                    ...
                    if (response == null || response.length < 2) {
                        AsyncHttpClient.log.mo2625e(LOG_TAG, "PROGRESS_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 5:
                    ...
                    if (response == null || response.length != 1) {
                        AsyncHttpClient.log.mo2625e(LOG_TAG, "RETRY_MESSAGE didn't get enough params");
                        return;
                    } else {
