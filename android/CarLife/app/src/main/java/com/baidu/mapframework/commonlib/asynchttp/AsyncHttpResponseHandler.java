  ...
  implements ResponseHandlerInterface
{
    ...
    throws IOException
  {
    ...
    //   41: lcmp
    //   42: ifle +13 -> 55
    //   45: new 121	java/lang/IllegalArgumentException
    //   48: dup
    //   49: ldc 123
    //   51: invokespecial 126	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   54: athrow
    //   55: lload 5
    //   57: lconst_0
    //   58: lcmp
    ...
    //   62: sipush 4096
    //   65: istore_2
    //   66: new 128	org/apache/http/util/ByteArrayBuffer
    //   69: dup
    //   70: iload_2
    //   71: invokespecial 131	org/apache/http/util/ByteArrayBuffer:<init>	(I)V
    //   74: astore 9
    //   76: sipush 4096
    ...
    //   85: aload 11
    //   87: aload 10
    //   89: invokevirtual 137	java/io/InputStream:read	([B)I
    //   92: istore_2
    //   93: iload_2
    //   94: iconst_m1
    //   95: if_icmpeq +90 -> 185
    //   98: invokestatic 143	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   101: invokevirtual 146	java/lang/Thread:isInterrupted	()Z
    //   104: ifne +81 -> 185
    //   107: lload_3
    //   108: iload_2
    //   109: i2l
    ...
    //   117: iconst_0
    //   118: iload_2
    //   119: invokevirtual 150	org/apache/http/util/ByteArrayBuffer:append	([BII)V
    //   122: lload 5
    //   124: lconst_0
    //   125: lcmp
    //   126: ifgt +53 -> 179
    ...
    //   132: lload 7
    //   134: lload_3
    //   135: invokevirtual 154	com/baidu/mapframework/commonlib/asynchttp/AsyncHttpResponseHandler:sendProgressMessage	(JJ)V
    //   138: lload 7
    //   140: lstore_3
    //   141: goto -56 -> 85
    //   144: astore 9
    //   146: aload 11
    //   148: invokestatic 160	com/baidu/mapframework/commonlib/asynchttp/AsyncHttpClient:silentCloseInputStream	(Ljava/io/InputStream;)V
    //   151: aload_1
    //   152: invokestatic 164	com/baidu/mapframework/commonlib/asynchttp/AsyncHttpClient:endEntityViaReflection	(Lorg/apache/http/HttpEntity;)V
    //   155: aload 9
    //   157: athrow
    //   158: astore_1
    //   159: invokestatic 169	java/lang/System:gc	()V
    //   162: new 105	java/io/IOException
    //   165: dup
    //   166: ldc -85
    //   168: invokespecial 172	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   171: athrow
    //   172: lload 5
    //   174: l2i
    //   175: istore_2
    ...
    //   182: goto -51 -> 131
    //   185: aload 11
    //   187: invokestatic 160	com/baidu/mapframework/commonlib/asynchttp/AsyncHttpClient:silentCloseInputStream	(Ljava/io/InputStream;)V
    //   190: aload_1
    //   191: invokestatic 164	com/baidu/mapframework/commonlib/asynchttp/AsyncHttpClient:endEntityViaReflection	(Lorg/apache/http/HttpEntity;)V
    //   194: aload 9
    //   196: invokevirtual 176	org/apache/http/util/ByteArrayBuffer:toByteArray	()[B
    //   199: astore 9
    //   201: aload 9
    //   203: areturn
    ...
    //   0	204	1	paramHttpEntity	org.apache.http.HttpEntity
    //   65	111	2	i	int
    //   84	98	3	l1	long
    //   34	146	5	l2	long
    //   111	28	7	l3	long
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/mapframework/commonlib/asynchttp/AsyncHttpResponseHandler.class
