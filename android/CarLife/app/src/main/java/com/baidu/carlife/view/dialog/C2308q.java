...
public class C2308q extends BaseDialog {
    ...
    public class C2307b extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = LayoutInflater.from(this.f7565a.getContext()).inflate(C0965R.layout.sdcard_selection_item, null);
            ImageView imageView = (ImageView) convertView.findViewById(C0965R.id.imageview_storage);
            TextView textView01 = (TextView) convertView.findViewById(C0965R.id.TextView01);
            TextView textView02 = (TextView) convertView.findViewById(C0965R.id.TextView02);
            CheckBox checkBox = (CheckBox) convertView.findViewById(C0965R.id.CheckBox1);
            ...
            if (this.f7566b != null && position >= 0 && position < this.f7566b.size()) {
                ...
                if (this.f7565a.f7572j < 2) {
                    checkBox.setButtonDrawable(check.booleanValue() ? C0965R.drawable.bnav_common_check_box_checked : C0965R.drawable.bnav_common_check_box_unchecked);
                }
                ...
                if (StorageOptions.INTERNAL_STORAGE.equals(sdcard)) {
                    imageView.setImageResource(C0965R.drawable.bnav_sdcard_choose_sdcard0);
                } else {
                    imageView.setImageResource(C0965R.drawable.bnav_sdcard_choose_sdcard1);
                }
            }
            return convertView;
        }
    ...
    public C2308q(Context context, ArrayList<HashMap<String, Object>> dataList) {
        ...
        if (this.f7572j == 0) {
            this.f7568f.setText(C0965R.string.muti_sdcard_choose_alert);
        } else if (this.f7572j == 2) {
            this.f7568f.setText(C0965R.string.muti_sdcard_choose_alert_sdcard0_1);
        } else if (this.f7572j == 1) {
            if (StorageOptions.INTERNAL_STORAGE.equals(sdcard)) {
                this.f7568f.setText(C0965R.string.muti_sdcard_choose_alert_sdcard0);
            } else {
                this.f7568f.setText(C0965R.string.muti_sdcard_choose_alert_sdcard1);
            }
        }
    ...
    protected View mo1528a() {
        return LayoutInflater.from(this.c).inflate(C0965R.layout.sdcard_selection_layout, null);
    }

    /* renamed from: b */
    protected void mo1529b() {
        this.f7567e = (TextView) findViewById(C0965R.id.title_bar);
        this.f7568f = (TextView) findViewById(C0965R.id.title_detail);
        this.f7569g = (ListView) findViewById(C0965R.id.listView1);
        this.f7569g.setSelector(C0965R.drawable.bnav_common_bg_pressed_mask_selector);
        this.f7570h = (TextView) findViewById(C0965R.id.ok_btn);
