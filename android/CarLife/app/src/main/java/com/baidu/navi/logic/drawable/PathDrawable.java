...
public class PathDrawable extends Drawable {
    ...
    /* renamed from: com.baidu.navi.logic.drawable.PathDrawable$1 */
    class C39361 extends UserTask<String, String, Bitmap> {
        C39361() {
        }

        public Bitmap doInBackground(String... params) {
            return Tools.getBitmapFromPath(PathDrawable.this.mKeyPath);
        }
    ...
    /* renamed from: com.baidu.navi.logic.drawable.PathDrawable$2 */
    class C39372 extends UserTask<String, String, Bitmap> {
        C39372() {
        }
