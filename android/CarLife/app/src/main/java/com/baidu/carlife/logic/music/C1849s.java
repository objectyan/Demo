...
public class C1849s extends C1790b {
    ...
    /* renamed from: X */
    private C0936j f5724X = new C0936j(this, BaiduNaviApplication.getInstance().getMainLooper()) {
        /* renamed from: a */
    ...
    class C18471 extends Thread {
        ...
        public void run() {
            int n;
            C1260i.m4435b(C1818h.f5590a, "---startSync-2--");
            ...
            if (model != null && !TextUtils.isEmpty(model.m7398a())) {
                if (isAboveAndroidM) {
                    try {
                        ...
                        C1260i.m4445e(C1818h.f5590a, "AboveAndroidM ActivityNotFoundException");
                ...
                try {
                    ...
                    if (componentName == null) {
                        try {
                            ...
                            C2201w.m8371a((int) C0965R.string.module_music_thirdparty_sync_fail, 0);
    ...
    public void m7022a(List<CLAlbum> list) {
        C1260i.m4435b("CarLifePlatform", "PlatformManager.onGetAlbumList() --2");
        this.I.clear();
        for (CLAlbum clAlbum : list) {
            this.I.add(new C1929i(clAlbum));
        }
        if (this.I.isEmpty()) {
            C1261k.m4454a((int) C1253f.dQ, m6649s(), 1000);
            return;
        }
    ...
    public void m7021a(String songId, long downloadSize, long totalSize, boolean stop) {
        ...
        if (this.f5721U == null) {
            C1260i.m4445e(C1818h.f5590a, "---onGetSong--songId:" + songId);
            return;
        }
        this.f5721U.f5922n = downloadSize;
        this.f5721U.f5923o = totalSize;
        if (stop && downloadSize >= totalSize && downloadSize > 0) {
            C1260i.m4435b(C1818h.f5590a, "----MSG_MUSIC_THIRDPARTY_DOWNLOAD_COMPLETE---");
            C1261k.m4459a(217, this.f5721U);
        }
        if (stop) {
            this.f5721U = null;
        }
    ...
    public void m7023a(List<MusicSongModel> newList, String songListId, int pn, int rn, int total) {
        if (newList == null || newList.isEmpty()) {
            ...
            if (oldList == null || oldList.isEmpty()) {
                C1260i.m4435b(C1818h.f5590a, "PlatformManager.onGetSongList() - FAIL");
                m6613b(songListId);
            }
            if (this.I == null || this.I.size() == 0 || this.A == null || !this.A.equals(songListId)) {
                C1261k.m4462b(C1253f.dR, m6649s());
                return;
            }
            m6613b(songListId);
        ...
        if (total > 0 && total <= pn + offset) {
            C1260i.m4435b(C1818h.f5590a, "PlatformManager.onGetSongList() - ALL");
            mo1687j(songListId);
        }
    }
