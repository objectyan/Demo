...
public class C0995k extends BaseAdapter {
    /* renamed from: a */
    ...
    public C0995k(Context context, List<C1931j> list) {
        this.f2537a = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = this.f2538b.inflate(C0965R.layout.music_apps_list_item, null);
            convertView.setLayoutParams(new LayoutParams(-1, (int) this.f2537a.getResources().getDimension(C0965R.dimen.frag_music_typelist_item_height)));
            C0994a viewCache = new C0994a();
            viewCache.f2535b = (TextView) convertView.findViewById(C0965R.id.tv_app_name);
            viewCache.f2534a = (MultiImageView) convertView.findViewById(C0965R.id.ib_app_icon);
            viewCache.f2536c = (ImageView) convertView.findViewById(C0965R.id.iv_selected_app_mark);
        ...
        if (model.f6066a) {
            cache.f2536c.setImageDrawable(C2188r.m8331b(C0965R.drawable.com_ic_selected));
            cache.f2536c.setVisibility(0);
            cache.f2535b.setTextColor(C2188r.m8328a((int) C0965R.color.cl_other_c_highlight));
            return convertView;
        }
        cache.f2536c.setVisibility(4);
        cache.f2535b.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_content));
        return convertView;
    }
    ...
    private void m3213a(MultiImageView imageView, C1931j model) {
        if (model.f6068c >= 3) {
            imageView.setDefaultDrawable(C2188r.m8331b(C0965R.drawable.music_ic_default));
