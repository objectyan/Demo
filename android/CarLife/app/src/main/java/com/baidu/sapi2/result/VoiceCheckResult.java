  ...
  extends SapiResult
{
  ...
  {
    this.msgMap.put(2, "您输入的帐号不存在");
    this.msgMap.put(3, "用户尚未正常化，无法使用此功能");
    this.msgMap.put(4, "用户被封禁，无法使用此功能");
    this.msgMap.put(400021, "用户登录状态失效，请重新登录");
    this.msgMap.put(400401, "请确认您输入的是帐号是用户名还是手机号");
    this.msgMap.put(-101, "请输入帐号");
  }
}


/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/baidu/sapi2/result/VoiceCheckResult.class
