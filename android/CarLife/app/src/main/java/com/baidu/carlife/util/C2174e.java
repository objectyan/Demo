...
public class C2174e {
    ...
    public boolean m8240a(String cmd) {
        int exitVal = 1;
        C1260i.m4435b(f6938a, "exec: " + cmd);
        try {
            exitVal = this.f6940c.exec(cmd).waitFor();
        } catch (InterruptedException e) {
            C1260i.m4445e(f6938a, "exec: " + cmd + " get InterruptedException");
            e.printStackTrace();
        } catch (IOException e2) {
            C1260i.m4445e(f6938a, "exec: " + cmd + " get IOException");
            e2.printStackTrace();
        }
        C1260i.m4435b(f6938a, "exit value: " + exitVal);
        if (exitVal != 0) {
            return false;
        }
        return true;
    ...
    public boolean m8241b(String cmd) {
        ...
        C1260i.m4435b(f6938a, "exit value: " + 0);
        if (null != null) {
            return false;
        }
        return true;
