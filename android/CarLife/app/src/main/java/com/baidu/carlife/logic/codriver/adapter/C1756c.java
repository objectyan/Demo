...
public class C1756c implements C1750o {
    ...
    public int mo1631a(byte[] inputData) {
        ...
        if (flag == -1 || flag != 12) {
            C1260i.m4445e(f5306c, "-- get data length failed");
            return -1;
        }
        ...
        if (dataLength > inputData.length) {
            C1260i.m4445e(f5306c, "---- get data too long!!!-len:" + dataLength);
            return -1;
        } else if (C1663a.m5979a().m6033e(inputData, dataLength) < 0) {
            C1260i.m4445e(f5306c, "-- get data failed---");
            return -1;
            ...
            if (recData == null) {
                C1260i.m4445e(f5306c, "decrypt failed!");
                return -1;
            }
    ...
    public void mo1633a(C2610a in) {
        C1260i.m4435b(f5306c, "record InputData");
    ...
    /* renamed from: a */
    public void mo1632a() {
        C1260i.m4435b(f5306c, "startRecord");
        this.f5311h.startRecordForAsr(this);
    }

    /* renamed from: b */
    public void mo1634b() {
        C1260i.m4435b(f5306c, "endRecord");
        this.f5311h.release();
    }

    /* renamed from: c */
    public void mo1635c() {
        C1260i.m4435b(f5306c, "initRecorder");
        this.f5311h.reset();
    }
}
