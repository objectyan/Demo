...
public class BCruiser {
    ...
    private IQuitCruiseClickListener mBCruiserQuitCruiseClickListener = new C42645();
    private Context mContext;
    private CruiseDialogManagerInterface mCruiseDialogManagerInterface;
    private ILocationListener mCruiseLocationListener = new C42612();
    ...
    private OnNaviClickListener mOnDownloadClickListener = new C42667();
    ...
    /* renamed from: com.baidu.navisdk.ui.cruise.BCruiser$2 */
    class C42612 implements ILocationListener {
        C42612() {
        }
    ...
    /* renamed from: com.baidu.navisdk.ui.cruise.BCruiser$3 */
    class C42623 extends Handler {
        C42623() {
        }
    ...
    /* renamed from: com.baidu.navisdk.ui.cruise.BCruiser$4 */
    class C42634 extends MsgHandler {
        C42634() {
        }
    ...
    /* renamed from: com.baidu.navisdk.ui.cruise.BCruiser$5 */
    class C42645 implements IQuitCruiseClickListener {
        C42645() {
        }
    ...
    /* renamed from: com.baidu.navisdk.ui.cruise.BCruiser$6 */
    class C42656 implements OnNaviClickListener {
        C42656() {
        }
    ...
    /* renamed from: com.baidu.navisdk.ui.cruise.BCruiser$7 */
    class C42667 implements OnNaviClickListener {
        C42667() {
        }
    ...
    public View init(Activity activity, Bundle configParams, MapGLSurfaceView nmapView) {
        ...
        try {
            this.mParentView = (FrameLayout) JarUtils.inflate(this.mActivity, C4048R.layout.nsdk_layout_cruise_main_layout, null);
    ...
    private void startRouteCruise() {
        if (!this.mIsCruiserStarted) {
            ...
            TTSPlayerControl.playTTSText(BNStyleManager.getString(C4048R.string.nsdk_string_cruise_enter_cruise_prompt_content), 0);
    ...
    private void setupUI() {
        ...
        if (this.mParentView != null) {
            ...
            CruiseMapView cruiseMapView = this.mCruiseMapView;
            if (BNSettingManager.getNaviDayAndNightMode() == 3) {
                z = false;
            }
            cruiseMapView.onUpdateStyle(z);
        }
    }
    ...
    private void initCruise() {
        Bundle b = new Bundle();
        b.putInt(Key.SP_Close_Speed_Camera, PreferenceHelper.getInstance(this.mContext).getInt(Key.SP_Close_Speed_Camera, 0));
        b.putInt(Key.SP_Close_Traffic_Camera, PreferenceHelper.getInstance(this.mContext).getInt(Key.SP_Close_Traffic_Camera, 0));
        b.putInt(Key.SP_Close_Break_Rules, PreferenceHelper.getInstance(this.mContext).getInt(Key.SP_Close_Break_Rules, 0));
        b.putInt("CloseTrafficSign", PreferenceHelper.getInstance(this.mContext).getInt("CloseTrafficSign", 0));
        BNRouteGuider.getInstance().SetCruiseSetting(b);
    ...
    public void onResume() {
        checkCurrentProvinceDataDownloaded();
        boolean showingDialog = checkDataDownload();
        ...
        if (this.mGPSOpened) {
            ...
            if (!(showingDialog || this.mDialogManager == null)) {
        ...
        BNWorkerCenter.getInstance().submitMainThreadTask(new BNWorkerNormalTask<String, String>("onResume-" + getClass().getSimpleName(), null) {
        ...
        try {
            ...
            LogUtil.m15791e("Cruise", "onResume e: " + e.getMessage());
        }
    }
    ...
    private void createHandler() {
        this.mHandler = new C42623();
    }

    private void createMsgHandler() {
        this.mMsgHandler = new C42634();
    }
    ...
    public void showQuitDialog() {
        this.mDialogManager.showQuitDialog(new C42656());
    }
    ...
    public static void showNetworkUnavailableTips(Context context) {
        TipTool.onCreateToastDialog(context, JarUtils.getResources().getString(C4048R.string.nsdk_string_cruise_network_unavailable));
    }
    ...
    public void setOnControlPanelClickListener(ControlPanelClickListener controlPanelClickListener) {
        if (this.mCruiseMapView != null) {
            this.mCruiseMapView.setOnControlPanelClickListener(controlPanelClickListener);
        }
    }
}
