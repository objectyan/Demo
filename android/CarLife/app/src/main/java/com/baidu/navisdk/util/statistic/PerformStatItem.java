...
public class PerformStatItem {
    ...
    public static final boolean[] P_LOGGABLE = new boolean[]{sUserTest & 1, sUserTest & 1, sUserTest & 1, sUserTest & 1, sUserTest & 0, sUserTest & 0, sUserTest & 0, sUserTest & 1, sUserTest & 1};
    ...
    public static boolean sBatchTestNetworkAndServerTime = (sUserTest & 0);
    public static long sCalcRoutePrepareStart = 0;
    public static long sDataHandleAfterLightStart = 0;
    public static boolean sEnableTestData = false;
    public static long sGetEngineCalcDataStart = 0;
    public static boolean sIsSatelliteFlashForPerform = true;
    public static long sNetWorkRequestStart = 0;
    public static long sPoiToNaviTime1 = 0;
    public static long sPoiToNaviTime10 = 0;
    public static long sPoiToNaviTime11 = 0;
    public static long sPoiToNaviTime12 = 0;
    public static long sPoiToNaviTime2 = 0;
    public static long sPoiToNaviTime3 = 0;
    public static long sPoiToNaviTime4 = 0;
    public static long sPoiToNaviTime8 = 0;
    public static long sPoiToNaviTime9 = 0;
    public static long sRequestMapLightServiceStart = 0;
    ...
    public static long sRoutePageToNaviTime5 = 0;
    public static long sRoutePageToNaviTime6 = 0;
    public static long sRoutePlanBeginWithRouteNodeStart = 0;
    public static long sRoutePlanSuccessNormalFirstStart = 0;
    public static long sRoutePlanSuccessNormalStart = 0;
    public static long sRoutePlanWithMultiNaviStart = 0;
    public static Map<String, Long> sTimeMap = new HashMap();
