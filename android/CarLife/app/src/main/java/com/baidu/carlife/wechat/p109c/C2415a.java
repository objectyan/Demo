...
public class C2415a {
    ...
    class C24012 implements C2400g {
        ...
        public void mo1835e() {
            if (C2380c.m9070a().m9083d() == C2379b.LOGIN) {
                ...
                C1328h.m4757a().removeWeChatFragmentFromStack();
            }
        }
    }
    ...
    private void m9234g() {
        ...
        } else if (C2359b.m8969a(C1157a.m3876a())) {
            C2434b.m9291a(new C24012(this));
        } else {
            Toast.makeText(C1157a.m3876a(), "网络连接异常，请检查您的网络连接", 0).show();
    ...
    public void m9238a(final C2376b contact, final String content) {
        ...
        C2434b.m9298a(contact.m9052a(), content + "【以上文字由语音转换】", new C2411f(this) {
            ...
            public void mo1844b() {
                ...
                this.f7955c.m9245e();
                C2454d.m9369a("登录态失效");
                Toast.makeText(C1157a.m3876a(), "登录态失效，请重新登录", 0).show();
                C1328h.m4757a().showFragment(NaviFragmentManager.TYPE_WECHAT_LOGIN, null);
                C1328h.m4757a().removeWeChatFragmentFromStack();
            }
        });
    ...
    public void m9239a(C2382d msg) {
        if (msg == null) {
        ...
        } else if (C1190a.m4065a() || C2369a.m9013b(C1157a.m3876a())) {
            this.f7960d = null;
            ...
            this.f7960d = msg;
            C1157a.m3876a().sendBroadcast(new Intent(C1984a.f6384c));
        }
    }
