...
public class C1079i {
    ...
    public static boolean m3608a(Class<?> btClass, BluetoothDevice btDevice) throws Exception {
        ...
        C1260i.m4440c(f2836i, "createBond");
    ...
    public static boolean m3614b(Class<?> btClass, BluetoothDevice btDevice) throws Exception {
        C1260i.m4440c(f2836i, "cancelBondProcess");
    ...
    public static boolean m3617c(Class<?> btClass, BluetoothDevice btDevice) throws Exception {
        C1260i.m4440c(f2836i, "removeBond");
    ...
    public static boolean m3609a(Class<?> btClass, BluetoothDevice btDevice, String pin) throws Exception {
        try {
            if (VERSION.SDK_INT >= 19) {
                return btDevice.setPin(C1079i.m3612a(pin));
            }
            return ((Boolean) btClass.getDeclaredMethod("setPin", new Class[]{byte[].class}).invoke(btDevice, new Object[]{C1079i.m3612a(pin)})).booleanValue();
    ...
    public static byte[] m3612a(String pin) {
        ...
        try {
            ...
            C1260i.m4445e(f2836i, "UTF-8 not supported?!?");
            return null;
        }
    }
    ...
    public static boolean m3619d() {
        C1260i.m4435b(f2836i, "channel ID = " + C1253f.jx);
        if (C1253f.jx.equals(C1252a.VEHICLE_CHANNEL_AUDI_DUAL_AUDIO)) {
            return true;
        }
        return false;
    }
