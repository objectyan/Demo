...
public class CLPlatformService extends Service {
    ...
    class C20121 extends C2011a {
        ...
        public int mo1742a(String appName, String sdkVersion, String secretKey, C2016h callback) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.register appName=" + appName + " sdkVersion=" + sdkVersion + " secretKey=" + secretKey);
            try {
        ...
        public String mo1743a(String appName) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.startServer appName=" + appName);
        ...
        public void mo1746a(String appName, int errorNo, String errorMsg) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.onSDKClientError appName=" + appName + " errorNo=" + errorNo + " errorMsg=" + errorMsg);
        ...
        public void mo1750b(String name) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.stopDownloadSong appName=" + name);
        ...
        public boolean mo1749a(C1991f callback) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.registerLocalCallback");
        ...
        public void mo1747a(String name, String songListId, int pn, int rn) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.getSongList appName=" + name + " songListId=" + songListId);
            C2017c client = C2013a.m7695a().m7699c(name);
            if (client != null) {
                try {
        ...
        public void mo1748a(String name, String songId, long size) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.getSong appName=" + name + " songId=" + songId);
            C2017c client = C2013a.m7695a().m7699c(name);
            if (client != null) {
                try {
        ...
        public List<String> mo1744a() throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.getRemoteClients");
            return C2013a.m7695a().m7700c();
        }

        /* renamed from: c */
        public void mo1751c(String name) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.getAlbumList");
            C2017c client = C2013a.m7695a().m7699c(name);
            if (client != null) {
                try {
                    client.m7723b();
        ...
        public void mo1752d(String name) throws RemoteException {
            C1260i.m4435b("CarLifePlatform", "CLPlatformService.disconnectApp");
            C2017c client = C2013a.m7695a().m7699c(name);
            if (client != null) {
                client.m7725d();
            }
