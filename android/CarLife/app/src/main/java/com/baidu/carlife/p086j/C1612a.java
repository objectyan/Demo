...
public class C1612a {
    ...
    class C16101 implements BNRouteGuider$OnRGSubStatusListener {
        ...
        public void onArriveDest(Message message) {
            C1260i.m4435b(C1612a.f4920c, "onArriveDest " + message.toString());
            this.f4918a.m5895d();
        }
    }
    ...
    public void m5892b() {
        if (!this.f4924d) {
            ...
            C1260i.m4435b(f4920c, "init isInit:" + this.f4924d + " isSendActionShow:" + this.f4925e + " isNaviBegin:" + this.f4927g + " isArriveDest:" + this.f4926f);
        }
    }
    ...
    public void m5894c() {
        if (this.f4924d) {
            ...
            this.f4927g = false;
            this.f4926f = true;
            C1260i.m4435b(f4920c, "unInit isInit:" + this.f4924d + " isSendActionShow:" + this.f4925e + " isNaviBegin:" + this.f4927g + " isArriveDest:" + this.f4926f);
        }
    }
                        ...
                        if (this.f4922a.containsKey(turnIconName)) {
                            ...
                            if (icon != null) {
                                ...
                                if (turnIcon.length > 30720) {
                                    ...
                                    try {
                                        if (turnIcon.length > 30720) {
                                            C1260i.m4435b(f4920c, "bitmap is too large");
                                            return;
                                        }
                                    } catch (Exception e) {
                                        C1260i.m4435b(f4920c, e.toString());
                                        return;
                                    }
                                }
    ...
    private void m5886a(CarlifeNaviNextTurnInfo carlifeNaviNextTurnInfo) {
        if (carlifeNaviNextTurnInfo != null) {
            C1212c hudCommand = new C1212c(true);
            hudCommand.m4201c(C1253f.ag);
    ...
    public void m5891a(boolean isNaviBegin) {
        C1260i.m4435b(f4920c, "onNaviBegin isNaviBegin:" + isNaviBegin);
    ...
    public void m5893b(boolean isConnected) {
        C1260i.m4435b(f4920c, "setConnected isConnected:" + isConnected);
