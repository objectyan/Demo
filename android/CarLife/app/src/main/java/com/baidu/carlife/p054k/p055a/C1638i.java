...
public class C1638i extends Thread implements Comparable<C1638i> {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (this.f5030a.f5038f != null) {
                        ...
                        C1260i.m4435b(C1638i.f5034b, this.f5030a.f5039g.f5007d + ":state=" + state.name() + ",errorCode=" + errorCode.name());
                        return;
                    }
                    return;
                case 2:
    ...
    private void m5926a(C1633a errorCode) {
        switch (errorCode) {
            case ERROR_MAKE_FILE:
                C2201w.m8371a((int) C0965R.string.error_make_file, 0);
                return;
            case ERROR_SDCARD_UNUSE:
                C2201w.m8371a((int) C0965R.string.error_sdcard_unuse, 0);
                return;
        ...
        if (!m5939d()) {
            ...
            try {
                ...
                if (!this.f5039g.f5010g) {
                    ...
                    C1260i.m4435b(f5034b, this.f5039g.f5007d + ":续传初始Size=" + currentSize);
                }
                if (this.f5041i.getResponseCode() == 200 || this.f5041i.getResponseCode() == 206) {
                    ...
                    C1260i.m4435b(f5034b, this.f5039g.f5007d + ":serverSize=" + serverSize + ",totalSize=" + this.f5039g.f5009f);
                    ...
                    try {
                        ...
                        m5927a(C1634b.ERROR, C1633a.ERROR_HTTP);
                        e2.printStackTrace();
                        C1260i.m4445e(f5034b, "IOException");
                        if (in != null) {
                            try {
                                in.close();
                        ...
                        m5927a(C1634b.ERROR, C1633a.ERROR_HTTP);
                        e3.printStackTrace();
                        C1260i.m4445e(f5034b, "OtherException");
                        if (in != null) {
                            try {
                                in.close();
    ...
    protected void m5943h() {
        if (!m5939d()) {
            ...
            C1260i.m4435b(f5034b, this.f5039g.f5007d + ":下载成功");
        }
    }
