...
public class BaiduNaviParams
{
  ...
  public static abstract interface AddThroughType
  {
  ...
  public static abstract interface MapRCRequestType
  {
  ...
  public class NERoutePlanMode
  {
    ...
    public NERoutePlanMode() {}
  }
  
  public static abstract interface NaviEvent
  {
  ...
  public static abstract interface RPEntry
  {
  ...
  public static abstract interface RouteDataMode
  {
  ...
  public static abstract interface RouteInfoStatus
  {
    public static final int Route_All = 1;
    public static final int Route_Part = 2;
  }
  
  public static abstract interface RouteOutDataType
  {
    public static final int RoadCondition = 0;
    public static final int Route = 1;
  }
  
  public static abstract interface RoutePlanFailedSubType
  {
  ...
  public static abstract interface RoutePlanKey
  {
  ...
  public static abstract interface RoutePlanNetMode
  {
  ...
  public static abstract interface RoutePlanStrategy
  {
    public static final int Force_Online_Priority = 1;
    public static final int User_Setting = 2;
  }
  
  public static abstract interface RoutePlanSuccessSubType
  {
  ...
  public static abstract interface RouteRefreshReason
  {
  ...
  public static abstract interface RouteSearchMode
  {
    public static final int By_Keyword = 1;
    public static final int By_Type = 0;
  }
  
  public static abstract interface SearchKey
  {
  ...
  public static abstract interface SearchRouteNodeType
  {
  ...
  public static abstract interface SearchSortType
  {
  ...
  public static abstract interface SearchSuccessSubType
  {
    public static final int CityList = 0;
    public static final int PoiList = 1;
  }
  
  public static abstract interface UgcEvent
  {
  ...
  public static abstract interface VoiceKey
  {
  ...
  public static abstract interface VoiceMode
  {
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/com/baidu/baidunavis/BaiduNaviParams.class
