...
public class C1443g extends C1436a implements OnFocusChangeListener {
    ...
    public boolean mo1554a() {
        C1260i.m4435b("FocusManager", "grantFocus FocusViewGroup");
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        C1260i.m4435b("FocusManager", "hasFocus=" + v.isFocused());
    }
    ...
    private boolean m5294i(View view) {
        ...
        C1260i.m4443d("FocusManager", "illegalview view=" + view + " code=" + code);
        return false;
    }
