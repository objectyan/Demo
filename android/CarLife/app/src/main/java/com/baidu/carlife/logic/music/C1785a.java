...
public class C1785a implements C0924a {
    ...
    /* renamed from: i */
    private static final int[] f5432i = new int[]{C0965R.drawable.music_ic_localmusic_display, C0965R.drawable.music_ic_qqmusic_display, C0965R.drawable.music_ic_netease_display};
    /* renamed from: j */
    ...
    class C17771 implements C1776b {
        ...
        public void mo1650a(int errorNo, String errorMsg, String packageName, String songListId, List<MusicSongModel> songList, int pn, int rn, int total) {
            ...
            C1260i.m4435b("CarLifePlatform", "--onGetSongList-pn:" + pn + "-rn:" + rn + "---total:" + total);
            if (errorNo != 0) {
                C1260i.m4435b("CarLifePlatform", "PlatformManager.onGetSongList() - FAIL");
                C1261k.m4462b(C1253f.dR, dataManager.m6649s());
                return;
            }
            C1260i.m4435b("CarLifePlatform", "PlatformManager.onGetSongList() - OK");
            dataManager.m7023a(songList, songListId, pn, rn, total);
        }
        ...
        public void mo1649a(int errorNo, String errorMsg, String packageName, String songId, long downloadSize, long totalSize, boolean stop) {
            if (errorNo != 0) {
                C1260i.m4445e("CarLifeMusic", "---onGetSong---error:" + errorNo + "---packageName:" + packageName);
                return;
            }
            C1849s dataManager = (C1849s) C1818h.m6730b().m6792b(packageName);
            if (dataManager == null) {
                C1260i.m4445e("CarLifeMusic", "---onGetSong--dataManager == Null----packageName:" + packageName);
            } else {
        ...
        public void mo1651a(int errorNo, String errorMsg, String packageName, List<CLAlbum> albumList) {
            ...
            if (dataManager != null) {
                if (errorNo != 0 || albumList == null || albumList.size() <= 0) {
                    C1261k.m4454a((int) C1253f.dQ, dataManager.m6649s(), 1000);
                ...
                C1260i.m4435b("CarLifePlatform", "PlatformManager.onGetAlbumList() --OK-");
        ...
        public void mo1652a(String packageName) {
            C1261k.m4459a(412, (Object) packageName);
        }
    ...
    class C17782 implements Runnable {
        ...
        public void run() {
            String data = C1251e.m4374g(C1785a.f5431c);
            C1260i.m4435b("CarLifeMusic", "----getLocalData---" + data);
    ...
    private class C1781a extends C0936j {
        /* renamed from: a */
    ...
    public void m6565a(Context context, C1782b callBack) {
        ...
        this.f5441m = new C0995k(this.f5437g, this.f5439k);
    ...
    public void onNetWorkResponse(int responseCode) {
        switch (responseCode) {
            case -3:
                m6556b(null);
                C1251e.m4365c(f5431c, "");
                return;
            case 0:
                C1260i.m4435b("ouyang", "------RESPONSE_SUCCESS------");
                String jsonData = this.f5434d.m5970b();
                if (!TextUtils.isEmpty(jsonData) && !jsonData.equals(C1251e.m4374g(f5431c))) {
                    C1260i.m4435b("ouyang", "------RESPONSE_SUCCESS---1---");
                    m6556b(this.f5434d.m5969a());
                    C1251e.m4365c(f5431c, jsonData);
                    return;
                }
                return;
            default:
    ...
    private void m6553a(List<C1931j> list) {
        String[] appNameList = this.f5437g.getResources().getStringArray(C0965R.array.module_music_apps_list);
