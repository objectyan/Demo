...
public class BNVoiceParams {
    ...
    public static final String VOICE_DEFUALT_IMAGE_URL = (HttpURLManager.getInstance().getScheme() + "imgsa.baidu.com/lbsopn/pic/item/48540923dd54564ed3cc8e93b0de9c82d0584fea.jpg");
    ...
    public static final String[] VOICE_RECORD_ORGWORD = new String[]{"导航开始", "闯红灯拍照", "限速拍照", "您已超速", "请减速慢行", "违章拍照", "请小心驾驶", "导航结束"};
    public static final String[] VOICE_RECORD_ORGWORD_DETAIL_FORMAP = new String[]{"亲爱的，导航已准备就绪，系好安全带，准备出发喽~", "注意闯红灯拍照，更要注意安全！", "有限速拍照，不要开太快啦！", "你已经超速啦，一定要慢点开", "你开的太快了，要减速啦", "违章拍照盯着你呢，不要被拍", "开车安全最重要，要小心驾驶", "你已经安全到达目的地啦，记得出门就查百度地图哦~新年快乐！"};
    public static final String[] VOICE_RECORD_ORGWORD_DETAIL_FORNAVI = new String[]{"亲爱的，导航已准备就绪，系好安全带，准备出发喽~", "注意闯红灯拍照，更要注意安全！", "有限速拍照，不要开太快啦！", "你已经超速啦，一定要慢点开", "你开的太快了，要减速啦", "违章拍照盯着你呢，不要被拍", "开车安全最重要，要小心驾驶", "你已经安全到达目的地啦，记得出门就查百度导航哦~新年快乐！"};
    public static final String[] VOICE_RECORD_SHOWWORD = new String[]{"导航欢迎语", "有闯红灯拍照", "有限速拍照", "您已超速", "请减速慢行", "有违章拍照", "请小心驾驶", "导航结束语"};
    public static final String VOICE_SILENCE_DOWNLOAD_URL = (HttpURLManager.getInstance().getScheme() + "client.map.baidu.com/opn/pvn/getcfg");
    public static final String VOICE_SQUARE_DEFAULT_IMAGE_URL = (HttpURLManager.getInstance().getScheme() + "map.baidu.com/zt/y2014/dhyylist/mobile/others/shareicon.jpg");
    ...
    static {
        ...
        if (BNSettingManager.isUseHttpsOfflineURL()) {
            str = "http://cp01-rdqa04-dev108.cp01.baidu.com:8111/static/webpage/voice_market_details_v2/";
        } else {
            str = HttpURLManager.getInstance().getScheme() + "webpagenavi.baidu.com/static/webpage/voice_market_details_v2/";
        }
