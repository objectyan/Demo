...
public class C2173d {
    ...
    private C2173d() {
        ...
        C1260i.m4435b(f6924a, "mCarLifeRootDir=" + this.f6936l + ", mCarLifeNaviDir=" + this.f6937m);
    }
    ...
    private File m8226m() {
        try {
            ...
            if (Environment.getExternalStorageState().equals("mounted")) {
                ...
                rootDir = C1157a.m3876a().getFilesDir();
            }
            return rootDir;
        } catch (Exception e) {
            C1260i.m4445e(f6924a, "Get SD Path Failed");
            return null;
        }
    }
    ...
    /* renamed from: b */
    public File m8228b() {
        return C1157a.m3876a().getDir("h5_database", 0);
    }

    /* renamed from: c */
    public File m8229c() {
        return C1157a.m3876a().getDir("h5_cache", 0);
    }
