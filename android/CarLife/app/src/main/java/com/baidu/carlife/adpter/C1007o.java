...
public class C1007o extends C1006b {
    /* renamed from: a */
    ...
    private class C1004a {
        ...
        TextView f2557b;
        /* renamed from: c */
        final /* synthetic */ C1007o f2558c;

        private C1004a(C1007o c1007o) {
            this.f2558c = c1007o;
        }
    }
    ...
    public View mo1373a(int section, int position, View convertView, ViewGroup parent) {
        C1004a viewCache;
        if (convertView == null) {
            convertView = this.f2566a.inflate(C0965R.layout.phone_book_list_item, parent, false);
            viewCache = new C1004a();
            viewCache.f2556a = (TextView) convertView.findViewById(C0965R.id.tv_phonebook_name);
            viewCache.f2557b = (TextView) convertView.findViewById(C0965R.id.tv_phonebook_num);
        ...
        viewCache.f2556a.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a5_content));
        viewCache.f2557b.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a2_content));
        return convertView;
    }
    ...
    public View mo1366a(int section, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = this.f2566a.inflate(C0965R.layout.contact_header_item, parent, false);
        }
        convertView.setBackground(C2188r.m8331b(C0965R.color.cl_bg_a_input));
        ((TextView) convertView.findViewById(C0965R.id.section_tv)).setText(String.valueOf(this.f2568c[section]));
        return convertView;
    }
}
