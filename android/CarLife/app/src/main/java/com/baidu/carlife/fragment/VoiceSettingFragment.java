...
public class VoiceSettingFragment extends ContentFragment {
    ...
    class C15852 implements OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (C1912n.m7270a().m7315n()) {
                ...
                C2201w.m8370a((int) C0965R.string.voice_feature_no_wakeup);
                return;
            }
            boolean isWakeUpOpen = C1251e.m4358a().m4398o();
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        this.mContentView = inflater.inflate(C0965R.layout.fragment_voice_setting, null);
        setCommonTitleBar(this.mContentView, getStringUtil(C0965R.string.carlife_person_ctrl_voice_setting));
        this.f4839b = (SwitchButton) this.mContentView.findViewById(C0965R.id.sw_voice_wakeup);
        this.f4840c = (TextView) this.mContentView.findViewById(C0965R.id.btn_standard);
        this.f4841d = (TextView) this.mContentView.findViewById(C0965R.id.btn_taiwan);
    ...
    private void m5819a(TextView button, boolean isSelected) {
        ...
        button.setTextColor(getResources().getColor(isSelected ? C0965R.color.white : C0965R.color.text_def_white_title));
    }

    /* renamed from: a */
    private void m5824a(boolean isWakeUp) {
        if (isWakeUp != C1251e.m4358a().m4398o()) {
            if (isWakeUp) {
                m5818a();
            } else {
                m5826b();
    ...
    private void m5818a() {
        ...
        C2201w.m8370a((int) C0965R.string.voice_open);
    ...
    private void m5826b() {
        ...
        C2201w.m8371a((int) C0965R.string.voice_close, 0);
    ...
    public void onInitFocusAreas() {
        ...
        if (this.f4842e == null) {
            this.f4842e = new C1443g(this.mContentView.findViewById(C0965R.id.common_top_title), 2);
            this.f4842e.m5300d(this.mContentView.findViewById(C0965R.id.ib_left));
        }
        if (this.f4843f == null) {
    ...
    public void driving() {
        C1260i.m4435b("yftech", "VoiceSettingFragment driving");
