...
import com.baidu.android.bbalbs.common.security.a;
import com.baidu.android.bbalbs.common.security.b;
import java.io.File;
...
public final class c
{
  ...
  private static String a(File paramFile)
  {
    ...
    //   6: dup
    //   7: aload_0
    //   8: invokespecial 51	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   11: astore_2
    //   12: aload_2
    //   13: astore_0
    //   14: sipush 8192
    ...
    //   20: aload_2
    //   21: astore_0
    //   22: new 53	java/io/CharArrayWriter
    //   25: dup
    //   26: invokespecial 54	java/io/CharArrayWriter:<init>	()V
    //   29: astore 5
    //   31: aload_2
    //   32: astore_0
    //   33: aload_2
    //   34: aload_3
    //   35: invokevirtual 58	java/io/FileReader:read	([C)I
    //   38: istore_1
    //   39: iload_1
    //   40: ifle +39 -> 79
    //   43: aload_2
    ...
    //   48: iconst_0
    //   49: iload_1
    //   50: invokevirtual 62	java/io/CharArrayWriter:write	([CII)V
    //   53: goto -22 -> 31
    //   56: astore_3
    //   57: aload_2
    //   58: astore_0
    //   59: aload_3
    //   60: invokestatic 65	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/Throwable;)V
    //   63: aload 4
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +10 -> 77
    //   70: aload_2
    //   71: invokevirtual 68	java/io/FileReader:close	()V
    //   74: aload 4
    //   76: astore_0
    //   77: aload_0
    //   78: areturn
    ...
    //   80: astore_0
    //   81: aload 5
    //   83: invokevirtual 71	java/io/CharArrayWriter:toString	()Ljava/lang/String;
    //   86: astore_3
    //   87: aload_3
    //   88: astore_0
    //   89: aload_2
    //   90: ifnull -13 -> 77
    //   93: aload_2
    //   94: invokevirtual 68	java/io/FileReader:close	()V
    //   97: aload_3
    //   98: areturn
    //   99: astore_0
    //   100: aload_0
    //   101: invokestatic 65	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/Throwable;)V
    //   104: aload_3
    //   105: areturn
    //   106: astore_0
    //   107: aload_0
    //   108: invokestatic 65	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/Throwable;)V
    //   111: aconst_null
    //   112: areturn
    //   113: astore_2
    //   114: aconst_null
    ...
    //   117: ifnull +7 -> 124
    //   120: aload_0
    //   121: invokevirtual 68	java/io/FileReader:close	()V
    //   124: aload_2
    //   125: athrow
    //   126: astore_0
    //   127: aload_0
    //   128: invokestatic 65	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/Throwable;)V
    //   131: goto -7 -> 124
    //   134: astore_2
    //   135: goto -19 -> 116
    //   138: astore_3
        ...
        if ((((ResolveInfo)localObject3).activityInfo != null) && (((ResolveInfo)localObject3).activityInfo.applicationInfo != null)) {
          for (;;)
          {
            try
            {
              ...
              if (this.a.getPackageName().equals(((ResolveInfo)localObject3).activityInfo.applicationInfo.packageName)) {
              ...
              if (paramBoolean)
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject2))
                {
                  ...
                  {
                    localObject2 = a(Base64.decode(((String)localObject2).getBytes()), this.c);
                    arrayOfByte = com.baidu.android.bbalbs.common.security.c.a(arrayOfByte);
  ...
  private void a()
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 289	java/io/ByteArrayInputStream
    //   5: dup
    //   6: invokestatic 293	com/baidu/android/bbalbs/common/a/b:a	()[B
    //   9: invokespecial 294	java/io/ByteArrayInputStream:<init>	([B)V
    //   12: astore_1
    //   13: aload_0
    //   14: ldc_w 296
    //   17: invokestatic 302	java/security/cert/CertificateFactory:getInstance	(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    //   20: aload_1
    //   21: invokevirtual 306	java/security/cert/CertificateFactory:generateCertificate	(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    //   24: invokevirtual 312	java/security/cert/Certificate:getPublicKey	()Ljava/security/PublicKey;
    //   27: putfield 259	com/baidu/android/bbalbs/common/a/c:c	Ljava/security/PublicKey;
    //   30: aload_1
    //   31: ifnull +7 -> 38
    //   34: aload_1
    //   35: invokevirtual 313	java/io/ByteArrayInputStream:close	()V
    //   38: return
    //   39: astore_1
    //   40: aload_1
    //   41: invokestatic 65	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/Throwable;)V
    //   44: return
    //   45: astore_1
    //   46: aconst_null
    //   47: astore_1
    ...
    //   49: ifnull -11 -> 38
    //   52: aload_1
    //   53: invokevirtual 313	java/io/ByteArrayInputStream:close	()V
    //   56: return
    //   57: astore_1
    //   58: aload_1
    //   59: invokestatic 65	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/Throwable;)V
    //   62: return
    //   63: astore_1
    //   64: aload_2
    //   65: ifnull +7 -> 72
    //   68: aload_2
    //   69: invokevirtual 313	java/io/ByteArrayInputStream:close	()V
    //   72: aload_1
    //   73: athrow
    //   74: astore_2
    //   75: aload_2
    //   76: invokestatic 65	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/Throwable;)V
    //   79: goto -7 -> 72
    //   82: astore_3
    //   83: aload_1
    //   84: astore_2
  ...
  private boolean a(String paramString)
  {
    ...
    try
    {
      FileOutputStream localFileOutputStream = this.a.openFileOutput("libcuid.so", 1);
  ...
  private boolean a(String paramString1, String paramString2)
  {
    try
    {
      boolean bool = Settings.System.putString(this.a.getContentResolver(), paramString1, paramString2);
      return bool;
    }
  ...
  private String[] a(Signature[] paramArrayOfSignature)
  {
    ...
    {
      arrayOfString[i] = a(com.baidu.android.bbalbs.common.security.c.a(paramArrayOfSignature[i].toByteArray()));
      i += 1;
    }
  ...
  private b b()
  {
    ...
    int j = 0;
    Object localObject1 = a(new Intent("com.baidu.intent.action.GALAXY").setPackage(this.a.getPackageName()), true);
    int i;
    boolean bool;
    ...
    for (;;)
    {
      localObject1 = new File(this.a.getFilesDir(), "libcuid.so");
                ...
                for (;;)
                {
                  ...
                  for (localObject1 = e(((b)localObject3).a());; localObject1 = null)
                  {
                    ...
                    if (c("android.permission.WRITE_EXTERNAL_STORAGE"))
                    {
                      ...
                      if (((this.b & 0x8) != 0) || (!((File)localObject1).exists()))
                      {
                        localObject1 = localObject2;
                        if (TextUtils.isEmpty((CharSequence)localObject2)) {
                    ...
                    if ((bool) && (((this.b & 0x1) != 0) || (TextUtils.isEmpty(b("com.baidu.deviceid")))))
                    {
                    ...
                    if ((bool) && (!TextUtils.isEmpty(((b)localObject3).b)))
                    {
                      ...
                      if (((this.b & 0x2) != 0) || (!((File)localObject1).exists())) {
  ...
  private static void b(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1.write(Base64.encode(a.a("30212102dicudiab", "30212102dicudiab", localStringBuilder.toString().getBytes()), "utf-8"));
      paramString1.flush();
      paramString1.close();
      return;
    }
  ...
  private b d()
  {
    ...
    {
      localObject2 = b(this.a);
      localObject2 = b(b.a(("com.baidu" + (String)localObject1 + (String)localObject2).getBytes(), true));
    }
    if (!TextUtils.isEmpty((CharSequence)localObject2))
    {
      localObject3 = new b(null);
  ...
  private b d(String paramString)
  {
    ...
    //   0: iconst_0
    //   1: istore_3
    //   2: getstatic 453	android/os/Build$VERSION:SDK_INT	I
    //   5: bipush 23
    //   7: if_icmpge +18 -> 25
    //   10: iconst_1
    //   11: istore_2
    ...
    //   30: ldc 81
    //   32: astore 6
    //   34: new 393	java/io/File
    //   37: dup
    //   38: invokestatic 486	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   41: ldc_w 600
    //   44: invokespecial 400	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   47: astore 4
    //   49: aload 4
    //   51: invokevirtual 403	java/io/File:exists	()Z
    //   54: ifeq +98 -> 152
    //   57: new 602	java/io/BufferedReader
    //   60: dup
    //   61: new 48	java/io/FileReader
    //   64: dup
    //   65: aload 4
    //   67: invokespecial 51	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   70: invokespecial 605	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   73: astore 4
    ...
    //   82: astore 5
    //   84: aload 4
    //   86: invokevirtual 608	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   89: astore 7
    //   91: aload 7
    //   93: ifnull +79 -> 172
    //   96: aload 5
    ...
    //   119: astore 5
    //   121: aload 6
    //   123: invokestatic 182	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   126: ifne +192 -> 318
    //   129: new 11	com/baidu/android/bbalbs/common/a/c$b
    //   132: dup
    //   133: aconst_null
    //   134: invokespecial 446	com/baidu/android/bbalbs/common/a/c$b:<init>	(Lcom/baidu/android/bbalbs/common/a/c$1;)V
    //   137: astore_1
    //   138: aload_1
    //   139: aload 6
    //   141: putfield 467	com/baidu/android/bbalbs/common/a/c$b:a	Ljava/lang/String;
    //   144: aload_1
    //   145: aload 5
    //   147: putfield 469	com/baidu/android/bbalbs/common/a/c$b:b	Ljava/lang/String;
    //   150: aload_1
    //   151: areturn
    //   152: new 393	java/io/File
    //   155: dup
    //   156: invokestatic 486	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   159: ldc_w 497
    //   162: invokespecial 400	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   165: astore 4
    //   167: iconst_1
    //   168: istore_3
    //   169: goto -112 -> 57
    //   172: aload 4
    //   174: invokevirtual 611	java/io/BufferedReader:close	()V
    //   177: new 89	java/lang/String
    //   180: dup
    //   181: ldc_w 557
    //   184: ldc_w 557
    //   187: aload 5
    //   189: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   192: invokevirtual 257	java/lang/String:getBytes	()[B
    //   195: invokestatic 194	com/baidu/android/bbalbs/common/security/Base64:decode	([B)[B
    //   198: invokestatic 613	com/baidu/android/bbalbs/common/security/a:b	(Ljava/lang/String;Ljava/lang/String;[B)[B
    //   201: invokespecial 199	java/lang/String:<init>	([B)V
    //   204: ldc_w 519
    //   207: invokevirtual 617	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   210: astore 5
    //   212: aload 5
    //   214: ifnull +146 -> 360
    //   217: aload 5
    ...
    //   231: iconst_0
    //   232: aaload
    //   233: invokevirtual 222	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   236: ifeq +54 -> 290
    //   239: aload 5
    //   241: iconst_1
    //   242: aaload
    ...
    //   262: aload 4
    //   264: aload_1
    //   265: invokestatic 499	com/baidu/android/bbalbs/common/a/c:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   268: aload_1
    //   269: astore 6
    //   271: aload 4
    //   273: astore 5
    ...
    //   295: astore 4
    //   297: aload_1
    //   298: invokestatic 182	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   301: ifeq +9 -> 310
    //   304: aload 5
    //   306: iconst_1
    //   307: aaload
  ...
  private b e()
  {
    ...
    if (((File)localObject).exists())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        try
        {
          localObject = b.a(new String(a.b("30212102dicudiab", "30212102dicudiab", Base64.decode(((String)localObject).getBytes()))));
  ...
  private static String e(String paramString)
  {
    ...
    try
    {
      paramString = Base64.encode(a.a("30212102dicudiab", "30212102dicudiab", paramString.getBytes()), "utf-8");
      return paramString;
    }
  ...
  private static String f(String paramString)
  {
    ...
    try
    {
      paramString = new String(a.b("30212102dicudiab", "30212102dicudiab", Base64.decode(paramString.getBytes())));
      return paramString;
    }
    catch (Exception paramString)
    {
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/com/baidu/android/bbalbs/common/a/c.class
