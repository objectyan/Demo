    ...
    public synchronized void initialize(Context context) {
        if (!this.initialized) {
            ...
            try {
                ...
                C2911f.a(StorageSettings.class.getSimpleName(), "exception", ex);
            }
            try {
                if (this.allStorages.size() > 0) {
                    ...
                    if (setDefaultStorage && this.currentStorage != null && dataCount < 2) {
                        setPreferredStorage(C2907c.f(), this.currentStorage);
                    }
                }
            } catch (Exception ex2) {
                C2911f.a(StorageSettings.class.getSimpleName(), "exception", ex2);
            }
            try {
                ...
                C2911f.a(StorageSettings.class.getSimpleName(), "exception", ex22);
            }
        }
    }
