...
public class C1210a implements C0689h {
    /* renamed from: L */
    ...
    /* renamed from: c */
    private static C1210a f3264c = null;
    /* renamed from: k */
    ...
    class C11941 extends TimerTask {
        /* renamed from: a */
        final /* synthetic */ C1210a f3206a;

        C11941(C1210a this$0) {
            this.f3206a = this$0;
        }

        public void run() {
            C1260i.m4445e(C1210a.f3263b, "timeout 1");
            if (this.f3206a.f3285H != null) {
                C1260i.m4445e(C1210a.f3263b, "timeout 2");
                C1260i.m4440c(C1210a.f3263b, "numOfHeartBeat = " + this.f3206a.f3287J + ", oldNumOfHeartBeat = " + this.f3206a.f3288K);
    ...
    class C11952 extends Thread {
        /* renamed from: a */
        final /* synthetic */ C1210a f3207a;

        C11952(C1210a this$0) {
            this.f3207a = this$0;
        }
        ...
        L_0x0010:
            ...
            r11 = r11.append(r0);
            r11 = r11.toString();
            com.baidu.carlife.core.C1260i.m4445e(r10, r11);
            r10 = "AOAConnectManager";
            r11 = new java.lang.StringBuilder;
            r11.<init>();
            r12 = "Write Time = ";
        ...
        L_0x004b:
            ...
            com.baidu.carlife.core.C1260i.m4435b(r10, r11);	 Catch:{ Exception -> 0x0097 }
        ...
        L_0x007b:
            ...
            r11 = r11.toString();	 Catch:{ Exception -> 0x0097 }
            com.baidu.carlife.core.C1260i.m4445e(r10, r11);	 Catch:{ Exception -> 0x0097 }
            goto L_0x0010;
        L_0x0097:
            r2 = move-exception;
    ...
    class C11963 extends Thread {
        /* renamed from: a */
        final /* synthetic */ C1210a f3208a;

        C11963(C1210a this$0) {
            this.f3208a = this$0;
        }
        ...
        public void run() {
            Exception e;
            try {
                C1260i.m4445e(C1210a.f3263b, "sleep 1s before read...");
                C11963.sleep(1000);
            } catch (InterruptedException e2) {
                e2.printStackTrace();
            }
            byte[] data = new byte[C1210a.f3275u];
            int cnt = -1;
            long mStartTime = SystemClock.elapsedRealtime();
            String str = null;
            while (true) {
                int ret = this.f3208a.m4144b(data, C1210a.f3275u);
                if (ret != C1210a.f3275u) {
                    C1260i.m4445e(C1210a.f3263b, "read data error, ret = " + ret);
                    String str2 = str;
                    return;
                }
                cnt++;
                try {
                    if (cnt >= C1210a.f3274t) {
                        C1260i.m4445e(C1210a.f3263b, "Read Time = " + (SystemClock.elapsedRealtime() - mStartTime));
                    }
                    str2 = new String(data);
                    try {
                        C1260i.m4435b(C1210a.f3263b, "read data:" + cnt + Config.TRACE_TODAY_VISIT_SPLIT + ret + Config.TRACE_TODAY_VISIT_SPLIT + str2.substring(0, 20));
                        str = str2;
                    } catch (Exception e3) {
                        e = e3;
                    }
            ...
            C1260i.m4445e(C1210a.f3263b, "get exception when read");
            C1260i.m4445e(C1210a.f3263b, e.toString());
            e.printStackTrace();
        }
    }
    ...
    private class C1197a extends Thread {
        ...
        public C1197a(C1210a c1210a) {
            this.f3209a = c1210a;
            C1260i.m4435b(C1210a.f3263b, "ReadThread Created");
            setName(C1210a.f3265k);
        }
        ...
        public void run() {
            this.f3210b = true;
            C1260i.m4435b(C1210a.f3263b, "Begin to read data by AOA");
            try {
                C1197a.sleep(100);
                while (this.f3210b) {
                    if (!this.f3210b) {
                        C1260i.m4445e(C1210a.f3263b, "read data cancled");
                    } else if (this.f3209a.m4144b(this.f3212d, 8) < 0) {
                        C1260i.m4445e(C1210a.f3263b, "bulkTransferIn fail 1");
                    } else {
                        this.f3213e = C1211b.m4178b(new byte[]{this.f3212d[0], this.f3212d[1], this.f3212d[2], this.f3212d[3]});
                        this.f3214f = C1211b.m4178b(new byte[]{this.f3212d[4], this.f3212d[5], this.f3212d[6], this.f3212d[7]});
                        C1260i.m4435b(C1210a.f3263b, "typeMsg = " + this.f3213e + ", lenMsg = " + this.f3214f);
                        int tatalChannel = 6;
                        if (C1253f.jw) {
                            tatalChannel = 7;
                        }
                        if (this.f3213e < 1 || this.f3213e > tatalChannel || this.f3214f < 0 || this.f3214f > C1210a.f3277y) {
                            C1260i.m4445e(C1210a.f3263b, "typeMsg or lenMsg is error");
                            C1215d.m4207a().m4222a(false);
                        } else {
                            ...
                            if (this.f3209a.m4144b(this.f3211c, this.f3214f) < 0) {
                                C1260i.m4445e(C1210a.f3263b, "bulkTransferIn fail 2");
                            } else {
                                this.f3216h = -1;
                                while (this.f3210b) {
                                    this.f3215g++;
                                    if (this.f3215g >= 100) {
                                        C1260i.m4445e(C1210a.f3263b, "write data to socket fail...retry");
                                        this.f3215g = 0;
                                        this.f3210b = false;
                                    } else {
                                        switch (this.f3213e) {
                                            ...
                                            case 7:
                                                ...
                                                break;
                                            default:
                                                C1260i.m4445e(C1210a.f3263b, "AOAReadThread typeMsg error");
                                                this.f3210b = false;
                                                break;
                                        }
                                        if (this.f3216h < 0) {
                ...
                C1260i.m4445e(C1210a.f3263b, "Exception when read data by AOA");
                e.printStackTrace();
            }
        }
    }
    ...
    private class C1198b extends Thread {
        ...
        public C1198b(C1210a c1210a, int port, String name) {
            this.f3218b = c1210a;
            try {
                this.f3222f = name + C1210a.f3266l;
                setName(this.f3222f);
                C1260i.m4435b(C1210a.f3263b, "Create " + this.f3222f);
                this.f3220d = port;
                this.f3221e = name;
                this.f3219c = true;
                if (this.f3221e.equals(C1253f.iN)) {
                    System.arraycopy(C1211b.m4175a(1), 0, this.f3230n, 0, 4);
                } else if (this.f3221e.equals(C1253f.iO)) {
                    System.arraycopy(C1211b.m4175a(2), 0, this.f3230n, 0, 4);
                } else if (this.f3221e.equals(C1253f.iP)) {
                    System.arraycopy(C1211b.m4175a(3), 0, this.f3230n, 0, 4);
                } else if (this.f3221e.equals("TTS")) {
                    System.arraycopy(C1211b.m4175a(4), 0, this.f3230n, 0, 4);
                } else if (this.f3221e.equals(C1253f.iR)) {
                    System.arraycopy(C1211b.m4175a(5), 0, this.f3230n, 0, 4);
                } else if (this.f3221e.equals(C1253f.iS)) {
                    System.arraycopy(C1211b.m4175a(6), 0, this.f3230n, 0, 4);
                } else if (this.f3221e.equals(C1253f.iT)) {
                    System.arraycopy(C1211b.m4175a(7), 0, this.f3230n, 0, 4);
                }
            } catch (Exception e) {
                C1260i.m4445e(C1210a.f3263b, "Create " + this.f3222f + " fail");
                e.printStackTrace();
            }
        }
        ...
        public void m4108a() {
            try {
                ...
                C1260i.m4445e(C1210a.f3263b, "Close " + this.f3222f + " fail");
                e.printStackTrace();
            }
        }
                ...
                if (this.f3224h != null) {
                    ...
                    while (cnt > 0) {
                        ...
                        if (r > 0) {
                            ...
                            C1260i.m4445e(C1210a.f3263b, this.f3221e + " Receive Data Error: ret = " + r);
                    ...
                    C1260i.m4445e(C1210a.f3263b, this.f3221e + " Receive Data Error: dataLen = " + dataLen);
                    throw new IOException();
                }
                C1260i.m4445e(C1210a.f3263b, this.f3221e + " Receive Data Fail, mInputStream is null");
                throw new IOException();
            } catch (Exception e) {
                C1260i.m4445e(C1210a.f3263b, this.f3221e + " IOException, Receive Data Fail");
                C1215d.m4207a().m4222a(false);
                e.printStackTrace();
                return r;
            }
        ...
        public int m4109b(byte[] buffer, int offset, int len) {
            try {
                ...
                C1260i.m4445e(C1210a.f3263b, this.f3221e + " Send Data Fail, mOutputStream is null");
                throw new IOException();
            } catch (Exception e) {
                C1260i.m4445e(C1210a.f3263b, this.f3221e + " IOException, Send Data Fail");
                e.printStackTrace();
                return -1;
            }
        }
        ...
        public void run() {
            while (this.f3219c) {
                try {
                    C1198b.sleep(100);
                    this.f3231o++;
                    C1260i.m4435b(C1210a.f3263b, "Try to connect to socket...retry = " + this.f3231o);
                    if (this.f3231o >= 100) {
                        C1260i.m4435b(C1210a.f3263b, "connect to socket fail");
                        this.f3231o = 0;
                        this.f3219c = false;
                        break;
                    }
                    this.f3217a = InetAddress.getByName(C1210a.f3267m);
                    this.f3223g = new Socket(this.f3217a, this.f3220d);
                    if (this.f3223g != null) {
                        C1260i.m4435b(C1210a.f3263b, "Connected to: " + this.f3223g.toString());
                    }
                    ...
                    C1260i.m4445e(C1210a.f3263b, "Create " + this.f3222f + " fail 1");
                    e.printStackTrace();
                }
            }
            do {
                try {
                    if (this.f3223g != null && this.f3219c) {
                        if (!this.f3223g.isConnected()) {
                            C1260i.m4445e(C1210a.f3263b, "socket is disconnected when read data");
                            break;
                        }
                        if (!this.f3221e.equals(C1253f.iN) && !this.f3221e.equals(C1253f.iS) && !this.f3221e.equals(C1253f.iT)) {
                            if (m4107a(this.f3229m, 0, 12) < 0) {
                                break;
                            }
                            this.f3226j = 12;
                            this.f3227k = C1211b.m4178b(new byte[]{this.f3229m[0], this.f3229m[1], this.f3229m[2], this.f3229m[3]});
                        } else if (m4107a(this.f3229m, 0, 8) < 0) {
                            break;
                        } else {
                            this.f3226j = 8;
                            this.f3227k = C1211b.m4188d(new byte[]{this.f3229m[0], this.f3229m[1]});
                        }
                        C1260i.m4435b(C1210a.f3263b, "Channel = " + this.f3221e + ", lenMsgHead = " + this.f3226j + ", lenMsgData = " + this.f3227k);
                        System.arraycopy(C1211b.m4175a(this.f3226j + this.f3227k), 0, this.f3230n, 4, 4);
                    ...
                    C1260i.m4445e(C1210a.f3263b, "get Exception in " + this.f3222f);
                    ex.printStackTrace();
                    return;
                }
            } while (this.f3218b.m4161a(this.f3230n, 8, this.f3229m, this.f3228l) >= 0);
            C1260i.m4445e(C1210a.f3263b, "bulkTransferOut fail");
            this.f3218b.m4163b();
        }
    }

    /* renamed from: a */
    public static C1210a m4143a() {
        if (f3264c == null) {
    ...
    public void m4162a(Context context, UsbAccessory accessory) {
        C1260i.m4445e(f3263b, "init");
        this.f3289d = context;
        this.f3290e = (UsbManager) this.f3289d.getSystemService("usb");
        this.f3291f = accessory;
        if (this.f3291f == null) {
            C1260i.m4445e(f3263b, "mUsbAccessory is null");
        } else if (C1215d.m4207a().m4226d()) {
            try {
                ...
                C1218e.m4228a().m4237a(2);
                m4166e();
                m4164c();
            } catch (Exception ex) {
                C1260i.m4445e(f3263b, "get fd fail");
                ex.printStackTrace();
            }
        } else {
            C1260i.m4445e(f3263b, "usb is not connected");
        }
    }

    /* renamed from: b */
    public void m4163b() {
        C1260i.m4445e(f3263b, "uninit");
        try {
            if (this.f3294i != null) {
                this.f3294i.close();
                this.f3294i = null;
            ...
            C1260i.m4445e(f3263b, "uninit fail");
        }
        this.f3291f = null;
        this.f3293h = null;
        C1218e.m4228a().m4237a(1);
        m4167f();
        m4165d();
    }
    ...
    private int m4144b(byte[] data, int len) {
        try {
            if (this.f3295j == null) {
                C1260i.m4445e(f3263b, "mFin is null");
                throw new IOException();
            }
            int cnt = len;
            int dataLen = 0;
            while (cnt > 0) {
                ...
                if (ret > 0) {
                    ...
                    C1260i.m4445e(f3263b, "bulkTransferIn error 1: ret = " + ret);
                    throw new IOException();
                }
            }
            if (dataLen == len) {
            ...
            C1260i.m4445e(f3263b, "bulkTransferIn error 3: dataLen = " + dataLen + ", len = " + len);
            throw new IOException();
        } catch (Exception e) {
            C1260i.m4445e(f3263b, "bulkTransferIn catch exception");
            C1215d.m4207a().m4222a(false);
            e.printStackTrace();
            return -1;
        }
    ...
    public int m4160a(byte[] data, int len) {
        try {
            ...
            C1260i.m4445e(f3263b, "bulkTransferOut catch exception");
            C1215d.m4207a().m4222a(false);
            e.printStackTrace();
            return -1;
        }
    ...
    public synchronized int m4161a(byte[] head, int lenHead, byte[] msg, int lenMsg) {
        ...
        synchronized (this) {
            ...
            if (m4160a(head, lenHead) < 0) {
                C1260i.m4445e(f3263b, "bulkTransferOut fail 1");
            } else if (m4160a(msg, lenMsg) < 0) {
                C1260i.m4445e(f3263b, "bulkTransferOut fail 2");
            } else {
                i = lenHead + lenMsg;
            }
        }
    ...
    public void m4164c() {
        try {
            ...
            C1260i.m4445e(f3263b, "Start AOAReadThread Fail");
            e.printStackTrace();
        }
    }
    ...
    public void m4165d() {
        try {
            ...
            C1260i.m4445e(f3263b, "Stop AOAReadThread Fail");
            e.printStackTrace();
        }
    }
    ...
    public void m4166e() {
        try {
            this.f3278A = new C1198b(this, C1253f.iG, C1253f.iN);
            this.f3278A.start();
            this.f3279B = new C1198b(this, C1253f.iH, C1253f.iO);
            this.f3279B.start();
            this.f3280C = new C1198b(this, C1253f.iI, C1253f.iP);
            this.f3280C.start();
            this.f3281D = new C1198b(this, C1253f.iJ, "TTS");
            this.f3281D.start();
            this.f3282E = new C1198b(this, C1253f.iK, C1253f.iR);
            this.f3282E.start();
            this.f3283F = new C1198b(this, C1253f.iL, C1253f.iS);
            this.f3283F.start();
            this.f3284G = new C1198b(this, C1253f.iM, C1253f.iT);
            this.f3284G.start();
        } catch (Exception e) {
            C1260i.m4445e(f3263b, "Start Read Thread Fail");
            e.printStackTrace();
        }
    }
    ...
    public void m4167f() {
        try {
            ...
            C1260i.m4445e(f3263b, "Stop Read Thread Fail");
            e.printStackTrace();
        }
    }
    ...
    public void m4168g() {
        try {
            C1260i.m4445e(f3263b, "start timer");
            this.f3287J = 0;
            this.f3288K = -1;
            ...
            C1260i.m4445e(f3263b, "start timer get exception");
            ex.printStackTrace();
        }
    }
    ...
    /* renamed from: h */
    public void m4169h() {
        C1260i.m4445e(f3263b, "timer Stop");
        if (this.f3285H != null) {
            this.f3285H.cancel();
            this.f3285H = null;
        }
