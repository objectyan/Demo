...
public class C2017c implements C1999c, C2015a, C2016h {
    ...
    L_0x0024:
        ...
        com.baidu.carlife.core.C1260i.m4445e(r0, r2);	 Catch:{ all -> 0x0044 }
    L_0x0042:
        monitor-exit(r1);	 Catch:{ all -> 0x0044 }
        goto L_0x001c;
    L_0x0044:
    ...
    L_0x0047:
        ...
        com.baidu.carlife.core.C1260i.m4435b(r0, r2);	 Catch:{ all -> 0x0044 }
        r0 = r7.songData;	 Catch:{ all -> 0x0044 }
    ...
    public void m7723b() throws IllegalArgumentException {
        C1260i.m4435b("CarLifePlatform", "getAlbumList");
    ...
    public void m7719a(String songListId, int pn, int rn) throws IllegalArgumentException {
        C1260i.m4435b("CarLifePlatform", "getSongList songListId=" + songListId);
    ...
    public void m7720a(String songId, long totalSize) throws IllegalArgumentException {
        C1260i.m4435b("CarLifePlatform", "getSong songId=" + songId);
    ...
    /* renamed from: c */
    public void m7724c() {
        C1260i.m4435b("CarLifePlatform", "stopDownloadSong appName=" + this.f6520b);
        synchronized (f6518e) {
            if (this.f6523f != null) {
    ...
    public void m7725d() {
        if (!this.f6522d) {
            this.f6522d = true;
            C1260i.m4435b("CarLifePlatform", "destroy appName=" + this.f6520b);
            this.f6519a = null;
            synchronized (f6518e) {
                if (this.f6523f != null) {
                    this.f6523f.m7734a(this.f6520b);
    ...
    public void mo1757a(Thread thread, Exception e) {
        if (thread != null) {
            C1260i.m4435b("CarLifePlatform", "onThreadQuit() " + thread.getName());
        }
        m7725d();
    }
}
