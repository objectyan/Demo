...
public class C1654n extends C1626e {
    ...
    public static class C1653a {
        ...
        public JSONObject m5964a(String act, Map<String, String> actParam, long time) {
            ...
            try {
                ...
                C1260i.m4445e("StatisticMobileParams", e.toString());
                return null;
            }
        }
    ...
    protected C1622d getPostRequestParams() {
        ...
        if ("harman".equals(this.f5090a.f5080a.toLowerCase()) || C1252a.VEHICLE_CHANNEL_AUDI.m4403a().equals(this.f5090a.f5080a) || C1252a.VEHICLE_CHANNEL_AUDI_DUAL_AUDIO.m4403a().equals(this.f5090a.f5080a)) {
