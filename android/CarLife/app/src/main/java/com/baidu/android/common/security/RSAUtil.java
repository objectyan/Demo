...
public final class RSAUtil
{
    ...
    throws Exception
  {
    // Byte code:
    //   0: ldc 8
    //   2: invokestatic 51	java/security/KeyFactory:getInstance	(Ljava/lang/String;)Ljava/security/KeyFactory;
    //   5: astore_2
    //   6: new 150	java/security/spec/RSAPrivateKeySpec
    //   9: dup
    //   10: aload_0
    //   11: aload_1
    //   12: invokespecial 153	java/security/spec/RSAPrivateKeySpec:<init>	(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    //   15: astore_0
    //   16: aload_2
    //   17: aload_0
    //   18: invokevirtual 55	java/security/KeyFactory:generatePrivate	(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    //   21: checkcast 132	java/security/interfaces/RSAPrivateKey
    //   24: astore_0
    //   25: aload_0
    //   26: areturn
    //   27: astore_0
    ...
    //   31: dup
    //   32: aload_0
    //   33: invokevirtual 156	java/security/NoSuchAlgorithmException:getMessage	()Ljava/lang/String;
    //   36: invokespecial 159	java/lang/Exception:<init>	(Ljava/lang/String;)V
    //   39: athrow
    //   40: astore_0
    //   41: new 28	java/lang/Exception
    //   44: dup
    //   45: aload_0
    //   46: invokevirtual 160	java/security/spec/InvalidKeySpecException:getMessage	()Ljava/lang/String;
    //   49: invokespecial 159	java/lang/Exception:<init>	(Ljava/lang/String;)V
    //   52: athrow
    ...
    throws Exception
  {
    ...
    //   2: invokestatic 51	java/security/KeyFactory:getInstance	(Ljava/lang/String;)Ljava/security/KeyFactory;
    //   5: astore_2
    //   6: new 164	java/security/spec/RSAPublicKeySpec
    //   9: dup
    //   10: aload_0
    //   11: aload_1
    //   12: invokespecial 165	java/security/spec/RSAPublicKeySpec:<init>	(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    //   15: astore_0
    //   16: aload_2
    //   17: aload_0
    //   18: invokevirtual 78	java/security/KeyFactory:generatePublic	(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    //   21: checkcast 126	java/security/interfaces/RSAPublicKey
    //   24: astore_0
    //   25: aload_0
    //   26: areturn
    //   27: astore_0
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes-dex2jar.jar!/com/baidu/android/common/security/RSAUtil.class
