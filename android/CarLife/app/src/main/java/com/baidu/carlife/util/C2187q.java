...
public class C2187q {
    ...
    /* renamed from: a */
    public static boolean m8327a(Context context, C1277e listener) {
        if (C1253f.jx != C1252a.VEHICLE_CHANNEL_DAIMLER || C1251e.m4382t() || C2187q.m8326a(context)) {
            return true;
        }
        C1260i.m4445e(f6992a, "package signature check fail");
