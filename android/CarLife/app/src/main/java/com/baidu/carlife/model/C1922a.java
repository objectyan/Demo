...
public class C1922a extends C1921b {
    ...
    /* renamed from: e */
    public int f5938e = C0965R.drawable.douban_fm;
    ...
    private class C1920a extends Thread {
        ...
        public void run() {
            while (!this.f5930c) {
                ...
                C1260i.m4445e(C1922a.f5933h, "-----download-------progress:" + this.f5928a.f5936c);
                try {
                    C1261k.m4461b(600);
                    C1920a.sleep(1000);
    ...
    public void mo1723a(int curStatus) {
        ...
        switch (this.f) {
            case 0:
                this.f5934a = C1253f.gp;
                this.f5935b = C1253f.gu;
                return;
            case 1:
                this.f5934a = C1253f.gq;
                this.f5935b = C1253f.gr;
                return;
            case 2:
                this.f5934a = C1253f.gr;
                this.f5935b = C1253f.gu;
                return;
            case 3:
                this.f5934a = C1253f.gs;
                this.f5935b = C1253f.gv;
                return;
            default:
                return;
        }
