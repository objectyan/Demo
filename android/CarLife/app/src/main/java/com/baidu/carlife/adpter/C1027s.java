...
public class C1027s extends BaseAdapter {
    /* renamed from: a */
        ...
        if (convertView == null) {
            switch (this.f2624c) {
                ...
                case ITEM_TYPE_MUSIC_ONLINE:
                    convertView = LayoutInflater.from(this.f2622a).inflate(C0965R.layout.voice_results_list_item_music, parent, false);
                    cacheView.f2620a = (TextView) convertView.findViewById(C0965R.id.tv_song);
                    cacheView.f2621b = (TextView) convertView.findViewById(C0965R.id.tv_singer);
                    break;
                case ITEM_TYPE_PHONE:
                    convertView = LayoutInflater.from(this.f2622a).inflate(C0965R.layout.voice_results_list_item_phone, parent, false);
                    cacheView.f2620a = (TextView) convertView.findViewById(C0965R.id.tv_name);
                    cacheView.f2621b = (TextView) convertView.findViewById(C0965R.id.tv_num);
                    break;
            }
