...
public class BaseActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        C1260i.m4429a(f2326a, "Time test:Start in BaseActivity 0 ");
        StatService.setAppChannel(getApplicationContext(), PackageUtil.getChannel(), true);
        C1260i.m4429a(f2326a, "Time test:Start in BaseActivity 1 ");
        String cuid = CommonParam.getCUID(getApplicationContext());
        PackageUtil.setCuid(cuid);
        C1260i.m4429a(f2326a, "cuid = " + cuid);
        C1260i.m4429a(f2326a, "Time test:Start in BaseActivity 2");
