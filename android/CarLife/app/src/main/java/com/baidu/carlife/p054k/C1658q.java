...
public class C1658q extends C1626e {
    ...
    protected C1622d getUrlParams() {
        ...
        params.put("cl_app_version", C1251e.m4373g());
        params.put("cl_sdk_version", "1.0");
        params.put("cl_device_id", C1251e.m4359b());
        params.put("cl_width", String.valueOf(C1251e.m4367d()));
        params.put("cl_height", String.valueOf(C1251e.m4369e()));
        params.put("cl_system_version", C1251e.m4377i());
        params.put("cl_device_type", C1251e.m4378j());
        return params;
    }
