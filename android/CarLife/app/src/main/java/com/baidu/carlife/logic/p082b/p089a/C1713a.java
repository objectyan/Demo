...
public class C1713a extends C1100a<C1717a> {
    ...
    public List<C1717a> mo1620c() {
        ...
        for (String title : C1157a.m3876a().getResources().getStringArray(C0965R.array.home_help_items)) {
    ...
    private C1717a m6262a(String content) {
        ...
        layoutId.mo1419b(Integer.valueOf(C0965R.layout.item_setting_single_text));
