...
class C1332c extends C1330a {
    ...
    /* renamed from: l */
    private static C1338e f3847l = C1338e.m4826b();
    /* renamed from: m */
    private long f3848m = ((long) C1338e.f3864e);
    /* renamed from: n */
    ...
    public void mo1524a(int newRate) {
        if (newRate > 0 && this.c != null) {
            try {
                ...
                C1260i.m4445e(f3844i, "changeFrameRate Writer error");
                e.printStackTrace();
            }
        }
    }
    ...
    public void run() {
        if (f3847l.m4879j() || f3847l.m4840G()) {
            this.f3848m = (long) C1338e.f3864e;
            try {
                this.f3849n = new LocalSocket();
                this.f3849n.connect(new LocalSocketAddress(f3845j));
                try {
                    C1260i.m4440c(f3844i, "accept");
                    this.b = new DataInputStream(this.f3849n.getInputStream());
                    this.c = new DataOutputStream(this.f3849n.getOutputStream());
                    this.c.writeInt(C1338e.f3861b);
                    this.c.writeInt(C1338e.f3862c);
                    this.c.writeInt(C1249d.m4331a().m4351h());
                    this.c.writeInt(C1249d.m4331a().m4352i());
                    this.c.writeInt(0);
                    this.c.write((byte) (C1338e.f3863d + 100));
                    this.c.write(1);
                    f3847l.m4874g(true);
                    int dataLength = (C1338e.f3861b * C1338e.f3862c) * 4;
                    if (d == null || d.length != dataLength) {
                        d = new byte[dataLength];
                    }
                    while (!C1192c.m4069a().m4082e() && this.a) {
                        if (f3847l.m4888s()) {
                    ...
                    if (f3847l.m4879j()) {
                        if (e == null || f == null || f.getWidth() != C1338e.f3861b || f.getHeight() != C1338e.f3862c) {
                            e = ByteBuffer.wrap(d);
                            f = Bitmap.createBitmap(C1338e.f3861b, C1338e.f3862c, Config.ARGB_8888);
                        }
                        while (this.a) {
                            m4799b(dataLength);
                        }
                    } else if (mColorFormat == 15 || mColorFormat == 16) {
                        if (f3847l.m4837D() || C1341g.m4915b()) {
                            f3847l.m4876h(false);
                        } else {
                        ...
                        if ((f3847l.m4837D() && f3846k == null) || C1341g.m4915b()) {
                            if (mColorFormat == 6 || mColorFormat == 7) {
                                f3846k = new byte[((C1338e.f3861b * C1338e.f3862c) * 2)];
                            } else {
                                f3846k = new byte[(((C1338e.f3861b * C1338e.f3862c) * 3) / 2)];
                            }
                            f3847l.m4876h(false);
                        } else {
                            m4798a(true, dataLength);
                            C1341g.m4912a(f3846k);
                        }
                        f3847l.m4834A();
                        while (this.a) {
                            m4801c(dataLength);
                    ...
                    C1260i.m4445e(f3843h, "LocalSocket 读写异常");
                    e2.printStackTrace();
                } catch (NullPointerException e3) {
                    C1260i.m4440c(f3843h, "Output Thread closeLocalSocket lead to");
                }
                m4800c();
                return;
            } catch (IOException e22) {
                C1260i.m4445e(f3843h, "connect to localSocket fail");
                f3847l.m4891v();
                this.f3849n = null;
                e22.printStackTrace();
                return;
    ...
    private void m4799b(int imgDataLength) throws IOException {
        ...
        this.b.readFully(d, 0, imgDataLength);
        C1260i.m4440c(f3844i, "JAVA got frame time = " + (System.currentTimeMillis() - startTime));
        e.rewind();
        ...
        this.c.write(1);
        this.g.reset();
        C1260i.m4440c(f3844i, "JAVA jpeg time = " + (System.currentTimeMillis() - startTime) + ", length = " + length);
    }
    ...
    private void m4801c(int imgDataLength) throws IOException {
        ...
        JniMethod.convert(d, f3846k, C1338e.f3861b, C1338e.f3862c);
        C1260i.m4440c(f3844i, "JAVA native convert time = " + (System.currentTimeMillis() - startTime) + "~~~~~");
        startTime = System.currentTimeMillis();
        ...
        C1260i.m4440c(f3844i, "JAVA input2Encoder time = " + (System.currentTimeMillis() - startTime));
    }
    ...
    private void m4803d(int imgDataLength) throws IOException {
        ...
        C1260i.m4440c(f3844i, "JAVA encode time = " + (System.currentTimeMillis() - startTime));
    }
