...
import com.baidu.carlife.adpter.C0986h.C0985a;
import com.baidu.carlife.adpter.C0992j;
...
public class MusicPlayerFragment extends ContentFragment {
    ...
    /* renamed from: L */
    private C0936j f4611L = new C15456(this);
    /* renamed from: M */
    ...
    class C15412 implements C0985a {
        ...
        public void mo1591a() {
            ...
            C2201w.m8373a(this.f4592a.getContext().getString(C0965R.string.carlife_update_no_network), 0);
        }
    }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case C0965R.id.ib_left:
                    this.f4594a.m5659i();
                    return;
                case C0965R.id.ib_mode:
                    this.f4594a.f4634v.m6825m();
                    this.f4594a.m5651e();
                    return;
                case C0965R.id.ib_more:
                    this.f4594a.m5655g();
                    return;
                case C0965R.id.music_prev:
                ...
                case C0965R.id.iv_list:
                    if (this.f4594a.f4631s != null) {
                        if (C1343b.m4932a().m4935b()) {
                            this.f4594a.m5643a(C1328h.m4757a().getNaviFragmentManager().isDriving());
                        }
    ...
    class C15456 extends C0936j {
        ...
        public void handleMessage(Message msg) {
                ...
                case 225:
                    if (msg.arg1 == this.f4596a.f4633u.m6649s() && this.f4596a.f4623k != null) {
                        if (this.f4596a.f4637y == null || !this.f4596a.f4637y.f5919k) {
                            this.f4596a.f4623k.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_play));
                            return;
                        } else {
                            this.f4596a.f4623k.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_pause));
                            return;
                        }
                    }
                    return;
                ...
                case C1253f.dR /*249*/:
                    if (msg.arg1 == this.f4596a.f4633u.m6649s()) {
                        ...
                        if (msg.arg1 >= 3 && msg.arg2 != -1) {
                            C2201w.m8373a(this.f4596a.getString(C0965R.string.module_music_thirdparty_null_list), 1);
                        }
            ...
            if (msg.obj == null) {
                ...
                this.f4596a.m5643a(C1328h.m4757a().getNaviFragmentManager().isDriving());
            }
        }
    }
    ...
    class C15489 implements Runnable {
        ...
        public void run() {
            this.f4599a.f4623k.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_play));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.f4635w = new C0992j(getContext());
        this.f4636x = new ArrayList();
        C1261k.m4460a(this.f4611L);
    }
    ...
    public void onStart() {
        m5675q();
        super.onStart();
        C1260i.m4435b(C1818h.f5590a, "------onStart()------");
    }
    ...
    public void onResume() {
        ...
        super.onResume();
        onInitFocusAreas();
        C1260i.m4434b(C1818h.f5590a);
        this.f4605E = SystemClock.elapsedRealtime();
        C1260i.m4435b(C1818h.f5590a, "--QA_Test---time:" + (this.f4605E - this.f4604D) + "ms");
    }
    ...
    protected View onCreateContentView(LayoutInflater inflater) {
        this.mContentView = inflater.inflate(C0965R.layout.frag_music_player, null);
        m5677r();
        m5680u();
    ...
    protected void onUpdateSkin() {
        updateCommonSkin();
        this.f4615c.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a4_title));
        this.f4617e.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a2_content));
        this.f4616d.setTextColor(C2188r.m8328a((int) C0965R.color.cl_text_a2_content));
        this.f4621i.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_flipchannel));
        this.f4622j.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_lastsong));
        this.f4624l.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_nextsong));
        this.f4614b.setImageDrawable(C2188r.m8331b(C0965R.drawable.com_ic_back));
        this.f4621i.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_btn_selector));
        this.f4622j.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_btn_selector));
        this.f4624l.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_btn_selector));
        this.f4614b.setBackground(C2251b.m8527a(getContext()));
        this.f4630r.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_btn_selector));
        if (this.f4637y == null || !this.f4637y.f5919k) {
            this.f4623k.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_play));
        } else {
            this.f4623k.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_pause));
        }
        this.f4623k.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_music_play_btn_selector));
        m5651e();
    ...
    private void m5634a(int status) {
        ...
        if (this.f4633u.m6649s() == 0) {
            ...
            this.f4619g.m8398a((int) C0965R.string.module_music_null_hint, (int) C0965R.drawable.com_ic_music_empty);
            this.f4619g.m8396a();
        } else if (this.f4633u.m6649s() == 1) {
            this.f4614b.setVisibility(0);
            this.f4621i.setVisibility(4);
            this.f4619g.m8398a((int) C0965R.string.module_music_content_no_network, (int) C0965R.string.module_music_content_reconnect);
        ...
        switch (status) {
            ...
            case 3:
                ...
                break;
            case 4:
                this.f4619g.m8398a((int) C0965R.string.module_musicqq_downlist_empty, (int) C0965R.string.module_music_content_reconnect);
                ...
                break;
            case 5:
                this.f4619g.m8398a((int) C0965R.string.module_musicqq_list_empty, (int) C0965R.string.module_music_content_reconnect);
                this.f4619g.m8401a(true);
                this.f4626n.setVisibility(8);
                this.f4619g.setVisibility(0);
                if (this.f4633u.m6649s() == 0) {
            ...
            case 6:
                ...
                this.f4619g.m8398a((int) C0965R.string.module_music_thirdparty_downlist_empty2, (int) C0965R.string.module_music_content_reconnect);
                this.f4619g.m8401a(true);
                this.f4626n.setVisibility(8);
                this.f4619g.setVisibility(0);
                if (this.f4633u.m6649s() == 0) {
    ...
    /* renamed from: e */
    private void m5651e() {
        this.f4625m.setBackground(C2188r.m8331b(C0965R.drawable.com_bg_btn_selector));
        switch (this.f4634v.m6820k()) {
            case 0:
                this.f4625m.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_singlecycle));
                return;
            case 1:
                this.f4625m.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_random));
                return;
            case 2:
                this.f4625m.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_cycle));
                return;
            default:
                this.f4625m.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_cycle));
                return;
    ...
    private void m5661j() {
        if (this.f4634v.m6828p()) {
            ...
            this.f4632t.setImageResource(C0965R.anim.anim_music_playing);
            this.f4602B = (AnimationDrawable) this.f4632t.getDrawable();
            this.f4602B.start();
        } else {
            this.f4632t.setVisibility(0);
            this.f4632t.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_player_normal));
            if (this.f4602B != null) {
                this.f4602B.stop();
            }
        }
    ...
    private void m5671o() {
        ...
        this.f4632t.setImageDrawable(C2188r.m8331b(C0965R.drawable.music_ic_playlist));
        if (this.f4602B != null) {
            this.f4602B.stop();
        }
    }
    ...
    private void m5674p() {
        if (C1343b.m4932a().m4935b()) {
            m5643a(C1328h.m4757a().getNaviFragmentManager().isDriving());
        }
    ...
    /* renamed from: r */
    private void m5677r() {
        this.f4615c = (MarqueeTextView) this.mContentView.findViewById(C0965R.id.music_name);
        this.f4617e = (MarqueeTextView) this.mContentView.findViewById(C0965R.id.music_album);
        this.f4616d = (MarqueeTextView) this.mContentView.findViewById(C0965R.id.music_singer);
        this.f4622j = (ImageButton) this.mContentView.findViewById(C0965R.id.music_prev);
        this.f4623k = (ImageButton) this.mContentView.findViewById(C0965R.id.music_play);
        this.f4624l = (ImageButton) this.mContentView.findViewById(C0965R.id.music_next);
        this.f4625m = (ImageButton) this.mContentView.findViewById(C0965R.id.ib_mode);
        this.f4621i = (ImageButton) this.mContentView.findViewById(C0965R.id.ib_more);
        this.f4614b = (ImageButton) this.mContentView.findViewById(C0965R.id.ib_left);
        this.f4620h = (MusicCircleProgressView) this.mContentView.findViewById(C0965R.id.cp_progress);
        this.f4601A = (MultiImageView) this.mContentView.findViewById(C0965R.id.iv_music_type);
        this.f4632t = (ImageView) this.mContentView.findViewById(C0965R.id.iv_list);
        this.f4619g = (CommonTipView) this.mContentView.findViewById(C0965R.id.common_tip_view);
        this.f4619g.setCommonTipCallBack(new C15478(this));
        this.f4626n = (RelativeLayout) this.mContentView.findViewById(C0965R.id.rl_music_content);
        this.f4618f = this.mContentView.findViewById(C0965R.id.iv_null_arrow);
        this.f4630r = (RelativeLayout) this.mContentView.findViewById(C0965R.id.rl_music_type);
        this.f4632t.setOnClickListener(this.f4609J);
        ...
        this.f4603C = new C2268a(mActivity, C0965R.string.module_music_select_source, this.f4634v.m6771E(), this.f4634v.m6772F());
        this.f4603C.m8605j();
    }
    ...
    /* renamed from: t */
    private void m5679t() {
        this.f4631s = new C2268a(mActivity, C0965R.string.module_music_title_gedan, this.f4635w, this.f4610K);
        this.f4631s.m8605j();
    ...
    private void m5645b(int pos) {
        ...
        if (app != null) {
            if (app.f6068c >= 3) {
                this.f4601A.setDefaultDrawable(C2188r.m8331b(C0965R.drawable.music_ic_default));
    ...
    /* renamed from: w */
    private void m5682w() {
        C1260i.m4435b(C1818h.f5590a, "startTimerForLoadmore");
        ...
        try {
            ...
            this.f4607H = new TimerTask(this) {
                ...
                class C15381 implements Runnable {
                    ...
                    public void run() {
                        ...
                        C2201w.m8371a((int) C0965R.string.module_music_getlist_timeout_hint, 1);
                    }
                }
            ...
            C1260i.m4435b(C1818h.f5590a, "startTimer get exception");
            e.printStackTrace();
        }
    }
    ...
    private void m5683x() {
        ...
        C1260i.m4435b(C1818h.f5590a, "stop timer");
    }
    ...
    public boolean onVoiceCommand(String strCommand, String strIntent) {
        C1260i.m4435b(C1818h.f5590a, "Voice Command: " + strCommand + " # " + strIntent);
    ...
    public void onInitFocusAreas() {
        if (this.f4634v != null && this.isDisplayed && this.f4633u != null && getCurrentFragmentType() == NaviFragmentManager.TYPE_MUSIC_PLAYER && !isDialogShown()) {
            ...
            switch (this.f4633u.m6654x()) {
                case 2:
                    C1260i.m4435b(C1818h.f5590a, "onInitFocusAreas normal");
                ...
                case 5:
                case 6:
                    C1260i.m4435b(C1818h.f5590a, "onInitFocusAreas nullfail");
                    focusManager.m5256b(m5631A());
                    focusManager.m5268h(m5631A());
                    return;
                case 4:
                    C1260i.m4435b(C1818h.f5590a, "onInitFocusAreas notbuttonfail");
                    focusManager.m5256b(m5632B());
                    focusManager.m5268h(m5632B());
                    return;
                default:
                    C1260i.m4435b(C1818h.f5590a, "onInitFocusAreas default");
                    return;
            }
        }
    }
