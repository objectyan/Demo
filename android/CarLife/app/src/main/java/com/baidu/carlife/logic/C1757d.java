...
public class C1757d {
    ...
    public boolean m6394e() {
        try {
            ...
            C1260i.m4445e(f5312a, "computerProtocolMatchStatus fail");
            ex.printStackTrace();
            return false;
        }
    }
    ...
    public void m6397h() {
        try {
            C1212c protocolM = new C1212c(true);
            protocolM.m4201c(C1253f.f3536C);
            ...
            C1260i.m4445e(f5312a, "sendProtocolMatchStatus fail");
            ex.printStackTrace();
        }
    }
}
