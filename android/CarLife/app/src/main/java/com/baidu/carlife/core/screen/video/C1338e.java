...
import com.baidu.carlife.core.screen.presentation.p071a.C1321j;
...
public class C1338e {
    ...
    /* renamed from: C */
    private C1330a f3881C;
    /* renamed from: D */
    private C1341g f3882D;
    /* renamed from: E */
    ...
    class C13341 extends Handler {
        /* renamed from: a */
        final /* synthetic */ C1338e f3856a;

        C13341(C1338e this$0) {
            this.f3856a = this$0;
        }
    ...
    class C13352 implements Runnable {
        /* renamed from: a */
        final /* synthetic */ C1338e f3857a;

        C13352(C1338e this$0) {
            this.f3857a = this$0;
        }
    ...
    class C13363 extends Thread {
        /* renamed from: a */
        final /* synthetic */ C1338e f3858a;

        C13363(C1338e this$0) {
            this.f3858a = this$0;
        }
            ...
            synchronized (this.f3858a.f3897S) {
                synchronized (this.f3858a.f3898T) {
                    try {
                        ...
                        C1260i.m4435b(C1338e.f3860a, "Recorder mEncoder.stop()");
                    } catch (IllegalStateException e) {
                        e.printStackTrace();
                    }
                    try {
                        this.f3858a.f3880B.release();
                        C1260i.m4435b(C1338e.f3860a, "Recorder mEncoder.release");
                    ...
                    try {
                        ...
                        if (this.f3858a.am != null) {
                            ...
                            this.f3858a.am = null;
                            C1260i.m4435b(C1338e.f3860a, "Recorder mEncSurface.release");
                        }
                    } catch (Exception e3) {
                        e3.printStackTrace();
                    }
    ...
    private class C1337a extends Callback {
        /* renamed from: a */
        final /* synthetic */ C1338e f3859a;

        private C1337a(C1338e c1338e) {
            this.f3859a = c1338e;
        }
    ...
    private C1338e() {
        ...
        this.f3901W = new C1340f();
        if (!this.ag) {
            this.f3902X = C1157a.m3876a().getSharedPreferences(C1253f.ia, 0);
    ...
    /* renamed from: a */
    public void m4857a(C0940j listener) {
    ...
    public boolean m4880k() {
        if (!this.f3894P && C1215d.m4207a().m4225c()) {
            return this.f3885G;
        }
        return false;
    }
    ...
    public void m4855a(int type) {
        ...
        command.m4199b(info.toByteArray());
        command.m4203d(info.getSerializedSize());
    ...
    public void m4882m() {
        if (C1190a.m4065a()) {
            C1260i.m4435b(f3860a, " onActivityPause internal screen capture ");
        } else {
            C1260i.m4435b(f3860a, " onActivityPause fullscreen capture, Invoke's Recorder pauseFromMobile() ");
            m4866c(false);
            m4875h();
        }
    ...
    public boolean m4883n() {
        if (C1190a.m4065a() || !this.ag || this.ak != null || m4879j()) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: v */
    void m4891v() {
        C1260i.m4435b(f3860a, "setInputThreadNull...");
        this.f3881C = null;
    }
    ...
    boolean m4841H() {
        ...
        C1260i.m4435b(f3860a, "Recorder releaseVideoEncoder");
        this.f3893O = true;
    ...
    private void m4814T() {
        if (f3863d >= 15) {
            try {
                if (!C1190a.m4065a() && this.f3881C != null) {
    ...
    int m4844K() {
        ...
        if (this.f3894P) {
            if (this.f3881C == null) {
                if (C1190a.m4065a()) {
                    this.f3881C = new C1331b();
                } else {
                    this.f3881C = new C1332c();
                }
                this.f3881C.start();
                return 0;
            }
            C1260i.m4445e(f3860a, "The RecordThread didnt close last time");
            return -1;
        } else if (C1190a.m4065a()) {
            C1260i.m4435b(f3860a, "startThread internal screen capture.");
            m4818X();
            return 0;
        } else if (this.ag) {
            m4818X();
            ...
            C1260i.m4435b(f3860a, "startThread full screen capture.");
            if (this.f3881C != null) {
                return -1;
            }
            this.f3881C = new C1332c();
    ...
    /* renamed from: U */
    private void m4815U() {
        C1260i.m4435b(f3860a, "Recorder  ==============================> begin stopThread()");
        if ((C1190a.m4065a() || this.ag) && !this.f3894P) {
            if (!C1190a.m4065a()) {
                aa();
                if (this.am != null) {
                    this.am.release();
        ...
        C1260i.m4435b(f3860a, "Recorder  ==============================> end stopThread()");
    }
    ...
    boolean m4865b(int destWidth, int destHeight, int destFrameRate) {
        ...
        C1260i.m4445e(f3860a, "mContainerWidth = " + f3861b + ", mContainerHeight = " + f3862c);
        try {
        ...
        while (this.f3909x < f3878w.length) {
            ...
            if (isConfigSuccess) {
                C1260i.m4445e(f3860a, "with level 3.0 mColorFormat=" + this.f3910y);
                break;
            }
            try {
                ...
                mediaFormat.setInteger("color-format", this.f3910y);
                this.f3880B.configure(mediaFormat, null, null, 1);
                C1260i.m4445e(f3860a, "mColorFormat=" + this.f3910y);
                break;
            } catch (Exception e22) {
                e22.printStackTrace();
                this.f3909x++;
        ...
        while (needErgodic) {
            ...
            if (this.f3909x != 45 || this.f3909x == 46) {
                C1260i.m4445e(f3860a, "没有合适的参数可完成初始化 n = " + this.f3909x);
                this.f3880B = null;
                return false;
            }
            try {
                ...
                C1260i.m4435b(f3860a, "initMediaCodec mColorFormat=" + this.f3910y);
                if (C1190a.m4065a()) {
                }
                return true;
    ...
    int m4852a(byte[] input) {
        synchronized (this.f3897S) {
            if (this.f3880B == null) {
                C1260i.m4445e(f3860a, "还没完成初始化, 或已经被释放");
                return -2;
            }
            try {
                ...
                C1260i.m4443d(f3860a, "input2Encoder -1;sendEmptyPacket");
                m4845L();
                return -1;
            } catch (Throwable t) {
                t.printStackTrace();
    ...
    int m4845L() {
        ...
        synchronized (this.f3899U) {
            ...
            a = C1218e.m4228a().m4236a(this.f3883E, 12);
        }
        return a;
    }
    ...
    int m4853a(byte[] videoData, int length) {
        ...
        int sendLen = length;
        if (C1208e.m4120a().m4135c() && length > 0) {
            sendDtata = this.f3904Z.m4112a(videoData, length);
            if (sendDtata == null) {
                C1260i.m4445e(f3860a, "encrypt failed!");
                return -1;
            }
        ...
        synchronized (this.f3899U) {
            ...
            this.f3883E[10] = (byte) 0;
            this.f3883E[11] = (byte) 1;
            C1218e.m4228a().m4236a(this.f3883E, 12);
            a = C1218e.m4228a().m4236a(sendDtata, sendLen);
        }
        return a;
    }
            ...
            synchronized (this.f3898T) {
                ...
                try {
                    ...
                    if (C1249d.m4334m()) {
                        ...
                        C1260i.m4435b(f3860a, "####### Adapte Video size");
                    }
                    C1260i.m4435b(f3860a, "####### set vidoe size[" + this.ae + " : " + this.af + "]");
                    if (!(f3861b == this.ae && f3862c == this.af)) {
                        C1260i.m4435b(f3860a, "####### set setFirstEncodeFrame size[" + this.ae + " : " + this.af + "]");
                        m4872f(true);
                        C1341g.m4916c();
                    }
                    f3861b = this.ae;
    ...
    boolean m4867c(int destWidth, int destHeight, int destFrameRate) {
        if (this.f3905f != null) {
            C1260i.m4445e(f3860a, "重复调用了initMediaCodec50TextureView");
        } else {
