...
final class bj
  implements Runnable
{
  bj(String paramString, c paramc, Context paramContext) {}
  ...
  public final void run()
  {
    try
    {
      ...
      if (f.b()) {
        j.g().b("add begin key:" + this.b.toString());
      }
      if (j.l().containsKey(this.b))
      {
        j.g().g("Duplicate CustomEvent key: " + this.b.toString() + ", trackCustomBeginEvent() repeated?");
        return;
      }
    }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes3-dex2jar.jar!/com/tencent/wxop/stat/bj.class
