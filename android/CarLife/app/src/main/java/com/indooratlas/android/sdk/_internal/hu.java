    ...
    for (;;)
    {
      synchronized (b)
      {
        ...
        if (localDateFormat == null)
        {
          ...
          ((DateFormat)localObject).setTimeZone(gy.d);
          c[i] = localObject;
        }
...
/* Location:              /Users/objectyan/Documents/OY/baiduCarLife_40/dist/classes2-dex2jar.jar!/com/indooratlas/android/sdk/_internal/hu.class
