...
class SimpleMultipartEntity implements C3008n {
    ...
    private class FilePart {
        ...
        private byte[] createHeader(String key, String filename, String type) {
            ...
            try {
                ...
                AsyncHttpClient.log.mo4881e(SimpleMultipartEntity.LOG_TAG, "createHeader ByteArrayOutputStream exception", e);
            }
    ...
    public void addPart(String key, String value, String contentType) {
        try {
            ...
            AsyncHttpClient.log.mo4881e(LOG_TAG, "addPart ByteArrayOutputStream exception", e);
        }
    }
    ...
    public C6327f getContentType() {
        return new C6541b("Content-Type", "multipart/form-data; boundary=" + this.boundary);
    }
