...
public abstract class SaxAsyncHttpResponseHandler<T extends DefaultHandler> extends AsyncHttpResponseHandler {
    ...
    public abstract void onFailure(int i, C6327f[] c6327fArr, T t);

    public abstract void onSuccess(int i, C6327f[] c6327fArr, T t);
            ...
            if (instream != null) {
                try {
                    ...
                    try {
                        ...
                        try {
                            AsyncHttpClient.log.mo4881e(LOG_TAG, "getResponseData exception", e);
                            AsyncHttpClient.silentCloseInputStream(instream);
                        ...
                        e2 = e7;
                        inputStreamReader = inputStreamReader2;
                        AsyncHttpClient.log.mo4881e(LOG_TAG, "getResponseData exception", e2);
                        AsyncHttpClient.silentCloseInputStream(instream);
                        if (inputStreamReader != null) {
                            try {
                                inputStreamReader.close();
